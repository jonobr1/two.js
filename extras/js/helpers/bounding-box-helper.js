(function () {
   ...
   */
  class BoundingBoxHelper extends Two.Group {
    /**
    ...
    constructor(target, options = {}) {
      ...
      const rotLine = new Two.Line(
        0,
        0,
        0,
        -this._options.rotationHandleOffset
      );
      rotLine.stroke = this._options.color;
      rotLine.linewidth = this._options.linewidth;

      const rotCircle = new Two.Circle(
        0,
        -this._options.rotationHandleOffset,
        5
      );
    ...
    _getSingleTargetInfo(target) {
      ...
      const rotation =
        typeof target.rotation === 'number' ? target.rotation : 0;
  ...
  Two.Helpers = Two.Helpers || {};
  Two.Helpers.BoundingBoxHelper = BoundingBoxHelper;
})();

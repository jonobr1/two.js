...
(function() {
  ...
  test('Two.Path.getBoundingClientRect', 4, function(o) {
    ...
    (function() {
      ...
      deepEqual(shape.getBoundingClientRect(), answer, 'Two.Path.getBoundingClientRect properly calculates rotated shapes.');
    ...
    (function() {
      ...
      deepEqual(shape.getBoundingClientRect(), answer, 'Two.Path.getBoundingClientRect properly calculates scaled shapes.');
    ...
    (function() {
      ...
      deepEqual(shape.getBoundingClientRect(), answer, 'Two.Path.getBoundingClientRect properly calculates circles.');
    ...
    (function() {
      ...
      deepEqual(shape.getBoundingClientRect(), answer, 'Two.Path.getBoundingClientRect properly calculates rotated circles (projected).');
  ...
  test('Two.getComputedMatrix', 2, function(o) {
    ...
    (function() {
      ...
      deepEqual(bBox, answer, 'Two.Path.getBoundingClientRect properly calculates nested shapes / groups.');
      deepEqual(bBoxClose, answer, 'Two.Path.getBoundingClientRect properly calculates nested shapes / groups.');

...
QUnit.test('Two Intersecting Circles', function (assert) {
  ...
  assert.equal(
    ...
    2,
    'Expected 2 intersections between two overlapping circles'
  );
});
...
QUnit.test('Overlapping Rectangles', function (assert) {
  ...
  assert.equal(
    intersections.length,
    4,
    'Expected 4 intersections between overlapping rectangles'
  );
});
...
QUnit.test('Tangent Circles', function (assert) {
  ...
  assert.equal(
    intersections.length,
    1,
    'Expected 1 intersection at tangent point'
  );
});
...
QUnit.test('Non-intersecting Shapes', function (assert) {
  ...
  assert.equal(
    intersections.length,
    0,
    'Expected 0 intersections for non-overlapping shapes'
  );
});
...
QUnit.test('Circle Intersecting Rectangle', function (assert) {
  ...
  assert.equal(
    intersections.length,
    8,
    'Expected 8 intersections between circle and rectangle'
  );
});
...
QUnit.test('Curved Path Intersection', function (assert) {
  ...
  assert.ok(
    ...
    'Expected at least 1 intersection between curved paths'
  );
});
...
QUnit.test('Star Intersecting Circle', function (assert) {
  ...
  assert.equal(
    intersections.length,
    10,
    'Expected 10 intersections between star and circle'
  );
});
...
QUnit.test('Two Intersecting Ellipses', function (assert) {
  ...
  assert.equal(
    intersections.length,
    2,
    'Expected 2 intersections between two overlapping ellipses'
  );
});
...
QUnit.test('Circle Completely Within Circle', function (assert) {
  ...
  assert.equal(
    intersections.length,
    0,
    'Expected 0 intersections when inner circle is fully contained'
  );
});
...
QUnit.test('Identical Coincident Circles', function (assert) {
  ...
  two.update();
  Two.Utils.findPathIntersections(circle1, circle2);
...
QUnit.test('Rotated Rectangles Intersecting', function (assert) {
  ...
  assert.equal(
    intersections.length,
    8,
    'Expected 8 intersections with 45-degree rotated rectangle'
  );
});
...
QUnit.test('Self-Intersecting Figure-8 Path', function (assert) {
  ...
  assert.ok(
    intersections.length >= 1,
    'Expected at least 1 intersection in figure-8 configuration'
  );
});
...
QUnit.test('Rectangle Within Rectangle', function (assert) {
  ...
  assert.equal(
    intersections.length,
    0,
    'Expected 0 intersections when inner rectangle is fully contained'
  );
});
...
QUnit.test('Nearly Tangent Circles (Tiny Gap)', function (assert) {
  ...
  assert.equal(
    intersections.length,
    0,
    'Expected 0 intersections with 0.1px gap between circles'
  );
});
...
QUnit.test('Scaled Circle Containing Rectangle', function (assert) {
  ...
  assert.equal(
    intersections.length,
    0,
    'Expected 0 intersections when scaled circle contains rectangle'
  );
});
...
QUnit.test('Scaled Circle Intersecting Rectangle', function (assert) {
  ...
  assert.equal(
    intersections.length,
    8,
    'Expected 8 intersections between scaled circle and rectangle'
  );
});

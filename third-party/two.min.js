...
l=!j}}e.pop();return l}var f=this,n=f._,p={},m=Array.prototype,c=Object.prototype,b=m.slice,l=m.unshift,a=c.toString,e=c.hasOwnProperty,t=m.forEach,A=m.map,s=m.reduce,j=m.reduceRight,y=m.filter,I=m.every,x=m.some,w=m.indexOf,v=m.lastIndexOf,c=Array.isArray,r=Object.keys,u=Function.prototype.bind,d=function(k){return new J(k)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=d),exports._=d):f._=d;d.VERSION="1.3.3";var z=d.each=d.forEach=function(k,
a,b){if(null!=k)if(t&&k.forEach===t)k.forEach(a,b);else if(k.length===+k.length)for(var e=0,c=k.length;e<c&&!(e in k&&a.call(b,k[e],e,k)===p);e++);else for(e in k)if(d.has(k,e)&&a.call(b,k[e],e,k)===p)break};d.map=d.collect=function(k,a,d){var b=[];if(null==k)return b;if(A&&k.map===A)return k.map(a,d);z(k,function(k,e,c){b[b.length]=a.call(d,k,e,c)});k.length===+k.length&&(b.length=k.length);return b};d.reduce=d.foldl=d.inject=function(k,a,b,e){var c=2<arguments.length;null==k&&(k=[]);if(s&&k.reduce===
s)return e&&(a=d.bind(a,e)),c?k.reduce(a,b):k.reduce(a);z(k,function(k,d,j){c?b=a.call(e,b,k,d,j):(b=k,c=!0)});if(!c)throw new TypeError("Reduce of empty array with no initial value");return b};d.reduceRight=d.foldr=function(k,a,b,e){var c=2<arguments.length;null==k&&(k=[]);if(j&&k.reduceRight===j)return e&&(a=d.bind(a,e)),c?k.reduceRight(a,b):k.reduceRight(a);var l=d.toArray(k).reverse();e&&!c&&(a=d.bind(a,e));return c?d.reduce(l,a,b,e):d.reduce(l,a)};d.find=d.detect=function(k,a,d){var b;D(k,function(k,
e,c){if(a.call(d,k,e,c))return b=k,!0});return b};d.filter=d.select=function(k,a,d){var b=[];if(null==k)return b;if(y&&k.filter===y)return k.filter(a,d);z(k,function(k,e,c){a.call(d,k,e,c)&&(b[b.length]=k)});return b};d.reject=function(k,a,d){var b=[];if(null==k)return b;z(k,function(k,e,c){a.call(d,k,e,c)||(b[b.length]=k)});return b};d.every=d.all=function(k,a,d){var b=!0;if(null==k)return b;if(I&&k.every===I)return k.every(a,d);z(k,function(k,e,c){if(!(b=b&&a.call(d,k,e,c)))return p});return!!b};
var D=d.some=d.any=function(k,a,b){a||(a=d.identity);var e=!1;if(null==k)return e;if(x&&k.some===x)return k.some(a,b);z(k,function(k,d,c){if(e||(e=a.call(b,k,d,c)))return p});return!!e};d.include=d.contains=function(k,a){var d=!1;return null==k?d:w&&k.indexOf===w?-1!=k.indexOf(a):d=D(k,function(k){return k===a})};d.invoke=function(k,a){var e=b.call(arguments,2);return d.map(k,function(k){return(d.isFunction(a)?a||k:k[a]).apply(k,e)})};d.pluck=function(k,a){return d.map(k,function(k){return k[a]})};
d.max=function(k,a,b){if(!a&&d.isArray(k)&&k[0]===+k[0])return Math.max.apply(Math,k);if(!a&&d.isEmpty(k))return-Infinity;var e={computed:-Infinity};z(k,function(k,d,c){d=a?a.call(b,k,d,c):k;d>=e.computed&&(e={value:k,computed:d})});return e.value};d.min=function(k,a,b){if(!a&&d.isArray(k)&&k[0]===+k[0])return Math.min.apply(Math,k);if(!a&&d.isEmpty(k))return Infinity;var e={computed:Infinity};z(k,function(k,d,c){d=a?a.call(b,k,d,c):k;d<e.computed&&(e={value:k,computed:d})});return e.value};d.shuffle=
function(k){var a=[],d;z(k,function(k,b){d=Math.floor(Math.random()*(b+1));a[b]=a[d];a[d]=k});return a};d.sortBy=function(k,a,b){var e=d.isFunction(a)?a:function(k){return k[a]};return d.pluck(d.map(k,function(k,a,d){return{value:k,criteria:e.call(b,k,a,d)}}).sort(function(k,a){var d=k.criteria,b=a.criteria;return void 0===d?1:void 0===b?-1:d<b?-1:d>b?1:0}),"value")};d.groupBy=function(k,a){var b={},e=d.isFunction(a)?a:function(k){return k[a]};z(k,function(k,a){var d=e(k,a);(b[d]||(b[d]=[])).push(k)});
...
return function(){for(var d=arguments,b=a.length-1;0<=b;b--)d=[a[b].apply(this,d)];return d[0]}};d.after=function(a,d){return 0>=a?d():function(){if(1>--a)return d.apply(this,arguments)}};d.keys=r||function(a){if(a!==Object(a))throw new TypeError("Invalid object");var b=[],e;for(e in a)d.has(a,e)&&(b[b.length]=e);return b};d.values=function(a){return d.map(a,d.identity)};d.functions=d.methods=function(a){var b=[],e;for(e in a)d.isFunction(a[e])&&b.push(e);return b.sort()};d.extend=function(a){z(b.call(arguments,
1),function(d){for(var b in d)a[b]=d[b]});return a};d.pick=function(a){var e={};z(d.flatten(b.call(arguments,1)),function(d){d in a&&(e[d]=a[d])});return e};d.defaults=function(a){z(b.call(arguments,1),function(d){for(var b in d)null==a[b]&&(a[b]=d[b])});return a};d.clone=function(a){return!d.isObject(a)?a:d.isArray(a)?a.slice():d.extend({},a)};d.tap=function(a,d){d(a);return a};d.isEqual=function(a,d){return q(a,d,[])};d.isEmpty=function(a){if(null==a)return!0;if(d.isArray(a)||d.isString(a))return 0===
...
e=(e-b)/2,c=(c-d)/2,l=[new j.Vector(-e,-c),new j.Vector(e,c)],l=(new j.Polygon(l)).noFill();l.translation.set(b+e,d+c);return j.Utils.applySvgAttributes(a,l)}},subdivide:function(b,f,d,m,t,s,A,n,p){var y=j.Utils.Curve.CollinearityEpsilon,q=j.Utils.Curve.CuspLimit,x=j.Utils.Curve.Tolerance;p=p||0;var I=(b+d)/2,w=(f+m)/2,v=(d+t)/2,k=(m+s)/2,R=(t+A)/2,S=(s+n)/2,T=(I+v)/2,U=(w+k)/2,v=(v+R)/2,k=(k+S)/2,F=(T+v)/2,G=(U+k)/2;if(0<p){var B=A-b,C=n-f,K=l((d-A)*C-(m-n)*B),L=l((t-A)*C-(s-n)*B);if(K>y&&L>y&&(K+
L)*(K+L)<=x.distance*(B*B+C*C)){if(x.angle<x.epsilon)return[new j.Vector(F,G)];B=c(s-m,t-d);y=l(B-c(m-f,d-b));B=l(c(n-s,A-t)-B);y>=a&&(y=e-y);B>=a&&(B=e-B);if(y+B<x.angle)return[new j.Vector(F,G)];if(0!==q){if(y>q)return[new j.Vector(d,m)];if(B>q)return[new j.Vector(t,s)]}}}else if(K>y)if(K*K<=x.distance*(B*B+C*C)){if(x.angle<x.epsilon)return[new j.Vector(F,G)];y=l(c(s-m,t-d)-c(m-f,d-b));y>=a&&(y=e-y);if(y<x.angle)return[new j.Vector(d,m),new j.Vector(t,s)];if(0!==q&&y>q)return[new j.Vector(d,m)]}else if(L>
y){if(L*L<=x.distance*(B*B+C*C)){if(x.angle<x.epsilon)return[new j.Vector(F,G)];y=l(c(n-s,A-t)-c(s-m,t-d));y>=a&&(y=e-y);if(y<x.angle)return[new j.Vector(d,m),new j.Vector(t,s)];if(0!==q&&y>q)return[new j.Vector2(t,s)]}}else if(B=F-(b+A)/2,C=G-(f+n)/2,B*B+C*C<=x.distance)return[new j.Vector(F,G)];return j.Utils.subdivide(b,f,I,w,T,U,F,G,p+1).concat(j.Utils.subdivide(F,G,v,k,R,S,A,n,p+1))},getCurveFromPoints:function(a,b){for(var d=[],e=a.length,c=e-1,j=0;j<e;j++){var l=a[j],m={x:l.x,y:l.y};d.push(m);
var l=b?v(j-1,e):Math.max(j-1,0),f=b?v(j+1,e):Math.min(j+1,c);w(a[l],m,a[f]);!m.u.x&&!m.u.y&&(m.u.x=m.x,m.u.y=m.y);!m.v.x&&!m.v.y&&(m.v.x=m.x,m.v.y=m.y)}return d},getControlPoints:function(b,e,d){var c=x(b,e),j=x(d,e);b=y(b,e);d=y(d,e);var l=(c+j)/2;if(1E-4>b||1E-4>d)return e.u={x:e.x,y:e.y},e.v={x:e.x,y:e.y},e;b*=0.33;d*=0.33;l=j<c?l+t:l-t;c={x:e.x+m(l)*b,y:e.y+p(l)*b};l-=a;j={x:e.x+m(l)*d,y:e.y+p(l)*d};e.u=c;e.v=j;return e},angleBetween:function(a,b){return c(a.y-b.y,a.x-b.x)},distanceBetweenSquared:function(a,
b){var d=a.x-b.x,e=a.y-b.y;return d*d+e*e},distanceBetween:function(a,e){return b(I(a,e))},mod:function(a,b){for(;0>a;)a+=b;return a%b},Error:function(a){this.name="two.js";this.message=a}}});j.Utils.Error.prototype=Error();j.Utils.Error.prototype.constructor=j.Utils.Error;var y=j.Utils.distanceBetween,I=j.Utils.distanceBetweenSquared,x=j.Utils.angleBetween,w=j.Utils.getControlPoints,v=j.Utils.mod;_.extend(j.prototype,Backbone.Events,{appendTo:function(a){a.appendChild(this.renderer.domElement);return this},
...
n+this.x,(f.y-this.y)*n+this.y)},isZero:function(){return 1E-4>this.length()}})})();(function(){_.range(6);var q=Math.cos,f=Math.sin,n=Math.tan,p=Two.Matrix=function(m,c,b,l,a,e){this.elements=new Two.Array(9);var f=m;_.isArray(f)||(f=_.toArray(arguments));this.identity().set(f)};_.extend(p,{Identity:[1,0,0,0,1,0,0,0,1],Multiply:function(m,c){if(3>=c.length){var b=c[0]||0,l=c[1]||0,a=c[2]||0;return{x:m[0]*b+m[1]*l+m[2]*a,y:m[3]*b+m[4]*l+m[5]*a,z:m[6]*b+m[7]*l+m[8]*a}}var b=m[0],l=m[1],a=m[2],e=m[3],f=m[4],A=m[5],s=m[6],j=m[7],n=m[8],p=c[0],q=c[1],w=c[2],v=c[3],r=c[4],u=c[5],d=c[6],
z=c[7],D=c[8];return[b*p+l*v+a*d,b*q+l*r+a*z,b*w+l*u+a*D,e*p+f*v+A*d,e*q+f*r+A*z,e*w+f*u+A*D,s*p+j*v+n*d,s*q+j*r+n*z,s*w+j*u+n*D]}});_.extend(p.prototype,{set:function(m,c,b,l,a,e){var f=m;_.isArray(f)||(f=_.toArray(arguments));_.each(f,function(a,b){_.isNumber(a)&&(this.elements[b]=a)},this);return this},identity:function(){this.set(p.Identity);return this},multiply:function(m,c,b,l,a,e,f,A,s){var j=arguments,n=j.length;if(1>=n)return _.each(this.elements,function(a,b){this.elements[b]=a*m},this),
...
var p=function(b){_.each(b,function(b,a){this[a]=b},this)};_.extend(p.prototype,{render:function(b){var c=this.matrix,a=this.stroke,e=this.linewidth,m=this.fill,n=this.opacity,s=this.cap,j=this.join,p=this.miter,q=this.curved,x=this.closed,w=this.commands,v=w.length,r=v-1;if(!this.visible)return this;b.save();c&&b.transform(c[0],c[1],c[2],c[3],c[4],c[5]);m&&(b.fillStyle=m);a&&(b.strokeStyle=a);e&&(b.lineWidth=e);p&&(b.miterLimit=p);j&&(b.lineJoin=j);s&&(b.lineCap=s);_.isNumber(n)&&(b.globalAlpha=
n);b.beginPath();_.each(w,function(a,d){var e=a.x.toFixed(3),c=a.y.toFixed(3);if(q){var j=x?f(d-1,v):Math.max(d-1,0),l=x?f(d+1,v):Math.min(d+1,r),m=w[j],l=w[l],j=m.v.x.toFixed(3),m=m.v.y.toFixed(3),n=a.u.x.toFixed(3),s=a.u.y.toFixed(3);0>=d?b.moveTo(e,c):(b.bezierCurveTo(j,m,n,s,e,c),d>=r&&x&&(j=a.v.x.toFixed(3),m=a.v.y.toFixed(3),n=l.u.x.toFixed(3),s=l.u.y.toFixed(3),e=l.x.toFixed(3),c=l.y.toFixed(3),b.bezierCurveTo(j,m,n,s,e,c)))}else 0>=d?b.moveTo(e,c):b.lineTo(e,c)});x&&!q&&b.closePath();b.fill();
b.stroke();b.restore()}});var m={toArray:function(b,c,a){return!c?_.map(b,function(a){return{x:a.x,y:a.y}}):q(b,a)}},c=Two[Two.Types.canvas]=function(){this.count=0;this.domElement=document.createElement("canvas");this.ctx=this.domElement.getContext("2d");this.elements=[];this.stage=null};_.extend(c,{});_.extend(c,{Group:n,Element:p,getStyles:function(b){var c={},a=b.id,e=b._matrix,f=b.stroke,n=b.linewidth,s=b.fill,j=b.opacity,p=b.visible,q=b.cap,x=b.join,w=b.miter,v=b.curved,r=b.closed;b=b.vertices;
a&&(c.id=a);_.isObject(e)&&(c.matrix=e.toArray());f&&(c.stroke=f);s&&(c.fill=s);_.isNumber(j)&&(c.opacity=j);q&&(c.cap=q);x&&(c.join=x);w&&(c.miter=w);n&&(c.linewidth=n);b&&(c.commands=m.toArray(b,v,r));c.visible=!!p;c.curved=!!v;c.closed=!!r;return c},setStyles:function(b,c,a,e,f){switch(c){case "matrix":c="matrix";a=a.toArray();break;case "vertices":c="commands",b.curved=f,b.closed=e,a=m.toArray(a,b.curved,b.closed)}b[c]=a},Utils:m});_.extend(c.prototype,Backbone.Events,{setSize:function(b,c){this.width=
...
a.top,c=a.left,f=a.right;a=a.bottom;return new Two.Array([c,b,f,b,c,a,c,a,f,b,f,a])},updateCanvas:function(a){var b=a.commands,c=this.canvas,f=this.ctx,l=a._scale,j=a.stroke,m=a.linewidth*l,n=a.fill,q=a.opacity,w=a.cap,v=a.join,r=a.miter,u=a.curved,d=a.closed,z=b.length,D=z-1;c.width=Math.max(Math.ceil(a.rect.width*l),1);c.height=Math.max(Math.ceil(a.rect.height*l),1);a=a.rect.centroid;var E=a.x*l,H=a.y*l;f.clearRect(0,0,c.width,c.height);n&&(f.fillStyle=n);j&&(f.strokeStyle=j);m&&(f.lineWidth=m);
r&&(f.miterLimit=r);v&&(f.lineJoin=v);w&&(f.lineCap=w);_.isNumber(q)&&(f.globalAlpha=q);f.beginPath();_.each(b,function(a,c){var j=(a.x*l+E).toFixed(3),m=(a.y*l+H).toFixed(3);if(u){var n=d?p(c-1,z):Math.max(c-1,0),t=d?p(c+1,z):Math.min(c+1,D),q=b[n],t=b[t],n=(q.v.x*l+E).toFixed(3),q=(q.v.y*l+H).toFixed(3),r=(a.u.x*l+E).toFixed(3),k=(a.u.y*l+H).toFixed(3);0>=c?f.moveTo(j,m):(f.bezierCurveTo(n,q,r,k,j,m),c>=D&&d&&(n=(a.v.x*l+E).toFixed(3),q=(a.v.y*l+H).toFixed(3),r=(t.u.x*l+E).toFixed(3),k=(t.u.y*l+

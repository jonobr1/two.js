...
arguments[h];if(!_.isNumber(e))break;d.push(new m.Vector(e,arguments[h+1]))}var b=arguments[b-1],d=new m.Polygon(d,!(_.isBoolean(b)&&b)),b=d.getBoundingClientRect(),g=b.left+b.width/2,f=b.top+b.height/2;_.each(d.vertices,function(a){a.x-=g;a.y-=f});d.translation.set(g,f);this.scene.add(d);return d},makeGroup:function(a){var b=a;_.isArray(a)||(b=_.toArray(arguments));var d=new m.Group;this.scene.add(d);d.add(b);return d}});(function(){_.each(m.Instances,function(a){a.playing&&a.update().render()});
requestAnimationFrame(arguments.callee)})()})();(function(){function l(d){var b={},a=d.id,h=d.translation,f=d.rotation,m=d.scale,t=d.stroke,j=d.linewidth,p=d.fill,l=d.opacity,y=d.visible,u=d.cap,r=d.join,x=d.miter,v=d.curved,e=d.closed;d=d.vertices;a&&(b.id=g.Identifier+a);h&&(_.isNumber(m)&&_.isNumber(f))&&(b.transform="translate("+h.x+","+h.y+") scale("+m+") rotate("+f+")");t&&(b.stroke=t);p&&(b.fill=p);l&&(b["stroke-opacity"]=b["fill-opacity"]=l);b.visibility=y?"visible":"hidden";u&&(b["stroke-linecap"]=u);r&&(b["stroke-linejoin"]=r);x&&(b["stroke-miterlimit"]=

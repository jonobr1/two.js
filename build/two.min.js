...
b.source&&k.global==b.global&&k.multiline==b.multiline&&k.ignoreCase==b.ignoreCase}if("object"!=typeof k||"object"!=typeof b)return!1;for(var j=e.length;j--;)if(e[j]==k)return!0;e.push(k);var j=0,l=!0;if("[object Array]"==c){if(j=k.length,l=j==b.length)for(;j--&&(l=j in k==j in b&&q(k[j],b[j],e)););}else{if("constructor"in k!="constructor"in b||k.constructor!=b.constructor)return!1;for(var r in k)if(d.has(k,r)&&(j++,!(l=d.has(b,r)&&q(k[r],b[r],e))))break;if(l){for(r in b)if(d.has(b,r)&&!j--)break;
l=!j}}e.pop();return l}var f=this,n=f._,p={},m=Array.prototype,c=Object.prototype,b=m.slice,l=m.unshift,a=c.toString,e=c.hasOwnProperty,t=m.forEach,z=m.map,s=m.reduce,j=m.reduceRight,B=m.filter,I=m.every,v=m.some,x=m.indexOf,w=m.lastIndexOf,c=Array.isArray,r=Object.keys,u=Function.prototype.bind,d=function(k){return new J(k)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=d),exports._=d):f._=d;d.VERSION="1.3.3";var y=d.each=d.forEach=function(k,
a,b){if(null!=k)if(t&&k.forEach===t)k.forEach(a,b);else if(k.length===+k.length)for(var e=0,c=k.length;e<c&&!(e in k&&a.call(b,k[e],e,k)===p);e++);else for(e in k)if(d.has(k,e)&&a.call(b,k[e],e,k)===p)break};d.map=d.collect=function(k,a,d){var b=[];if(null==k)return b;if(z&&k.map===z)return k.map(a,d);y(k,function(k,e,c){b[b.length]=a.call(d,k,e,c)});k.length===+k.length&&(b.length=k.length);return b};d.reduce=d.foldl=d.inject=function(k,a,b,e){var c=2<arguments.length;null==k&&(k=[]);if(s&&k.reduce===
...
var D=d.some=d.any=function(k,a,b){a||(a=d.identity);var e=!1;if(null==k)return e;if(v&&k.some===v)return k.some(a,b);y(k,function(k,d,c){if(e||(e=a.call(b,k,d,c)))return p});return!!e};d.include=d.contains=function(k,a){var d=!1;return null==k?d:x&&k.indexOf===x?-1!=k.indexOf(a):d=D(k,function(k){return k===a})};d.invoke=function(k,a){var e=b.call(arguments,2);return d.map(k,function(k){return(d.isFunction(a)?a||k:k[a]).apply(k,e)})};d.pluck=function(k,a){return d.map(k,function(k){return k[a]})};
...
y(e,function(b){a[b]=d.bind(a[b],a)});return a};d.memoize=function(a,b){var e={};b||(b=d.identity);return function(){var c=b.apply(this,arguments);return d.has(e,c)?e[c]:e[c]=a.apply(this,arguments)}};d.delay=function(a,d){var e=b.call(arguments,2);return setTimeout(function(){return a.apply(null,e)},d)};d.defer=function(a){return d.delay.apply(d,[a,1].concat(b.call(arguments,1)))};d.throttle=function(a,b){var e,c,j,l,r,u,m=d.debounce(function(){r=l=!1},b);return function(){e=this;c=arguments;j||
(j=setTimeout(function(){j=null;r&&a.apply(e,c);m()},b));l?r=!0:u=a.apply(e,c);m();l=!0;return u}};d.debounce=function(a,d,b){var e;return function(){var c=this,j=arguments;b&&!e&&a.apply(c,j);clearTimeout(e);e=setTimeout(function(){e=null;b||a.apply(c,j)},d)}};d.once=function(a){var d=!1,b;return function(){if(d)return b;d=!0;return b=a.apply(this,arguments)}};d.wrap=function(a,d){return function(){var e=[a].concat(b.call(arguments,0));return d.apply(this,e)}};d.compose=function(){var a=arguments;
return function(){for(var d=arguments,b=a.length-1;0<=b;b--)d=[a[b].apply(this,d)];return d[0]}};d.after=function(a,d){return 0>=a?d():function(){if(1>--a)return d.apply(this,arguments)}};d.keys=r||function(a){if(a!==Object(a))throw new TypeError("Invalid object");var b=[],e;for(e in a)d.has(a,e)&&(b[b.length]=e);return b};d.values=function(a){return d.map(a,d.identity)};d.functions=d.methods=function(a){var b=[],e;for(e in a)d.isFunction(a[e])&&b.push(e);return b.sort()};d.extend=function(a){y(b.call(arguments,
...
b,l){var a,e,m,f,s,j,B,p;if(!this._events||!n(this,"off",c,[b,l]))return this;if(!c&&!b&&!l)return this._events={},this;f=c?[c]:_.keys(this._events);s=0;for(j=f.length;s<j;s++)if(c=f[s],a=this._events[c]){m=[];if(b||l){B=0;for(p=a.length;B<p;B++)e=a[B],(b&&b!==(e.callback._callback||e.callback)||l&&l!==e.context)&&m.push(e)}this._events[c]=m}return this},trigger:function(c){if(!this._events)return this;var b=q.call(arguments,1);if(!n(this,"trigger",c,b))return this;var l=this._events[c],a=this._events.all;
l&&p(this,l,b);a&&p(this,a,arguments);return this},listenTo:function(c,b,l){var a=this._listeners||(this._listeners={}),e=c._listenerId||(c._listenerId=_.uniqueId("l"));a[e]=c;c.on(b,l||this,this);return this},stopListening:function(c,b,l){var a=this._listeners;if(a){if(c)c.off(b,l,this),!b&&!l&&delete a[c._listenerId];else{for(var e in a)a[e].off(null,null,this);this._listeners={}}return this}}};m.bind=m.on;m.unbind=m.off})();(function(){for(var q=0,f=["ms","moz","webkit","o"],n=0;n<f.length&&!window.requestAnimationFrame;++n)window.requestAnimationFrame=window[f[n]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[f[n]+"CancelAnimationFrame"]||window[f[n]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=function(f){var m=(new Date).getTime(),c=Math.max(0,16-(m-q)),b=window.setTimeout(function(){f(m+c)},c);q=m+c;return b});window.cancelAnimationFrame||(window.cancelAnimationFrame=
function(f){clearTimeout(f)})})();(function(){function q(){var a=document.body.getBoundingClientRect(),b=this.width=a.width,a=this.height=a.height;this.renderer.setSize(b,a);this.trigger(j.Events.resize,b,a)}var f=this,n=f.Two||{},p=Math.sin,m=Math.cos,c=Math.atan2,b=Math.sqrt,l=Math.abs,a=Math.PI,e=2*a,t=a/2,z=Math.pow,s={hasEventListeners:_.isFunction(f.addEventListener),bind:function(a,b,d,e){this.hasEventListeners?a.addEventListener(b,d,!!e):a.attachEvent("on"+b,d);return this},unbind:function(a,b,d,e){this.hasEventListeners?
...
function(a){a=d.getItem(a);return new j.Vector(a.x,a.y)}),e=(new j.Polygon(e,!b)).noStroke();return j.Utils.applySvgAttributes(a,e)},polyline:function(a){return j.Utils.read.polygon(a,!0)},path:function(a){var b=a.getAttribute("d"),b=_.flatten(_.map(_.compact(b.split(/M/g)),function(a){a=_.map(_.compact(a.split(/m/g)),function(a,d){return 0>=d?a:"m"+a});a[0]="M"+a[0];return a})),d=new j.Vector,e=new j.Vector;return _.map(b,function(b){var c,l=!1,m=!1;b=_.flatten(_.map(b.match(/[a-z][^a-z]*/ig),function(a){var b,
r,f=a[0],u=f.toLowerCase();c=a.slice(1).trim().split(/[\s,]+|(?=[+-])/);l=f===u;switch(u){case "z":m=!0;break;case "m":case "l":r=parseFloat(c[0]);b=parseFloat(c[1]);b=new j.Vector(r,b);l&&b.addSelf(d);d.copy(b);break;case "h":case "v":r="h"===u?"x":"y";a="x"===r?"y":"x";b=new j.Vector;b[r]=parseFloat(c[0]);b[a]=d[a];l&&(b[r]+=d[r]);d.copy(b);break;case "s":case "c":var t,s,k;b=d.x;a=d.y;"c"===u?(f=parseFloat(c[0]),r=parseFloat(c[1]),u=parseFloat(c[2]),t=parseFloat(c[3]),s=parseFloat(c[4]),k=parseFloat(c[5])):
(t=(new j.Vector).copy(d).subSelf(e),f=parseFloat(t.x),r=parseFloat(t.y),u=parseFloat(c[0]),t=parseFloat(c[1]),s=parseFloat(c[2]),k=parseFloat(c[3]));l&&(f+=b,r+=a,u+=b,t+=a,s+=b,k+=a);b=j.Utils.subdivide(b,a,f,r,u,t,s,k);d.set(s,k);e.set(u,t);break;case "t":case "q":b=d.x;a=d.y;e.isZero()?(f=b,r=a):(f=e.x,a=e.y);"q"===u?(u=parseFloat(c[0]),t=parseFloat(c[1]),s=parseFloat(c[1]),k=parseFloat(c[2])):(t=(new j.Vector).copy(d).subSelf(e),u=parseFloat(t.x),t=parseFloat(t.y),s=parseFloat(c[0]),k=parseFloat(c[1]));
l&&(f+=b,r+=a,u+=b,t+=a,s+=b,k+=a);b=j.Utils.subdivide(b,a,f,r,u,t,s,k);d.set(s,k);e.set(u,t);break;case "a":throw new j.Utils.Error("not yet able to interpret Elliptical Arcs.");}return b}));_.isUndefined(b[b.length-1])&&b.pop();b=(new j.Polygon(b,m)).noStroke();return j.Utils.applySvgAttributes(a,b)})},circle:function(a){var b=parseFloat(a.getAttribute("cx")),d=parseFloat(a.getAttribute("cy")),c=parseFloat(a.getAttribute("r")),l=j.Resolution,f=_.map(_.range(l),function(a){var b=a/l*e;a=c*m(b);b=
c*p(b);return new j.Vector(a,b)},this),f=(new j.Polygon(f,!0,!0)).noStroke();f.translation.set(b,d);return j.Utils.applySvgAttributes(a,f)},ellipse:function(a){var b=parseFloat(a.getAttribute("cx")),d=parseFloat(a.getAttribute("cy")),c=parseFloat(a.getAttribute("rx")),l=parseFloat(a.getAttribute("ry")),f=j.Resolution,t=_.map(_.range(f),function(a){var b=a/f*e;a=c*m(b);b=l*p(b);return new j.Vector(a,b)},this),t=(new j.Polygon(t,!0,!0)).noStroke();t.translation.set(b,d);return j.Utils.applySvgAttributes(a,
t)},rect:function(a){var b=parseFloat(a.getAttribute("x")),d=parseFloat(a.getAttribute("y")),e=parseFloat(a.getAttribute("width")),c=parseFloat(a.getAttribute("height")),e=e/2,c=c/2,l=[new j.Vector(e,c),new j.Vector(-e,c),new j.Vector(-e,-c),new j.Vector(e,-c)],l=(new j.Polygon(l,!0)).noStroke();l.translation.set(b+e,d+c);return j.Utils.applySvgAttributes(a,l)},line:function(a){var b=parseFloat(a.getAttribute("x1")),d=parseFloat(a.getAttribute("y1")),e=parseFloat(a.getAttribute("x2")),c=parseFloat(a.getAttribute("y2")),
e=(e-b)/2,c=(c-d)/2,l=[new j.Vector(-e,-c),new j.Vector(e,c)],l=(new j.Polygon(l)).noFill();l.translation.set(b+e,d+c);return j.Utils.applySvgAttributes(a,l)}},subdivide:function(b,f,d,m,t,s,z,n,B){var p=j.Utils.Curve.CollinearityEpsilon,q=j.Utils.Curve.CuspLimit,v=j.Utils.Curve.Tolerance;B=B||0;var I=(b+d)/2,x=(f+m)/2,w=(d+t)/2,k=(m+s)/2,R=(t+z)/2,S=(s+n)/2,T=(I+w)/2,U=(x+k)/2,w=(w+R)/2,k=(k+S)/2,F=(T+w)/2,G=(U+k)/2;if(0<B){var A=z-b,C=n-f,K=l((d-z)*C-(m-n)*A),L=l((t-z)*C-(s-n)*A);if(K>p&&L>p&&(K+
L)*(K+L)<=v.distance*(A*A+C*C)){if(v.angle<v.epsilon)return[new j.Vector(F,G)];A=c(s-m,t-d);p=l(A-c(m-f,d-b));A=l(c(n-s,z-t)-A);p>=a&&(p=e-p);A>=a&&(A=e-A);if(p+A<v.angle)return[new j.Vector(F,G)];if(0!==q){if(p>q)return[new j.Vector(d,m)];if(A>q)return[new j.Vector(t,s)]}}}else if(K>p)if(K*K<=v.distance*(A*A+C*C)){if(v.angle<v.epsilon)return[new j.Vector(F,G)];p=l(c(s-m,t-d)-c(m-f,d-b));p>=a&&(p=e-p);if(p<v.angle)return[new j.Vector(d,m),new j.Vector(t,s)];if(0!==q&&p>q)return[new j.Vector(d,m)]}else if(L>
p){if(L*L<=v.distance*(A*A+C*C)){if(v.angle<v.epsilon)return[new j.Vector(F,G)];p=l(c(n-s,z-t)-c(s-m,t-d));p>=a&&(p=e-p);if(p<v.angle)return[new j.Vector(d,m),new j.Vector(t,s)];if(0!==q&&p>q)return[new j.Vector2(t,s)]}}else if(A=F-(b+z)/2,C=G-(f+n)/2,A*A+C*C<=v.distance)return[new j.Vector(F,G)];return j.Utils.subdivide(b,f,I,x,T,U,F,G,B+1).concat(j.Utils.subdivide(F,G,w,k,R,S,z,n,B+1))},getCurveFromPoints:function(a,b){for(var d=[],e=a.length,c=e-1,j=0;j<e;j++){var l=a[j],m={x:l.x,y:l.y};d.push(m);
var l=b?w(j-1,e):Math.max(j-1,0),f=b?w(j+1,e):Math.min(j+1,c);x(a[l],m,a[f]);!m.u.x&&!m.u.y&&(m.u.x=m.x,m.u.y=m.y);!m.v.x&&!m.v.y&&(m.v.x=m.x,m.v.y=m.y)}return d},getControlPoints:function(b,e,d){var c=v(b,e),j=v(d,e);b=B(b,e);d=B(d,e);var l=(c+j)/2;if(1E-4>b||1E-4>d)return e.u={x:e.x,y:e.y},e.v={x:e.x,y:e.y},e;b*=0.33;d*=0.33;l=j<c?l+t:l-t;c={x:e.x+m(l)*b,y:e.y+p(l)*b};l-=a;j={x:e.x+m(l)*d,y:e.y+p(l)*d};e.u=c;e.v=j;return e},angleBetween:function(a,b){return c(a.y-b.y,a.x-b.x)},distanceBetweenSquared:function(a,
...
function(a){var b=a/l*e;a=d*m(b);b=c*p(b);return new j.Vector(a,b)},this),f=new j.Polygon(f,!0,!0);f.translation.set(a,b);this.scene.add(f);return f},makeCurve:function(a){var b=arguments.length,d=a;if(!_.isArray(a))for(var d=[],e=0;e<b;e+=2){var c=arguments[e];if(!_.isNumber(c))break;d.push(new j.Vector(c,arguments[e+1]))}var b=arguments[b-1],d=new j.Polygon(d,!(_.isBoolean(b)&&b),!0),b=d.getBoundingClientRect(),l=b.left+b.width/2,m=b.top+b.height/2;_.each(d.vertices,function(a){a.x-=l;a.y-=m});
d.translation.set(l,m);this.scene.add(d);return d},makePolygon:function(a){var b=arguments.length,d=a;if(!_.isArray(a))for(var d=[],e=0;e<b;e+=2){var c=arguments[e];if(!_.isNumber(c))break;d.push(new j.Vector(c,arguments[e+1]))}b=arguments[b-1];d=new j.Polygon(d,!(_.isBoolean(b)&&b));d.center();this.scene.add(d);return d},makeGroup:function(a){var b=a;_.isArray(a)||(b=_.toArray(arguments));var e=new j.Group;this.scene.add(e);e.add(b);return e},interpret:function(a){var b=a.tagName.toLowerCase();if(!(b in
j.Utils.read))return null;a=j.Utils.read[b].call(this,a);this.add(a);return a}});(function(){_.each(j.Instances,function(a){a.playing&&a.update().render()});requestAnimationFrame(arguments.callee)})()})();(function(){var q=Two.Vector=function(f,n){f=f||0;n=n||0;Object.defineProperty(this,"x",{get:function(){return f},set:function(n){f=n;this.trigger("change","x")}});Object.defineProperty(this,"y",{get:function(){return n},set:function(f){n=f;this.trigger("change","y")}})};_.extend(q,{});_.extend(q.prototype,Backbone.Events,{set:function(f,n){this.x=f;this.y=n;return this},copy:function(f){this.x=f.x;this.y=f.y;return this},clear:function(){this.y=this.x=0;return this},clone:function(){return new q(this.x,
...
n+this.x,(f.y-this.y)*n+this.y)},isZero:function(){return 1E-4>this.length()}})})();(function(){_.range(6);var q=Math.cos,f=Math.sin,n=Math.tan,p=Two.Matrix=function(m,c,b,l,a,e){this.elements=new Two.Array(9);var f=m;_.isArray(f)||(f=_.toArray(arguments));this.identity().set(f)};_.extend(p,{Identity:[1,0,0,0,1,0,0,0,1],Multiply:function(m,c){if(3>=c.length){var b=c[0]||0,l=c[1]||0,a=c[2]||0;return{x:m[0]*b+m[1]*l+m[2]*a,y:m[3]*b+m[4]*l+m[5]*a,z:m[6]*b+m[7]*l+m[8]*a}}var b=m[0],l=m[1],a=m[2],e=m[3],f=m[4],z=m[5],s=m[6],j=m[7],n=m[8],p=c[0],v=c[1],q=c[2],w=c[3],r=c[4],u=c[5],d=c[6],
y=c[7],D=c[8];return[b*p+l*w+a*d,b*v+l*r+a*y,b*q+l*u+a*D,e*p+f*w+z*d,e*v+f*r+z*y,e*q+f*u+z*D,s*p+j*w+n*d,s*v+j*r+n*y,s*q+j*u+n*D]}});_.extend(p.prototype,{set:function(m,c,b,l,a,e){var f=m;_.isArray(f)||(f=_.toArray(arguments));_.each(f,function(a,b){_.isNumber(a)&&(this.elements[b]=a)},this);return this},identity:function(){this.set(p.Identity);return this},multiply:function(m,c,b,l,a,e,f,z,s){var j=arguments,n=j.length;if(1>=n)return _.each(this.elements,function(a,b){this.elements[b]=a*m},this),
...
A6*B0+A7*B3+A8*B6;this.elements[7]=A6*B1+A7*B4+A8*B7;this.elements[8]=A6*B2+A7*B5+A8*B8;return this},scale:function(m,c){1>=arguments.length&&(c=m);return this.multiply(m,0,0,0,c,0,0,0,1)},rotate:function(m){var c=q(m);m=f(m);return this.multiply(c,-m,0,m,c,0,0,0,1)},translate:function(m,c){return this.multiply(1,0,m,0,1,c,0,0,1)},skewX:function(m){m=n(m);return this.multiply(1,m,0,0,1,0,0,0,1)},skewY:function(m){m=n(m);return this.multiply(1,0,0,m,1,0,0,0,1)},toString:function(){return this.toArray().join(" ")},
toArray:function(m){var c=this.elements,b=parseFloat(c[0].toFixed(3)),l=parseFloat(c[1].toFixed(3)),a=parseFloat(c[2].toFixed(3)),e=parseFloat(c[3].toFixed(3)),f=parseFloat(c[4].toFixed(3)),n=parseFloat(c[5].toFixed(3));if(m){m=parseFloat(c[6].toFixed(3));var s=parseFloat(c[7].toFixed(3)),c=parseFloat(c[8].toFixed(3));return[b,e,m,l,f,s,a,n,c]}return[b,e,l,f,a,n]},clone:function(){var f=this.elements[0],c=this.elements[1],b=this.elements[2],l=this.elements[3],a=this.elements[4],e=this.elements[5];
g=this.elements[6];h=this.elements[7];i=this.elements[8];return new Two.Matrix(f,c,b,l,a,e,g,h,i)}})})();(function(){function q(c){var b={},l=c.id,a=c.translation,e=c.rotation,f=c.scale,n=c.stroke,s=c.linewidth,j=c.fill,B=c.opacity,q=c.visible,v=c.cap,x=c.join,w=c.miter,r=c.curved,u=c.closed,d=c.vertices;l&&(b.id=m.Identifier+l);a&&(_.isNumber(f)&&_.isNumber(e))&&(b.transform="matrix("+c._matrix.toString()+")");n&&(b.stroke=n);j&&(b.fill=j);B&&(b["stroke-opacity"]=b["fill-opacity"]=B);b.visibility=q?"visible":"hidden";v&&(b["stroke-linecap"]=v);x&&(b["stroke-linejoin"]=x);w&&(b["stroke-miterlimit"]=
w);s&&(b["stroke-width"]=s);d&&(b.d=p.toString(d,u,r));return b}var f=Two.Utils.getCurveFromPoints,n=Two.Utils.mod,p={version:1.1,ns:"http://www.w3.org/2000/svg",xlink:"http://www.w3.org/1999/xlink",createElement:function(c,b){var l=c.toLowerCase(),a=document.createElementNS(this.ns,l);"svg"===l&&(b=_.defaults(b||{},{version:this.version}));_.isObject(b)&&this.setAttributes(a,b);return a},setAttributes:function(c,b){_.each(b,function(b,a){this.setAttribute(a,b)},c);return this},removeAttributes:function(c,
b){_.each(b,function(b){this.removeAttribute(b)},c);return this},toString:function(c,b,l){var a=c.length,e=a-1;if(!l)return _.map(c,function(a,c){var j;j=(0>=c?"M":"L")+(" "+a.x.toFixed(3)+" "+a.y.toFixed(3));c>=e&&b&&(j+=" Z");return j}).join(" ");var m=f(c,b);return _.map(m,function(c,l){var j,f=b?n(l-1,a):Math.max(l-1,0),p=b?n(l+1,a):Math.min(l+1,e);j=m[f];var p=m[p],f=j.v.x.toFixed(3),q=j.v.y.toFixed(3),x=c.u.x.toFixed(3),w=c.u.y.toFixed(3),r=c.x.toFixed(3),u=c.y.toFixed(3);j=0>=l?"M "+r+" "+
u:"C "+f+" "+q+" "+x+" "+w+" "+r+" "+u;l>=e&&b&&(f=c.v.x.toFixed(3),q=c.v.y.toFixed(3),x=p.u.x.toFixed(3),w=p.u.y.toFixed(3),r=p.x.toFixed(3),u=p.y.toFixed(3),j=j+(" C "+f+" "+q+" "+x+" "+w+" "+r+" "+u)+" Z");return j}).join(" ")}},m=Two[Two.Types.svg]=function(){this.count=0;this.domElement=p.createElement("svg");this.elements=[];this.domElement.style.visibility="hidden";this.unveil=_.once(_.bind(function(){this.domElement.style.visibility="visible"},this))};_.extend(m,{Identifier:"two-"});_.extend(m.prototype,
...
a.top,c=a.left,f=a.right;a=a.bottom;return new Two.Array([c,b,f,b,c,a,c,a,f,b,f,a])},updateCanvas:function(a){var b=a.commands,c=this.canvas,f=this.ctx,l=a._scale,j=a.stroke,m=a.linewidth*l,n=a.fill,q=a.opacity,x=a.cap,w=a.join,r=a.miter,u=a.curved,d=a.closed,y=b.length,D=y-1;c.width=Math.max(Math.ceil(a.rect.width*l),1);c.height=Math.max(Math.ceil(a.rect.height*l),1);a=a.rect.centroid;var E=a.x*l,H=a.y*l;f.clearRect(0,0,c.width,c.height);n&&(f.fillStyle=n);j&&(f.strokeStyle=j);m&&(f.lineWidth=m);
r&&(f.miterLimit=r);w&&(f.lineJoin=w);x&&(f.lineCap=x);_.isNumber(q)&&(f.globalAlpha=q);f.beginPath();_.each(b,function(a,c){var j=(a.x*l+E).toFixed(3),m=(a.y*l+H).toFixed(3);if(u){var n=d?p(c-1,y):Math.max(c-1,0),t=d?p(c+1,y):Math.min(c+1,D),q=b[n],t=b[t],n=(q.v.x*l+E).toFixed(3),q=(q.v.y*l+H).toFixed(3),r=(a.u.x*l+E).toFixed(3),k=(a.u.y*l+H).toFixed(3);0>=c?f.moveTo(j,m):(f.bezierCurveTo(n,q,r,k,j,m),c>=D&&d&&(n=(a.v.x*l+E).toFixed(3),q=(a.v.y*l+H).toFixed(3),r=(t.u.x*l+E).toFixed(3),k=(t.u.y*l+
H).toFixed(3),j=(t.x*l+E).toFixed(3),m=(t.y*l+H).toFixed(3),f.bezierCurveTo(n,q,r,k,j,m)))}else 0>=c?f.moveTo(j,m):f.lineTo(j,m)});d&&!u&&f.closePath();f.fill();f.stroke()},updateTexture:function(a,b){this.updateCanvas(b);b.texture&&a.deleteTexture(b.texture);a.bindBuffer(a.ARRAY_BUFFER,b.textureCoordsBuffer);b.texture=a.createTexture();a.bindTexture(a.TEXTURE_2D,b.texture);a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_S,a.CLAMP_TO_EDGE);a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_T,a.CLAMP_TO_EDGE);
...
n,{get:function(){return this[m]},set:function(c){this[m]=c;this.trigger(Two.Events.change,this.id,n,c,this)}})})}});_.extend(q.prototype,Backbone.Events,{addTo:function(f){f.add(this);return this},noFill:function(){this.fill="none";return this},noStroke:function(){this.stroke="none";return this},clone:function(){var f=new q;f.translation.copy(this.translation);_.each(q.Properties,function(n){f[n]=this[n]},this);return this}})})();(function(){var q=Two.Group=function(){Two.Shape.call(this,!0);delete this.stroke;delete this.fill;delete this.linewidth;delete this.opacity;delete this.cap;delete this.join;delete this.miter;q.MakeGetterSetter(this,Two.Shape.Properties);this.children={}};_.extend(q,{MakeGetterSetter:function(f,n){_.isArray(n)||(n=[n]);_.each(n,function(n){var m="_"+n;Object.defineProperty(f,n,{get:function(){return this[m]},set:function(c){this[m]=c;_.each(this.children,function(b){b[n]=c})}})})}});_.extend(q.prototype,
Two.Shape.prototype,{clone:function(){var f=_.map(this.children,function(f){return f.clone()}),n=new q;this.parent.add(n);n.add(f);n.translation.copy(this.translation);n.rotation=this.rotation;n.scale=this.scale;return n},center:function(){var f=this.getBoundingClientRect();f.centroid={x:f.left+f.width/2,y:f.top+f.height/2};_.each(this.children,function(n){n.translation.subSelf(f.centroid)});this.translation.copy(f.centroid);return this},add:function(f){var n=f,p=this.children,m=this.parent,c=[];
_.isArray(f)||(n=_.toArray(arguments));var b=_.bind(function(b,a,c,f,m,n){this.trigger(Two.Events.change,b,a,c,f,m,n)},this);_.each(n,function(f){var a=f.id,e=f.parent;_.isUndefined(a)&&(m.add(f),a=f.id);_.isUndefined(p[a])&&(e&&delete e.children[a],p[a]=f,f.parent=this,f.unbind(Two.Events.change).bind(Two.Events.change,b),c.push(a))},this);0<c.length&&this.trigger(Two.Events.change,this.id,Two.Properties.hierarchy,c);return this},remove:function(f){var n=f,p=this.children,m=this.parent,c=[];if(0>=
arguments.length&&m)return m.remove(this),this;_.isArray(f)||(n=_.toArray(arguments));_.each(n,function(b){var f=b.id;f in p&&(delete p[f],b.unbind(Two.Events.change),c.push(f))});0<c.length&&this.trigger(Two.Events.change,this.id,Two.Properties.demotion,c);return this},getBoundingClientRect:function(){var f=Infinity,n=-Infinity,p=Infinity,m=-Infinity;_.each(this.children,function(b){b=b.getBoundingClientRect();p=Math.min(b.top,p);f=Math.min(b.left,f);n=Math.max(b.right,n);m=Math.max(b.bottom,m)},
this);var c=this._matrix.multiply(f,p,1),b=this._matrix.multiply(n,m,1);return{top:c.y,left:c.x,right:b.x,bottom:b.y,width:b.x-c.x,height:b.y-c.y}},noFill:function(){_.each(this.children,function(f){f.noFill()});return this},noStroke:function(){_.each(this.children,function(f){f.noStroke()});return this}})})();(function(){var q=Math.min,f=Math.max,n=Math.round,p=Two.Polygon=function(m,c,b){Two.Shape.call(this);c=!!c;b=!!b;var l=0,a=1,e=!1,p=m.slice(0),z=_.debounce(_.bind(function(){var f,j;if(e){f=this.vertices.length;f-=1;j=n(l*f);f=n(a*f);for(p.length=0;j<f+1;j++){var m=this.vertices[j];p.push(new Two.Vector(m.x,m.y))}}this.trigger(Two.Events.change,this.id,"vertices",p,c,b,e);e=!1},this),0);Object.defineProperty(this,"closed",{get:function(){return c},set:function(a){c=!!a;z()}});Object.defineProperty(this,
"curved",{get:function(){return b},set:function(a){b=!!a;z()}});Object.defineProperty(this,"beginning",{get:function(){return l},set:function(a){l=q(f(a,0),1);e=!0;z()}});Object.defineProperty(this,"ending",{get:function(){return a},set:function(b){a=q(f(b,0),1);e=!0;z()}});this.vertices=m.slice(0);_.each(this.vertices,function(a){a.bind(Two.Events.change,z)},this);z()};_.extend(p,{});_.extend(p.prototype,Two.Shape.prototype,{clone:function(){var f=_.map(this.vertices,function(b){return new Two.Vector(b.x,

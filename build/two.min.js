...
Math.max(Math.ceil((b-a)/e),0),f=0,d=Array(c);f<c;)d[f++]=a,a+=e;return d};var R=function(){};e.bind=function(a,b){var c,f;if(a.bind===u&&u)return u.apply(a,h.call(arguments,1));if(!e.isFunction(a))throw new TypeError;f=h.call(arguments,2);return c=function(){if(!(this instanceof c))return a.apply(b,f.concat(h.call(arguments)));R.prototype=a.prototype;var e=new R,d=a.apply(e,f.concat(h.call(arguments)));return Object(d)===d?d:e}};e.bindAll=function(a){var b=h.call(arguments,1);0==b.length&&(b=e.functions(a));
x(b,function(b){a[b]=e.bind(a[b],a)});return a};e.memoize=function(a,b){var c={};b||(b=e.identity);return function(){var f=b.apply(this,arguments);return e.has(c,f)?c[f]:c[f]=a.apply(this,arguments)}};e.delay=function(a,b){var e=h.call(arguments,2);return setTimeout(function(){return a.apply(null,e)},b)};e.defer=function(a){return e.delay.apply(e,[a,1].concat(h.call(arguments,1)))};e.throttle=function(a,b){var c,f,d,g,h,k,q=e.debounce(function(){h=g=!1},b);return function(){c=this;f=arguments;d||
(d=setTimeout(function(){d=null;h&&a.apply(c,f);q()},b));g?h=!0:k=a.apply(c,f);q();g=!0;return k}};e.debounce=function(a,b,e){var c;return function(){var f=this,d=arguments;e&&!c&&a.apply(f,d);clearTimeout(c);c=setTimeout(function(){c=null;e||a.apply(f,d)},b)}};e.once=function(a){var b=!1,e;return function(){if(b)return e;b=!0;return e=a.apply(this,arguments)}};e.wrap=function(a,b){return function(){var e=[a].concat(h.call(arguments,0));return b.apply(this,e)}};e.compose=function(){var a=arguments;
...
function(a,b){for(var c=0;3>c;++c)if(!b.delaunay_edge[c]){var d=b.GetNeighbor(c);if(null!=d){var g=b.GetPoint(c),h=d.OppositePoint(b,g),f=d.Index(h);if(d.constrained_edge[f]||d.delaunay_edge[f])b.constrained_edge[c]=d.constrained_edge[f];else if(tessellation.sweep.Incircle(g,b.PointCCW(g),b.PointCW(g),h))return b.delaunay_edge[c]=!0,d.delaunay_edge[f]=!0,tessellation.sweep.RotateTrianglePair(b,g,d,h),(g=!tessellation.sweep.Legalize(a,b))&&a.MapTriangleToNodes(b),(g=!tessellation.sweep.Legalize(a,
d))&&a.MapTriangleToNodes(d),b.delaunay_edge[c]=!1,d.delaunay_edge[f]=!1,!0}}return!1};tessellation.sweep.Incircle=function(a,b,c,d){var g=a.x-d.x;a=a.y-d.y;var h=b.x-d.x;b=b.y-d.y;var f=g*b-h*a;if(0>=f)return!1;var k=c.x-d.x;c=c.y-d.y;d=k*a-g*c;return 0>=d?!1:0<(g*g+a*a)*(h*c-k*b)+(h*h+b*b)*d+(k*k+c*c)*f};tessellation.sweep.RotateTrianglePair=function(a,b,c,d){var g,h,f,k;g=a.NeighborCCW(b);h=a.NeighborCW(b);f=c.NeighborCCW(d);k=c.NeighborCW(d);var m,l,n,r;m=a.GetConstrainedEdgeCCW(b);l=a.GetConstrainedEdgeCW(b);
n=c.GetConstrainedEdgeCCW(d);r=c.GetConstrainedEdgeCW(d);var j,s,p,w;j=a.GetDelaunayEdgeCCW(b);s=a.GetDelaunayEdgeCW(b);p=c.GetDelaunayEdgeCCW(d);w=c.GetDelaunayEdgeCW(d);a.Legalize(b,d);c.Legalize(d,b);c.SetDelaunayEdgeCCW(b,j);a.SetDelaunayEdgeCW(b,s);a.SetDelaunayEdgeCCW(d,p);c.SetDelaunayEdgeCW(d,w);c.SetConstrainedEdgeCCW(b,m);a.SetConstrainedEdgeCW(b,l);a.SetConstrainedEdgeCCW(d,n);c.SetConstrainedEdgeCW(d,r);a.ClearNeigbors();c.ClearNeigbors();g&&c.MarkNeighbor(g);h&&a.MarkNeighbor(h);f&&a.MarkNeighbor(f);
k&&c.MarkNeighbor(k);a.MarkNeighbor(c)};tessellation.sweep.FillBasin=function(a,b){a.basin.left_node=tessellation.Orient2d(b.point,b.next.point,b.next.next.point)==tessellation.Orientation.CCW?b.next.next:b.next;for(a.basin.bottom_node=a.basin.left_node;null!=a.basin.bottom_node.next&&a.basin.bottom_node.point.y>=a.basin.bottom_node.next.point.y;)a.basin.bottom_node=a.basin.bottom_node.next;if(a.basin.bottom_node!=a.basin.left_node){for(a.basin.right_node=a.basin.bottom_node;null!=a.basin.right_node.next&&
...
CuspLimit:0,Tolerance:{distance:0.25,angle:0,epsilon:0.01}},decoupleShapes:function(a,b,c){c=c||0;var d=a.length;if(3>=d||c>j.Utils.Curve.RecursionLimit)return a;for(var f=0,d=a.length;f<d;f++)if(b||!(f>=d-1))for(var g=u(f+1,d),h=a[f],k=a[g],m=0,l=u(f+1,d);m<d;m++){var n=u(l+1,d),r=a[l],s=a[n];if(!(l==f||l==g||n==f||n==g))if(r=q(h,k,r,s))return f=[r],h=[r.clone()],f=a.slice(0,g).concat(f),l=a.slice(g,l+1).concat(h),n>g?f=f.concat(a.slice(n,d)):0<n&&(l=l.concat(a.slice(n,d))),[v(f,b,c+1),v(l,b,c+1)];
l=u(l+1,d)}return[a]},solveSegmentIntersection:function(a,b,c,d){var f=(d.x-c.x)*(a.y-c.y)-(d.y-c.y)*(a.x-c.x),g=(b.x-a.x)*(a.y-c.y)-(b.y-a.y)*(a.x-c.x);c=(d.y-c.y)*(b.x-a.x)-(d.x-c.x)*(b.y-a.y);return 0!=c&&(f/=c,g/=c,0<=f&&1>=f&&0<=g&&1>=g)?new j.Vector(a.x+f*(b.x-a.x),a.y+f*(b.y-a.y)):null},subdivide:function(a,b,c,d,h,q,l,v,u){var n=j.Utils.Curve.CollinearityEpsilon,r=j.Utils.Curve.CuspLimit,s=j.Utils.Curve.Tolerance;u=u||0;var p=(a+c)/2,t=(b+d)/2,A=(c+h)/2,w=(d+q)/2,N=(h+l)/2,O=(q+v)/2,P=(p+
A)/2,Q=(t+w)/2,A=(A+N)/2,w=(w+O)/2,C=(P+A)/2,D=(Q+w)/2;if(0<u){var y=l-a,B=v-b,G=f((c-l)*B-(d-v)*y),H=f((h-l)*B-(q-v)*y);if(G>n&&H>n&&(G+H)*(G+H)<=s.distance*(y*y+B*B)){if(s.angle<s.epsilon)return[new j.Vector(C,D)];y=g(q-d,h-c);n=f(y-g(d-b,c-a));y=f(g(v-q,l-h)-y);n>=k&&(n=m-n);y>=k&&(y=m-y);if(n+y<s.angle)return[new j.Vector(C,D)];if(0!==r){if(n>r)return[new j.Vector(c,d)];if(y>r)return[new j.Vector(h,q)]}}}else if(G>n)if(G*G<=s.distance*(y*y+B*B)){if(s.angle<s.epsilon)return[new j.Vector(C,D)];
n=f(g(q-d,h-c)-g(d-b,c-a));n>=k&&(n=m-n);if(n<s.angle)return[new j.Vector(c,d),new j.Vector(h,q)];if(0!==r&&n>r)return[new j.Vector(c,d)]}else if(H>n){if(H*H<=s.distance*(y*y+B*B)){if(s.angle<s.epsilon)return[new j.Vector(C,D)];n=f(g(v-q,l-h)-g(q-d,h-c));n>=k&&(n=m-n);if(n<s.angle)return[new j.Vector(c,d),new j.Vector(h,q)];if(0!==r&&n>r)return[new j.Vector2(h,q)]}}else if(y=C-(a+l)/2,B=D-(b+v)/2,y*y+B*B<=s.distance)return[new j.Vector(C,D)];return j.Utils.subdivide(a,b,p,t,P,Q,C,D,u+1).concat(j.Utils.subdivide(C,
D,A,w,N,O,l,v,u+1))},getCurveFromPoints:function(a,b){for(var c=[],d=a.length,f=d-1,g=0;g<d;g++){var h=a[g],q={x:h.x,y:h.y};c.push(q);var h=b?u(g-1,d):Math.max(g-1,0),k=b?u(g+1,d):Math.min(g+1,f);t(a[h],q,a[k]);!q.u.x&&!q.u.y&&(q.u.x=q.x,q.u.y=q.y);!q.v.x&&!q.v.y&&(q.v.x=q.x,q.v.y=q.y)}return c},getControlPoints:function(a,b,f){var g=w(a,b),h=w(f,b);a=s(a,b);f=s(f,b);var q=(g+h)/2;if(1E-4>a||1E-4>f)return b.u={x:b.x,y:b.y},b.v={x:b.x,y:b.y},b;a*=0.33;f*=0.33;q=h<g?q+l:q-l;g={x:b.x+d(q)*a,y:b.y+c(q)*
a};q-=k;h={x:b.x+d(q)*f,y:b.y+c(q)*f};b.u=g;b.v=h;return b},angleBetween:function(a,b){return g(a.y-b.y,a.x-b.x)},distanceBetweenSquared:function(a,b){var c=a.x-b.x,d=a.y-b.y;return c*c+d*d},distanceBetween:function(a,b){return h(A(a,b))},mod:function(a,b){for(;0>a;)a+=b;return a%b},Error:function(a){this.name="two.js";this.message=a}}});j.Utils.Error.prototype=Error();j.Utils.Error.prototype.constructor=j.Utils.Error;var s=j.Utils.distanceBetween,A=j.Utils.distanceBetweenSquared,w=j.Utils.angleBetween,
t=j.Utils.getControlPoints,q=j.Utils.solveSegmentIntersection,v=j.Utils.decoupleShapes,u=j.Utils.mod;_.extend(j.prototype,Backbone.Events,{appendTo:function(a){a.appendChild(this.renderer.domElement);return this},play:function(){this.playing=!0;return this.trigger(j.Events.play)},pause:function(){this.playing=!1;return this.trigger(j.Events.pause)},update:function(){this.frameCount++;var a=this.width,b=this.height,c=this.renderer;(a!==c.width||b!==c.height)&&c.setSize(a,b);return this.trigger(j.Events.update,
...
-d)];d=new j.Polygon(d,!0);d.translation.set(a,b);this.scene.add(d);return d},makeCircle:function(a,b,c){return this.makeEllipse(a,b,c,c)},makeEllipse:function(a,b,f,g){var q=j.Resolution,h=_.map(_.range(q),function(a){var b=a/q*m;a=f*d(b);b=g*c(b);return new j.Vector(a,b)},this),h=new j.Polygon(h,!0,!0);h.translation.set(a,b);this.scene.add(h);return h},makeCurve:function(a){var b=arguments.length,c=a;if(!_.isArray(a))for(var c=[],d=0;d<b;d+=2){var f=arguments[d];if(!_.isNumber(f))break;c.push(new j.Vector(f,
arguments[d+1]))}var b=arguments[b-1],c=new j.Polygon(c,!(_.isBoolean(b)&&b),!0),b=c.getBoundingClientRect(),g=b.left+b.width/2,q=b.top+b.height/2;_.each(c.vertices,function(a){a.x-=g;a.y-=q});c.translation.set(g,q);this.scene.add(c);return c},makePolygon:function(a){var b=arguments.length,c=a;if(!_.isArray(a))for(var c=[],d=0;d<b;d+=2){var f=arguments[d];if(!_.isNumber(f))break;c.push(new j.Vector(f,arguments[d+1]))}var b=arguments[b-1],c=new j.Polygon(c,!(_.isBoolean(b)&&b)),b=c.getBoundingClientRect(),
g=b.left+b.width/2,q=b.top+b.height/2;_.each(c.vertices,function(a){a.x-=g;a.y-=q});c.translation.set(g,q);this.scene.add(c);return c},makeGroup:function(a){var b=a;_.isArray(a)||(b=_.toArray(arguments));var c=new j.Group;this.scene.add(c);c.add(b);return c}});(function(){_.each(j.Instances,function(a){a.playing&&a.update().render()});requestAnimationFrame(arguments.callee)})()})();(function(){var p=Two.Vector=function(a,b){a=a||0;b=b||0;Object.defineProperty(this,"x",{get:function(){return a},set:function(b){a=b;this.trigger("change","x")}});Object.defineProperty(this,"y",{get:function(){return b},set:function(a){b=a;this.trigger("change","y")}})};_.extend(p,{});_.extend(p.prototype,Backbone.Events,{set:function(a,b){this.x=a;this.y=b;return this},copy:function(a){this.x=a.x;this.y=a.y;return this},clear:function(){this.y=this.x=0;return this},clone:function(){return new p(this.x,
...
b+this.x,(a.y-this.y)*b+this.y)},isZero:function(){return 1E-4>this.length()}})})();(function(){_.range(6);var p=Math.cos,a=Math.sin,b=Math.tan,c=Two.Matrix=function(a,b,c,f,k,m){this.elements=new Two.Array(9);var l=a;_.isArray(l)||(l=_.toArray(arguments));this.identity().set(l)};_.extend(c,{Identity:[1,0,0,0,1,0,0,0,1],Determinant:function(a,b,c,f,k,m,l,n,r){return a*k*r-a*m*n-b*f*r+b*m*l+c*f*n-c*k*l},Multiply:function(a,b){var c=a[0],f=a[1],k=a[2],m=a[3],l=a[4],n=a[5],r=a[6],j=a[7],s=a[8],p=b[0],w=b[1],t=b[2],q=b[3],v=b[4],u=b[5],e=b[6],x=b[7],F=b[8];return[c*p+f*q+k*e,c*w+f*v+
k*x,c*t+f*u+k*F,m*p+l*q+n*e,m*w+l*v+n*x,m*t+l*u+n*F,r*p+j*q+s*e,r*w+j*v+s*x,r*t+j*u+s*F]}});_.extend(c.prototype,{set:function(a,b,c,f,k,m){var l=a;_.isArray(l)||(l=_.toArray(arguments));_.each(l,function(a,b){_.isNumber(a)&&(this.elements[b]=a)},this);return this},identity:function(){this.set(c.Identity);return this},multiply:function(a,b,c,f,k,m,l,n,r){var j=arguments,s=j.length;if(1>=s)return _.each(this.elements,function(b,c){this.elements[c]=b*a},this),this;if(3>=s)return a=a||0,b=b||0,c=c||
0,k=this.elements,{x:k[0]*a+k[1]*b+k[2]*c,y:k[3]*a+k[4]*b+k[5]*c,z:k[6]*a+k[7]*b+k[8]*c};s=this.elements;A0=s[0];A1=s[1];A2=s[2];A3=s[3];A4=s[4];A5=s[5];A6=s[6];A7=s[7];A8=s[8];B0=j[0];B1=j[1];B2=j[2];B3=j[3];B4=j[4];B5=j[5];B6=j[6];B7=j[7];B8=j[8];this.elements[0]=A0*B0+A1*B3+A2*B6;this.elements[1]=A0*B1+A1*B4+A2*B7;this.elements[2]=A0*B2+A1*B5+A2*B8;this.elements[3]=A3*B0+A4*B3+A5*B6;this.elements[4]=A3*B1+A4*B4+A5*B7;this.elements[5]=A3*B2+A4*B5+A5*B8;this.elements[6]=A6*B0+A7*B3+A8*B6;this.elements[7]=
A6*B1+A7*B4+A8*B7;this.elements[8]=A6*B2+A7*B5+A8*B8;return this},determinant:function(){var a=this.elements,b=a[0],c=a[1],f=a[2],k=a[3],m=a[4],l=a[5],n=a[6],r=a[7],a=a[8];return b*m*a-b*l*r-c*k*a+c*l*n+f*k*r-f*m*n},scale:function(a,b){1>=arguments.length&&(b=a);return this.multiply(a,0,0,0,b,0,0,0,1)},rotate:function(b){var c=p(b);b=a(b);return this.multiply(c,-b,0,b,c,0,0,0,1)},translate:function(a,b){return this.multiply(1,0,a,0,1,b,0,0,1)},skewX:function(a){a=b(a);return this.multiply(1,a,0,0,
1,0,0,0,1)},skewY:function(a){a=b(a);return this.multiply(1,0,0,a,1,0,0,0,1)},toString:function(){return this.toArray().join(" ")},toArray:function(a){var b=this.elements,c=parseFloat(b[0].toFixed(3)),f=parseFloat(b[1].toFixed(3)),k=parseFloat(b[2].toFixed(3)),m=parseFloat(b[3].toFixed(3)),l=parseFloat(b[4].toFixed(3)),n=parseFloat(b[5].toFixed(3));if(a){a=parseFloat(b[6].toFixed(3));var r=parseFloat(b[7].toFixed(3)),b=parseFloat(b[8].toFixed(3));return[c,m,a,f,l,r,k,n,b]}return[c,m,f,l,k,n]},clone:function(){return new Two.Matrix(this.elements[0],
this.elements[1],this.elements[2],this.elements[3],this.elements[4],this.elements[5])}})})();(function(){function p(a){var b={},c=a.id,m=a.translation,l=a.rotation,n=a.scale,r=a.stroke,j=a.linewidth,s=a.fill,p=a.opacity,w=a.visible,t=a.cap,q=a.join,v=a.miter,u=a.curved,e=a.closed;a=a.vertices;c&&(b.id=g.Identifier+c);m&&(_.isNumber(n)&&_.isNumber(l))&&(b.transform="translate("+m.x+","+m.y+") scale("+n+") rotate("+l+")");r&&(b.stroke=r);s&&(b.fill=s);p&&(b["stroke-opacity"]=b["fill-opacity"]=p);b.visibility=w?"visible":"hidden";t&&(b["stroke-linecap"]=t);q&&(b["stroke-linejoin"]=q);v&&(b["stroke-miterlimit"]=
v);j&&(b["stroke-width"]=j);a&&(b.d=d.toString(a,e,u));return b}var a=0,b=Two.Utils.getCurveFromPoints,c=Two.Utils.mod,d={version:1.1,ns:"http://www.w3.org/2000/svg",xlink:"http://www.w3.org/1999/xlink",createElement:function(a,b){var c=a.toLowerCase(),d=document.createElementNS(this.ns,c);"svg"===c&&(b=_.defaults(b||{},{version:this.version}));_.isObject(b)&&this.setAttributes(d,b);return d},setAttributes:function(a,b){_.each(b,function(a,b){this.setAttribute(b,a)},a);return this},removeAttributes:function(a,
b){_.each(b,function(a){this.removeAttribute(a)},a);return this},toString:function(a,f,d){var g=a.length,l=g-1;if(!d)return _.map(a,function(a,b){var c;c=(0>=b?"M":"L")+(" "+a.x.toFixed(3)+" "+a.y.toFixed(3));b>=l&&f&&(c+=" Z");return c}).join(" ");var n=b(a,f);return _.map(n,function(a,b){var d,h=f?c(b-1,g):Math.max(b-1,0),k=f?c(b+1,g):Math.min(b+1,l);d=n[h];var k=n[k],h=d.v.x.toFixed(3),p=d.v.y.toFixed(3),q=a.u.x.toFixed(3),v=a.u.y.toFixed(3),u=a.x.toFixed(3),e=a.y.toFixed(3);d=0>=b?"M "+u+" "+
e:"C "+h+" "+p+" "+q+" "+v+" "+u+" "+e;b>=l&&f&&(h=a.v.x.toFixed(3),p=a.v.y.toFixed(3),q=k.u.x.toFixed(3),v=k.u.y.toFixed(3),u=k.x.toFixed(3),e=k.y.toFixed(3),d=d+(" C "+h+" "+p+" "+q+" "+v+" "+u+" "+e)+" Z");return d}).join(" ")}},g=Two[Two.Types.svg]=function(){this.domElement=d.createElement("svg");this.elements=[];this.commands=[];this.domElement.style.visibility="hidden";this.unveil=_.once(_.bind(function(){this.domElement.style.visibility="visible"},this))};_.extend(g,{Identifier:"two-"});_.extend(g.prototype,
...
break;case Two.Properties.demotion:_.each(c,function(a){p.removeChild(j[a]);this.elements[a]=null},this);default:h.setStyles.call(this,p,b,c,d,g)}return this},render:function(){if(_.isNull(this.stage))return this;this.ctx.clearRect(0,0,this.width,this.height);this.stage.render(this.ctx);return this}})})();(function(){function p(a){var b=[];_.each(a,function(a){_.isArray(a)&&_.isArray(a[0])?b=b.concat(p(a)):b.push(a)});return b}function a(a){return g.apply(this,a)}var b=Two[Two.Types.canvas],c=Two.Utils.getCurveFromPoints,d=Two.Matrix.Multiply,g=Two.Matrix.Determinant,h=Two.Utils.decoupleShapes,f=Two.Utils.subdivide,k={aliceblue:"#F0F8FF",antiquewhite:"#FAEBD7",aqua:"#00FFFF",aquamarine:"#7FFFD4",azure:"#F0FFFF",beige:"#F5F5DC",bisque:"#FFE4C4",black:"#000000",blanchedalmond:"#FFEBCD",blue:"#0000FF",
...
steelblue:"#4682B4",tan:"#D2B48C",teal:"#008080",thistle:"#D8BFD8",tomato:"#FF6347",turquoise:"#40E0D0",violet:"#EE82EE",wheat:"#F5DEB3",white:"#FFFFFF",whitesmoke:"#F5F5F5",yellow:"#FFFF00",yellowgreen:'#9ACD32"'},m="(?:\\+|-)?\\d+",l="(?:\\+|-)?\\d*\\.\\d+",n="(?:"+m+")|(?:"+l+")",m="("+m+")",l="("+l+")",n="("+n+")",l=n+"%",r=RegExp(["^hsl(a?)\\(",n,",",l,",",l,"(,",n,")?\\)$"].join("\\s*?")),j=RegExp(["^rgb(a?)\\(",m,",",m,",",m,"(,",n,")?\\)$"].join("\\s*?")),s=RegExp(["^rgb(a?)\\(",l,",",l,",",
l,"(,",n,")?\\)$"].join("\\s*?")),A=/^,\s*/,w=[function(a){function b(c,d){var f=a.match(c);if(f&&1!==!!f[1]+!!f[5]){var g=_.isUndefined(f[5])?1:f[5].replace(A,"");return{r:Math.min(1,Math.max(0,f[2]/d)),g:Math.min(1,Math.max(0,f[3]/d)),b:Math.min(1,Math.max(0,f[4]/d)),a:Math.min(1,Math.max(g,0))}}}a=a.replace(/^\s+|\s+$/g,"");var c=b(j,255);return c?c:b(s,100)},function(a){var b=a.toLowerCase();b in k&&(a=k[b]);if(a.match(/^#([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/)){a=a.replace(/^#/,"");var b=a.length/
...
_.isNull(b)?1:b.replace(A,"");return{r:f(h,g,a+1/3),g:f(h,g,a),b:f(h,g,a-1/3),a:c}}],m=function(a){b.Group.call(this,a)};_.extend(m.prototype,b.Group.prototype,{appendChild:function(){b.Group.prototype.appendChild.apply(this,arguments);this.updateMatrix();return this},updateMatrix:function(a){a=a||this.parent&&this.parent.matrix;if(!a)return this;this._matrix=d(this.matrix,a);_.each(this.children,function(a){a.updateMatrix(this._matrix)},this);return this},render:function(a,b,c,d){_.each(this.children,
...
b:0,a:0}},toArray:function(a,b,d){if(!d)return a.slice(0);var e=c(a,b),g=e.length,h=g-1,j=[];_.each(e,function(a,c){if(b||!b&&c<h){var d=e[(c+1)%g],d=f(a.x,a.y,a.v.x,a.v.y,d.u.x,d.u.y,d.x,d.y);j=j.concat(d)}});return j},tessellate:function(a,b,c,d,f){a=p(h(a,b));var g=[],j=[],k=0,l=0;_.each(a,function(a){a=new tessellation.SweepContext(a);tessellation.sweep.Triangulate(a);k+=6*a.triangles.length;_.each(a.triangles,function(a){var b=a.points;a=b[0];var c=b[1],b=b[2];g.push(a.x,a.y,c.x,c.y,b.x,b.y)});
l+=4*a.edges.length;_.each(a.edges,function(a){var b=a.p;a=a.q;j.push(b.x,b.y,a.x,a.y)})});d=d&&k<=d.length?d:new Two.Array(k);f=f&&l<=f.length?f:new Two.Array(l);d.set(g);f.set(j);return{triangles:d,vertices:f,triangleAmount:k/2,vertexAmount:l/2}},program:{create:function(a,b){var c=a.createProgram();_.each(b,function(b){a.attachShader(c,b)});a.linkProgram(c);if(!a.getProgramParameter(c,a.LINK_STATUS))throw error=a.getProgramInfoLog(c),new Two.Utils.Error("unable to link program: "+error);return c}},
...
noStroke:function(){_.each(this.children,function(a){a.noStroke()});return this}})})();(function(){var p=Math.min,a=Math.max,b=Math.round,c=Two.Polygon=function(c,g,h){Two.Shape.call(this);g=!!g;h=!!h;var f=0,k=1,m=!1,l=c.slice(0),n=_.debounce(_.bind(function(){var a,c;if(m){a=this.vertices.length;a-=1;c=b(f*a);a=b(k*a);for(l.length=0;c<a+1;c++){var d=this.vertices[c];l.push(new Two.Vector(d.x,d.y))}m=!1}this.trigger(Two.Events.change,this.id,"vertices",l,g,h)},this),0);Object.defineProperty(this,"closed",{get:function(){return g},set:function(a){g=!!a;n()}});Object.defineProperty(this,
"curved",{get:function(){return h},set:function(a){h=!!a;n()}});Object.defineProperty(this,"beginning",{get:function(){return f},set:function(b){f=p(a(b,0),1);m=!0;n()}});Object.defineProperty(this,"ending",{get:function(){return k},set:function(b){k=p(a(b,0),1);m=!0;n()}});this.vertices=c.slice(0);_.each(this.vertices,function(a){a.bind(Two.Events.change,n)},this);n()};_.extend(c,{});_.extend(c.prototype,Two.Shape.prototype,{clone:function(){var a=_.map(this.vertices,function(a){return new Two.Vector(a.x,
...
b=b-a,c=c+a,k=k+a,a=this._matrix.multiply(b,f,1),m=this._matrix.multiply(c,k,1);return{top:a.y,left:a.x,right:m.x,bottom:m.y,width:m.x-a.x,height:m.y-a.y}}})})();

...
var u=d.some=d.any=function(a,k,p){k||(k=d.identity);var b=!1;if(null==a)return b;if(E&&a.some===E)return a.some(k,p);r(a,function(a,d,c){if(b||(b=k.call(p,a,d,c)))return m});return!!b};d.include=d.contains=function(a,d){var p=!1;return null==a?p:H&&a.indexOf===H?-1!=a.indexOf(d):p=u(a,function(a){return a===d})};d.invoke=function(a,k){var p=g.call(arguments,2);return d.map(a,function(a){return(d.isFunction(k)?k||a:a[k]).apply(a,p)})};d.pluck=function(a,k){return d.map(a,function(a){return a[k]})};
...
c=Array(b),f=0;f<b;f++)c[f]=d.pluck(a,""+f);return c};d.indexOf=function(a,b,c){if(null==a)return-1;var f;if(c)return c=d.sortedIndex(a,b),a[c]===b?c:-1;if(H&&a.indexOf===H)return a.indexOf(b);c=0;for(f=a.length;c<f;c++)if(c in a&&a[c]===b)return c;return-1};d.lastIndexOf=function(a,d){if(null==a)return-1;if(L&&a.lastIndexOf===L)return a.lastIndexOf(d);for(var b=a.length;b--;)if(b in a&&a[b]===d)return b;return-1};d.range=function(a,d,b){1>=arguments.length&&(d=a||0,a=0);b=arguments[2]||1;for(var c=
Math.max(Math.ceil((d-a)/b),0),f=0,l=Array(c);f<c;)l[f++]=a,a+=b;return l};var v=function(){};d.bind=function(a,b){var c,f;if(a.bind===s&&s)return s.apply(a,g.call(arguments,1));if(!d.isFunction(a))throw new TypeError;f=g.call(arguments,2);return c=function(){if(!(this instanceof c))return a.apply(b,f.concat(g.call(arguments)));v.prototype=a.prototype;var d=new v,l=a.apply(d,f.concat(g.call(arguments)));return Object(l)===l?l:d}};d.bindAll=function(a){var b=g.call(arguments,1);0==b.length&&(b=d.functions(a));
r(b,function(b){a[b]=d.bind(a[b],a)});return a};d.memoize=function(a,b){var c={};b||(b=d.identity);return function(){var f=b.apply(this,arguments);return d.has(c,f)?c[f]:c[f]=a.apply(this,arguments)}};d.delay=function(a,d){var b=g.call(arguments,2);return setTimeout(function(){return a.apply(null,b)},d)};d.defer=function(a){return d.delay.apply(d,[a,1].concat(g.call(arguments,1)))};d.throttle=function(a,b){var c,f,l,g,e,j,q=d.debounce(function(){e=g=!1},b);return function(){c=this;f=arguments;l||
(l=setTimeout(function(){l=null;e&&a.apply(c,f);q()},b));g?e=!0:j=a.apply(c,f);q();g=!0;return j}};d.debounce=function(a,d,b){var c;return function(){var f=this,l=arguments;b&&!c&&a.apply(f,l);clearTimeout(c);c=setTimeout(function(){c=null;b||a.apply(f,l)},d)}};d.once=function(a){var d=!1,b;return function(){if(d)return b;d=!0;return b=a.apply(this,arguments)}};d.wrap=function(a,d){return function(){var b=[a].concat(g.call(arguments,0));return d.apply(this,b)}};d.compose=function(){var a=arguments;
...
(function(){_.each(f.Instances,function(b){b.playing&&b.update().render()});requestAnimationFrame(arguments.callee)})()})();(function(){function n(b){var c={},f=b.translation,e=b.rotation,j=b.scale,g=b.stroke,l=b.linewidth,h=b.fill,m=b.opacity,d=b.visible,n=b.cap,u=b.join,v=b.miter,F=b.curved,w=b.closed,A=b.vertices;b.id&&(c.id=y.Identifier+b.id);f&&(_.isNumber(j)&&_.isNumber(e))&&(c.transform="translate("+f.x+","+f.y+") scale("+j+") rotate("+e+")");g&&(c.stroke=g);h&&(c.fill=h);m&&(c["stroke-opacity"]=c["fill-opacity"]=m);d&&(c.visibility=d?"visible":"hidden");n&&(c["stroke-linecap"]=n);u&&(c["stroke-linejoin"]=u);v&&
(c["stroke-miterlimit"]=v);l&&(c["stroke-width"]=l);A&&(c.d=x.toString(A,w,F));return c}function e(b,c){var e=b.x-c.x,j=b.y-c.y;return f(e*e+j*j)}function h(b,c){for(;0>b;)b+=c;return b%c}var m=0,j=Math.sin,c=Math.cos,g=Math.atan2,f=Math.sqrt,b=Math.PI,l=b/2,x={version:1.1,ns:"http://www.w3.org/2000/svg",xlink:"http://www.w3.org/1999/xlink",createElement:function(b,c){var f=b.toLowerCase(),e=document.createElementNS(this.ns,f);"svg"===f&&(c=_.defaults(c||{},{version:this.version}));_.isObject(c)&&
this.setAttributes(e,c);return e},setAttributes:function(b,c){_.each(c,function(b,c){this.setAttribute(c,b)},b);return this},removeAttributes:function(b,c){_.each(c,function(b){this.removeAttribute(b)},b);return this},toString:function(f,q,m){var n=f.length,E=n-1;if(!m)return _.map(f,function(b,d){var c;c=(0>=d?"M":"L")+(" "+b.x.toFixed(3)+" "+b.y.toFixed(3));d>=E&&q&&(c+=" Z");return c}).join(" ");var x=[];m=f.length;for(var y=m-1,C=0;C<m;C++){var s=f[C],s={x:s.x,y:s.y};x.push(s);var d=q?h(C-1,m):
Math.max(C-1,0),r=q?h(C+1,m):Math.min(C+1,y);var u=f[d],d=s,v=f[r],r=g(u.y-d.y,u.x-d.x),F=g(v.y-d.y,v.x-d.x),u=e(u,d),v=e(v,d),w=(r+F)/2,A=void 0,G=void 0;1E-4>u||1E-4>v?(d.u={x:d.x,y:d.y},d.v={x:d.x,y:d.y}):(u*=0.33,v*=0.33,w=F<r?w+l:w-l,A={x:d.x+c(w)*u,y:d.y+j(w)*u},w-=b,G={x:d.x+c(w)*v,y:d.y+j(w)*v},d.u=A,d.v=G);!s.u.x&&!s.u.y&&(s.u.x=s.x,s.u.y=s.y);!s.v.x&&!s.v.y&&(s.v.x=s.x,s.v.y=s.y)}return _.map(x,function(b,d){var c,f=q?h(d-1,n):Math.max(d-1,0),e=q?h(d+1,n):Math.min(d+1,E);c=x[f];var e=x[e],
f=c.v.x.toFixed(3),a=c.v.y.toFixed(3),j=b.u.x.toFixed(3),g=b.u.y.toFixed(3),l=b.x.toFixed(3),m=b.y.toFixed(3);c=0>=d?"M "+l+" "+m:"C "+f+" "+a+" "+j+" "+g+" "+l+" "+m;d>=E&&q&&(f=b.v.x.toFixed(3),a=b.v.y.toFixed(3),j=e.u.x.toFixed(3),g=e.u.y.toFixed(3),l=e.x.toFixed(3),m=e.y.toFixed(3),c=c+(" C "+f+" "+a+" "+j+" "+g+" "+l+" "+m)+" Z");return c}).join(" ")}},y=Two[Two.Types.svg]=function(){this.domElement=x.createElement("svg");this.elements=[];this.commands=[]};_.extend(y,{Identifier:"two-"});_.extend(y.prototype,
Backbone.Events,{setSize:function(b,c){this.width=b;this.height=c;x.setAttributes(this.domElement,{width:b,height:c});return this},add:function(b){var c=b,f=this.elements,e=this.domElement;_.isArray(b)||(c=_.map(arguments,function(b){return b}));_.each(c,function(b){var c;c=b instanceof Two.Group;if(_.isUndefined(b.id)){var j=m;m++;b.id=j}c?(c="g",_.isUndefined(b.parent)&&(b.parent=this,b.unbind(Two.Events.change).bind(Two.Events.change,_.bind(this.update,this))),b=n(b),delete b.stroke,delete b.fill,
delete b["fill-opacity"],delete b["stroke-opacity"],delete b["stroke-linecap"],delete b["stroke-linejoin"],delete b["stroke-miterlimit"],delete b["stroke-width"]):(c="path",b=n(b));b=x.createElement(c,b);e.appendChild(b);f.push(b)},this);return this},update:function(b,c,f){this.commands.push(arguments);return this},render:function(){var b=this.elements;_.each(this.commands,function(c){var f=c[1],e=c[2],j=c[3],g=c[4],l=b[c[0]];switch(f){case Two.Properties.hierarchy:_.each(e,function(c){l.appendChild(b[c])});
break;default:a:{c=f;switch(c){case "matrix":c="transform";e="matrix("+e+")";break;case "visible":c="visibility";e=e?"visible":"hidden";break;case "cap":c="stroke-linecap";break;case "join":c="stroke-linejoin";break;case "miter":c="stroke-miterlimit";break;case "linewidth":c="stroke-width";break;case "vertices":c="d";e=x.toString(e,j,g);break;case "opacity":x.setAttributes(l,{"stroke-opacity":opacity,"fill-opacity":opacity});break a}l.setAttribute(c,e)}}},this);this.commands.length=0;return this}})})();(function(){var n=Two.Vector=function(e,h){e=e||0;h=h||0;Object.defineProperty(this,"x",{get:function(){return e},set:function(h){e=h;this.trigger("change","x")}});Object.defineProperty(this,"y",{get:function(){return h},set:function(e){h=e;this.trigger("change","y")}})};_.extend(n,{});_.extend(n.prototype,Backbone.Events,{set:function(e,h){this.x=e;this.y=h;return this},copy:function(e){this.x=e.x;this.y=e.y;return this},clear:function(){this.y=this.x=0;return this},clone:function(){return new n(this.x,
...
Two.Shape.prototype,{add:function(e){var h=e,m=this.children,j=this.parent,c=[];_.isArray(e)||(h=_.toArray(arguments));var g=_.bind(function(c,b,e,g,j){this.trigger(Two.Events.change,c,b,e,g,j)},this);_.each(h,function(e){var b=e.id,h=e.parent;_.isUndefined(b)&&(j.add(e),b=e.id);_.isUndefined(m[b])&&(h&&delete h.children[b],m[b]=e,e.parent=this,e.unbind(Two.Events.change).bind(Two.Events.change,g),c.push(b))},this);0<c.length&&this.trigger(Two.Events.change,this.id,"hierarchy",c);return this},getBoundingClientRect:function(){var e=
Infinity,h=-Infinity,m=Infinity,j=-Infinity;_.each(this.children,function(c){c=c.getBoundingClientRect();m=Math.min(c.top,m);e=Math.min(c.left,e);h=Math.max(c.right,h);j=Math.max(c.bottom,j)},this);var c=this._matrix.multiply(e,m,1),g=this._matrix.multiply(h,j,1);return{top:c.y,left:c.x,right:g.x,bottom:g.y,width:g.x-c.x,height:g.y-c.y}},noFill:function(){_.each(this.children,function(e){e.noFill()});return this},noStroke:function(){_.each(this.children,function(e){e.noStroke()});return this}})})();(function(){var n=Math.min,e=Math.max,h=Math.round,m=Two.Polygon=function(j,c,g){Two.Shape.call(this);c=!!c;g=!!g;var f=0,b=1,l=!1,m=[],y=_.debounce(_.bind(function(){var c,e;if(l){c=this.vertices.length;c-=1;e=h(f*c);c=h(b*c);for(m.length=0;e<c+1;e++){var g=this.vertices[e];m.push({x:g.x,y:g.y})}l=!1}this.trigger(Two.Events.change,this.id,"vertices",m,this.closed,this.curved)},this),0);Object.defineProperty(this,"closed",{get:function(){return c},set:function(b){c=!!b;y()}});Object.defineProperty(this,
"curved",{get:function(){return g},set:function(b){g=!!b;y()}});Object.defineProperty(this,"beginning",{get:function(){return f},set:function(b){f=n(e(b,0),1);l=!0;y()}});Object.defineProperty(this,"ending",{get:function(){return b},set:function(c){b=n(e(c,0),1);l=!0;y()}});this.vertices=j.slice(0);_.each(this.vertices,function(b){b.bind(Two.Events.change,y)},this)};_.extend(m,{});_.extend(m.prototype,Two.Shape.prototype,{clone:function(){var e=_.map(this.vertices,function(c){return new Two.Vector(c.x,

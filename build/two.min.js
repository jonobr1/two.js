...
this.domElement);return this}})})();(function(){var B=Two.Utils.mod,m=Two.Utils.getRatio,h,f,q,p,d,n,l,v,G,w,s,c,C,x,A,y,z,E,F,a,b,r,g,H,u,D,I,J={group:{renderChild:function(a){J[a._renderer.type].render.call(a,this)},render:function(a){this.update();h=this._matrix.elements;a.save();a.transform(h[0],h[3],h[1],h[4],h[2],h[5]);_.each(this.children,J.group.renderChild,a);a.restore();return this.flagReset()}},polygon:{render:function(m){this.update();h=this._matrix.elements;f=this.stroke;q=this.linewidth;p=this.fill;d=this.opacity;n=this.visible;
l=this.cap;v=this.join;G=this.miter;w=this.closed;s=this._vertices;c=s.length;C=c-1;if(!n)return this;m.save();h&&m.transform(h[0],h[3],h[1],h[4],h[2],h[5]);p&&(m.fillStyle=p);f&&(m.strokeStyle=f);q&&(m.lineWidth=q);G&&(m.miterLimit=G);v&&(m.lineJoin=v);l&&(m.lineCap=l);_.isNumber(d)&&(m.globalAlpha=d);m.beginPath();_.each(s,function(d,f){D=d.x.toFixed(3);I=d.y.toFixed(3);switch(d._command){case Two.Commands.close:m.closePath();break;case Two.Commands.curve:A=w?B(f-1,c):Math.max(f-1,0);x=w?B(f+1,
c):Math.min(f+1,C);y=s[A];z=s[x];r=y.controls&&y.controls.right||y;g=d.controls&&d.controls.left||d;a=r.x.toFixed(3);b=r.y.toFixed(3);E=g.x.toFixed(3);F=g.y.toFixed(3);m.bezierCurveTo(a,b,E,F,D,I);f>=C&&w&&(H=d.controls&&d.controls.right||d,u=z.controls&&z.controls.left||z,a=H.x.toFixed(3),b=H.y.toFixed(3),E=u.x.toFixed(3),F=u.y.toFixed(3),D=z.x.toFixed(3),I=z.y.toFixed(3),m.bezierCurveTo(a,b,E,F,D,I));break;case Two.Commands.line:m.lineTo(D,I);break;case Two.Commands.move:m.moveTo(D,I)}});w&&m.closePath();
...
!1,0,0);a.drawArrays(a.TRIANGLES,0,6);return this.flagReset()}},getBoundingClientRect:function(e,d,g){v=Infinity;G=-Infinity;w=Infinity;s=-Infinity;_.each(e,function(b,d){c=b.x;C=b.y;x;A;y;z;E=b.controls;w=Math.min(C,w);v=Math.min(c,v);G=Math.max(c,G);s=Math.max(C,s);b.controls&&(F=E.left,a=E.right,F&&a&&(x=F.x,A=F.y,y=a.x,z=a.y,x&&(A&&y&&z)&&(w=Math.min(A,z,w),v=Math.min(x,y,v),G=Math.max(x,y,G),s=Math.max(A,z,s))))});_.isNumber(d)&&(w-=d,v-=d,G+=d,s+=d);b=G-v;r=s-w;g.top=w;g.left=v;g.right=G;g.bottom=
...
n={x:d.left,y:d.top};_.each(this.children,function(a){a.translation.subSelf(n)});return this},center:function(){d=this.getBoundingClientRect(!0);d.centroid={x:d.left+d.width/2,y:d.top+d.height/2};_.each(this.children,function(a){a.translation.subSelf(d.centroid)});return this},add:function(a){l=arguments.length;v=a;q=this.children;G=this.parent;w=this.additions;_.isArray(a)||(v=_.toArray(arguments));_.each(v,function(a){a&&(s=a.id,f=a.parent,_.isUndefined(q[s])&&(f&&(delete f.children[s],b=_.indexOf(f.additions,
s),0<=b&&f.additions.splice(b,1)),q[s]=a,a.parent=this,w.push(s),this._flagAdditions=!0))},this);return this},remove:function(a){l=arguments.length;v=a;q=this.children;G=this.parent;w=this.subtractions;if(0>=l&&G)return G.remove(this),this;_.isArray(a)||(v=_.toArray(arguments));_.each(v,function(a){s=a.id;grandchildren=a.children;f=a.parent;s in q&&(delete q[s],delete a.parent,b=_.indexOf(f.additions,s),0<=b&&f.additions.splice(b,1),w.push(s),this._flagSubtractions=!0)},this);return this},getBoundingClientRect:function(b){this.update();
c=Infinity;C=-Infinity;x=Infinity;A=-Infinity;_.each(this.children,function(a){d=a.getBoundingClientRect(!0);_.isNumber(d.top)&&(_.isNumber(d.left)&&_.isNumber(d.right)&&_.isNumber(d.bottom))&&(x=B(d.top,x),c=B(d.left,c),C=m(d.right,C),A=m(d.bottom,A))},this);y=b?this._matrix:Two.Utils.getComputedMatrix(this);z=y.multiply(c,x,1);E=y.multiply(C,x,1);F=y.multiply(C,A,1);a=y.multiply(c,A,1);x=B(z.y,E.y,F.y,a.y);c=B(z.x,E.x,F.x,a.x);C=m(z.x,E.x,F.x,a.x);A=m(z.y,E.y,F.y,a.y);return{top:x,left:c,right:C,
bottom:A,width:C-c,height:A-x}},noFill:function(){_.each(this.children,function(a){a.noFill()});return this},noStroke:function(){_.each(this.children,function(a){a.noStroke()});return this},subdivide:function(){var a=arguments;_.each(this.children,function(b){b.subdivide.apply(b,a)});return this},flagReset:function(){this._flagAdditions&&(this.additions.length=0,this._flagAdditions=!1);this._flagSubtractions&&(this.subtractions.length=0,this._flagSubtractions=!1);Two.Shape.prototype.flagReset.call(this);

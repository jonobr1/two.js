...
(null==e||a?1:e))};e.last=function(h,e,a){return null==h?void 0:null!=e&&!a?c.call(h,Math.max(h.length-e,0)):h[h.length-1]};e.rest=e.tail=e.drop=function(h,e,a){return c.call(h,null==e||a?1:e)};e.compact=function(h){return e.filter(h,e.identity)};var R=function(h,a,c){if(a&&e.every(h,e.isArray))return p.apply(c,h);x(h,function(h){e.isArray(h)||e.isArguments(h)?a?b.apply(c,h):R(h,a,c):c.push(h)});return c};e.flatten=function(h,e){return R(h,e,[])};e.without=function(h){return e.difference(h,c.call(arguments,
...
String(c);case "[object Number]":return b!=+b?c!=+c:0==b?1/b==1/c:b==+c;case "[object Date]":case "[object Boolean]":return+b==+c;case "[object RegExp]":return b.source==c.source&&b.global==c.global&&b.multiline==c.multiline&&b.ignoreCase==c.ignoreCase}if("object"!=typeof b||"object"!=typeof c)return!1;for(var q=d.length;q--;)if(d[q]==b)return g[q]==c;var q=b.constructor,n=c.constructor;if(q!==n&&(!e.isFunction(q)||!(q instanceof q&&e.isFunction(n)&&n instanceof n)))return!1;d.push(b);g.push(c);q=
0;n=!0;if("[object Array]"==r){if(q=b.length,n=q==c.length)for(;q--&&(n=K(b[q],c[q],d,g)););}else{for(var f in b)if(e.has(b,f)&&(q++,!(n=e.has(c,f)&&K(b[f],c[f],d,g))))break;if(n){for(f in c)if(e.has(c,f)&&!q--)break;n=!q}}d.pop();g.pop();return n};e.isEqual=function(a,e){return K(a,e,[],[])};e.isEmpty=function(a){if(null==a)return!0;if(e.isArray(a)||e.isString(a))return 0===a.length;for(var b in a)if(e.has(a,b))return!1;return!0};e.isElement=function(a){return!!(a&&1===a.nodeType)};e.isArray=d||
...
+a};e.isBoolean=function(e){return!0===e||!1===e||"[object Boolean]"==a.call(e)};e.isNull=function(a){return null===a};e.isUndefined=function(a){return void 0===a};e.has=function(a,e){return n.call(a,e)};e.noConflict=function(){m._=k;return this};e.identity=function(a){return a};e.times=function(a,e,b){for(var c=Array(Math.max(0,a)),d=0;d<a;d++)c[d]=e.call(b,d);return c};e.random=function(a,e){null==e&&(e=a,a=0);return a+Math.floor(Math.random()*(e-a+1))};var I={escape:{"&":"&amp;","<":"&lt;",">":"&gt;",
...
context:b,ctx:b||this});return this},once:function(f,d,b){var c=this,p=_.once(function(){c.off(f,p);d.apply(this,arguments)});p._callback=d;this.on(f,p,b);return this},off:function(f,d,b){var c,p,a,n,l,w,u,g;if(!this._events)return this;if(!f&&!d&&!b)return this._events={},this;n=f?[f]:_.keys(this._events);l=0;for(w=n.length;l<w;l++)if(f=n[l],c=this._events[f]){a=[];if(d||b){u=0;for(g=c.length;u<g;u++)p=c[u],(d&&d!==(p.callback._callback||p.callback)||b&&b!==p.context)&&a.push(p)}this._events[f]=
...
c)}},polyline:function(a){return g.Utils.read.polygon(a,!0)},path:function(a){var b=a.getAttribute("d"),b=_.flatten(_.map(_.compact(b.split(/M/g)),function(a){a=_.map(_.compact(a.split(/m/g)),function(a,b){return 0>=b?a:"m"+a});a[0]="M"+a[0];return a})),e,c,b=_.map(b,function(b){var d,f=!1,n=!1;b=_.flatten(_.map(b.match(/[a-z][^a-z]*/ig),function(a){var b,q,r=a[0],l=r.toLowerCase();d=a.slice(1).trim().split(/[\s,]+|(?=[+\-])/);f=r===l;var p,j,w;switch(l){case "z":n=!0;break;case "m":case "l":q=parseFloat(d[0]);
b=parseFloat(d[1]);b=new g.Point(q,b);b._command="m"===l?g.Commands.move:g.Commands.line;f&&b.addSelf(e);e=b;break;case "h":case "v":q="h"===l?"x":"y";l="x"===q?"y":"x";b=new g.Point;b[q]=parseFloat(d[0]);b[l]=e[l];b._command=g.Commands.line;f&&(b[q]+=e[q]);e=b;break;case "s":case "c":b=e.x;a=e.y;"c"===l?(r=parseFloat(d[0]),q=parseFloat(d[1]),l=parseFloat(d[2]),p=parseFloat(d[3]),j=parseFloat(d[4]),w=parseFloat(d[5])):(p=g.Utils.getReflection(e,c,f),r=p.x,q=p.y,l=parseFloat(d[0]),p=parseFloat(d[1]),
j=parseFloat(d[2]),w=parseFloat(d[3]));f&&(r+=b,q+=a,l+=b,p+=a,j+=b,w+=a);e.v.set(r,q);b=new g.Point(j,w,l,p);b._command=g.Commands.curve;e=b;c=b.u;break;case "t":case "q":b=e.x;a=e.y;c.isZero()?(r=b,q=a):(r=c.x,a=c.y);"q"===l?(l=parseFloat(d[0]),p=parseFloat(d[1]),j=parseFloat(d[1]),w=parseFloat(d[2])):(p=g.Utils.getReflection(e,c,f),l=p.x,p=p.y,j=parseFloat(d[0]),w=parseFloat(d[1]));f&&(r+=b,q+=a,l+=b,p+=a,j+=b,w+=a);e.v.set(r,q);b=new g.Point(j,w,l,p);b._command=g.Commands.curve;e=b;c=b.u;break;
case "a":throw new g.Utils.Error("not yet able to interpret Elliptical Arcs.");}return b}));if(!(1>=b.length))return b=_.compact(b),b=(new g.Polygon(b,n,void 0,!0)).noStroke(),g.Utils.applySvgAttributes(a,b)});return _.compact(b)},circle:function(a){var b=parseFloat(a.getAttribute("cx")),e=parseFloat(a.getAttribute("cy")),c=parseFloat(a.getAttribute("r")),f=g.Resolution,l=_.map(_.range(f),function(a){var b=a/f*n;a=c*d(b);b=c*j(b);return new g.Point(a,b)},this),l=(new g.Polygon(l,!0,!0)).noStroke();
l.translation.set(b,e);return g.Utils.applySvgAttributes(a,l)},ellipse:function(a){var b=parseFloat(a.getAttribute("cx")),e=parseFloat(a.getAttribute("cy")),c=parseFloat(a.getAttribute("rx")),f=parseFloat(a.getAttribute("ry")),l=g.Resolution,p=_.map(_.range(l),function(a){var b=a/l*n;a=c*d(b);b=f*j(b);return new g.Point(a,b)},this),p=(new g.Polygon(p,!0,!0)).noStroke();p.translation.set(b,e);return g.Utils.applySvgAttributes(a,p)},rect:function(a){var b=parseFloat(a.getAttribute("x")),e=parseFloat(a.getAttribute("y")),
c=parseFloat(a.getAttribute("width")),d=parseFloat(a.getAttribute("height")),c=c/2,d=d/2,f=[new g.Point(c,d),new g.Point(-c,d),new g.Point(-c,-d),new g.Point(c,-d)],f=(new g.Polygon(f,!0)).noStroke();f.translation.set(b+c,e+d);return g.Utils.applySvgAttributes(a,f)},line:function(a){var b=parseFloat(a.getAttribute("x1")),e=parseFloat(a.getAttribute("y1")),c=parseFloat(a.getAttribute("x2")),d=parseFloat(a.getAttribute("y2")),c=(c-b)/2,d=(d-e)/2,f=[new g.Point(-c,-d),new g.Point(c,d)],f=(new g.Polygon(f)).noFill();
f.translation.set(b+c,e+d);return g.Utils.applySvgAttributes(a,f)}},subdivide:function(c,d,e,f,l,j,w,u,k){var t=g.Utils.Curve.CollinearityEpsilon,z=g.Utils.Curve.RecursionLimit,v=g.Utils.Curve.CuspLimit,s=g.Utils.Curve.Tolerance,m;k=k||0;if(k>z)return[];var z=(c+e)/2,y=(d+f)/2,F=(e+l)/2,h=(f+j)/2,M=(l+w)/2,N=(j+u)/2,O=(z+F)/2,P=(y+h)/2,F=(F+M)/2,h=(h+N)/2,D=(O+F)/2,E=(P+h)/2;m=w-c;var B=u-d,G=p((e-w)*B-(f-u)*m),H=p((l-w)*B-(j-u)*m);if(0<k){if(G>t&&H>t&&(G+H)*(G+H)<=s.distance*(m*m+B*B)){if(s.angle<
s.epsilon)return[new g.Vector(D,E)];m=b(j-f,l-e);t=p(m-b(f-d,e-c));m=p(b(u-j,w-l)-m);t>=a&&(t=n-t);m>=a&&(m=n-m);if(t+m<s.angle)return[new g.Vector(D,E)];if(0!==v){if(t>v)return[new g.Vector(e,f)];if(m>v)return[new g.Vector(l,j)]}}}else if(G>t)if(G*G<=s.distance*(m*m+B*B)){if(s.angle<s.epsilon)return[new g.Vector(D,E)];t=p(b(j-f,l-e)-b(f-d,e-c));t>=a&&(t=n-t);if(t<s.angle)return[new g.Vector(e,f),new g.Vector(l,j)];if(0!==v&&t>v)return[new g.Vector(e,f)]}else if(H>t){if(H*H<=s.distance*(m*m+B*B)){if(s.angle<
s.epsilon)return[new g.Vector(D,E)];t=p(b(u-j,w-l)-b(j-f,l-e));t>=a&&(t=n-t);if(t<s.angle)return[new g.Vector(e,f),new g.Vector(l,j)];if(0!==v&&t>v)return[new g.Vector2(l,j)]}}else if(m=D-(c+w)/2,B=E-(d+u)/2,m*m+B*B<=s.distance)return[new g.Vector(D,E)];return g.Utils.subdivide(c,d,z,y,O,P,D,E,k+1).concat(g.Utils.subdivide(D,E,F,h,M,N,w,u,k+1))},getCurveFromPoints:function(a,b){for(var e=a.length,c=e-1,d=0;d<e;d++){var f=a[d],n=b?y(d-1,e):Math.max(d-1,0),l=b?y(d+1,e):Math.min(d+1,c);s(a[n],f,a[l]);
f._command=0===d?g.Commands.move:g.Commands.curve;f.u.x=_.isNumber(f.u.x)?f.u.x:f.x;f.u.y=_.isNumber(f.u.y)?f.u.y:f.y;f.v.x=_.isNumber(f.v.x)?f.v.x:f.x;f.v.y=_.isNumber(f.v.y)?f.v.y:f.y}},getControlPoints:function(b,c,e){var f=v(b,c),n=v(e,c);b=t(b,c);e=t(e,c);var p=(f+n)/2;c.u=_.isObject(c.u)?c.u:new g.Vector(c.x,c.y);c.v=_.isObject(c.v)?c.v:new g.Vector(c.x,c.y);if(1E-4>b||1E-4>e)return c.u.copy(c),c.v.copy(c),c;b*=0.33;e*=0.33;p=n<f?p+l:p-l;c.u.x=c.x+d(p)*b;c.u.y=c.y+j(p)*b;p-=a;c.v.x=c.x+d(p)*
e;c.v.y=c.y+j(p)*e;return c},getReflection:function(a,b,e){var c=a.distanceTo(b);if(1E-4>=c)return e?new g.Vector:a.clone();b=v(a,b);return new g.Vector(c*Math.cos(b)+(e?0:a.x),c*Math.sin(b)+(e?0:a.y))},angleBetween:function(a,c){return b(a.y-c.y,a.x-c.x)},distanceBetweenSquared:function(a,b){var e=a.x-b.x,c=a.y-b.y;return e*e+c*c},distanceBetween:function(a,b){return c(z(a,b))},mod:function(a,b){for(;0>a;)a+=b;return a%b},Collection:function(){Array.call(this);1<arguments.length?Array.prototype.push.apply(this,
arguments):arguments[0]&&Array.isArray(arguments[0])&&Array.prototype.push.apply(this,arguments[0])},Error:function(a){this.name="two.js";this.message=a}}});g.Utils.Error.prototype=Error();g.Utils.Error.prototype.constructor=g.Utils.Error;g.Utils.Collection.prototype=[];g.Utils.Collection.constructor=g.Utils.Collection;_.extend(g.Utils.Collection.prototype,Backbone.Events,{pop:function(){var a=Array.prototype.pop.apply(this,arguments);this.trigger(g.Events.remove,[a]);return a},shift:function(){var a=
Array.prototype.shift.apply(this,arguments);this.trigger(g.Events.remove,[a]);return a},push:function(){var a=Array.prototype.push.apply(this,arguments);this.trigger(g.Events.insert,arguments);return a},unshift:function(){var a=Array.prototype.unshift.apply(this,arguments);this.trigger(g.Events.insert,arguments);return a},splice:function(){var a=Array.prototype.splice.apply(this,arguments),b;this.trigger(g.Events.remove,a);2<arguments.length&&(b=this.slice(arguments[0],arguments.length-2),this.trigger(g.Events.insert,
b));return a}});var t=g.Utils.distanceBetween,z=g.Utils.distanceBetweenSquared,v=g.Utils.angleBetween,s=g.Utils.getControlPoints,y=g.Utils.mod;_.extend(g.prototype,Backbone.Events,{appendTo:function(a){a.appendChild(this.renderer.domElement);return this},play:function(){g.Utils.setPlaying.call(this,!0);return this.trigger(g.Events.play)},pause:function(){this.playing=!1;return this.trigger(g.Events.pause)},update:function(){_.defer(_.bind(function(){var a=!!this._lastFrame,b=(k.performance&&k.performance.now?
k.performance:Date).now();this.frameCount++;a&&(this.timeDelta=parseFloat((b-this._lastFrame).toFixed(3)));this._lastFrame=b;var a=this.width,b=this.height,e=this.renderer;(a!==e.width||b!==e.height)&&e.setSize(a,b);this.trigger(g.Events.update,this.frameCount,this.timeDelta);this.render()},this));return this},render:function(){this.renderer.render();return this.trigger(g.Events.render,this.frameCount)},add:function(a){var b=a;_.isArray(a)||(b=_.toArray(arguments));this.scene.add(b);return this},
remove:function(a){var b=a;_.isArray(a)||(b=_.toArray(arguments));this.scene.remove(b);return this},clear:function(){_.each(this.scene.children,function(a){a.remove()});return this},makeLine:function(a,b,e,c){e=(e-a)/2;c=(c-b)/2;var d=[new g.Point(-e,-c),new g.Point(e,c)],d=(new g.Polygon(d)).noFill();d.translation.set(a+e,b+c);this.scene.add(d);return d},makeRectangle:function(a,b,c,d){c/=2;d/=2;d=[new g.Point(c,d),new g.Point(-c,d),new g.Point(-c,-d),new g.Point(c,-d)];d=new g.Polygon(d,!0);d.translation.set(a,
b);this.scene.add(d);return d},makeCircle:function(a,b,c){return this.makeEllipse(a,b,c,c)},makeEllipse:function(a,b,c,f){var l=g.Resolution,p=_.map(_.range(l),function(a){var b=a/l*n;a=c*d(b);b=f*j(b);return new g.Point(a,b)},this),p=new g.Polygon(p,!0,!0);p.translation.set(a,b);this.scene.add(p);return p},makeCurve:function(a){var b=arguments.length,c=a;if(!_.isArray(a))for(var c=[],d=0;d<b;d+=2){var f=arguments[d];if(!_.isNumber(f))break;c.push(new g.Point(f,arguments[d+1]))}var b=arguments[b-
1],c=new g.Polygon(c,!(_.isBoolean(b)&&b),!0),b=c.getBoundingClientRect(),n=b.left+b.width/2,l=b.top+b.height/2;_.each(c.vertices,function(a){a.x-=n;a.y-=l});c.translation.set(n,l);this.scene.add(c);return c},makePolygon:function(a){var b=arguments.length,c=a;if(!_.isArray(a))for(var c=[],d=0;d<b;d+=2){var f=arguments[d];if(!_.isNumber(f))break;c.push(new g.Point(f,arguments[d+1]))}b=arguments[b-1];c=new g.Polygon(c,!(_.isBoolean(b)&&b));b=c.getBoundingClientRect();c.center().translation.set(b.left+
b.width/2,b.top+b.height/2);this.scene.add(c);return c},makeGroup:function(a){var b=a;_.isArray(a)||(b=_.toArray(arguments));var c=new g.Group;this.scene.add(c);c.add(b);return c},interpret:function(a){var b=a.tagName.toLowerCase();if(!(b in g.Utils.read))return null;a=g.Utils.read[b].call(this,a);this.add(a);return a}});(function(){_.each(g.Instances,function(a){a.playing&&a.update()});requestAnimationFrame(arguments.callee)})();"function"===typeof define&&define.amd?define(function(){return g}):
...
A3*B1+A4*B4+A5*B7;this.elements[5]=A3*B2+A4*B5+A5*B8;this.elements[6]=A6*B0+A7*B3+A8*B6;this.elements[7]=A6*B1+A7*B4+A8*B7;this.elements[8]=A6*B2+A7*B5+A8*B8;return this.trigger(Two.Events.change)},inverse:function(d){var b=this.elements;d=d||new Two.Matrix;var c=b[0],f=b[1],a=b[2],n=b[3],l=b[4],j=b[5],k=b[6],g=b[7],b=b[8],t=b*l-j*g,m=-b*n+j*k,v=g*n-l*k,s=c*t+f*m+a*v;if(!s)return null;s=1/s;d.elements[0]=t*s;d.elements[1]=(-b*f+a*g)*s;d.elements[2]=(j*f-a*l)*s;d.elements[3]=m*s;d.elements[4]=(b*c-
a*k)*s;d.elements[5]=(-j*c+a*n)*s;d.elements[6]=v*s;d.elements[7]=(-g*c+f*k)*s;d.elements[8]=(l*c-f*n)*s;return d},scale:function(d,b){1>=arguments.length&&(b=d);return this.multiply(d,0,0,0,b,0,0,0,1)},rotate:function(d){var b=m(d);d=k(d);return this.multiply(b,-d,0,d,b,0,0,0,1)},translate:function(d,b){return this.multiply(1,0,d,0,1,b,0,0,1)},skewX:function(d){d=f(d);return this.multiply(1,d,0,0,1,0,0,0,1)},skewY:function(d){d=f(d);return this.multiply(1,0,0,d,1,0,0,0,1)},toString:function(){return this.toArray().join(" ")},
toArray:function(d){var b=this.elements,c=parseFloat(b[0].toFixed(3)),f=parseFloat(b[1].toFixed(3)),a=parseFloat(b[2].toFixed(3)),n=parseFloat(b[3].toFixed(3)),l=parseFloat(b[4].toFixed(3)),j=parseFloat(b[5].toFixed(3));if(d){d=parseFloat(b[6].toFixed(3));var k=parseFloat(b[7].toFixed(3)),b=parseFloat(b[8].toFixed(3));return[c,n,d,f,l,k,a,j,b]}return[c,n,f,l,a,j]},clone:function(){return new Two.Matrix(this.elements[0],this.elements[1],this.elements[2],this.elements[3],this.elements[4],this.elements[5],
this.elements[6],this.elements[7],this.elements[8])}})})();(function(){function m(d){var b={},c=d.id,p=d.translation,a=d.rotation,n=d.scale,l=d.stroke,k=d.linewidth,u=d.fill,g=d.opacity,t=d.visible,m=d.cap,v=d.join,s=d.miter,y=d.closed,r=d.vertices;c&&(b.id=j.Identifier+c);p&&(_.isNumber(n)&&_.isNumber(a))&&(b.transform="matrix("+d._matrix.toString()+")");l&&(b.stroke=l);u&&(b.fill=u);g&&(b["stroke-opacity"]=b["fill-opacity"]=g);b.visibility=t?"visible":"hidden";m&&(b["stroke-linecap"]=m);v&&(b["stroke-linejoin"]=v);s&&(b["stroke-miterlimit"]=s);k&&(b["stroke-width"]=
...
b){var c=d.length,f=c-1;return _.map(d,function(a,n){var l,j=b?k(n-1,c):Math.max(n-1,0),u=b?k(n+1,c):Math.min(n+1,f);l=d[j];var u=d[u],g,t,m,v=a.x.toFixed(3),s=a.y.toFixed(3);switch(a._command){case Two.Commands.curve:j=l.v.x.toFixed(3);g=l.v.y.toFixed(3);t=a.u.x.toFixed(3);m=a.u.y.toFixed(3);l=a._command+" "+j+" "+g+" "+t+" "+m+" "+v+" "+s;break;default:l=(a._command||(0===n?Two.Commands.move:Two.Commands.line))+" "+v+" "+s}n>=f&&b&&(a._command===Two.Commands.curve&&(j=a.v.x.toFixed(3),g=a.v.y.toFixed(3),
...
_.each(z,function(a,c){var d,e,f,g,n,l=a.x.toFixed(3),j=a.y.toFixed(3);switch(a._command){case Two.Commands.curve:e=t?m(c-1,v):Math.max(c-1,0);d=t?m(c+1,v):Math.min(c+1,s);f=z[e];d=z[d];e=f.v.x.toFixed(3);n=f.v.y.toFixed(3);f=a.u.x.toFixed(3);g=a.u.y.toFixed(3);b.bezierCurveTo(e,n,f,g,l,j);c>=s&&t&&(e=a.v.x.toFixed(3),n=a.v.y.toFixed(3),f=d.u.x.toFixed(3),g=d.u.y.toFixed(3),l=d.x.toFixed(3),j=d.y.toFixed(3),b.bezierCurveTo(e,n,f,g,l,j));break;case Two.Commands.line:b.lineTo(l,j);break;case Two.Commands.move:b.moveTo(l,
...
!1,this._matrix);a.bindBuffer(a.ARRAY_BUFFER,this.buffer);a.vertexAttribPointer(b.position,2,a.FLOAT,!1,0,0);a.drawArrays(a.TRIANGLES,0,6);return this}});var c={canvas:document.createElement("canvas"),uv:new Two.Array([0,0,1,0,0,1,0,1,1,0,1,1]),getBoundingClientRect:function(a,b){var c=Infinity,d=-Infinity,f=Infinity,g=-Infinity;_.each(a,function(a){var b=a.x,j=a.y,n;f=Math.min(j,f);c=Math.min(b,c);d=Math.max(b,d);g=Math.max(j,g);b=a.u&&a.u.x;j=a.u&&a.u.y;n=a.v&&a.v.x;a=a.v&&a.v.y;b&&(j&&n&&a)&&(f=
Math.min(j,a,f),c=Math.min(b,n,c),d=Math.max(b,n,d),g=Math.max(j,a,g))});_.isNumber(b)&&(f-=b,c-=b,d+=b,g+=b);return{top:f,left:c,right:d,bottom:g,width:d-c,height:g-f,centroid:{x:-c,y:-f}}},getTriangles:function(a){var b=a.top,c=a.left,d=a.right;a=a.bottom;return new Two.Array([c,b,d,b,c,a,c,a,d,b,d,a])},updateCanvas:function(a){var b=a.commands,c=this.canvas,d=this.ctx,f=a._scale,g=a.stroke,k=a.linewidth*f,p=a.fill,m=a.opacity,s=a.cap,y=a.join,r=a.miter,q=a.closed,e=b.length,x=e-1;c.width=Math.max(Math.ceil(a.rect.width*
f),1);c.height=Math.max(Math.ceil(a.rect.height*f),1);a=a.rect.centroid;var A=a.x*f,C=a.y*f;d.clearRect(0,0,c.width,c.height);p&&(d.fillStyle=p);g&&(d.strokeStyle=g);k&&(d.lineWidth=k);r&&(d.miterLimit=r);y&&(d.lineJoin=y);s&&(d.lineCap=s);_.isNumber(m)&&(d.globalAlpha=m);d.beginPath();_.each(b,function(a,c){var g,l,k,p,m,r=(a.x*f+A).toFixed(3),s=(a.y*f+C).toFixed(3);switch(a._command){case Two.Commands.curve:l=q?j(c-1,e):Math.max(c-1,0);g=q?j(c+1,e):Math.min(c+1,x);k=b[l];g=b[g];l=(k.v.x*f+A).toFixed(3);
m=(k.v.y*f+C).toFixed(3);k=(a.u.x*f+A).toFixed(3);p=(a.u.y*f+C).toFixed(3);d.bezierCurveTo(l,m,k,p,r,s);c>=x&&q&&(l=(a.v.x*f+A).toFixed(3),m=(a.v.y*f+C).toFixed(3),k=(g.u.x*f+A).toFixed(3),p=(g.u.y*f+C).toFixed(3),r=(g.x*f+A).toFixed(3),s=(g.y*f+C).toFixed(3),d.bezierCurveTo(l,m,k,p,r,s));break;case Two.Commands.line:d.lineTo(r,s);break;case Two.Commands.move:d.moveTo(r,s)}});q&&d.closePath();d.fill();d.stroke()},updateTexture:function(a,b){this.updateCanvas(b);b.texture&&a.deleteTexture(b.texture);
...
a.disable(a.DEPTH_TEST);a.enable(a.BLEND);a.blendEquationSeparate(a.FUNC_ADD,a.FUNC_ADD);a.blendFuncSeparate(a.SRC_ALPHA,a.ONE_MINUS_SRC_ALPHA,a.ONE,a.ONE_MINUS_SRC_ALPHA)};_.extend(p,{Group:d,Element:b,getStyles:function(a){var d={},f=a.id,j=a._matrix,k=a.stroke,g=a.linewidth,p=a.fill,m=a.opacity,v=a.visible,s=a.cap,y=a.join,r=a.miter,q=a.closed,e=a.vertices;f&&(d.id=f);_.isObject(j)&&(d.matrix=d._matrix=j.toArray(!0),d.scale=d._scale=1);k&&(d.stroke=k);p&&(d.fill=p);_.isNumber(m)&&(d.opacity=m);

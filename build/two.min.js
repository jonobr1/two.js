...
z(b,function(b){a[b]=e.bind(a[b],a)});return a};e.memoize=function(a,b){var c={};b||(b=e.identity);return function(){var f=b.apply(this,arguments);return e.has(c,f)?c[f]:c[f]=a.apply(this,arguments)}};e.delay=function(a,b){var e=h.call(arguments,2);return setTimeout(function(){return a.apply(null,e)},b)};e.defer=function(a){return e.delay.apply(e,[a,1].concat(h.call(arguments,1)))};e.throttle=function(a,b){var c,f,d,g,h,k,m=e.debounce(function(){h=g=!1},b);return function(){c=this;f=arguments;d||
(d=setTimeout(function(){d=null;h&&a.apply(c,f);m()},b));g?h=!0:k=a.apply(c,f);m();g=!0;return k}};e.debounce=function(a,b,e){var c;return function(){var f=this,d=arguments;e&&!c&&a.apply(f,d);clearTimeout(c);c=setTimeout(function(){c=null;e||a.apply(f,d)},b)}};e.once=function(a){var b=!1,e;return function(){if(b)return e;b=!0;return e=a.apply(this,arguments)}};e.wrap=function(a,b){return function(){var e=[a].concat(h.call(arguments,0));return b.apply(this,e)}};e.compose=function(){var a=arguments;
...
1),function(b){for(var e in b)a[e]=b[e]});return a};e.pick=function(a){var b={};z(e.flatten(h.call(arguments,1)),function(e){e in a&&(b[e]=a[e])});return b};e.defaults=function(a){z(h.call(arguments,1),function(b){for(var e in b)null==a[e]&&(a[e]=b[e])});return a};e.clone=function(a){return!e.isObject(a)?a:e.isArray(a)?a.slice():e.extend({},a)};e.tap=function(a,b){b(a);return a};e.isEqual=function(a,b){return p(a,b,[])};e.isEmpty=function(a){if(null==a)return!0;if(e.isArray(a)||e.isString(a))return 0===
...
{updateMatrix:function(a){a=a||this.parent&&this.parent.matrix;if(!a)return this;this._matrix=c(this.matrix,a);return this},render:function(a,b,c,d){if(!this.visible||!this.fillBuffer||!this.strokeBuffer)return this;0<this.fill.a&&(a.bindBuffer(a.ARRAY_BUFFER,this.fillBuffer),a.vertexAttribPointer(b,2,a.FLOAT,!1,0,0),a.uniformMatrix3fv(c,!1,this._matrix),a.uniform4f(d,this.fill.r,this.fill.g,this.fill.b,this.fill.a),a.drawArrays(a.TRIANGLES,0,this.triangleAmount));if(0>=this.linewidth||0>=this.stroke.a)return this;
a.bindBuffer(a.ARRAY_BUFFER,this.strokeBuffer);a.vertexAttribPointer(b,2,a.FLOAT,!1,0,0);a.uniformMatrix3fv(c,!1,this._matrix);a.uniform4f(d,this.stroke.r,this.stroke.g,this.stroke.b,this.stroke.a);a.lineWidth(this.linewidth);a.drawArrays(a.LINES,0,this.vertexAmount);return this}});var l={updateBuffer:function(a,b,c){_.isObject(b.fillBuffer)&&a.deleteBuffer(b.fillBuffer);b.fillBuffer=a.createBuffer();a.bindBuffer(a.ARRAY_BUFFER,b.fillBuffer);a.enableVertexAttribArray(c);a.bufferData(a.ARRAY_BUFFER,
b.triangles,a.STATIC_DRAW);_.isObject(b.strokeBuffer)&&a.deleteBuffer(b.strokeBuffer);b.strokeBuffer=a.createBuffer();a.bindBuffer(a.ARRAY_BUFFER,b.strokeBuffer);a.enableVertexAttribArray(c);a.bufferData(a.ARRAY_BUFFER,b.vertices,a.STATIC_DRAW)},interpret:function(a){for(var b=0,c=j.length;b<c;b++){var d=j[b](a);if(d)return d}return{r:0,g:0,b:0,a:0}},toArray:function(a,c,d){if(!c)return a;var f=b(a,d),g=f.length,h=g-1,e=[];_.each(f,function(a,b){if(d||!d&&b<h){var c=f[(b+1)%g],c=Two.Utils.subdivide(a.x,
a.y,a.v.x,a.v.y,c.u.x,c.u.y,c.x,c.y);e=e.concat(c)}});return e},tessellate:function(a,b,c,f,g){a=p(d(a,c));var h=[],e=[],j=0,k=0;_.each(a,function(a){a=new tessellation.SweepContext(a);tessellation.sweep.Triangulate(a);j+=6*a.triangles.length;_.each(a.triangles,function(a){var b=a.points;a=b[0];var c=b[1],b=b[2];h.push(a.x,a.y,c.x,c.y,b.x,b.y)});k+=4*a.edges.length;_.each(a.edges,function(a){var b=a.p;a=a.q;e.push(b.x,b.y,a.x,a.y)})});f=f&&j<=f.length?f:new Two.Array(j);g=g&&k<=g.length?g:new Two.Array(k);
f.set(h);g.set(e);return{triangles:f,vertices:g,triangleAmount:j/2,vertexAmount:k/2}},program:{create:function(a,b){var c=a.createProgram();_.each(b,function(b){a.attachShader(c,b)});a.linkProgram(c);if(!a.getProgramParameter(c,a.LINK_STATUS))throw error=a.getProgramInfoLog(c),new Two.Utils.Error("unable to link program: "+error);return c}},shaders:{create:function(a,b,c){c=a.createShader(a[c]);a.shaderSource(c,b);a.compileShader(c);if(!a.getShaderParameter(c,a.COMPILE_STATUS))throw a=a.getShaderInfoLog(c),
new Two.Utils.Error("unable to compile shader "+c+": "+a);return c},types:{vertex:"VERTEX_SHADER",fragment:"FRAGMENT_SHADER"},vertex:"attribute vec2 position;\nuniform mat3 matrix;\nuniform vec2 resolution;\n\nvoid main() {\n   vec2 projected = (matrix * vec3(position, 1)).xy;\n   vec2 normal = projected / resolution;\n   vec2 clipspace = (normal * 2.0) - 1.0;\n\n   gl_Position = vec4(clipspace * vec2(1.0, -1.0), 0.0, 1.0);\n}",fragment:"precision mediump float;\n\nuniform vec4 color;\n\nvoid main() {\n  gl_FragColor = color;\n}"}},
f=Two[Two.Types.webgl]=function(){this.domElement=document.createElement("canvas");this.elements=[];this.stage=null;var a={antialias:!0,premultipliedAlpha:!1};this.ctx=this.domElement.getContext("webgl",a)||this.domElement.getContext("experimental-webgl",a);if(!this.ctx)throw new Two.Utils.Error("unable to create a webgl context. Try using another renderer.");var a=l.shaders.create(this.ctx,l.shaders.vertex,l.shaders.types.vertex),b=l.shaders.create(this.ctx,l.shaders.fragment,l.shaders.types.fragment);
this.program=l.program.create(this.ctx,[a,b]);this.ctx.useProgram(this.program);this.positionLocation=this.ctx.getAttribLocation(this.program,"position");this.colorLocation=this.ctx.getUniformLocation(this.program,"color");this.matrixLocation=this.ctx.getUniformLocation(this.program,"matrix");this.ctx.enable(this.ctx.BLEND);this.ctx.disable(this.ctx.DEPTH_TEST)};_.extend(f,{Group:h,Element:k,getStyles:function(a){var b={},c=a.id,d=a._matrix,f=a.stroke,g=a.linewidth,e=a.fill,h=a.opacity,j=a.visible,
k=a.cap,n=a.join,p=a.miter,s=a.curved,q=a.closed;a=a.vertices;c&&(b.id=c);_.isObject(d)&&(b.matrix=b._matrix=d.toArray(!0));f&&(b.stroke=l.interpret(f));e&&(b.fill=l.interpret(e));_.isNumber(h)&&(b.opacity=h);k&&(b.cap=k);n&&(b.join=n);p&&(b.miter=p);g&&(b.linewidth=g);a&&(a=l.toArray(a,s,q),c=l.tessellate(a,s,q),b.triangles=c.triangles,b.vertices=c.vertices,b.vertexAmount=c.vertexAmount,b.triangleAmount=c.triangleAmount);b.visible=!!j;b.curved=!!s;b.closed=!!q;return b},setStyles:function(a,b,c){switch(b){case "matrix":b=
"matrix";c=c.toArray(!0);break;case "stroke":c=l.interpret(c);break;case "fill":c=l.interpret(c);break;case "vertices":b="triangles";c=l.toArray(c,a.curved,a.closed);var d=l.tessellate(c,a.curved,a.closed,a.triangles,a.vertices);c=d.triangles;a.vertices=d.vertices;a.vertexAmount=d.vertexAmount;a.triangleAmount=d.triangleAmount}a[b]=c;"triangles"===b&&l.updateBuffer(this.ctx,a,this.positionLocation);"matrix"===b&&a.updateMatrix()}});_.extend(f.prototype,Backbone.Events,a.prototype,{setSize:function(b,
c){a.prototype.setSize.apply(this,arguments);this.ctx.viewport(0,0,b,c);var d=this.ctx.getUniformLocation(this.program,"resolution");this.ctx.uniform2f(d,b,c);return this},render:function(){if(_.isNull(this.stage))return this;var a=this.ctx;a.clear(a.COLOR_BUFFER_BIT);this.stage.render(a,this.positionLocation,this.matrixLocation,this.colorLocation);return this}})})();(function(){var p=Two.Shape=function(a){this._matrix=new Two.Matrix;var b=_.debounce(_.bind(function(){var a=this._matrix.identity().translate(this.translation.x,this.translation.y).scale(this.scale).rotate(this.rotation);this.trigger(Two.Events.change,this.id,"matrix",a)},this),0);this._rotation="rotation";Object.defineProperty(this,"rotation",{get:function(){return this._rotation},set:function(a){this._rotation=a;b()}});this._scale="scale";Object.defineProperty(this,"scale",{get:function(){return this._scale},
...
a.y)}),b=new c(a,this.closed,this.curved);_.each(Two.Shape.Properties,function(a){b[a]=this[a]},this);b.translation.copy(this.translation);b.rotation=this.rotation;b.scale=this.scale;return b},getBoundingClientRect:function(){var a=this.linewidth,b=Infinity,c=-Infinity,f=Infinity,k=-Infinity;_.each(this.vertices,function(a){var d=a.x;a=a.y;f=Math.min(a,f);b=Math.min(d,b);c=Math.max(d,c);k=Math.max(a,k)});var f=f-a,b=b-a,c=c+a,k=k+a,a=this._matrix.multiply(b,f,1),n=this._matrix.multiply(c,k,1);return{top:a.y,
left:a.x,right:n.x,bottom:n.y,width:n.x-a.x,height:n.y-a.y}}})})();

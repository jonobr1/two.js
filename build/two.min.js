...
a),b.add(a)))},this);return c.Utils.applySvgAttributes(a,b)},polygon:function(a,b){var d=[];a.getAttribute("points").replace(/([\d\.?]+),([\d\.?]+)/g,function(a,b,g){d.push(new c.Anchor(parseFloat(b),parseFloat(g)))});var g=(new c.Polygon(d,!b)).noStroke();g.fill="black";return c.Utils.applySvgAttributes(a,g)},polyline:function(a){return c.Utils.read.polygon(a,!0)},path:function(a){var b,d,g,l=!1,f=!1,n=a.getAttribute("d").match(/[a-df-z][^a-df-z]*/ig),q=n.length-1,n=_.flatten(_.map(n,function(a,
n){var k,p,m=a[0],v=m.toLowerCase();g=a.slice(1).trim();g=g.replace(/(-?\d+(?:\.\d*)?)[eE]([+\-]?\d+)/g,function(a,b,c){return parseFloat(b)*Math.pow(10,c)});g=g.split(/[\s,]+|(?=\s?[+\-])/);l=m===v;var e,h,t,s;switch(v){case "z":n>=q?f=!0:(p=b.x,k=b.y,k=new c.Anchor(p,k,void 0,void 0,void 0,void 0,c.Commands.close));break;case "m":case "l":p=parseFloat(g[0]);k=parseFloat(g[1]);k=new c.Anchor(p,k,void 0,void 0,void 0,void 0,"m"===v?c.Commands.move:c.Commands.line);l&&k.addSelf(b);k.controls.left.copy(k);
k.controls.right.copy(k);b=k;break;case "h":case "v":p="h"===v?"x":"y";m="x"===p?"y":"x";k=new c.Anchor(void 0,void 0,void 0,void 0,void 0,void 0,c.Commands.line);k[p]=parseFloat(g[0]);k[m]=b[m];l&&(k[p]+=b[p]);k.controls.left.copy(k);k.controls.right.copy(k);b=k;break;case "s":case "c":k=b.x;m=b.y;d||(d=(new c.Vector).copy(b));"c"===v?(e=parseFloat(g[0]),p=parseFloat(g[1]),v=parseFloat(g[2]),h=parseFloat(g[3]),t=parseFloat(g[4]),s=parseFloat(g[5])):(h=c.Utils.getReflection(b,d,l),e=h.x,p=h.y,v=parseFloat(g[0]),
h=parseFloat(g[1]),t=parseFloat(g[2]),s=parseFloat(g[3]));l&&(e+=k,p+=m,v+=k,h+=m,t+=k,s+=m);_.isObject(b.controls)||c.Anchor.AppendCurveProperties(b);b.controls.right.set(e,p);b=k=new c.Anchor(t,s,v,h,void 0,void 0,c.Commands.curve);d=k.controls.left;break;case "t":case "q":k=b.x;m=b.y;d||(d=(new c.Vector).copy(b));d.isZero()?(e=k,p=m):(e=d.x,m=d.y);"q"===v?(v=parseFloat(g[0]),h=parseFloat(g[1]),t=parseFloat(g[1]),s=parseFloat(g[2])):(h=c.Utils.getReflection(b,d,l),v=h.x,h=h.y,t=parseFloat(g[0]),
s=parseFloat(g[1]));l&&(e+=k,p+=m,v+=k,h+=m,t+=k,s+=m);_.isObject(b.controls)||c.Anchor.AppendCurveProperties(b);b.controls.right.set(e,p);b=k=new c.Anchor(t,s,v,h,void 0,void 0,c.Commands.curve);d=k.controls.left;break;case "a":throw new c.Utils.Error("not yet able to interpret Elliptical Arcs.");}return k}));if(!(1>=n.length))return n=_.compact(n),n=(new c.Polygon(n,f,void 0,!0)).noStroke(),n.fill="black",c.Utils.applySvgAttributes(a,n)},circle:function(a){var b=parseFloat(a.getAttribute("cx")),
d=parseFloat(a.getAttribute("cy")),g=parseFloat(a.getAttribute("r")),k=c.Resolution,u=_.map(_.range(k),function(a){var b=a/k*l;a=g*q(b);b=g*f(b);return new c.Anchor(a,b)},this),u=(new c.Polygon(u,!0,!0)).noStroke();u.translation.set(b,d);u.fill="black";return c.Utils.applySvgAttributes(a,u)},ellipse:function(a){var b=parseFloat(a.getAttribute("cx")),d=parseFloat(a.getAttribute("cy")),g=parseFloat(a.getAttribute("rx")),k=parseFloat(a.getAttribute("ry")),u=c.Resolution,n=_.map(_.range(u),function(a){var b=
a/u*l;a=g*q(b);b=k*f(b);return new c.Anchor(a,b)},this),n=(new c.Polygon(n,!0,!0)).noStroke();n.translation.set(b,d);n.fill="black";return c.Utils.applySvgAttributes(a,n)},rect:function(a){var b=parseFloat(a.getAttribute("x")),d=parseFloat(a.getAttribute("y")),g=parseFloat(a.getAttribute("width")),l=parseFloat(a.getAttribute("height")),g=g/2,l=l/2,f=[new c.Anchor(g,l),new c.Anchor(-g,l),new c.Anchor(-g,-l),new c.Anchor(g,-l)],f=(new c.Polygon(f,!0)).noStroke();f.translation.set(b+g,d+l);f.fill="black";
return c.Utils.applySvgAttributes(a,f)},line:function(a){var b=parseFloat(a.getAttribute("x1")),d=parseFloat(a.getAttribute("y1")),g=parseFloat(a.getAttribute("x2")),l=parseFloat(a.getAttribute("y2")),g=(g-b)/2,l=(l-d)/2,f=[new c.Anchor(-g,-l),new c.Anchor(g,l)],f=(new c.Polygon(f)).noFill();f.translation.set(b+g,d+l);return c.Utils.applySvgAttributes(a,f)}},subdivide:function(a,b,d,g,l,f,k,n,q){q=q||c.Utils.Curve.RecursionLimit;var p=q+1;return _.map(_.range(0,p),function(q){var m=q/p;q=F(m,a,d,
l,k);m=F(m,b,g,f,n);return new c.Anchor(q,m)})},getPointOnCubicBezier:function(a,b,c,g,d){var l=1-a;return l*l*l*b+3*l*l*a*c+3*l*a*a*g+a*a*a*d},getCurveFromPoints:function(a,b){for(var d=a.length,g=d-1,l=0;l<d;l++){var f=a[l];_.isObject(f.controls)||c.Anchor.AppendCurveProperties(f);var k=b?z(l-1,d):Math.max(l-1,0),n=b?z(l+1,d):Math.min(l+1,g);y(a[k],f,a[n]);f._command=0===l?c.Commands.move:c.Commands.curve;f.controls.left.x=_.isNumber(f.controls.left.x)?f.controls.left.x:f.x;f.controls.left.y=_.isNumber(f.controls.left.y)?
f.controls.left.y:f.y;f.controls.right.x=_.isNumber(f.controls.right.x)?f.controls.right.x:f.x;f.controls.right.y=_.isNumber(f.controls.right.y)?f.controls.right.y:f.y}},getControlPoints:function(a,b,d){var g=A(a,b),l=A(d,b);a=C(a,b);d=C(d,b);var k=(g+l)/2;b.u=_.isObject(b.controls.left)?b.controls.left:new c.Vector(b.x,b.y);b.v=_.isObject(b.controls.right)?b.controls.right:new c.Vector(b.x,b.y);if(1E-4>a||1E-4>d)return b.controls.left.copy(b),b.controls.right.copy(b),b;a*=0.33;d*=0.33;k=l<g?k+v:
k-v;b.controls.left.x=b.x+q(k)*a;b.controls.left.y=b.y+f(k)*a;k-=n;b.controls.right.x=b.x+q(k)*d;b.controls.right.y=b.y+f(k)*d;return b},getReflection:function(a,b,d){var g=a.distanceTo(b);if(1E-4>=g)return d?new c.Vector:a.clone();b=A(a,b);return new c.Vector(g*Math.cos(b)+(d?0:a.x),g*Math.sin(b)+(d?0:a.y))},angleBetween:function(a,b){var c,g;if(4<=arguments.length)return c=arguments[0]-arguments[2],g=arguments[1]-arguments[3],p(g,c);c=a.x-b.x;g=a.y-b.y;return p(g,c)},distanceBetweenSquared:function(a,
b){var c=a.x-b.x,g=a.y-b.y;return c*c+g*g},distanceBetween:function(a,b){return d(x(a,b))},mod:function(a,b){for(;0>a;)a+=b;return a%b},Collection:function(){Array.call(this);1<arguments.length?Array.prototype.push.apply(this,arguments):arguments[0]&&Array.isArray(arguments[0])&&Array.prototype.push.apply(this,arguments[0])},Error:function(a){this.name="two.js";this.message=a}}});c.Utils.Error.prototype=Error();c.Utils.Error.prototype.constructor=c.Utils.Error;c.Utils.Collection.prototype=[];c.Utils.Collection.constructor=
...
return this},play:function(){c.Utils.setPlaying.call(this,!0);return this.trigger(c.Events.play)},pause:function(){this.playing=!1;return this.trigger(c.Events.pause)},update:function(){var a=!!this._lastFrame,b=(m.performance&&m.performance.now?m.performance:Date).now();this.frameCount++;a&&(this.timeDelta=parseFloat((b-this._lastFrame).toFixed(3)));this._lastFrame=b;var a=this.width,b=this.height,d=this.renderer;a===d.width&&b===d.height||d.setSize(a,b,this.ratio);this.trigger(c.Events.update,this.frameCount,
this.timeDelta);return this.render()},render:function(){this.renderer.render();return this.trigger(c.Events.render,this.frameCount)},add:function(a){var b=a;_.isArray(a)||(b=_.toArray(arguments));this.scene.add(b);return this},remove:function(a){var b=a;_.isArray(a)||(b=_.toArray(arguments));this.scene.remove(b);return this},clear:function(){this.scene.remove(_.toArray(this.scene.children));return this},makeLine:function(a,b,d,g){d=(d-a)/2;g=(g-b)/2;var l=[new c.Anchor(-d,-g),new c.Anchor(d,g)],l=
(new c.Polygon(l)).noFill();l.translation.set(a+d,b+g);this.scene.add(l);return l},makeRectangle:function(a,b,d,g){d/=2;g/=2;g=[new c.Anchor(d,g),new c.Anchor(-d,g),new c.Anchor(-d,-g),new c.Anchor(d,-g)];g=new c.Polygon(g,!0);g.translation.set(a,b);this.scene.add(g);return g},makeCircle:function(a,b,c){return this.makeEllipse(a,b,c,c)},makeEllipse:function(a,b,d,g){var k=c.Resolution,n=_.map(_.range(k),function(a){var b=a/k*l;a=d*q(b);b=g*f(b);return new c.Anchor(a,b)},this),n=new c.Polygon(n,!0,
!0);n.translation.set(a,b);this.scene.add(n);return n},makeCurve:function(a){var b=arguments.length,d=a;if(!_.isArray(a))for(var d=[],g=0;g<b;g+=2){var l=arguments[g];if(!_.isNumber(l))break;d.push(new c.Anchor(l,arguments[g+1]))}var b=arguments[b-1],d=new c.Polygon(d,!(_.isBoolean(b)&&b),!0),b=d.getBoundingClientRect(),f=b.left+b.width/2,k=b.top+b.height/2;_.each(d.vertices,function(a){a.x-=f;a.y-=k});d.translation.set(f,k);this.scene.add(d);return d},makePolygon:function(a){var b=arguments.length,
d=a;if(!_.isArray(a))for(var d=[],g=0;g<b;g+=2){var l=arguments[g];if(!_.isNumber(l))break;d.push(new c.Anchor(l,arguments[g+1]))}b=arguments[b-1];d=new c.Polygon(d,!(_.isBoolean(b)&&b));b=d.getBoundingClientRect();d.center().translation.set(b.left+b.width/2,b.top+b.height/2);this.scene.add(d);return d},makeGroup:function(a){var b=a;_.isArray(a)||(b=_.toArray(arguments));var d=new c.Group;this.scene.add(d);d.add(b);return d},interpret:function(a){var b=a.tagName.toLowerCase();if(!(b in c.Utils.read))return null;

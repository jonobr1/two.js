(function(){function p(a,b,c){if(a===b)return 0!==a||1/a==1/b;if(null==a||null==b)return a===b;a._chain&&(a=a._wrapped);b._chain&&(b=b._wrapped);if(a.isEqual&&e.isFunction(a.isEqual))return a.isEqual(b);if(b.isEqual&&e.isFunction(b.isEqual))return b.isEqual(a);var f=l.call(a);if(f!=l.call(b))return!1;switch(f){case "[object String]":return a==String(b);case "[object Number]":return a!=+a?b!=+b:0==a?1/a==1/b:a==+b;case "[object Date]":case "[object Boolean]":return+a==+b;case "[object RegExp]":return a.source==
...
g=!d}}c.pop();return g}var a=this,b=a._,c={},d=Array.prototype,g=Object.prototype,h=d.slice,f=d.unshift,l=g.toString,k=g.hasOwnProperty,m=d.forEach,n=d.map,s=d.reduce,j=d.reduceRight,r=d.filter,A=d.every,w=d.some,t=d.indexOf,q=d.lastIndexOf,g=Array.isArray,u=Object.keys,v=Function.prototype.bind,e=function(a){return new E(a)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=e),exports._=e):a._=e;e.VERSION="1.3.3";var x=e.each=e.forEach=function(a,
b,d){if(null!=a)if(m&&a.forEach===m)a.forEach(b,d);else if(a.length===+a.length)for(var f=0,g=a.length;f<g&&!(f in a&&b.call(d,a[f],f,a)===c);f++);else for(f in a)if(e.has(a,f)&&b.call(d,a[f],f,a)===c)break};e.map=e.collect=function(a,b,e){var c=[];if(null==a)return c;if(n&&a.map===n)return a.map(b,e);x(a,function(a,z,f){c[c.length]=b.call(e,a,z,f)});a.length===+a.length&&(c.length=a.length);return c};e.reduce=e.foldl=e.inject=function(a,b,c,f){var d=2<arguments.length;null==a&&(a=[]);if(s&&a.reduce===
s)return f&&(b=e.bind(b,f)),d?a.reduce(b,c):a.reduce(b);x(a,function(a,e,z){d?c=b.call(f,c,a,e,z):(c=a,d=!0)});if(!d)throw new TypeError("Reduce of empty array with no initial value");return c};e.reduceRight=e.foldr=function(a,b,c,f){var d=2<arguments.length;null==a&&(a=[]);if(j&&a.reduceRight===j)return f&&(b=e.bind(b,f)),d?a.reduceRight(b,c):a.reduceRight(b);var g=e.toArray(a).reverse();f&&!d&&(b=e.bind(b,f));return d?e.reduce(g,b,c,f):e.reduce(g,b)};e.find=e.detect=function(a,b,e){var c;F(a,function(a,
z,f){if(b.call(e,a,z,f))return c=a,!0});return c};e.filter=e.select=function(a,b,e){var c=[];if(null==a)return c;if(r&&a.filter===r)return a.filter(b,e);x(a,function(a,f,z){b.call(e,a,f,z)&&(c[c.length]=a)});return c};e.reject=function(a,b,e){var c=[];if(null==a)return c;x(a,function(a,f,z){b.call(e,a,f,z)||(c[c.length]=a)});return c};e.every=e.all=function(a,b,e){var f=!0;if(null==a)return f;if(A&&a.every===A)return a.every(b,e);x(a,function(a,z,d){if(!(f=f&&b.call(e,a,z,d)))return c});return!!f};
var F=e.some=e.any=function(a,b,f){b||(b=e.identity);var d=!1;if(null==a)return d;if(w&&a.some===w)return a.some(b,f);x(a,function(a,e,z){if(d||(d=b.call(f,a,e,z)))return c});return!!d};e.include=e.contains=function(a,b){var e=!1;return null==a?e:t&&a.indexOf===t?-1!=a.indexOf(b):e=F(a,function(a){return a===b})};e.invoke=function(a,b){var c=h.call(arguments,2);return e.map(a,function(a){return(e.isFunction(b)?b||a:a[b]).apply(a,c)})};e.pluck=function(a,b){return e.map(a,function(a){return a[b]})};
e.max=function(a,b,c){if(!b&&e.isArray(a)&&a[0]===+a[0])return Math.max.apply(Math,a);if(!b&&e.isEmpty(a))return-Infinity;var f={computed:-Infinity};x(a,function(a,e,d){e=b?b.call(c,a,e,d):a;e>=f.computed&&(f={value:a,computed:e})});return f.value};e.min=function(a,b,c){if(!b&&e.isArray(a)&&a[0]===+a[0])return Math.min.apply(Math,a);if(!b&&e.isEmpty(a))return Infinity;var f={computed:Infinity};x(a,function(a,e,d){e=b?b.call(c,a,e,d):a;e<f.computed&&(f={value:a,computed:e})});return f.value};e.shuffle=
function(a){var b=[],e;x(a,function(a,c){e=Math.floor(Math.random()*(c+1));b[c]=b[e];b[e]=a});return b};e.sortBy=function(a,b,c){var f=e.isFunction(b)?b:function(a){return a[b]};return e.pluck(e.map(a,function(a,b,e){return{value:a,criteria:f.call(c,a,b,e)}}).sort(function(a,b){var e=a.criteria,c=b.criteria;return void 0===e?1:void 0===c?-1:e<c?-1:e>c?1:0}),"value")};e.groupBy=function(a,b){var c={},f=e.isFunction(b)?b:function(a){return a[b]};x(a,function(a,b){var e=f(a,b);(c[e]||(c[e]=[])).push(a)});
...
c=Array(b),f=0;f<b;f++)c[f]=e.pluck(a,""+f);return c};e.indexOf=function(a,b,c){if(null==a)return-1;var f;if(c)return c=e.sortedIndex(a,b),a[c]===b?c:-1;if(t&&a.indexOf===t)return a.indexOf(b);c=0;for(f=a.length;c<f;c++)if(c in a&&a[c]===b)return c;return-1};e.lastIndexOf=function(a,b){if(null==a)return-1;if(q&&a.lastIndexOf===q)return a.lastIndexOf(b);for(var e=a.length;e--;)if(e in a&&a[e]===b)return e;return-1};e.range=function(a,b,e){1>=arguments.length&&(b=a||0,a=0);e=arguments[2]||1;for(var c=
...
x(b,function(b){a[b]=e.bind(a[b],a)});return a};e.memoize=function(a,b){var c={};b||(b=e.identity);return function(){var f=b.apply(this,arguments);return e.has(c,f)?c[f]:c[f]=a.apply(this,arguments)}};e.delay=function(a,b){var e=h.call(arguments,2);return setTimeout(function(){return a.apply(null,e)},b)};e.defer=function(a){return e.delay.apply(e,[a,1].concat(h.call(arguments,1)))};e.throttle=function(a,b){var c,f,d,g,h,l,q=e.debounce(function(){h=g=!1},b);return function(){c=this;f=arguments;d||
(d=setTimeout(function(){d=null;h&&a.apply(c,f);q()},b));g?h=!0:l=a.apply(c,f);q();g=!0;return l}};e.debounce=function(a,b,e){var c;return function(){var f=this,d=arguments;e&&!c&&a.apply(f,d);clearTimeout(c);c=setTimeout(function(){c=null;e||a.apply(f,d)},b)}};e.once=function(a){var b=!1,e;return function(){if(b)return e;b=!0;return e=a.apply(this,arguments)}};e.wrap=function(a,b){return function(){var e=[a].concat(h.call(arguments,0));return b.apply(this,e)}};e.compose=function(){var a=arguments;
return function(){for(var b=arguments,e=a.length-1;0<=e;e--)b=[a[e].apply(this,b)];return b[0]}};e.after=function(a,b){return 0>=a?b():function(){if(1>--a)return b.apply(this,arguments)}};e.keys=u||function(a){if(a!==Object(a))throw new TypeError("Invalid object");var b=[],c;for(c in a)e.has(a,c)&&(b[b.length]=c);return b};e.values=function(a){return e.map(a,e.identity)};e.functions=e.methods=function(a){var b=[],c;for(c in a)e.isFunction(a[c])&&b.push(c);return b.sort()};e.extend=function(a){x(h.call(arguments,
...
a.length;for(var b in a)if(e.has(a,b))return!1;return!0};e.isElement=function(a){return!!(a&&1==a.nodeType)};e.isArray=g||function(a){return"[object Array]"==l.call(a)};e.isObject=function(a){return a===Object(a)};e.isArguments=function(a){return"[object Arguments]"==l.call(a)};e.isArguments(arguments)||(e.isArguments=function(a){return!(!a||!e.has(a,"callee"))});e.isFunction=function(a){return"[object Function]"==l.call(a)};e.isString=function(a){return"[object String]"==l.call(a)};e.isNumber=function(a){return"[object Number]"==
l.call(a)};e.isFinite=function(a){return e.isNumber(a)&&isFinite(a)};e.isNaN=function(a){return a!==a};e.isBoolean=function(a){return!0===a||!1===a||"[object Boolean]"==l.call(a)};e.isDate=function(a){return"[object Date]"==l.call(a)};e.isRegExp=function(a){return"[object RegExp]"==l.call(a)};e.isNull=function(a){return null===a};e.isUndefined=function(a){return void 0===a};e.has=function(a,b){return k.call(a,b)};e.noConflict=function(){a._=b;return this};e.identity=function(a){return a};e.times=
...
(function(){var p=[].slice,a=/\s+/,b=function(b,c,f,d){if(!f)return!0;if("object"===typeof f)for(var k in f)b[c].apply(b,[k,f[k]].concat(d));else if(a.test(f)){f=f.split(a);k=0;for(var m=f.length;k<m;k++)b[c].apply(b,[f[k]].concat(d))}else return!0},c=function(a,b,c){var d;a=-1;var k=b.length;switch(c.length){case 0:for(;++a<k;)(d=b[a]).callback.call(d.ctx);break;case 1:for(;++a<k;)(d=b[a]).callback.call(d.ctx,c[0]);break;case 2:for(;++a<k;)(d=b[a]).callback.call(d.ctx,c[0],c[1]);break;case 3:for(;++a<
k;)(d=b[a]).callback.call(d.ctx,c[0],c[1],c[2]);break;default:for(;++a<k;)(d=b[a]).callback.apply(d.ctx,c)}},d=Backbone.Events={on:function(a,c,f){if(!b(this,"on",a,[c,f])||!c)return this;this._events||(this._events={});(this._events[a]||(this._events[a]=[])).push({callback:c,context:f,ctx:f||this});return this},once:function(a,c,f){if(!b(this,"once",a,[c,f])||!c)return this;var d=this,k=_.once(function(){d.off(a,k);c.apply(this,arguments)});k._callback=c;this.on(a,k,f);return this},off:function(a,
c,f){var d,k,m,n,s,j,r,p;if(!this._events||!b(this,"off",a,[c,f]))return this;if(!a&&!c&&!f)return this._events={},this;n=a?[a]:_.keys(this._events);s=0;for(j=n.length;s<j;s++)if(a=n[s],d=this._events[a]){m=[];if(c||f){r=0;for(p=d.length;r<p;r++)k=d[r],(c&&c!==(k.callback._callback||k.callback)||f&&f!==k.context)&&m.push(k)}this._events[a]=m}return this},trigger:function(a){if(!this._events)return this;var d=p.call(arguments,1);if(!b(this,"trigger",a,d))return this;var f=this._events[a],l=this._events.all;
f&&c(this,f,d);l&&c(this,l,arguments);return this},listenTo:function(a,b,c){var d=this._listeners||(this._listeners={}),k=a._listenerId||(a._listenerId=_.uniqueId("l"));d[k]=a;a.on(b,c||this,this);return this},stopListening:function(a,b,c){var d=this._listeners;if(d){if(a)a.off(b,c,this),!b&&!c&&delete d[a._listenerId];else{for(var k in d)d[k].off(null,null,this);this._listeners={}}return this}}};d.bind=d.on;d.unbind=d.off})();(function(){for(var p=0,a=["ms","moz","webkit","o"],b=0;b<a.length&&!window.requestAnimationFrame;++b)window.requestAnimationFrame=window[a[b]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[a[b]+"CancelAnimationFrame"]||window[a[b]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=function(a){var b=(new Date).getTime(),g=Math.max(0,16-(b-p)),h=window.setTimeout(function(){a(b+g)},g);p=b+g;return h});window.cancelAnimationFrame||(window.cancelAnimationFrame=
...
(g=!tessellation.sweep.Legalize(a,d))&&a.MapTriangleToNodes(d),b.delaunay_edge[c]=!1,d.delaunay_edge[f]=!1,!0}}return!1};tessellation.sweep.Incircle=function(a,b,c,d){var g=a.x-d.x;a=a.y-d.y;var h=b.x-d.x;b=b.y-d.y;var f=g*b-h*a;if(0>=f)return!1;var l=c.x-d.x;c=c.y-d.y;d=l*a-g*c;return 0>=d?!1:0<(g*g+a*a)*(h*c-l*b)+(h*h+b*b)*d+(l*l+c*c)*f};tessellation.sweep.RotateTrianglePair=function(a,b,c,d){var g,h,f,l;g=a.NeighborCCW(b);h=a.NeighborCW(b);f=c.NeighborCCW(d);l=c.NeighborCW(d);var k,m,n,s;k=a.GetConstrainedEdgeCCW(b);
m=a.GetConstrainedEdgeCW(b);n=c.GetConstrainedEdgeCCW(d);s=c.GetConstrainedEdgeCW(d);var j,r,p,w;j=a.GetDelaunayEdgeCCW(b);r=a.GetDelaunayEdgeCW(b);p=c.GetDelaunayEdgeCCW(d);w=c.GetDelaunayEdgeCW(d);a.Legalize(b,d);c.Legalize(d,b);c.SetDelaunayEdgeCCW(b,j);a.SetDelaunayEdgeCW(b,r);a.SetDelaunayEdgeCCW(d,p);c.SetDelaunayEdgeCW(d,w);c.SetConstrainedEdgeCCW(b,k);a.SetConstrainedEdgeCW(b,m);a.SetConstrainedEdgeCCW(d,n);c.SetConstrainedEdgeCW(d,s);a.ClearNeigbors();c.ClearNeigbors();g&&c.MarkNeighbor(g);
h&&a.MarkNeighbor(h);f&&a.MarkNeighbor(f);l&&c.MarkNeighbor(l);a.MarkNeighbor(c)};tessellation.sweep.FillBasin=function(a,b){a.basin.left_node=tessellation.Orient2d(b.point,b.next.point,b.next.next.point)==tessellation.Orientation.CCW?b.next.next:b.next;for(a.basin.bottom_node=a.basin.left_node;null!=a.basin.bottom_node.next&&a.basin.bottom_node.point.y>=a.basin.bottom_node.next.point.y;)a.basin.bottom_node=a.basin.bottom_node.next;if(a.basin.bottom_node!=a.basin.left_node){for(a.basin.right_node=
...
b==a.edge_event.constrained_edge.p&&(d.MarkConstrainedEdge(b,c),h.MarkConstrainedEdge(b,c),tessellation.sweep.Legalize(a,d),tessellation.sweep.Legalize(a,h));else{var l=tessellation.Orient2d(c,f,b);d=tessellation.sweep.NextFlipTriangle(a,l,d,h,g,f);tessellation.sweep.FlipEdgeEvent(a,b,c,d,g)}else f=tessellation.sweep.NextFlipPoint(b,c,h,f),tessellation.sweep.FlipScanEdgeEvent(a,b,c,d,h,f),tessellation.sweep.EdgeEvent(a,b,c,d,g)}};tessellation.sweep.NextFlipTriangle=function(a,b,c,d,g,h){if(b==tessellation.Orientation.CCW)return b=
...
CuspLimit:0,Tolerance:{distance:0.25,angle:0,epsilon:0.01}},decoupleShapes:function(a,b,c){c=c||0;for(var d=0,f=a.length;d<f;d++)if(b||!(d>=f-1))for(var g=v(d+1,f),h=a[d],l=a[g],k=f-1;k>d+1;k--)if(!(k>=f-1)){var j=v(k+1,f),m=q(h,l,a[k],a[j]);if(m)return d=[m],m=[m.clone()],_.range(f),f=a.slice(0,g).concat(d,a.slice(j,f)),a=a.slice(g,j).concat(m),[u(f,b,c+1),u(a,b,c+1)]}return[a]},solveSegmentIntersection:function(a,b,c,d){var f=(d.x-c.x)*(a.y-c.y)-(d.y-c.y)*(a.x-c.x),g=(b.x-a.x)*(a.y-c.y)-(b.y-a.y)*
(a.x-c.x);c=(d.y-c.y)*(b.x-a.x)-(d.x-c.x)*(b.y-a.y);return 0!=c&&(f/=c,g/=c,0<=f&&1>=f&&0<=g&&1>=g)?new j.Vector(a.x+f*(b.x-a.x),a.y+f*(b.y-a.y)):null},subdivide:function(a,b,c,d,h,q,m,u,v){var n=j.Utils.Curve.CollinearityEpsilon,s=j.Utils.Curve.CuspLimit,r=j.Utils.Curve.Tolerance;v=v||0;var p=(a+c)/2,t=(b+d)/2,A=(c+h)/2,w=(d+q)/2,N=(h+m)/2,O=(q+u)/2,P=(p+A)/2,Q=(t+w)/2,A=(A+N)/2,w=(w+O)/2,C=(P+A)/2,D=(Q+w)/2;if(0<v){var y=m-a,B=u-b,G=f((c-m)*B-(d-u)*y),H=f((h-m)*B-(q-u)*y);if(G>n&&H>n&&(G+H)*(G+
H)<=r.distance*(y*y+B*B)){if(r.angle<r.epsilon)return[new j.Vector(C,D)];y=g(q-d,h-c);n=f(y-g(d-b,c-a));y=f(g(u-q,m-h)-y);n>=l&&(n=k-n);y>=l&&(y=k-y);if(n+y<r.angle)return[new j.Vector(C,D)];if(0!==s){if(n>s)return[new j.Vector(c,d)];if(y>s)return[new j.Vector(h,q)]}}}else if(G>n)if(G*G<=r.distance*(y*y+B*B)){if(r.angle<r.epsilon)return[new j.Vector(C,D)];n=f(g(q-d,h-c)-g(d-b,c-a));n>=l&&(n=k-n);if(n<r.angle)return[new j.Vector(c,d),new j.Vector(h,q)];if(0!==s&&n>s)return[new j.Vector(c,d)]}else if(H>
n){if(H*H<=r.distance*(y*y+B*B)){if(r.angle<r.epsilon)return[new j.Vector(C,D)];n=f(g(u-q,m-h)-g(q-d,h-c));n>=l&&(n=k-n);if(n<r.angle)return[new j.Vector(c,d),new j.Vector(h,q)];if(0!==s&&n>s)return[new j.Vector2(h,q)]}}else if(y=C-(a+m)/2,B=D-(b+u)/2,y*y+B*B<=r.distance)return[new j.Vector(C,D)];return j.Utils.subdivide(a,b,p,t,P,Q,C,D,v+1).concat(j.Utils.subdivide(C,D,A,w,N,O,m,u,v+1))},getCurveFromPoints:function(a,b){for(var c=[],d=a.length,f=d-1,g=0;g<d;g++){var h=a[g],q={x:h.x,y:h.y};c.push(q);
var h=b?v(g-1,d):Math.max(g-1,0),l=b?v(g+1,d):Math.min(g+1,f);t(a[h],q,a[l]);!q.u.x&&!q.u.y&&(q.u.x=q.x,q.u.y=q.y);!q.v.x&&!q.v.y&&(q.v.x=q.x,q.v.y=q.y)}return c},getControlPoints:function(a,b,f){var q=w(a,b),g=w(f,b);a=r(a,b);f=r(f,b);var h=(q+g)/2;if(1E-4>a||1E-4>f)return b.u={x:b.x,y:b.y},b.v={x:b.x,y:b.y},b;a*=0.33;f*=0.33;h=g<q?h+m:h-m;q={x:b.x+d(h)*a,y:b.y+c(h)*a};h-=l;g={x:b.x+d(h)*f,y:b.y+c(h)*f};b.u=q;b.v=g;return b},angleBetween:function(a,b){return g(a.y-b.y,a.x-b.x)},distanceBetweenSquared:function(a,
b){var c=a.x-b.x,d=a.y-b.y;return c*c+d*d},distanceBetween:function(a,b){return h(A(a,b))},mod:function(a,b){for(;0>a;)a+=b;return a%b},Error:function(a){this.name="two.js";this.message=a}}});j.Utils.Error.prototype=Error();j.Utils.Error.prototype.constructor=j.Utils.Error;var r=j.Utils.distanceBetween,A=j.Utils.distanceBetweenSquared,w=j.Utils.angleBetween,t=j.Utils.getControlPoints,q=j.Utils.solveSegmentIntersection,u=j.Utils.decoupleShapes,v=j.Utils.mod;_.extend(j.prototype,Backbone.Events,{appendTo:function(a){a.appendChild(this.renderer.domElement);
...
return this},makeLine:function(a,b,c,d){c=(c-a)/2;d=(d-b)/2;var f=[new j.Vector(-c,-d),new j.Vector(c,d)],f=(new j.Polygon(f)).noFill();f.translation.set(a+c,b+d);this.scene.add(f);return f},makeRectangle:function(a,b,c,d){c/=2;d/=2;d=[new j.Vector(c,d),new j.Vector(-c,d),new j.Vector(-c,-d),new j.Vector(c,-d)];d=new j.Polygon(d,!0);d.translation.set(a,b);this.scene.add(d);return d},makeCircle:function(a,b,c){return this.makeEllipse(a,b,c,c)},makeEllipse:function(a,b,f,h){var q=j.Resolution,g=_.map(_.range(q),
function(a){var b=a/q*k;a=f*d(b);b=h*c(b);return new j.Vector(a,b)},this),g=new j.Polygon(g,!0,!0);g.translation.set(a,b);this.scene.add(g);return g},makeCurve:function(a){var b=arguments.length,c=a;if(!_.isArray(a))for(var c=[],d=0;d<b;d+=2){var f=arguments[d];if(!_.isNumber(f))break;c.push(new j.Vector(f,arguments[d+1]))}var b=arguments[b-1],c=new j.Polygon(c,!(_.isBoolean(b)&&b),!0),b=c.getBoundingClientRect(),g=b.left+b.width/2,q=b.top+b.height/2;_.each(c.vertices,function(a){a.x-=g;a.y-=q});
c.translation.set(g,q);this.scene.add(c);return c},makePolygon:function(a){var b=arguments.length,c=a;if(!_.isArray(a))for(var c=[],d=0;d<b;d+=2){var f=arguments[d];if(!_.isNumber(f))break;c.push(new j.Vector(f,arguments[d+1]))}var b=arguments[b-1],c=new j.Polygon(c,!(_.isBoolean(b)&&b)),b=c.getBoundingClientRect(),g=b.left+b.width/2,q=b.top+b.height/2;_.each(c.vertices,function(a){a.x-=g;a.y-=q});c.translation.set(g,q);this.scene.add(c);return c},makeGroup:function(a){var b=a;_.isArray(a)||(b=_.toArray(arguments));
...
b+this.x,(a.y-this.y)*b+this.y)},isZero:function(){return 1E-4>this.length()}})})();(function(){_.range(6);var p=Math.cos,a=Math.sin,b=Math.tan,c=Two.Matrix=function(a,b,c,f,l,k){this.elements=new Two.Array(9);var m=a;_.isArray(m)||(m=_.toArray(arguments));this.identity().set(m)};_.extend(c,{Identity:[1,0,0,0,1,0,0,0,1],Determinant:function(a,b,c,f,l,k,m,n,s){return a*l*s-a*k*n-b*f*s+b*k*m+c*f*n-c*l*m},Multiply:function(a,b){var c=a[0],f=a[1],l=a[2],k=a[3],m=a[4],n=a[5],s=a[6],j=a[7],r=a[8],p=b[0],w=b[1],t=b[2],q=b[3],u=b[4],v=b[5],e=b[6],x=b[7],F=b[8];return[c*p+f*q+l*e,c*w+f*u+
l*x,c*t+f*v+l*F,k*p+m*q+n*e,k*w+m*u+n*x,k*t+m*v+n*F,s*p+j*q+r*e,s*w+j*u+r*x,s*t+j*v+r*F]}});_.extend(c.prototype,{set:function(a,b,c,f,l,k){var m=a;_.isArray(m)||(m=_.toArray(arguments));_.each(m,function(a,b){_.isNumber(a)&&(this.elements[b]=a)},this);return this},identity:function(){this.set(c.Identity);return this},multiply:function(a,b,c,f,l,k,m,n,s){var j=arguments,r=j.length;if(1>=r)return _.each(this.elements,function(b,c){this.elements[c]=b*a},this),this;if(3>=r)return a=a||0,b=b||0,c=c||
0,l=this.elements,{x:l[0]*a+l[1]*b+l[2]*c,y:l[3]*a+l[4]*b+l[5]*c,z:l[6]*a+l[7]*b+l[8]*c};r=this.elements;A0=r[0];A1=r[1];A2=r[2];A3=r[3];A4=r[4];A5=r[5];A6=r[6];A7=r[7];A8=r[8];B0=j[0];B1=j[1];B2=j[2];B3=j[3];B4=j[4];B5=j[5];B6=j[6];B7=j[7];B8=j[8];this.elements[0]=A0*B0+A1*B3+A2*B6;this.elements[1]=A0*B1+A1*B4+A2*B7;this.elements[2]=A0*B2+A1*B5+A2*B8;this.elements[3]=A3*B0+A4*B3+A5*B6;this.elements[4]=A3*B1+A4*B4+A5*B7;this.elements[5]=A3*B2+A4*B5+A5*B8;this.elements[6]=A6*B0+A7*B3+A8*B6;this.elements[7]=
A6*B1+A7*B4+A8*B7;this.elements[8]=A6*B2+A7*B5+A8*B8;return this},determinant:function(){var a=this.elements,b=a[0],c=a[1],f=a[2],l=a[3],k=a[4],m=a[5],n=a[6],s=a[7],a=a[8];return b*k*a-b*m*s-c*l*a+c*m*n+f*l*s-f*k*n},scale:function(a,b){1>=arguments.length&&(b=a);return this.multiply(a,0,0,0,b,0,0,0,1)},rotate:function(b){var c=p(b);b=a(b);return this.multiply(c,-b,0,b,c,0,0,0,1)},translate:function(a,b){return this.multiply(1,0,a,0,1,b,0,0,1)},skewX:function(a){a=b(a);return this.multiply(1,a,0,0,
1,0,0,0,1)},skewY:function(a){a=b(a);return this.multiply(1,0,0,a,1,0,0,0,1)},toString:function(){return this.toArray().join(" ")},toArray:function(a){var b=this.elements,c=parseFloat(b[0].toFixed(3)),f=parseFloat(b[1].toFixed(3)),l=parseFloat(b[2].toFixed(3)),k=parseFloat(b[3].toFixed(3)),m=parseFloat(b[4].toFixed(3)),n=parseFloat(b[5].toFixed(3));if(a){a=parseFloat(b[6].toFixed(3));var s=parseFloat(b[7].toFixed(3)),b=parseFloat(b[8].toFixed(3));return[c,k,a,f,m,s,l,n,b]}return[c,k,f,m,l,n]},clone:function(){return new Two.Matrix(this.elements[0],
this.elements[1],this.elements[2],this.elements[3],this.elements[4],this.elements[5])}})})();(function(){function p(a){var b={},c=a.id,k=a.translation,m=a.rotation,n=a.scale,s=a.stroke,j=a.linewidth,r=a.fill,p=a.opacity,w=a.visible,t=a.cap,q=a.join,u=a.miter,v=a.curved,e=a.closed;a=a.vertices;c&&(b.id=g.Identifier+c);k&&(_.isNumber(n)&&_.isNumber(m))&&(b.transform="translate("+k.x+","+k.y+") scale("+n+") rotate("+m+")");s&&(b.stroke=s);r&&(b.fill=r);p&&(b["stroke-opacity"]=b["fill-opacity"]=p);b.visibility=w?"visible":"hidden";t&&(b["stroke-linecap"]=t);q&&(b["stroke-linejoin"]=q);u&&(b["stroke-miterlimit"]=
u);j&&(b["stroke-width"]=j);a&&(b.d=d.toString(a,e,v));return b}var a=0,b=Two.Utils.getCurveFromPoints,c=Two.Utils.mod,d={version:1.1,ns:"http://www.w3.org/2000/svg",xlink:"http://www.w3.org/1999/xlink",createElement:function(a,b){var c=a.toLowerCase(),d=document.createElementNS(this.ns,c);"svg"===c&&(b=_.defaults(b||{},{version:this.version}));_.isObject(b)&&this.setAttributes(d,b);return d},setAttributes:function(a,b){_.each(b,function(a,b){this.setAttribute(b,a)},a);return this},removeAttributes:function(a,
b){_.each(b,function(a){this.removeAttribute(a)},a);return this},toString:function(a,f,d){var g=a.length,m=g-1;if(!d)return _.map(a,function(a,b){var c;c=(0>=b?"M":"L")+(" "+a.x.toFixed(3)+" "+a.y.toFixed(3));b>=m&&f&&(c+=" Z");return c}).join(" ");var n=b(a,f);return _.map(n,function(a,b){var d,h=f?c(b-1,g):Math.max(b-1,0),l=f?c(b+1,g):Math.min(b+1,m);d=n[h];var l=n[l],h=d.v.x.toFixed(3),p=d.v.y.toFixed(3),q=a.u.x.toFixed(3),u=a.u.y.toFixed(3),v=a.x.toFixed(3),e=a.y.toFixed(3);d=0>=b?"M "+v+" "+
e:"C "+h+" "+p+" "+q+" "+u+" "+v+" "+e;b>=m&&f&&(h=a.v.x.toFixed(3),p=a.v.y.toFixed(3),q=l.u.x.toFixed(3),u=l.u.y.toFixed(3),v=l.x.toFixed(3),e=l.y.toFixed(3),d=d+(" C "+h+" "+p+" "+q+" "+u+" "+v+" "+e)+" Z");return d}).join(" ")}},g=Two[Two.Types.svg]=function(){this.domElement=d.createElement("svg");this.elements=[];this.commands=[];this.domElement.style.visibility="hidden";this.unveil=_.once(_.bind(function(){this.domElement.style.visibility="visible"},this))};_.extend(g,{Identifier:"two-"});_.extend(g.prototype,
Backbone.Events,{setSize:function(a,b){this.width=a;this.height=b;d.setAttributes(this.domElement,{width:a,height:b});return this},add:function(b){var c=b,g=this.elements,k=this.domElement;_.isArray(b)||(c=_.map(arguments,function(a){return a}));_.each(c,function(b){var c;c=b instanceof Two.Group;if(_.isUndefined(b.id)){var f=a;a++;b.id=f}c?(c="g",_.isUndefined(b.parent)&&(b.parent=this,b.unbind(Two.Events.change).bind(Two.Events.change,_.bind(this.update,this))),b=p(b),delete b.stroke,delete b.fill,
delete b["fill-opacity"],delete b["stroke-opacity"],delete b["stroke-linecap"],delete b["stroke-linejoin"],delete b["stroke-miterlimit"],delete b["stroke-width"]):(c="path",b=p(b));b=d.createElement(c,b);k.appendChild(b);g.push(b)},this);return this},update:function(a,b,c){this.commands.push(arguments);return this},render:function(){this.unveil();var a=this.elements;_.each(this.commands,function(b){var c=b[1],g=b[2],m=b[3],n=b[4],s=a[b[0]];switch(c){case Two.Properties.hierarchy:_.each(g,function(b){s.appendChild(a[b])});
break;case Two.Properties.demotion:_.each(g,function(b){s.removeChild(a[b])});break;default:a:{b=c;switch(b){case "matrix":b="transform";g="matrix("+g.toString()+")";break;case "visible":b="visibility";g=g?"visible":"hidden";break;case "cap":b="stroke-linecap";break;case "join":b="stroke-linejoin";break;case "miter":b="stroke-miterlimit";break;case "linewidth":b="stroke-width";break;case "vertices":b="d";g=d.toString(g,m,n);break;case "opacity":d.setAttributes(s,{"stroke-opacity":opacity,"fill-opacity":opacity});
...
return this}});var d=function(a){_.each(a,function(a,b){this[b]=a},this)};_.extend(d.prototype,{render:function(a){var c=this.matrix,d=this.stroke,g=this.linewidth,h=this.fill,s=this.opacity,j=this.cap,r=this.join,p=this.miter,w=this.curved,t=this.closed,q=this.commands,u=q.length,v=u-1;if(!this.visible)return this;a.save();c&&a.transform(c[0],c[1],c[2],c[3],c[4],c[5]);h&&(a.fillStyle=h);d&&(a.strokeStyle=d);g&&(a.lineWidth=g);p&&(a.miterLimit=p);r&&(a.lineJoin=r);j&&(a.lineCap=j);_.isNumber(s)&&
(a.globalAlpha=s);a.beginPath();_.each(q,function(c,d){var g=c.x.toFixed(3),h=c.y.toFixed(3);if(w){var l=t?b(d-1,u):Math.max(d-1,0),j=t?b(d+1,u):Math.min(d+1,v),k=q[l],j=q[j],l=k.v.x.toFixed(3),k=k.v.y.toFixed(3),m=c.u.x.toFixed(3),n=c.u.y.toFixed(3);0>=d?a.moveTo(g,h):(a.bezierCurveTo(l,k,m,n,g,h),d>=v&&t&&(l=c.v.x.toFixed(3),k=c.v.y.toFixed(3),m=j.u.x.toFixed(3),n=j.u.y.toFixed(3),g=j.x.toFixed(3),h=j.y.toFixed(3),a.bezierCurveTo(l,k,m,n,g,h)))}else 0>=d?a.moveTo(g,h):a.lineTo(g,h)});t&&!w&&a.closePath();
a.fill();a.stroke();a.restore()}});var g={toArray:function(b,c,d){return!c?_.map(b,function(a){return{x:a.x,y:a.y}}):a(b,d)}},h=Two[Two.Types.canvas]=function(){this.domElement=document.createElement("canvas");this.ctx=this.domElement.getContext("2d");this.elements=[];this.stage=null};_.extend(h,{});_.extend(h,{Group:c,Element:d,getStyles:function(a){var b={},c=a.id,d=a._matrix,h=a.stroke,s=a.linewidth,j=a.fill,r=a.opacity,p=a.visible,w=a.cap,t=a.join,q=a.miter,u=a.curved,v=a.closed;a=a.vertices;
c&&(b.id=c);_.isObject(d)&&(b.matrix=d.toArray());h&&(b.stroke=h);j&&(b.fill=j);_.isNumber(r)&&(b.opacity=r);w&&(b.cap=w);t&&(b.join=t);q&&(b.miter=q);s&&(b.linewidth=s);a&&(b.commands=g.toArray(a,u,v));b.visible=!!p;b.curved=!!u;b.closed=!!v;return b},setStyles:function(a,b,c,d,h){switch(b){case "matrix":b="matrix";c=c.toArray();break;case "vertices":b="commands",a.curved=h,a.closed=d,c=g.toArray(c,a.curved,a.closed)}a[b]=c}});_.extend(h.prototype,Backbone.Events,{setSize:function(a,b){this.width=
this.domElement.width=a;this.height=this.domElement.height=b;_.extend(this.domElement.style,{width:this.width+"px",height:this.height+"px"});return this},add:function(a){constructor=Object.getPrototypeOf(this).constructor;var b=a,c=this.elements,d=constructor.Group,g=constructor.Element,h=constructor.getStyles;_.isArray(a)||(b=_.map(arguments,function(a){return a}));_.each(b,function(a){var b;b=a instanceof Two.Group;var f=_.isNull(this.stage);if(_.isUndefined(a.id)){var l=p;p++;a.id=l}b?(b=h.call(this,
a),delete b.stroke,delete b.fill,delete b.opacity,delete b.cap,delete b.join,delete b.miter,delete b.linewidth,b=new d(b),f&&(this.stage=b,this.stage.object=a,a.parent=this,a.unbind(Two.Events.change).bind(Two.Events.change,_.bind(this.update,this)))):b=new g(h.call(this,a));c.push(b);f||this.stage.appendChild(b)},this);return this},update:function(a,b,c,d,g){var h=Object.getPrototypeOf(this).constructor,j=this.elements,p=j[a];switch(b){case Two.Properties.hierarchy:_.each(c,function(a){p.appendChild(j[a])});
break;case Two.Properties.demotion:_.each(c,function(a){p.removeChild(j[a]);this.elements[a]=null},this);default:h.setStyles.call(this,p,b,c,d,g)}return this},render:function(){if(_.isNull(this.stage))return this;this.ctx.clearRect(0,0,this.width,this.height);this.stage.render(this.ctx);return this}})})();(function(){function p(a){var b=[];_.each(a,function(a){_.isArray(a)&&_.isArray(a[0])?b=b.concat(p(a)):b.push(a)});return b}function a(a){return g.apply(this,a)}var b=Two[Two.Types.canvas],c=Two.Utils.getCurveFromPoints,d=Two.Matrix.Multiply,g=Two.Matrix.Determinant,h=Two.Utils.decoupleShapes,f=Two.Utils.subdivide,l={aliceblue:"#F0F8FF",antiquewhite:"#FAEBD7",aqua:"#00FFFF",aquamarine:"#7FFFD4",azure:"#F0FFFF",beige:"#F5F5DC",bisque:"#FFE4C4",black:"#000000",blanchedalmond:"#FFEBCD",blue:"#0000FF",
...
palegreen:"#98FB98",paleturquoise:"#AFEEEE",palevioletred:"#D87093",papayawhip:"#FFEFD5",peachpuff:"#FFDAB9",peru:"#CD853F",pink:"#FFC0CB",plum:"#DDA0DD",powderblue:"#B0E0E6",purple:"#800080",red:"#FF0000",rosybrown:"#BC8F8F",royalblue:"#4169E1",saddlebrown:"#8B4513",salmon:"#FA8072",sandybrown:"#F4A460",seagreen:"#2E8B57",seashell:"#FFF5EE",sienna:"#A0522D",silver:"#C0C0C0",skyblue:"#87CEEB",slateblue:"#6A5ACD",slategray:"#708090",slategrey:"#708090",snow:"#FFFAFA",springgreen:"#00FF7F",transparent:"#000",
steelblue:"#4682B4",tan:"#D2B48C",teal:"#008080",thistle:"#D8BFD8",tomato:"#FF6347",turquoise:"#40E0D0",violet:"#EE82EE",wheat:"#F5DEB3",white:"#FFFFFF",whitesmoke:"#F5F5F5",yellow:"#FFFF00",yellowgreen:'#9ACD32"'},k="(?:\\+|-)?\\d+",m="(?:\\+|-)?\\d*\\.\\d+",n="(?:"+k+")|(?:"+m+")",k="("+k+")",m="("+m+")",n="("+n+")",m=n+"%",s=RegExp(["^hsl(a?)\\(",n,",",m,",",m,"(,",n,")?\\)$"].join("\\s*?")),j=RegExp(["^rgb(a?)\\(",k,",",k,",",k,"(,",n,")?\\)$"].join("\\s*?")),r=RegExp(["^rgb(a?)\\(",m,",",m,",",
m,"(,",n,")?\\)$"].join("\\s*?")),A=/^,\s*/,w=[function(a){function b(c,d){var f=a.match(c);if(f&&1!==!!f[1]+!!f[5]){var g=_.isUndefined(f[5])?1:f[5].replace(A,"");return{r:Math.min(1,Math.max(0,f[2]/d)),g:Math.min(1,Math.max(0,f[3]/d)),b:Math.min(1,Math.max(0,f[4]/d)),a:Math.min(1,Math.max(g,0))}}}a=a.replace(/^\s+|\s+$/g,"");var c=b(j,255);return c?c:b(r,100)},function(a){var b=a.toLowerCase();b in l&&(a=l[b]);if(a.match(/^#([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/)){a=a.replace(/^#/,"");var b=a.length/
3,c=Math.pow(16,b)-1;return{r:parseInt(a.slice(0,b),16)/c,g:parseInt(a.slice(1*b,2*b),16)/c,b:parseInt(a.slice(2*b),16)/c,a:1}}},function(a){var b=a.replace(/^\s+|\s+$/g,"").match(s);if(!b||1===!!b[1]+!!b[5])return null;a=(b[2]%360+360)%360/360;var c=Math.max(0,Math.min(parseInt(b[3],10)/100,1)),d=Math.max(0,Math.min(parseInt(b[4],10)/100,1)),b=b[5];if(0!=c)var f=function(a,b,c){0>c&&(c+=1);1<c&&(c-=1);return c<1/6?a+6*(b-a)*c:0.5>c?b:c<2/3?a+6*(b-a)*(2/3-c):a},g=0.5>d?d*(1+c):d+c-d*c,h=2*d-g;c=_.isUndefined(b)||
_.isNull(b)?1:b.replace(A,"");return{r:f(h,g,a+1/3),g:f(h,g,a),b:f(h,g,a-1/3),a:c}}],k=function(a){b.Group.call(this,a)};_.extend(k.prototype,b.Group.prototype,{appendChild:function(){b.Group.prototype.appendChild.apply(this,arguments);this.updateMatrix();return this},updateMatrix:function(a){a=a||this.parent&&this.parent.matrix;if(!a)return this;this._matrix=d(this.matrix,a);_.each(this.children,function(a){a.updateMatrix(this._matrix)},this);return this},render:function(a,b,c,d){_.each(this.children,
function(f){f.render(a,b,c,d)})}});n=function(a){b.Element.call(this,a)};_.extend(n.prototype,b.Element.prototype,{updateMatrix:function(b){b=b||this.parent&&this.parent.matrix;if(!b)return this;this._matrix=d(this.matrix,b);this._linewidth=this.linewidth*a(this._matrix);return this},render:function(a,b,c,d){if(!this.visible||!this.fillBuffer||!this.strokeBuffer)return this;0<this.fill.a&&(a.bindBuffer(a.ARRAY_BUFFER,this.fillBuffer),a.vertexAttribPointer(b,2,a.FLOAT,!1,0,0),a.uniformMatrix3fv(c,
!1,this._matrix),a.uniform4f(d,this.fill.r,this.fill.g,this.fill.b,this.fill.a),a.drawArrays(a.TRIANGLES,0,this.triangleAmount));if(0>=this._linewidth||0>=this.stroke.a)return this;a.bindBuffer(a.ARRAY_BUFFER,this.strokeBuffer);a.vertexAttribPointer(b,2,a.FLOAT,!1,0,0);a.uniformMatrix3fv(c,!1,this._matrix);a.uniform4f(d,this.stroke.r,this.stroke.g,this.stroke.b,this.stroke.a);a.lineWidth(this._linewidth);a.drawArrays(a.LINES,0,this.vertexAmount);return this}});var t={updateBuffer:function(a,b,c){_.isObject(b.fillBuffer)&&
a.deleteBuffer(b.fillBuffer);b.fillBuffer=a.createBuffer();a.bindBuffer(a.ARRAY_BUFFER,b.fillBuffer);a.enableVertexAttribArray(c);a.bufferData(a.ARRAY_BUFFER,b.triangles,a.STATIC_DRAW);_.isObject(b.strokeBuffer)&&a.deleteBuffer(b.strokeBuffer);b.strokeBuffer=a.createBuffer();a.bindBuffer(a.ARRAY_BUFFER,b.strokeBuffer);a.enableVertexAttribArray(c);a.bufferData(a.ARRAY_BUFFER,b.vertices,a.STATIC_DRAW)},interpret:function(a){for(var b=0,c=w.length;b<c;b++){var d=w[b](a);if(d)return d}return{r:0,g:0,
b:0,a:0}},toArray:function(a,b,d){if(!b)return a.slice(0);var e=c(a,d),g=e.length,h=g-1,j=[];_.each(e,function(a,b){if(d||!d&&b<h){var c=e[(b+1)%g],c=f(a.x,a.y,a.v.x,a.v.y,c.u.x,c.u.y,c.x,c.y);j=j.concat(c)}});return j},tessellate:function(a,b,c,d,f){a=p(h(a,c));var g=[],j=[],l=0,k=0;_.each(a,function(a){a=new tessellation.SweepContext(a);tessellation.sweep.Triangulate(a);l+=6*a.triangles.length;_.each(a.triangles,function(a){var b=a.points;a=b[0];var c=b[1],b=b[2];g.push(a.x,a.y,c.x,c.y,b.x,b.y)});
k+=4*a.edges.length;_.each(a.edges,function(a){var b=a.p;a=a.q;j.push(b.x,b.y,a.x,a.y)})});d=d&&l<=d.length?d:new Two.Array(l);f=f&&k<=f.length?f:new Two.Array(k);d.set(g);f.set(j);return{triangles:d,vertices:f,triangleAmount:l/2,vertexAmount:k/2}},program:{create:function(a,b){var c=a.createProgram();_.each(b,function(b){a.attachShader(c,b)});a.linkProgram(c);if(!a.getProgramParameter(c,a.LINK_STATUS))throw error=a.getProgramInfoLog(c),new Two.Utils.Error("unable to link program: "+error);return c}},
shaders:{create:function(a,b,c){c=a.createShader(a[c]);a.shaderSource(c,b);a.compileShader(c);if(!a.getShaderParameter(c,a.COMPILE_STATUS))throw a=a.getShaderInfoLog(c),new Two.Utils.Error("unable to compile shader "+c+": "+a);return c},types:{vertex:"VERTEX_SHADER",fragment:"FRAGMENT_SHADER"},vertex:"attribute vec2 position;\nuniform mat3 matrix;\nuniform vec2 resolution;\n\nvoid main() {\n   vec2 projected = (matrix * vec3(position, 1)).xy;\n   vec2 normal = projected / resolution;\n   vec2 clipspace = (normal * 2.0) - 1.0;\n\n   gl_Position = vec4(clipspace * vec2(1.0, -1.0), 0.0, 1.0);\n}",
fragment:"precision mediump float;\n\nuniform vec4 color;\n\nvoid main() {\n  gl_FragColor = color;\n}"}},m=Two[Two.Types.webgl]=function(a){this.domElement=document.createElement("canvas");this.elements=[];this.stage=null;a=_.defaults(a||{},{antialias:!0,alpha:!1,premultipliedAlpha:!1});this.domElement.style.background="#efefef";this.ctx=this.domElement.getContext("webgl",a)||this.domElement.getContext("experimental-webgl",a);if(!this.ctx)throw new Two.Utils.Error("unable to create a webgl context. Try using another renderer.");
a=t.shaders.create(this.ctx,t.shaders.vertex,t.shaders.types.vertex);var b=t.shaders.create(this.ctx,t.shaders.fragment,t.shaders.types.fragment);this.program=t.program.create(this.ctx,[a,b]);this.ctx.useProgram(this.program);this.positionLocation=this.ctx.getAttribLocation(this.program,"position");this.colorLocation=this.ctx.getUniformLocation(this.program,"color");this.matrixLocation=this.ctx.getUniformLocation(this.program,"matrix");this.ctx.enable(this.ctx.BLEND);this.ctx.disable(this.ctx.DEPTH_TEST);
this.ctx.blendFunc(this.ctx.SRC_ALPHA,this.ctx.ONE_MINUS_SRC_ALPHA)};_.extend(m,{Group:k,Element:n,getStyles:function(b){var c={},d=b.id,e=b._matrix,f=b.stroke,g=b.linewidth,h=b.fill,j=b.opacity,l=b.visible,k=b.cap,m=b.join,n=b.miter,p=b.curved,s=b.closed;b=b.vertices;d&&(c.id=d);_.isObject(e)&&(c.matrix=c._matrix=e.toArray(!0));f&&(c.stroke=t.interpret(f));h&&(c.fill=t.interpret(h));_.isNumber(j)&&(c.opacity=j);k&&(c.cap=k);m&&(c.join=m);n&&(c.miter=n);g&&(c.linewidth=g,c._linewidth=g*a(c._matrix));
b&&(b=t.toArray(b,p,s),d=t.tessellate(b,p,s),c.triangles=d.triangles,c.vertices=d.vertices,c.vertexAmount=d.vertexAmount,c.triangleAmount=d.triangleAmount);c.visible=!!l;c.curved=!!p;c.closed=!!s;return c},setStyles:function(b,c,d,e,f){switch(c){case "matrix":c="matrix";d=d.toArray(!0);break;case "linewidth":c="linewidth";b._linewidth=d*a(b._matrix);break;case "stroke":d=t.interpret(d);break;case "fill":d=t.interpret(d);break;case "vertices":c="triangles",b.curved=f,b.closed=e,d=t.toArray(d,b.curved,
b.closed),e=t.tessellate(d,b.curved,b.closed,b.triangles,b.vertices),d=e.triangles,b.vertices=e.vertices,b.vertexAmount=e.vertexAmount,b.triangleAmount=e.triangleAmount}b[c]=d;"triangles"===c&&t.updateBuffer(this.ctx,b,this.positionLocation);"matrix"===c&&b.updateMatrix()}});_.extend(m.prototype,Backbone.Events,b.prototype,{setSize:function(a,c){b.prototype.setSize.apply(this,arguments);this.ctx.viewport(0,0,a,c);var d=this.ctx.getUniformLocation(this.program,"resolution");this.ctx.uniform2f(d,a,
c);return this},render:function(){if(_.isNull(this.stage))return this;var a=this.ctx;a.clearColor(1,1,1,0);a.clear(a.COLOR_BUFFER_BIT);this.stage.render(a,this.positionLocation,this.matrixLocation,this.colorLocation);return this}})})();(function(){var p=Two.Shape=function(a){this._matrix=new Two.Matrix;var b=_.debounce(_.bind(function(){var a=this._matrix.identity().translate(this.translation.x,this.translation.y).scale(this.scale).rotate(this.rotation);this.trigger(Two.Events.change,this.id,"matrix",a)},this),0);this._rotation="rotation";Object.defineProperty(this,"rotation",{get:function(){return this._rotation},set:function(a){this._rotation=a;b()}});this._scale="scale";Object.defineProperty(this,"scale",{get:function(){return this._scale},
...
Two.Shape.prototype,{add:function(a){var b=a,c=this.children,d=this.parent,g=[];_.isArray(a)||(b=_.toArray(arguments));var h=_.bind(function(a,b,c,d,g){this.trigger(Two.Events.change,a,b,c,d,g)},this);_.each(b,function(a){var b=a.id,k=a.parent;_.isUndefined(b)&&(d.add(a),b=a.id);_.isUndefined(c[b])&&(k&&delete k.children[b],c[b]=a,a.parent=this,a.unbind(Two.Events.change).bind(Two.Events.change,h),g.push(b))},this);0<g.length&&this.trigger(Two.Events.change,this.id,Two.Properties.hierarchy,g);return this.center()},
...
this.id,Two.Properties.demotion,g);return this.center()},getBoundingClientRect:function(){var a=Infinity,b=-Infinity,c=Infinity,d=-Infinity;_.each(this.children,function(f){f=f.getBoundingClientRect();c=Math.min(f.top,c);a=Math.min(f.left,a);b=Math.max(f.right,b);d=Math.max(f.bottom,d)},this);var g=this._matrix.multiply(a,c,1),h=this._matrix.multiply(b,d,1);return{top:g.y,left:g.x,right:h.x,bottom:h.y,width:h.x-g.x,height:h.y-g.y}},noFill:function(){_.each(this.children,function(a){a.noFill()});return this},
noStroke:function(){_.each(this.children,function(a){a.noStroke()});return this}})})();(function(){var p=Math.min,a=Math.max,b=Math.round,c=Two.Polygon=function(c,g,h){Two.Shape.call(this);g=!!g;h=!!h;var f=0,l=1,k=!1,m=c.slice(0),n=_.debounce(_.bind(function(){var a,c;if(k){a=this.vertices.length;a-=1;c=b(f*a);a=b(l*a);for(m.length=0;c<a+1;c++){var d=this.vertices[c];m.push(new Two.Vector(d.x,d.y))}k=!1}this.trigger(Two.Events.change,this.id,"vertices",m,g,h)},this),0);Object.defineProperty(this,"closed",{get:function(){return g},set:function(a){g=!!a;n()}});Object.defineProperty(this,
"curved",{get:function(){return h},set:function(a){h=!!a;n()}});Object.defineProperty(this,"beginning",{get:function(){return f},set:function(b){f=p(a(b,0),1);k=!0;n()}});Object.defineProperty(this,"ending",{get:function(){return l},set:function(b){l=p(a(b,0),1);k=!0;n()}});this.vertices=c.slice(0);_.each(this.vertices,function(a){a.bind(Two.Events.change,n)},this);n()};_.extend(c,{});_.extend(c.prototype,Two.Shape.prototype,{clone:function(){var a=_.map(this.vertices,function(a){return new Two.Vector(a.x,
a.y)}),b=new c(a,this.closed,this.curved);_.each(Two.Shape.Properties,function(a){b[a]=this[a]},this);b.translation.copy(this.translation);b.rotation=this.rotation;b.scale=this.scale;return b},remove:function(){if(!this.parent)return this;this.parent.remove(this);return this},getBoundingClientRect:function(){var a=this.linewidth,b=Infinity,c=-Infinity,f=Infinity,l=-Infinity;_.each(this.vertices,function(a){var d=a.x;a=a.y;f=Math.min(a,f);b=Math.min(d,b);c=Math.max(d,c);l=Math.max(a,l)});var f=f-a,
b=b-a,c=c+a,l=l+a,a=this._matrix.multiply(b,f,1),k=this._matrix.multiply(c,l,1);return{top:a.y,left:a.x,right:k.x,bottom:k.y,width:k.x-a.x,height:k.y-a.y}}})})();

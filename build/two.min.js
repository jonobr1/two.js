...
(a.__webglObjects=[],a.__webglObjectsImmediate=[],a.__webglSprites=[],a.__webglFlares=[]);for(;a.__objectsAdded.length;){var j=a.__objectsAdded[0],k=a,m=void 0,n=void 0,p=void 0;if(!j.__webglInit)if(j.__webglInit=!0,j._modelViewMatrix=new THREE.Matrix4,j._normalMatrix=new THREE.Matrix3,j instanceof THREE.Mesh)if(n=j.geometry,n instanceof THREE.Geometry){if(void 0===n.geometryGroups){var t=n,u=void 0,x=void 0,B=void 0,C=void 0,z=void 0,D=void 0,E=void 0,G={},H=t.morphTargets.length,J=t.morphNormals.length;
t.geometryGroups={};u=0;for(x=t.faces.length;u<x;u++)B=t.faces[u],C=B.materialIndex,D=void 0!==C?C:-1,void 0===G[D]&&(G[D]={hash:D,counter:0}),E=G[D].hash+"_"+G[D].counter,void 0===t.geometryGroups[E]&&(t.geometryGroups[E]={faces3:[],faces4:[],materialIndex:C,vertices:0,numMorphTargets:H,numMorphNormals:J}),z=B instanceof THREE.Face3?3:4,65535<t.geometryGroups[E].vertices+z&&(G[D].counter+=1,E=G[D].hash+"_"+G[D].counter,void 0===t.geometryGroups[E]&&(t.geometryGroups[E]={faces3:[],faces4:[],materialIndex:C,
vertices:0,numMorphTargets:H,numMorphNormals:J})),B instanceof THREE.Face3?t.geometryGroups[E].faces3.push(u):t.geometryGroups[E].faces4.push(u),t.geometryGroups[E].vertices+=z;t.geometryGroupsList=[];var K=void 0;for(K in t.geometryGroups)t.geometryGroups[K].id=aa++,t.geometryGroupsList.push(t.geometryGroups[K])}for(m in n.geometryGroups)if(p=n.geometryGroups[m],!p.__webglVertexBuffer){var I=p;I.__webglVertexBuffer=l.createBuffer();I.__webglNormalBuffer=l.createBuffer();I.__webglTangentBuffer=l.createBuffer();

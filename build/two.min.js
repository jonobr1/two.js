(function(){function p(a,b,c){if(a===b)return 0!==a||1/a==1/b;if(null==a||null==b)return a===b;a._chain&&(a=a._wrapped);b._chain&&(b=b._wrapped);if(a.isEqual&&e.isFunction(a.isEqual))return a.isEqual(b);if(b.isEqual&&e.isFunction(b.isEqual))return b.isEqual(a);var f=j.call(a);if(f!=j.call(b))return!1;switch(f){case "[object String]":return a==String(b);case "[object Number]":return a!=+a?b!=+b:0==a?1/a==1/b:a==+b;case "[object Date]":case "[object Boolean]":return+a==+b;case "[object RegExp]":return a.source==
...
g=!d}}c.pop();return g}var a=this,b=a._,c={},d=Array.prototype,g=Object.prototype,h=d.slice,f=d.unshift,j=g.toString,l=g.hasOwnProperty,m=d.forEach,r=d.map,s=d.reduce,k=d.reduceRight,n=d.filter,A=d.every,t=d.some,q=d.indexOf,u=d.lastIndexOf,g=Array.isArray,v=Object.keys,w=Function.prototype.bind,e=function(a){return new E(a)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=e),exports._=e):a._=e;e.VERSION="1.3.3";var x=e.each=e.forEach=function(a,
b,d){if(null!=a)if(m&&a.forEach===m)a.forEach(b,d);else if(a.length===+a.length)for(var f=0,g=a.length;f<g&&!(f in a&&b.call(d,a[f],f,a)===c);f++);else for(f in a)if(e.has(a,f)&&b.call(d,a[f],f,a)===c)break};e.map=e.collect=function(a,b,e){var c=[];if(null==a)return c;if(r&&a.map===r)return a.map(b,e);x(a,function(a,z,f){c[c.length]=b.call(e,a,z,f)});a.length===+a.length&&(c.length=a.length);return c};e.reduce=e.foldl=e.inject=function(a,b,c,f){var d=2<arguments.length;null==a&&(a=[]);if(s&&a.reduce===
s)return f&&(b=e.bind(b,f)),d?a.reduce(b,c):a.reduce(b);x(a,function(a,e,z){d?c=b.call(f,c,a,e,z):(c=a,d=!0)});if(!d)throw new TypeError("Reduce of empty array with no initial value");return c};e.reduceRight=e.foldr=function(a,b,c,f){var d=2<arguments.length;null==a&&(a=[]);if(k&&a.reduceRight===k)return f&&(b=e.bind(b,f)),d?a.reduceRight(b,c):a.reduceRight(b);var g=e.toArray(a).reverse();f&&!d&&(b=e.bind(b,f));return d?e.reduce(g,b,c,f):e.reduce(g,b)};e.find=e.detect=function(a,b,e){var c;F(a,function(a,
f,z){if(b.call(e,a,f,z))return c=a,!0});return c};e.filter=e.select=function(a,b,e){var c=[];if(null==a)return c;if(n&&a.filter===n)return a.filter(b,e);x(a,function(a,f,z){b.call(e,a,f,z)&&(c[c.length]=a)});return c};e.reject=function(a,b,e){var c=[];if(null==a)return c;x(a,function(a,f,z){b.call(e,a,f,z)||(c[c.length]=a)});return c};e.every=e.all=function(a,b,e){var f=!0;if(null==a)return f;if(A&&a.every===A)return a.every(b,e);x(a,function(a,z,d){if(!(f=f&&b.call(e,a,z,d)))return c});return!!f};
var F=e.some=e.any=function(a,b,f){b||(b=e.identity);var d=!1;if(null==a)return d;if(t&&a.some===t)return a.some(b,f);x(a,function(a,e,z){if(d||(d=b.call(f,a,e,z)))return c});return!!d};e.include=e.contains=function(a,b){var e=!1;return null==a?e:q&&a.indexOf===q?-1!=a.indexOf(b):e=F(a,function(a){return a===b})};e.invoke=function(a,b){var c=h.call(arguments,2);return e.map(a,function(a){return(e.isFunction(b)?b||a:a[b]).apply(a,c)})};e.pluck=function(a,b){return e.map(a,function(a){return a[b]})};
...
c=Array(b),f=0;f<b;f++)c[f]=e.pluck(a,""+f);return c};e.indexOf=function(a,b,c){if(null==a)return-1;var f;if(c)return c=e.sortedIndex(a,b),a[c]===b?c:-1;if(q&&a.indexOf===q)return a.indexOf(b);c=0;for(f=a.length;c<f;c++)if(c in a&&a[c]===b)return c;return-1};e.lastIndexOf=function(a,b){if(null==a)return-1;if(u&&a.lastIndexOf===u)return a.lastIndexOf(b);for(var e=a.length;e--;)if(e in a&&a[e]===b)return e;return-1};e.range=function(a,b,e){1>=arguments.length&&(b=a||0,a=0);e=arguments[2]||1;for(var c=
Math.max(Math.ceil((b-a)/e),0),f=0,d=Array(c);f<c;)d[f++]=a,a+=e;return d};var R=function(){};e.bind=function(a,b){var c,f;if(a.bind===w&&w)return w.apply(a,h.call(arguments,1));if(!e.isFunction(a))throw new TypeError;f=h.call(arguments,2);return c=function(){if(!(this instanceof c))return a.apply(b,f.concat(h.call(arguments)));R.prototype=a.prototype;var e=new R,d=a.apply(e,f.concat(h.call(arguments)));return Object(d)===d?d:e}};e.bindAll=function(a){var b=h.call(arguments,1);0==b.length&&(b=e.functions(a));
x(b,function(b){a[b]=e.bind(a[b],a)});return a};e.memoize=function(a,b){var c={};b||(b=e.identity);return function(){var f=b.apply(this,arguments);return e.has(c,f)?c[f]:c[f]=a.apply(this,arguments)}};e.delay=function(a,b){var e=h.call(arguments,2);return setTimeout(function(){return a.apply(null,e)},b)};e.defer=function(a){return e.delay.apply(e,[a,1].concat(h.call(arguments,1)))};e.throttle=function(a,b){var c,f,d,g,h,j,q=e.debounce(function(){h=g=!1},b);return function(){c=this;f=arguments;d||
(d=setTimeout(function(){d=null;h&&a.apply(c,f);q()},b));g?h=!0:j=a.apply(c,f);q();g=!0;return j}};e.debounce=function(a,b,e){var c;return function(){var f=this,d=arguments;e&&!c&&a.apply(f,d);clearTimeout(c);c=setTimeout(function(){c=null;e||a.apply(f,d)},b)}};e.once=function(a){var b=!1,e;return function(){if(b)return e;b=!0;return e=a.apply(this,arguments)}};e.wrap=function(a,b){return function(){var e=[a].concat(h.call(arguments,0));return b.apply(this,e)}};e.compose=function(){var a=arguments;
...
(g=!tessellation.sweep.Legalize(a,d))&&a.MapTriangleToNodes(d),b.delaunay_edge[c]=!1,d.delaunay_edge[f]=!1,!0}}return!1};tessellation.sweep.Incircle=function(a,b,c,d){var g=a.x-d.x;a=a.y-d.y;var h=b.x-d.x;b=b.y-d.y;var f=g*b-h*a;if(0>=f)return!1;var j=c.x-d.x;c=c.y-d.y;d=j*a-g*c;return 0>=d?!1:0<(g*g+a*a)*(h*c-j*b)+(h*h+b*b)*d+(j*j+c*c)*f};tessellation.sweep.RotateTrianglePair=function(a,b,c,d){var g,h,f,j;g=a.NeighborCCW(b);h=a.NeighborCW(b);f=c.NeighborCCW(d);j=c.NeighborCW(d);var l,m,r,s;l=a.GetConstrainedEdgeCCW(b);
m=a.GetConstrainedEdgeCW(b);r=c.GetConstrainedEdgeCCW(d);s=c.GetConstrainedEdgeCW(d);var k,n,p,t;k=a.GetDelaunayEdgeCCW(b);n=a.GetDelaunayEdgeCW(b);p=c.GetDelaunayEdgeCCW(d);t=c.GetDelaunayEdgeCW(d);a.Legalize(b,d);c.Legalize(d,b);c.SetDelaunayEdgeCCW(b,k);a.SetDelaunayEdgeCW(b,n);a.SetDelaunayEdgeCCW(d,p);c.SetDelaunayEdgeCW(d,t);c.SetConstrainedEdgeCCW(b,l);a.SetConstrainedEdgeCW(b,m);a.SetConstrainedEdgeCCW(d,r);c.SetConstrainedEdgeCW(d,s);a.ClearNeigbors();c.ClearNeigbors();g&&c.MarkNeighbor(g);
h&&a.MarkNeighbor(h);f&&a.MarkNeighbor(f);j&&c.MarkNeighbor(j);a.MarkNeighbor(c)};tessellation.sweep.FillBasin=function(a,b){a.basin.left_node=tessellation.Orient2d(b.point,b.next.point,b.next.next.point)==tessellation.Orientation.CCW?b.next.next:b.next;for(a.basin.bottom_node=a.basin.left_node;null!=a.basin.bottom_node.next&&a.basin.bottom_node.point.y>=a.basin.bottom_node.next.point.y;)a.basin.bottom_node=a.basin.bottom_node.next;if(a.basin.bottom_node!=a.basin.left_node){for(a.basin.right_node=
...
b==a.edge_event.constrained_edge.p&&(d.MarkConstrainedEdge(b,c),h.MarkConstrainedEdge(b,c),tessellation.sweep.Legalize(a,d),tessellation.sweep.Legalize(a,h));else{var j=tessellation.Orient2d(c,f,b);d=tessellation.sweep.NextFlipTriangle(a,j,d,h,g,f);tessellation.sweep.FlipEdgeEvent(a,b,c,d,g)}else f=tessellation.sweep.NextFlipPoint(b,c,h,f),tessellation.sweep.FlipScanEdgeEvent(a,b,c,d,h,f),tessellation.sweep.EdgeEvent(a,b,c,d,g)}};tessellation.sweep.NextFlipTriangle=function(a,b,c,d,g,h){if(b==tessellation.Orientation.CCW)return b=
...
CuspLimit:0,Tolerance:{distance:0.25,angle:0,epsilon:0.01}},decoupleShapes:function(a,b,c){c=c||0;for(var d=0,f=a.length;d<f;d++)if(b||!(d>=f-1))for(var g=w(d+1,f),h=a[d],q=a[g],j=f-1;j>d+1;j--)if(!(j>=f-1)){var l=w(j+1,f),k=u(h,q,a[j],a[l]);if(k)return d=[k],k=[k.clone()],_.range(f),f=a.slice(0,g).concat(d,a.slice(l,f)),a=a.slice(g,l).concat(k),[v(f,b,c+1),v(a,b,c+1)]}return[a]},solveSegmentIntersection:function(a,b,c,d){var f=(d.x-c.x)*(a.y-c.y)-(d.y-c.y)*(a.x-c.x),g=(b.x-a.x)*(a.y-c.y)-(b.y-a.y)*
(a.x-c.x);c=(d.y-c.y)*(b.x-a.x)-(d.x-c.x)*(b.y-a.y);return 0!=c&&(f/=c,g/=c,0<=f&&1>=f&&0<=g&&1>=g)?new k.Vector(a.x+f*(b.x-a.x),a.y+f*(b.y-a.y)):null},subdivide:function(a,b,c,d,h,q,u,m,v){var n=k.Utils.Curve.CollinearityEpsilon,s=k.Utils.Curve.CuspLimit,r=k.Utils.Curve.Tolerance;v=v||0;var w=(a+c)/2,p=(b+d)/2,t=(c+h)/2,A=(d+q)/2,N=(h+u)/2,O=(q+m)/2,P=(w+t)/2,Q=(p+A)/2,t=(t+N)/2,A=(A+O)/2,C=(P+t)/2,D=(Q+A)/2;if(0<v){var y=u-a,B=m-b,G=f((c-u)*B-(d-m)*y),H=f((h-u)*B-(q-m)*y);if(G>n&&H>n&&(G+H)*(G+
H)<=r.distance*(y*y+B*B)){if(r.angle<r.epsilon)return[new k.Vector(C,D)];y=g(q-d,h-c);n=f(y-g(d-b,c-a));y=f(g(m-q,u-h)-y);n>=j&&(n=l-n);y>=j&&(y=l-y);if(n+y<r.angle)return[new k.Vector(C,D)];if(0!==s){if(n>s)return[new k.Vector(c,d)];if(y>s)return[new k.Vector(h,q)]}}}else if(G>n)if(G*G<=r.distance*(y*y+B*B)){if(r.angle<r.epsilon)return[new k.Vector(C,D)];n=f(g(q-d,h-c)-g(d-b,c-a));n>=j&&(n=l-n);if(n<r.angle)return[new k.Vector(c,d),new k.Vector(h,q)];if(0!==s&&n>s)return[new k.Vector(c,d)]}else if(H>
n){if(H*H<=r.distance*(y*y+B*B)){if(r.angle<r.epsilon)return[new k.Vector(C,D)];n=f(g(m-q,u-h)-g(q-d,h-c));n>=j&&(n=l-n);if(n<r.angle)return[new k.Vector(c,d),new k.Vector(h,q)];if(0!==s&&n>s)return[new k.Vector2(h,q)]}}else if(y=C-(a+u)/2,B=D-(b+m)/2,y*y+B*B<=r.distance)return[new k.Vector(C,D)];return k.Utils.subdivide(a,b,w,p,P,Q,C,D,v+1).concat(k.Utils.subdivide(C,D,t,A,N,O,u,m,v+1))},getCurveFromPoints:function(a,b){for(var c=[],d=a.length,f=d-1,g=0;g<d;g++){var h=a[g],j={x:h.x,y:h.y};c.push(j);
var h=b?w(g-1,d):Math.max(g-1,0),l=b?w(g+1,d):Math.min(g+1,f);q(a[h],j,a[l]);!j.u.x&&!j.u.y&&(j.u.x=j.x,j.u.y=j.y);!j.v.x&&!j.v.y&&(j.v.x=j.x,j.v.y=j.y)}return c},getControlPoints:function(a,b,f){var g=t(a,b),h=t(f,b);a=n(a,b);f=n(f,b);var q=(g+h)/2;if(1E-4>a||1E-4>f)return b.u={x:b.x,y:b.y},b.v={x:b.x,y:b.y},b;a*=0.33;f*=0.33;q=h<g?q+m:q-m;g={x:b.x+d(q)*a,y:b.y+c(q)*a};q-=j;h={x:b.x+d(q)*f,y:b.y+c(q)*f};b.u=g;b.v=h;return b},angleBetween:function(a,b){return g(a.y-b.y,a.x-b.x)},distanceBetweenSquared:function(a,
b){var c=a.x-b.x,d=a.y-b.y;return c*c+d*d},distanceBetween:function(a,b){return h(A(a,b))},mod:function(a,b){for(;0>a;)a+=b;return a%b},Error:function(a){this.name="two.js";this.message=a}}});k.Utils.Error.prototype=Error();k.Utils.Error.prototype.constructor=k.Utils.Error;var n=k.Utils.distanceBetween,A=k.Utils.distanceBetweenSquared,t=k.Utils.angleBetween,q=k.Utils.getControlPoints,u=k.Utils.solveSegmentIntersection,v=k.Utils.decoupleShapes,w=k.Utils.mod;_.extend(k.prototype,Backbone.Events,{appendTo:function(a){a.appendChild(this.renderer.domElement);
return this},play:function(){this.playing=!0;return this.trigger(k.Events.play)},pause:function(){this.playing=!1;return this.trigger(k.Events.pause)},update:function(){this.frameCount++;var a=this.width,b=this.height,c=this.renderer;(a!==c.width||b!==c.height)&&c.setSize(a,b);return this.trigger(k.Events.update,this.frameCount)},render:function(){this.renderer.render();return this.trigger(k.Events.render,this.frameCount)},add:function(a){var b=a;_.isArray(a)||(b=_.toArray(arguments));this.scene.add(b);
return this},makeLine:function(a,b,c,d){c=(c-a)/2;d=(d-b)/2;var f=[new k.Vector(-c,-d),new k.Vector(c,d)],f=(new k.Polygon(f)).noFill();f.translation.set(a+c,b+d);this.scene.add(f);return f},makeRectangle:function(a,b,c,d){c/=2;d/=2;d=[new k.Vector(c,d),new k.Vector(-c,d),new k.Vector(-c,-d),new k.Vector(c,-d)];d=new k.Polygon(d,!0);d.translation.set(a,b);this.scene.add(d);return d},makeCircle:function(a,b,c){return this.makeEllipse(a,b,c,c)},makeEllipse:function(a,b,f,g){var h=k.Resolution,q=_.map(_.range(h),
function(a){var b=a/h*l;a=f*d(b);b=g*c(b);return new k.Vector(a,b)},this),q=new k.Polygon(q,!0,!0);q.translation.set(a,b);this.scene.add(q);return q},makeCurve:function(a){var b=arguments.length,c=a;if(!_.isArray(a))for(var c=[],d=0;d<b;d+=2){var f=arguments[d];if(!_.isNumber(f))break;c.push(new k.Vector(f,arguments[d+1]))}var b=arguments[b-1],c=new k.Polygon(c,!(_.isBoolean(b)&&b),!0),b=c.getBoundingClientRect(),g=b.left+b.width/2,q=b.top+b.height/2;_.each(c.vertices,function(a){a.x-=g;a.y-=q});
c.translation.set(g,q);this.scene.add(c);return c},makePolygon:function(a){var b=arguments.length,c=a;if(!_.isArray(a))for(var c=[],d=0;d<b;d+=2){var f=arguments[d];if(!_.isNumber(f))break;c.push(new k.Vector(f,arguments[d+1]))}var b=arguments[b-1],c=new k.Polygon(c,!(_.isBoolean(b)&&b)),b=c.getBoundingClientRect(),g=b.left+b.width/2,q=b.top+b.height/2;_.each(c.vertices,function(a){a.x-=g;a.y-=q});c.translation.set(g,q);this.scene.add(c);return c},makeGroup:function(a){var b=a;_.isArray(a)||(b=_.toArray(arguments));
var c=new k.Group;this.scene.add(c);c.add(b);return c}});(function(){_.each(k.Instances,function(a){a.playing&&a.update().render()});requestAnimationFrame(arguments.callee)})()})();(function(){var p=Two.Vector=function(a,b){a=a||0;b=b||0;Object.defineProperty(this,"x",{get:function(){return a},set:function(b){a=b;this.trigger("change","x")}});Object.defineProperty(this,"y",{get:function(){return b},set:function(a){b=a;this.trigger("change","y")}})};_.extend(p,{});_.extend(p.prototype,Backbone.Events,{set:function(a,b){this.x=a;this.y=b;return this},copy:function(a){this.x=a.x;this.y=a.y;return this},clear:function(){this.y=this.x=0;return this},clone:function(){return new p(this.x,
...
b+this.x,(a.y-this.y)*b+this.y)},isZero:function(){return 1E-4>this.length()}})})();(function(){_.range(6);var p=Math.cos,a=Math.sin,b=Math.tan,c=Two.Matrix=function(a,b,c,f,j,l){this.elements=new Two.Array(9);var m=a;_.isArray(m)||(m=_.toArray(arguments));this.identity().set(m)};_.extend(c,{Identity:[1,0,0,0,1,0,0,0,1],Determinant:function(a,b,c,f,j,l,m,r,s){return a*j*s-a*l*r-b*f*s+b*l*m+c*f*r-c*j*m},Multiply:function(a,b){var c=a[0],f=a[1],j=a[2],l=a[3],m=a[4],r=a[5],s=a[6],k=a[7],n=a[8],p=b[0],t=b[1],q=b[2],u=b[3],v=b[4],w=b[5],e=b[6],x=b[7],F=b[8];return[c*p+f*u+j*e,c*t+f*v+
j*x,c*q+f*w+j*F,l*p+m*u+r*e,l*t+m*v+r*x,l*q+m*w+r*F,s*p+k*u+n*e,s*t+k*v+n*x,s*q+k*w+n*F]}});_.extend(c.prototype,{set:function(a,b,c,f,j,l){var m=a;_.isArray(m)||(m=_.toArray(arguments));_.each(m,function(a,b){_.isNumber(a)&&(this.elements[b]=a)},this);return this},identity:function(){this.set(c.Identity);return this},multiply:function(a,b,c,f,j,l,m,r,s){var k=arguments,n=k.length;if(1>=n)return _.each(this.elements,function(b,c){this.elements[c]=b*a},this),this;if(3>=n)return a=a||0,b=b||0,c=c||
0,j=this.elements,{x:j[0]*a+j[1]*b+j[2]*c,y:j[3]*a+j[4]*b+j[5]*c,z:j[6]*a+j[7]*b+j[8]*c};n=this.elements;A0=n[0];A1=n[1];A2=n[2];A3=n[3];A4=n[4];A5=n[5];A6=n[6];A7=n[7];A8=n[8];B0=k[0];B1=k[1];B2=k[2];B3=k[3];B4=k[4];B5=k[5];B6=k[6];B7=k[7];B8=k[8];this.elements[0]=A0*B0+A1*B3+A2*B6;this.elements[1]=A0*B1+A1*B4+A2*B7;this.elements[2]=A0*B2+A1*B5+A2*B8;this.elements[3]=A3*B0+A4*B3+A5*B6;this.elements[4]=A3*B1+A4*B4+A5*B7;this.elements[5]=A3*B2+A4*B5+A5*B8;this.elements[6]=A6*B0+A7*B3+A8*B6;this.elements[7]=
A6*B1+A7*B4+A8*B7;this.elements[8]=A6*B2+A7*B5+A8*B8;return this},determinant:function(){var a=this.elements,b=a[0],c=a[1],f=a[2],j=a[3],l=a[4],m=a[5],r=a[6],s=a[7],a=a[8];return b*l*a-b*m*s-c*j*a+c*m*r+f*j*s-f*l*r},scale:function(a,b){1>=arguments.length&&(b=a);return this.multiply(a,0,0,0,b,0,0,0,1)},rotate:function(b){var c=p(b);b=a(b);return this.multiply(c,-b,0,b,c,0,0,0,1)},translate:function(a,b){return this.multiply(1,0,a,0,1,b,0,0,1)},skewX:function(a){a=b(a);return this.multiply(1,a,0,0,
1,0,0,0,1)},skewY:function(a){a=b(a);return this.multiply(1,0,0,a,1,0,0,0,1)},toString:function(){return this.toArray().join(" ")},toArray:function(a){var b=this.elements,c=parseFloat(b[0].toFixed(3)),f=parseFloat(b[1].toFixed(3)),j=parseFloat(b[2].toFixed(3)),l=parseFloat(b[3].toFixed(3)),m=parseFloat(b[4].toFixed(3)),r=parseFloat(b[5].toFixed(3));if(a){a=parseFloat(b[6].toFixed(3));var s=parseFloat(b[7].toFixed(3)),b=parseFloat(b[8].toFixed(3));return[c,l,a,f,m,s,j,r,b]}return[c,l,f,m,j,r]},clone:function(){return new Two.Matrix(this.elements[0],
this.elements[1],this.elements[2],this.elements[3],this.elements[4],this.elements[5])}})})();(function(){function p(a){var b={},c=a.id,l=a.translation,m=a.rotation,r=a.scale,s=a.stroke,k=a.linewidth,n=a.fill,p=a.opacity,t=a.visible,q=a.cap,u=a.join,v=a.miter,w=a.curved,e=a.closed;a=a.vertices;c&&(b.id=g.Identifier+c);l&&(_.isNumber(r)&&_.isNumber(m))&&(b.transform="translate("+l.x+","+l.y+") scale("+r+") rotate("+m+")");s&&(b.stroke=s);n&&(b.fill=n);p&&(b["stroke-opacity"]=b["fill-opacity"]=p);b.visibility=t?"visible":"hidden";q&&(b["stroke-linecap"]=q);u&&(b["stroke-linejoin"]=u);v&&(b["stroke-miterlimit"]=
v);k&&(b["stroke-width"]=k);a&&(b.d=d.toString(a,e,w));return b}var a=0,b=Two.Utils.getCurveFromPoints,c=Two.Utils.mod,d={version:1.1,ns:"http://www.w3.org/2000/svg",xlink:"http://www.w3.org/1999/xlink",createElement:function(a,b){var c=a.toLowerCase(),d=document.createElementNS(this.ns,c);"svg"===c&&(b=_.defaults(b||{},{version:this.version}));_.isObject(b)&&this.setAttributes(d,b);return d},setAttributes:function(a,b){_.each(b,function(a,b){this.setAttribute(b,a)},a);return this},removeAttributes:function(a,
b){_.each(b,function(a){this.removeAttribute(a)},a);return this},toString:function(a,f,d){var g=a.length,m=g-1;if(!d)return _.map(a,function(a,b){var c;c=(0>=b?"M":"L")+(" "+a.x.toFixed(3)+" "+a.y.toFixed(3));b>=m&&f&&(c+=" Z");return c}).join(" ");var r=b(a,f);return _.map(r,function(a,b){var d,j=f?c(b-1,g):Math.max(b-1,0),h=f?c(b+1,g):Math.min(b+1,m);d=r[j];var h=r[h],j=d.v.x.toFixed(3),q=d.v.y.toFixed(3),u=a.u.x.toFixed(3),v=a.u.y.toFixed(3),w=a.x.toFixed(3),e=a.y.toFixed(3);d=0>=b?"M "+w+" "+
e:"C "+j+" "+q+" "+u+" "+v+" "+w+" "+e;b>=m&&f&&(j=a.v.x.toFixed(3),q=a.v.y.toFixed(3),u=h.u.x.toFixed(3),v=h.u.y.toFixed(3),w=h.x.toFixed(3),e=h.y.toFixed(3),d=d+(" C "+j+" "+q+" "+u+" "+v+" "+w+" "+e)+" Z");return d}).join(" ")}},g=Two[Two.Types.svg]=function(){this.domElement=d.createElement("svg");this.elements=[];this.commands=[];this.domElement.style.visibility="hidden";this.unveil=_.once(_.bind(function(){this.domElement.style.visibility="visible"},this))};_.extend(g,{Identifier:"two-"});_.extend(g.prototype,
Backbone.Events,{setSize:function(a,b){this.width=a;this.height=b;d.setAttributes(this.domElement,{width:a,height:b});return this},add:function(b){var c=b,g=this.elements,l=this.domElement;_.isArray(b)||(c=_.map(arguments,function(a){return a}));_.each(c,function(b){var c;c=b instanceof Two.Group;if(_.isUndefined(b.id)){var f=a;a++;b.id=f}c?(c="g",_.isUndefined(b.parent)&&(b.parent=this,b.unbind(Two.Events.change).bind(Two.Events.change,_.bind(this.update,this))),b=p(b),delete b.stroke,delete b.fill,
delete b["fill-opacity"],delete b["stroke-opacity"],delete b["stroke-linecap"],delete b["stroke-linejoin"],delete b["stroke-miterlimit"],delete b["stroke-width"]):(c="path",b=p(b));b=d.createElement(c,b);l.appendChild(b);g.push(b)},this);return this},update:function(a,b,c){this.commands.push(arguments);return this},render:function(){this.unveil();var a=this.elements;_.each(this.commands,function(b){var c=b[1],g=b[2],m=b[3],r=b[4],s=a[b[0]];switch(c){case Two.Properties.hierarchy:_.each(g,function(b){s.appendChild(a[b])});
break;case Two.Properties.demotion:_.each(g,function(b){s.removeChild(a[b])});break;default:a:{b=c;switch(b){case "matrix":b="transform";g="matrix("+g.toString()+")";break;case "visible":b="visibility";g=g?"visible":"hidden";break;case "cap":b="stroke-linecap";break;case "join":b="stroke-linejoin";break;case "miter":b="stroke-miterlimit";break;case "linewidth":b="stroke-width";break;case "vertices":b="d";g=d.toString(g,m,r);break;case "opacity":d.setAttributes(s,{"stroke-opacity":opacity,"fill-opacity":opacity});
...
return this}});var d=function(a){_.each(a,function(a,b){this[b]=a},this)};_.extend(d.prototype,{render:function(a){var c=this.matrix,d=this.stroke,g=this.linewidth,h=this.fill,s=this.opacity,k=this.cap,n=this.join,p=this.miter,t=this.curved,q=this.closed,u=this.commands,v=u.length,w=v-1;if(!this.visible)return this;a.save();c&&a.transform(c[0],c[1],c[2],c[3],c[4],c[5]);h&&(a.fillStyle=h);d&&(a.strokeStyle=d);g&&(a.lineWidth=g);p&&(a.miterLimit=p);n&&(a.lineJoin=n);k&&(a.lineCap=k);_.isNumber(s)&&
(a.globalAlpha=s);a.beginPath();_.each(u,function(c,d){var g=c.x.toFixed(3),h=c.y.toFixed(3);if(t){var j=q?b(d-1,v):Math.max(d-1,0),k=q?b(d+1,v):Math.min(d+1,w),l=u[j],k=u[k],j=l.v.x.toFixed(3),l=l.v.y.toFixed(3),m=c.u.x.toFixed(3),n=c.u.y.toFixed(3);0>=d?a.moveTo(g,h):(a.bezierCurveTo(j,l,m,n,g,h),d>=w&&q&&(j=c.v.x.toFixed(3),l=c.v.y.toFixed(3),m=k.u.x.toFixed(3),n=k.u.y.toFixed(3),g=k.x.toFixed(3),h=k.y.toFixed(3),a.bezierCurveTo(j,l,m,n,g,h)))}else 0>=d?a.moveTo(g,h):a.lineTo(g,h)});q&&!t&&a.closePath();
a.fill();a.stroke();a.restore()}});var g={toArray:function(b,c,d){return!c?_.map(b,function(a){return{x:a.x,y:a.y}}):a(b,d)}},h=Two[Two.Types.canvas]=function(){this.domElement=document.createElement("canvas");this.ctx=this.domElement.getContext("2d");this.elements=[];this.stage=null};_.extend(h,{});_.extend(h,{Group:c,Element:d,getStyles:function(a){var b={},c=a.id,d=a._matrix,h=a.stroke,s=a.linewidth,k=a.fill,n=a.opacity,p=a.visible,t=a.cap,q=a.join,u=a.miter,v=a.curved,w=a.closed;a=a.vertices;
c&&(b.id=c);_.isObject(d)&&(b.matrix=d.toArray());h&&(b.stroke=h);k&&(b.fill=k);_.isNumber(n)&&(b.opacity=n);t&&(b.cap=t);q&&(b.join=q);u&&(b.miter=u);s&&(b.linewidth=s);a&&(b.commands=g.toArray(a,v,w));b.visible=!!p;b.curved=!!v;b.closed=!!w;return b},setStyles:function(a,b,c,d,h){switch(b){case "matrix":b="matrix";c=c.toArray();break;case "vertices":b="commands",a.curved=h,a.closed=d,c=g.toArray(c,a.curved,a.closed)}a[b]=c}});_.extend(h.prototype,Backbone.Events,{setSize:function(a,b){this.width=
...
a),delete b.stroke,delete b.fill,delete b.opacity,delete b.cap,delete b.join,delete b.miter,delete b.linewidth,b=new d(b),f&&(this.stage=b,this.stage.object=a,a.parent=this,a.unbind(Two.Events.change).bind(Two.Events.change,_.bind(this.update,this)))):b=new g(h.call(this,a));c.push(b);f||this.stage.appendChild(b)},this);return this},update:function(a,b,c,d,g){var h=Object.getPrototypeOf(this).constructor,k=this.elements,n=k[a];switch(b){case Two.Properties.hierarchy:_.each(c,function(a){n.appendChild(k[a])});
break;case Two.Properties.demotion:_.each(c,function(a){n.removeChild(k[a]);this.elements[a]=null},this);default:h.setStyles.call(this,n,b,c,d,g)}return this},render:function(){if(_.isNull(this.stage))return this;this.ctx.clearRect(0,0,this.width,this.height);this.stage.render(this.ctx);return this}})})();(function(){function p(a){var b=[];_.each(a,function(a){_.isArray(a)&&_.isArray(a[0])?b=b.concat(p(a)):b.push(a)});return b}function a(a){return g.apply(this,a)}var b=Two[Two.Types.canvas],c=Two.Utils.getCurveFromPoints,d=Two.Matrix.Multiply,g=Two.Matrix.Determinant,h=Two.Utils.decoupleShapes,f={aliceblue:"#F0F8FF",antiquewhite:"#FAEBD7",aqua:"#00FFFF",aquamarine:"#7FFFD4",azure:"#F0FFFF",beige:"#F5F5DC",bisque:"#FFE4C4",black:"#000000",blanchedalmond:"#FFEBCD",blue:"#0000FF",blueviolet:"#8A2BE2",
...
paleturquoise:"#AFEEEE",palevioletred:"#D87093",papayawhip:"#FFEFD5",peachpuff:"#FFDAB9",peru:"#CD853F",pink:"#FFC0CB",plum:"#DDA0DD",powderblue:"#B0E0E6",purple:"#800080",red:"#FF0000",rosybrown:"#BC8F8F",royalblue:"#4169E1",saddlebrown:"#8B4513",salmon:"#FA8072",sandybrown:"#F4A460",seagreen:"#2E8B57",seashell:"#FFF5EE",sienna:"#A0522D",silver:"#C0C0C0",skyblue:"#87CEEB",slateblue:"#6A5ACD",slategray:"#708090",slategrey:"#708090",snow:"#FFFAFA",springgreen:"#00FF7F",transparent:"#000",steelblue:"#4682B4",
tan:"#D2B48C",teal:"#008080",thistle:"#D8BFD8",tomato:"#FF6347",turquoise:"#40E0D0",violet:"#EE82EE",wheat:"#F5DEB3",white:"#FFFFFF",whitesmoke:"#F5F5F5",yellow:"#FFFF00",yellowgreen:'#9ACD32"'},j="(?:\\+|-)?\\d+",l="(?:\\+|-)?\\d*\\.\\d+",m="(?:"+j+")|(?:"+l+")",j="("+j+")",l="("+l+")",m="("+m+")",l=m+"%",r=RegExp(["^hsl(a?)\\(",m,",",l,",",l,"(,",m,")?\\)$"].join("\\s*?")),s=RegExp(["^rgb(a?)\\(",j,",",j,",",j,"(,",m,")?\\)$"].join("\\s*?")),k=RegExp(["^rgb(a?)\\(",l,",",l,",",l,"(,",m,")?\\)$"].join("\\s*?")),
n=/^,\s*/,A=[function(a){function b(c,d){var f=a.match(c);if(f&&1!==!!f[1]+!!f[5]){var g=_.isUndefined(f[5])?1:f[5].replace(n,"");return{r:Math.min(1,Math.max(0,f[2]/d)),g:Math.min(1,Math.max(0,f[3]/d)),b:Math.min(1,Math.max(0,f[4]/d)),a:Math.min(1,Math.max(g,0))}}}a=a.replace(/^\s+|\s+$/g,"");var c=b(s,255);return c?c:b(k,100)},function(a){var b=a.toLowerCase();b in f&&(a=f[b]);if(a.match(/^#([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/)){a=a.replace(/^#/,"");var b=a.length/3,c=Math.pow(16,b)-1;return{r:parseInt(a.slice(0,
b),16)/c,g:parseInt(a.slice(1*b,2*b),16)/c,b:parseInt(a.slice(2*b),16)/c,a:1}}},function(a){var b=a.replace(/^\s+|\s+$/g,"").match(r);if(!b||1===!!b[1]+!!b[5])return null;a=(b[2]%360+360)%360/360;var c=Math.max(0,Math.min(parseInt(b[3],10)/100,1)),d=Math.max(0,Math.min(parseInt(b[4],10)/100,1)),b=b[5];if(0!=c)var e=function(a,b,c){0>c&&(c+=1);1<c&&(c-=1);return c<1/6?a+6*(b-a)*c:0.5>c?b:c<2/3?a+6*(b-a)*(2/3-c):a},f=0.5>d?d*(1+c):d+c-d*c,g=2*d-f;c=_.isUndefined(b)||_.isNull(b)?1:b.replace(n,"");return{r:e(g,
f,a+1/3),g:e(g,f,a),b:e(g,f,a-1/3),a:c}}],j=function(a){b.Group.call(this,a)};_.extend(j.prototype,b.Group.prototype,{appendChild:function(){b.Group.prototype.appendChild.apply(this,arguments);this.updateMatrix();return this},updateMatrix:function(a){a=a||this.parent&&this.parent.matrix;if(!a)return this;this._matrix=d(this.matrix,a);_.each(this.children,function(a){a.updateMatrix(this._matrix)},this);return this},render:function(a,b,c,d){_.each(this.children,function(e){e.render(a,b,c,d)})}});m=
function(a){b.Element.call(this,a)};_.extend(m.prototype,b.Element.prototype,{updateMatrix:function(b){b=b||this.parent&&this.parent.matrix;if(!b)return this;this._matrix=d(this.matrix,b);this._linewidth=this.linewidth*a(this._matrix);return this},render:function(a,b,c,d){if(!this.visible||!this.fillBuffer||!this.strokeBuffer)return this;0<this.fill.a&&(a.bindBuffer(a.ARRAY_BUFFER,this.fillBuffer),a.vertexAttribPointer(b,2,a.FLOAT,!1,0,0),a.uniformMatrix3fv(c,!1,this._matrix),a.uniform4f(d,this.fill.r,
this.fill.g,this.fill.b,this.fill.a),a.drawArrays(a.TRIANGLES,0,this.triangleAmount));if(0>=this._linewidth||0>=this.stroke.a)return this;a.bindBuffer(a.ARRAY_BUFFER,this.strokeBuffer);a.vertexAttribPointer(b,2,a.FLOAT,!1,0,0);a.uniformMatrix3fv(c,!1,this._matrix);a.uniform4f(d,this.stroke.r,this.stroke.g,this.stroke.b,this.stroke.a);a.lineWidth(this._linewidth);a.drawArrays(a.LINES,0,this.vertexAmount);return this}});var t={updateBuffer:function(a,b,c){_.isObject(b.fillBuffer)&&a.deleteBuffer(b.fillBuffer);
b.fillBuffer=a.createBuffer();a.bindBuffer(a.ARRAY_BUFFER,b.fillBuffer);a.enableVertexAttribArray(c);a.bufferData(a.ARRAY_BUFFER,b.triangles,a.STATIC_DRAW);_.isObject(b.strokeBuffer)&&a.deleteBuffer(b.strokeBuffer);b.strokeBuffer=a.createBuffer();a.bindBuffer(a.ARRAY_BUFFER,b.strokeBuffer);a.enableVertexAttribArray(c);a.bufferData(a.ARRAY_BUFFER,b.vertices,a.STATIC_DRAW)},interpret:function(a){for(var b=0,c=A.length;b<c;b++){var d=A[b](a);if(d)return d}return{r:0,g:0,b:0,a:0}},toArray:function(a,
b,d){if(!b)return a;var f=c(a,d),e=f.length,g=e-1,h=[];_.each(f,function(a,b){if(d||!d&&b<g){var c=f[(b+1)%e],c=Two.Utils.subdivide(a.x,a.y,a.v.x,a.v.y,c.u.x,c.u.y,c.x,c.y);h=h.concat(c)}});return h},tessellate:function(a,b,c,d,e){a=p(h(a,c));var f=[],g=[],j=0,k=0;_.each(a,function(a){a=new tessellation.SweepContext(a);tessellation.sweep.Triangulate(a);j+=6*a.triangles.length;_.each(a.triangles,function(a){var b=a.points;a=b[0];var c=b[1],b=b[2];f.push(a.x,a.y,c.x,c.y,b.x,b.y)});k+=4*a.edges.length;
_.each(a.edges,function(a){var b=a.p;a=a.q;g.push(b.x,b.y,a.x,a.y)})});d=d&&j<=d.length?d:new Two.Array(j);e=e&&k<=e.length?e:new Two.Array(k);d.set(f);e.set(g);return{triangles:d,vertices:e,triangleAmount:j/2,vertexAmount:k/2}},program:{create:function(a,b){var c=a.createProgram();_.each(b,function(b){a.attachShader(c,b)});a.linkProgram(c);if(!a.getProgramParameter(c,a.LINK_STATUS))throw error=a.getProgramInfoLog(c),new Two.Utils.Error("unable to link program: "+error);return c}},shaders:{create:function(a,
b,c){c=a.createShader(a[c]);a.shaderSource(c,b);a.compileShader(c);if(!a.getShaderParameter(c,a.COMPILE_STATUS))throw a=a.getShaderInfoLog(c),new Two.Utils.Error("unable to compile shader "+c+": "+a);return c},types:{vertex:"VERTEX_SHADER",fragment:"FRAGMENT_SHADER"},vertex:"attribute vec2 position;\nuniform mat3 matrix;\nuniform vec2 resolution;\n\nvoid main() {\n   vec2 projected = (matrix * vec3(position, 1)).xy;\n   vec2 normal = projected / resolution;\n   vec2 clipspace = (normal * 2.0) - 1.0;\n\n   gl_Position = vec4(clipspace * vec2(1.0, -1.0), 0.0, 1.0);\n}",
fragment:"precision mediump float;\n\nuniform vec4 color;\n\nvoid main() {\n  gl_FragColor = color;\n}"}},l=Two[Two.Types.webgl]=function(a){this.domElement=document.createElement("canvas");this.elements=[];this.stage=null;a=_.defaults(a||{},{antialias:!0,alpha:!1,premultipliedAlpha:!1});this.domElement.style.background="#efefef";this.ctx=this.domElement.getContext("webgl",a)||this.domElement.getContext("experimental-webgl",a);if(!this.ctx)throw new Two.Utils.Error("unable to create a webgl context. Try using another renderer.");
...
this.ctx.blendFunc(this.ctx.SRC_ALPHA,this.ctx.ONE_MINUS_SRC_ALPHA)};_.extend(l,{Group:j,Element:m,getStyles:function(b){var c={},d=b.id,f=b._matrix,e=b.stroke,g=b.linewidth,h=b.fill,j=b.opacity,k=b.visible,l=b.cap,m=b.join,n=b.miter,s=b.curved,p=b.closed;b=b.vertices;d&&(c.id=d);_.isObject(f)&&(c.matrix=c._matrix=f.toArray(!0));e&&(c.stroke=t.interpret(e));h&&(c.fill=t.interpret(h));_.isNumber(j)&&(c.opacity=j);l&&(c.cap=l);m&&(c.join=m);n&&(c.miter=n);g&&(c.linewidth=g,c._linewidth=g*a(c._matrix));
b&&(b=t.toArray(b,s,p),d=t.tessellate(b,s,p),c.triangles=d.triangles,c.vertices=d.vertices,c.vertexAmount=d.vertexAmount,c.triangleAmount=d.triangleAmount);c.visible=!!k;c.curved=!!s;c.closed=!!p;return c},setStyles:function(b,c,d,f,e){switch(c){case "matrix":c="matrix";d=d.toArray(!0);break;case "linewidth":c="linewidth";b._linewidth=d*a(b._matrix);break;case "stroke":d=t.interpret(d);break;case "fill":d=t.interpret(d);break;case "vertices":c="triangles",b.curved=e,b.closed=f,d=t.toArray(d,b.curved,
b.closed),f=t.tessellate(d,b.curved,b.closed,b.triangles,b.vertices),d=f.triangles,b.vertices=f.vertices,b.vertexAmount=f.vertexAmount,b.triangleAmount=f.triangleAmount}b[c]=d;"triangles"===c&&t.updateBuffer(this.ctx,b,this.positionLocation);"matrix"===c&&b.updateMatrix()}});_.extend(l.prototype,Backbone.Events,b.prototype,{setSize:function(a,c){b.prototype.setSize.apply(this,arguments);this.ctx.viewport(0,0,a,c);var d=this.ctx.getUniformLocation(this.program,"resolution");this.ctx.uniform2f(d,a,
...
noStroke:function(){_.each(this.children,function(a){a.noStroke()});return this}})})();(function(){var p=Math.min,a=Math.max,b=Math.round,c=Two.Polygon=function(c,g,h){Two.Shape.call(this);g=!!g;h=!!h;var f=0,j=1,l=!1,m=c.slice(0),r=_.debounce(_.bind(function(){var a,c;if(l){a=this.vertices.length;a-=1;c=b(f*a);a=b(j*a);for(m.length=0;c<a+1;c++){var d=this.vertices[c];m.push(new Two.Vector(d.x,d.y))}l=!1}this.trigger(Two.Events.change,this.id,"vertices",m,g,h)},this),0);Object.defineProperty(this,"closed",{get:function(){return g},set:function(a){g=!!a;r()}});Object.defineProperty(this,
"curved",{get:function(){return h},set:function(a){h=!!a;r()}});Object.defineProperty(this,"beginning",{get:function(){return f},set:function(b){f=p(a(b,0),1);l=!0;r()}});Object.defineProperty(this,"ending",{get:function(){return j},set:function(b){j=p(a(b,0),1);l=!0;r()}});this.vertices=c.slice(0);_.each(this.vertices,function(a){a.bind(Two.Events.change,r)},this);r()};_.extend(c,{});_.extend(c.prototype,Two.Shape.prototype,{clone:function(){var a=_.map(this.vertices,function(a){return new Two.Vector(a.x,
a.y)}),b=new c(a,this.closed,this.curved);_.each(Two.Shape.Properties,function(a){b[a]=this[a]},this);b.translation.copy(this.translation);b.rotation=this.rotation;b.scale=this.scale;return b},remove:function(){if(!this.parent)return this;this.parent.remove(this);return this},getBoundingClientRect:function(){var a=this.linewidth,b=Infinity,c=-Infinity,f=Infinity,j=-Infinity;_.each(this.vertices,function(a){var d=a.x;a=a.y;f=Math.min(a,f);b=Math.min(d,b);c=Math.max(d,c);j=Math.max(a,j)});var f=f-a,
b=b-a,c=c+a,j=j+a,a=this._matrix.multiply(b,f,1),l=this._matrix.multiply(c,j,1);return{top:a.y,left:a.x,right:l.x,bottom:l.y,width:l.x-a.x,height:l.y-a.y}}})})();

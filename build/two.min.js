...
function(c){c.unbind(Two.Events.change,this._broadcast)},this);return this},clone:function(){c=this.controls;return new Two.Anchor(this.x,this.y,c&&c.left.x,c&&c.left.y,c&&c.right.x,c&&c.right.y,this.command)}})})();(function(){_.range(6);var C=Math.cos,q=Math.sin,n=Math.tan,c,m,r,f,l,t,y,w,x,u,s,k,D,E,v,A,z,F,a,b,h,e,H,B,G,I,J,M,Q,N,R,S,d,g,p,ea,V,W,$,ba,X,L,O,P,aa,ca,da,Y,T,Z=[],fa=Two.Matrix=function(a,b,c,e,d,f){this.elements=new Two.Array(9);var g=a;_.isArray(g)||(g=_.toArray(arguments));this.identity().set(g)};_.extend(fa,{Identity:[1,0,0,0,1,0,0,0,1],Multiply:function(d,g,f){if(3>=g.length)return k,D,E,c=g[0]||0,m=g[1]||0,r=g[2]||0,l=d,k=l[0]*c+l[1]*m+l[2]*r,D=l[3]*c+l[4]*m+l[5]*r,E=l[6]*c+l[7]*m+l[8]*
r,{x:k,y:D,z:E};v=d[0];A=d[1];z=d[2];F=d[3];a=d[4];b=d[5];h=d[6];e=d[7];H=d[8];B=g[0];G=g[1];I=g[2];J=g[3];M=g[4];Q=g[5];N=g[6];R=g[7];S=g[8];f=f||new Two.Array(9);f[0]=v*B+A*J+z*N;f[1]=v*G+A*M+z*R;f[2]=v*I+A*Q+z*S;f[3]=F*B+a*J+b*N;f[4]=F*G+a*M+b*R;f[5]=F*I+a*Q+b*S;f[6]=h*B+e*J+H*N;f[7]=h*G+e*M+H*R;f[8]=h*I+e*Q+H*S;return f}});_.extend(fa.prototype,Backbone.Events,{set:function(a,b,c,e,d,g){s=a;p=arguments.length;_.isArray(s)||(s=_.toArray(arguments));_.each(s,function(a,b){_.isNumber(a)&&(this.elements[b]=
...
2,y:s.top+s.height/2};_.each(this.vertices,function(a){a.subSelf(s.centroid)});return this},remove:function(){if(!this.parent)return this;this.parent.remove(this);return this},getBoundingClientRect:function(d){this.update();D=this.linewidth/2;void 0;E=Infinity;v=-Infinity;A=Infinity;z=-Infinity;_.each(this._vertices,function(b){F=b.x;a=b.y;A=C(a,A);E=C(F,E);v=q(F,v);z=q(a,z)});A-=D;E-=D;v+=D;z+=D;B=d?this._matrix:c(this);b=B.multiply(E,A,1);h=B.multiply(v,A,1);e=B.multiply(v,z,1);H=B.multiply(E,z,
1);A=C(b.y,h.y,e.y,H.y);E=C(b.x,h.x,e.x,H.x);v=q(b.x,h.x,e.x,H.x);z=q(b.y,h.y,e.y,H.y);return{top:A,left:E,right:v,bottom:z,width:v-E,height:z-A}},plot:function(){if(this.curved)return Two.Utils.getCurveFromPoints(this.vertices,this.closed),this;_.each(this.vertices,function(a,b){a._command=0===b?Two.Commands.move:Two.Commands.line},this);return this},subdivide:function(){l=this.vertices.length-1;t=this._closed||this.vertices[l].command===Two.Commands.close;x=[];_.each(this.vertices,function(a,b){0>=
b&&!t||(v=h.controls&&h.controls.right,E=a.controls&&a.controls.left,G=h.x,I=h.y,J=(v||h).x,M=(v||h).y,Q=(E||a).x,N=(E||a).y,R=a.x,S=a.y,x.push(Two.Utils.subdivide(G,I,J,M,Q,N,R,S)));h=a},this);this._curved=this._automatic=!1;this.vertices=_.flatten(x);this.plot();return this},update:function(){if(this._flagVertices)for(this._automatic&&this.plot(),m=this.vertices.length,l=m-1,r=n(this._beginning*l),f=n(this._ending*l),this._vertices.length=0,w=r;w<f+1;w++)y=this.vertices[w],this._vertices.push(y);

...
d+1;e++)c=this.vertices[e],this._vertices.push(c);this._automatic&&this.plot()}a.Shape.prototype._update.apply(this,arguments);return this},flagReset:function(){this._flagVertices=this._flagFill=this._flagStroke=this._flagLinewidth=this._flagOpacity=this._flagVisible=this._flagCap=this._flagJoin=this._flagMiter=this._flagClip=!1;a.Shape.prototype.flagReset.call(this);return this}});e.MakeObservable(e.prototype)})(this.Two);(function(a){var m=a.Path,l=a.Utils,k=a.Line=function(f,h,g,d){g=(g-f)/2;d=(d-h)/2;m.call(this,[new a.Anchor(-g,-d),new a.Anchor(g,d)]);this.translation.set(f+g,h+d)};l.extend(k.prototype,m.prototype);m.MakeObservable(k.prototype)})(this.Two);(function(a){var m=a.Path,l=a.Utils,k=a.Rectangle=function(f,h,g,d){m.call(this,[new a.Anchor,new a.Anchor,new a.Anchor,new a.Anchor],!0);this.width=g;this.height=d;this._update().flagReset();this.translation.set(f,h)};l.extend(k,{Properties:["width","height"],MakeObservable:function(f){m.MakeObservable(f);l.each(k.Properties,a.Utils.defineProperty,f)}});l.extend(k.prototype,m.prototype,{_width:0,_height:0,_flagWidth:0,_flagHeight:0,_update:function(){if(this._flagWidth||this._flagHeight){var a=this._width/
2,h=this._height/2;this.vertices[0].set(-a,-h);this.vertices[1].set(a,-h);this.vertices[2].set(a,h);this.vertices[3].set(-a,h)}m.prototype._update.call(this);return this},flagReset:function(){this._flagWidth=this._flagHeight=!1;m.prototype.flagReset.call(this);return this}});k.MakeObservable(k.prototype)})(this.Two);(function(a){var m=a.Path,l=2*Math.PI,k=Math.cos,f=Math.sin,h=a.Utils,g=a.Ellipse=function(d,e,f,c){h.isNumber(c)||(c=f);var g=h.map(h.range(a.Resolution),function(c){return new a.Anchor},this);m.call(this,g,!0,!0);this.width=2*f;this.height=2*c;this._update().flagReset();this.translation.set(d,e)};h.extend(g,{Properties:["width","height"],MakeObservable:function(d){m.MakeObservable(d);h.each(g.Properties,a.Utils.defineProperty,d)}});h.extend(g.prototype,m.prototype,{_width:0,_height:0,_flagWidth:!1,
_flagHeight:!1,_update:function(){if(this._flagWidth||this._flagHeight)for(var a=0,e=this.vertices.length;a<e;a++){var g=a/e*l,c=this._width*k(g)/2,g=this._height*f(g)/2;this.vertices[a].set(c,g)}m.prototype._update.call(this);return this},flagReset:function(){this._flagWidth=this._flagHeight=!1;m.prototype.flagReset.call(this);return this}});g.MakeObservable(g.prototype)})(this.Two);(function(a){var m=a.Path,l=2*Math.PI,k=Math.cos,f=Math.sin,h=a.Utils,g=a.Circle=function(d,e,f){var c=h.map(h.range(a.Resolution),function(c){return new a.Anchor},this);m.call(this,c,!0,!0);this.radius=f;this._update().flagReset();this.translation.set(d,e)};h.extend(g,{Properties:["radius"],MakeObservable:function(d){m.MakeObservable(d);h.each(g.Properties,a.Utils.defineProperty,d)}});h.extend(g.prototype,m.prototype,{_radius:0,_flagRadius:!1,_update:function(){if(this._flagRadius)for(var a=0,e=
this.vertices.length;a<e;a++){var g=a/e*l,c=this._radius*k(g),g=this._radius*f(g);this.vertices[a].set(c,g)}m.prototype._update.call(this);return this},flagReset:function(){this._flagRadius=!1;m.prototype.flagReset.call(this);return this}});g.MakeObservable(g.prototype)})(this.Two);(function(a){var m=a.Path,l=2*Math.PI,k=Math.cos,f=Math.sin,h=a.Utils,g=a.Polygon=function(d,e,f,c){c=Math.max(c||0,3);var g=h.map(h.range(c),function(c){return new a.Anchor});m.call(this,g,!0);this.width=2*f;this.height=2*f;this.sides=c;this._update().flagReset();this.translation.set(d,e)};h.extend(g,{Properties:["width","height","sides"],MakeObservable:function(d){m.MakeObservable(d);h.each(g.Properties,a.Utils.defineProperty,d)}});h.extend(g.prototype,m.prototype,{_width:0,_height:0,_sides:0,_flagWidth:!1,
...
g.MakeObservable(g.prototype)})(this.Two);(function(a){function m(a,e){for(;0>a;)a+=e;return a%e}var l=a.Path,k=2*Math.PI,f=Math.PI/2,h=a.Utils,g=a.ArcSegment=function(d,e,f,c,g,k,m){m=h.map(h.range(m||3*a.Resolution),function(){return new a.Anchor});l.call(this,m,!1,!1,!0);this.innerRadius=f;this.outerRadius=c;this.startAngle=g;this.endAngle=k;this._update().flagReset();this.translation.set(d,e)};h.extend(g,{Properties:["startAngle","endAngle","innerRadius","outerRadius"],MakeObservable:function(d){l.MakeObservable(d);h.each(g.Properties,
a.Utils.defineProperty,d)}});h.extend(g.prototype,l.prototype,{_flagStartAngle:!1,_flagEndAngle:!1,_flagInnerRadius:!1,_flagOuterRadius:!1,_startAngle:0,_endAngle:k,_innerRadius:0,_outerRadius:0,_update:function(){if(this._flagStartAngle||this._flagEndAngle||this._flagInnerRadius||this._flagOuterRadius){var d=this._startAngle,e=this._endAngle,g=this._innerRadius,c=this._outerRadius,h=m(d,k)===m(e,k),u=0<g,C=this.vertices,x=u?C.length/2:C.length,v,w=0;h?x--:u||(x-=2);for(var t=0,q=x-1;t<x;t++){var s=
t/q,n=C[w],s=s*(e-d)+d,y=(e-d)/x,z=c*Math.cos(s),B=c*Math.sin(s);switch(t){case 0:v=a.Commands.move;break;default:v=a.Commands.curve}n.command=v;n.x=z;n.y=B;n.controls.left.clear();n.controls.right.clear();n.command===a.Commands.curve&&(v=c*y/Math.PI,n.controls.left.x=v*Math.cos(s-f),n.controls.left.y=v*Math.sin(s-f),n.controls.right.x=v*Math.cos(s+f),n.controls.right.y=v*Math.sin(s+f),1===t&&n.controls.left.multiplyScalar(2),t===q&&n.controls.right.multiplyScalar(2));w++}if(u)for(h?(C[w].command=
a.Commands.close,w++):(x--,q=x-1),t=0;t<x;t++)s=t/q,n=C[w],s=(1-s)*(e-d)+d,y=(e-d)/x,z=g*Math.cos(s),B=g*Math.sin(s),v=a.Commands.curve,0>=t&&(v=h?a.Commands.move:a.Commands.line),n.command=v,n.x=z,n.y=B,n.controls.left.clear(),n.controls.right.clear(),n.command===a.Commands.curve&&(v=g*y/Math.PI,n.controls.left.x=v*Math.cos(s+f),n.controls.left.y=v*Math.sin(s+f),n.controls.right.x=v*Math.cos(s-f),n.controls.right.y=v*Math.sin(s-f),1===t&&n.controls.left.multiplyScalar(2),t===q&&n.controls.right.multiplyScalar(2)),
w++;else h||(C[w].command=a.Commands.line,C[w].x=0,C[w].y=0,w++);C[w].command=a.Commands.close}l.prototype._update.call(this);return this},flagReset:function(){l.prototype.flagReset.call(this);this._flagStartAngle=this._flagEndAngle=this._flagInnerRadius=this._flagOuterRadius=!1;return this}});g.MakeObservable(g.prototype)})(this.Two);(function(a){var m=a.Path,l=2*Math.PI,k=Math.cos,f=Math.sin,h=a.Utils,g=a.Star=function(d,e,f,c,g){h.isNumber(c)||(c=f/2);if(!h.isNumber(g)||0>=g)g=5;var k=h.map(h.range(2*g),function(c){return new a.Anchor});m.call(this,k,!0);this.innerRadius=c;this.outerRadius=f;this.sides=g;this._update().flagReset();this.translation.set(d,e)};h.extend(g,{Properties:["innerRadius","outerRadius","sides"],MakeObservable:function(d){m.MakeObservable(d);h.each(g.Properties,a.Utils.defineProperty,d)}});h.extend(g.prototype,
m.prototype,{_innerRadius:0,_outerRadius:0,_sides:0,_flagInnerRadius:!1,_flagOuterRadius:!1,_flagSides:!1,_update:function(){if(this._flagInnerRadius||this._flagOuterRadius||this._flagSides){var d=2*this._sides,e=this.vertices.length;e>d&&this.vertices.splice(d-1,e-d);for(var g=0;g<d;g++){var c=l*((g+0.5)/d),h=g%2?this._innerRadius:this._outerRadius,u=h*k(c),c=h*f(c);g>=e?this.vertices.push(new a.Anchor(u,c)):this.vertices[g].set(u,c)}}m.prototype._update.call(this);return this},flagReset:function(){this._flagInnerRadius=
this._flagOuterRadius=this._flagSides=!1;m.prototype.flagReset.call(this);return this}});g.MakeObservable(g.prototype)})(this.Two);(function(a){var m=a.Path,l=a.Utils,k=a.RoundedRectangle=function(f,h,g,d,e){l.isNumber(e)||(e=Math.floor(Math.min(g,d)/12));var k=l.map(l.range(10),function(c){return new a.Anchor(0,0,0,0,0,0,0===c?a.Commands.move:a.Commands.curve)});k[k.length-1].command=a.Commands.close;m.call(this,k,!1,!1,!0);this.width=g;this.height=d;this.radius=e;this._update().flagReset();this.translation.set(f,h)};l.extend(k,{Properties:["width","height","radius"],MakeObservable:function(f){m.MakeObservable(f);l.each(k.Properties,
a.Utils.defineProperty,f)}});l.extend(k.prototype,m.prototype,{_width:0,_height:0,_radius:0,_flagWidth:!1,_flagHeight:!1,_flagRadius:!1,_update:function(){if(this._flagWidth||this._flagHeight||this._flagRadius){var a=this._width,h=this._height,g=Math.min(Math.max(this._radius,0),Math.min(a,h)),a=a/2,d=h/2,h=this.vertices[0];h.x=-(a-g);h.y=-d;h=this.vertices[1];h.x=a-g;h.y=-d;h.controls.left.clear();h.controls.right.x=g;h.controls.right.y=0;h=this.vertices[2];h.x=a;h.y=-(d-g);h.controls.right.clear();
h.controls.left.clear();h=this.vertices[3];h.x=a;h.y=d-g;h.controls.left.clear();h.controls.right.x=0;h.controls.right.y=g;h=this.vertices[4];h.x=a-g;h.y=d;h.controls.right.clear();h.controls.left.clear();h=this.vertices[5];h.x=-(a-g);h.y=d;h.controls.left.clear();h.controls.right.x=-g;h.controls.right.y=0;h=this.vertices[6];h.x=-a;h.y=d-g;h.controls.left.clear();h.controls.right.clear();h=this.vertices[7];h.x=-a;h.y=-(d-g);h.controls.left.clear();h.controls.right.x=0;h.controls.right.y=-g;h=this.vertices[8];
h.x=-(a-g);h.y=-d;h.controls.left.clear();h.controls.right.clear();h=this.vertices[9];h.copy(this.vertices[8])}m.prototype._update.call(this);return this},flagReset:function(){this._flagWidth=this._flagHeight=this._flagRadius=!1;m.prototype.flagReset.call(this);return this}});k.MakeObservable(k.prototype)})(this.Two);(function(a){var m=a.Utils.getComputedMatrix,l=a.Utils;(this.document?this.document.createElement("canvas"):{getContext:l.identity}).getContext("2d");var k=a.Text=function(f,h,g,d){a.Shape.call(this);this._renderer.type="text";this._renderer.flagFill=l.bind(k.FlagFill,this);this._renderer.flagStroke=l.bind(k.FlagStroke,this);this.value=f;l.isNumber(h)&&(this.translation.x=h);l.isNumber(g)&&(this.translation.y=g);if(!l.isObject(d))return this;l.each(a.Text.Properties,function(a){a in d&&(this[a]=d[a])},

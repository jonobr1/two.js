...
b.source&&k.global==b.global&&k.multiline==b.multiline&&k.ignoreCase==b.ignoreCase}if("object"!=typeof k||"object"!=typeof b)return!1;for(var j=e.length;j--;)if(e[j]==k)return!0;e.push(k);var j=0,l=!0;if("[object Array]"==c){if(j=k.length,l=j==b.length)for(;j--&&(l=j in k==j in b&&q(k[j],b[j],e)););}else{if("constructor"in k!="constructor"in b||k.constructor!=b.constructor)return!1;for(var u in k)if(d.has(k,u)&&(j++,!(l=d.has(b,u)&&q(k[u],b[u],e))))break;if(l){for(u in b)if(d.has(b,u)&&!j--)break;
l=!j}}e.pop();return l}var f=this,n=f._,p={},m=Array.prototype,c=Object.prototype,b=m.slice,l=m.unshift,a=c.toString,e=c.hasOwnProperty,r=m.forEach,A=m.map,t=m.reduce,j=m.reduceRight,x=m.filter,B=m.every,z=m.some,s=m.indexOf,w=m.lastIndexOf,c=Array.isArray,u=Object.keys,v=Function.prototype.bind,d=function(k){return new I(k)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=d),exports._=d):f._=d;d.VERSION="1.3.3";var y=d.each=d.forEach=function(k,
a,b){if(null!=k)if(r&&k.forEach===r)k.forEach(a,b);else if(k.length===+k.length)for(var e=0,c=k.length;e<c&&!(e in k&&a.call(b,k[e],e,k)===p);e++);else for(e in k)if(d.has(k,e)&&a.call(b,k[e],e,k)===p)break};d.map=d.collect=function(k,a,d){var b=[];if(null==k)return b;if(A&&k.map===A)return k.map(a,d);y(k,function(k,e,c){b[b.length]=a.call(d,k,e,c)});k.length===+k.length&&(b.length=k.length);return b};d.reduce=d.foldl=d.inject=function(k,a,b,e){var c=2<arguments.length;null==k&&(k=[]);if(t&&k.reduce===
...
var D=d.some=d.any=function(k,a,b){a||(a=d.identity);var e=!1;if(null==k)return e;if(z&&k.some===z)return k.some(a,b);y(k,function(k,d,c){if(e||(e=a.call(b,k,d,c)))return p});return!!e};d.include=d.contains=function(k,a){var d=!1;return null==k?d:s&&k.indexOf===s?-1!=k.indexOf(a):d=D(k,function(k){return k===a})};d.invoke=function(k,a){var e=b.call(arguments,2);return d.map(k,function(k){return(d.isFunction(a)?a||k:k[a]).apply(k,e)})};d.pluck=function(k,a){return d.map(k,function(k){return k[a]})};
...
b,l){var a,e,m,f,t,j,p,q;if(!this._events||!n(this,"off",c,[b,l]))return this;if(!c&&!b&&!l)return this._events={},this;f=c?[c]:_.keys(this._events);t=0;for(j=f.length;t<j;t++)if(c=f[t],a=this._events[c]){m=[];if(b||l){p=0;for(q=a.length;p<q;p++)e=a[p],(b&&b!==(e.callback._callback||e.callback)||l&&l!==e.context)&&m.push(e)}this._events[c]=m}return this},trigger:function(c){if(!this._events)return this;var b=q.call(arguments,1);if(!n(this,"trigger",c,b))return this;var l=this._events[c],a=this._events.all;
...
return a})),d=new j.Vector,e=new j.Vector;return _.map(b,function(b){var c,l=!1,m=!1;b=_.flatten(_.map(b.match(/[a-z][^a-z]*/ig),function(a){var b,u,f=a[0],v=f.toLowerCase();c=a.slice(1).trim().split(/[\s,]+|(?=[+\-])/);l=f===v;var r,t,k;switch(v){case "z":m=!0;break;case "m":case "l":u=parseFloat(c[0]);b=parseFloat(c[1]);b=new j.Vector(u,b);l&&b.addSelf(d);d.copy(b);break;case "h":case "v":u="h"===v?"x":"y";a="x"===u?"y":"x";b=new j.Vector;b[u]=parseFloat(c[0]);b[a]=d[a];l&&(b[u]+=d[u]);d.copy(b);
break;case "s":case "c":b=d.x;a=d.y;"c"===v?(f=parseFloat(c[0]),u=parseFloat(c[1]),v=parseFloat(c[2]),r=parseFloat(c[3]),t=parseFloat(c[4]),k=parseFloat(c[5])):(r=(new j.Vector).copy(d).subSelf(e),f=parseFloat(r.x),u=parseFloat(r.y),v=parseFloat(c[0]),r=parseFloat(c[1]),t=parseFloat(c[2]),k=parseFloat(c[3]));l&&(f+=b,u+=a,v+=b,r+=a,t+=b,k+=a);b=j.Utils.subdivide(b,a,f,u,v,r,t,k);d.set(t,k);e.set(v,r);break;case "t":case "q":b=d.x;a=d.y;e.isZero()?(f=b,u=a):(f=e.x,a=e.y);"q"===v?(v=parseFloat(c[0]),
r=parseFloat(c[1]),t=parseFloat(c[1]),k=parseFloat(c[2])):(r=(new j.Vector).copy(d).subSelf(e),v=parseFloat(r.x),r=parseFloat(r.y),t=parseFloat(c[0]),k=parseFloat(c[1]));l&&(f+=b,u+=a,v+=b,r+=a,t+=b,k+=a);b=j.Utils.subdivide(b,a,f,u,v,r,t,k);d.set(t,k);e.set(v,r);break;case "a":throw new j.Utils.Error("not yet able to interpret Elliptical Arcs.");}return b}));_.isUndefined(b[b.length-1])&&b.pop();b=(new j.Polygon(b,m)).noStroke();return j.Utils.applySvgAttributes(a,b)})},circle:function(a){var b=
parseFloat(a.getAttribute("cx")),d=parseFloat(a.getAttribute("cy")),c=parseFloat(a.getAttribute("r")),l=j.Resolution,f=_.map(_.range(l),function(a){var b=a/l*e;a=c*m(b);b=c*p(b);return new j.Vector(a,b)},this),f=(new j.Polygon(f,!0,!0)).noStroke();f.translation.set(b,d);return j.Utils.applySvgAttributes(a,f)},ellipse:function(a){var b=parseFloat(a.getAttribute("cx")),d=parseFloat(a.getAttribute("cy")),c=parseFloat(a.getAttribute("rx")),l=parseFloat(a.getAttribute("ry")),f=j.Resolution,r=_.map(_.range(f),
function(a){var b=a/f*e;a=c*m(b);b=l*p(b);return new j.Vector(a,b)},this),r=(new j.Polygon(r,!0,!0)).noStroke();r.translation.set(b,d);return j.Utils.applySvgAttributes(a,r)},rect:function(a){var b=parseFloat(a.getAttribute("x")),d=parseFloat(a.getAttribute("y")),e=parseFloat(a.getAttribute("width")),c=parseFloat(a.getAttribute("height")),e=e/2,c=c/2,l=[new j.Vector(e,c),new j.Vector(-e,c),new j.Vector(-e,-c),new j.Vector(e,-c)],l=(new j.Polygon(l,!0)).noStroke();l.translation.set(b+e,d+c);return j.Utils.applySvgAttributes(a,
l)},line:function(a){var b=parseFloat(a.getAttribute("x1")),d=parseFloat(a.getAttribute("y1")),e=parseFloat(a.getAttribute("x2")),c=parseFloat(a.getAttribute("y2")),e=(e-b)/2,c=(c-d)/2,l=[new j.Vector(-e,-c),new j.Vector(e,c)],l=(new j.Polygon(l)).noFill();l.translation.set(b+e,d+c);return j.Utils.applySvgAttributes(a,l)}},subdivide:function(b,f,d,m,r,t,A,n,p){var x=j.Utils.Curve.CollinearityEpsilon,q=j.Utils.Curve.RecursionLimit,z=j.Utils.Curve.CuspLimit,B=j.Utils.Curve.Tolerance,s;p=p||0;if(p>q)return[];
var q=(b+d)/2,w=(f+m)/2,k=(d+r)/2,L=(m+t)/2,R=(r+A)/2,S=(t+n)/2,T=(q+k)/2,U=(w+L)/2,k=(k+R)/2,L=(L+S)/2,F=(T+k)/2,G=(U+L)/2;s=A-b;var C=n-f,J=l((d-A)*C-(m-n)*s),K=l((r-A)*C-(t-n)*s);if(0<p){if(J>x&&K>x&&(J+K)*(J+K)<=B.distance*(s*s+C*C)){if(B.angle<B.epsilon)return[new j.Vector(F,G)];s=c(t-m,r-d);x=l(s-c(m-f,d-b));s=l(c(n-t,A-r)-s);x>=a&&(x=e-x);s>=a&&(s=e-s);if(x+s<B.angle)return[new j.Vector(F,G)];if(0!==z){if(x>z)return[new j.Vector(d,m)];if(s>z)return[new j.Vector(r,t)]}}}else if(J>x)if(J*J<=
B.distance*(s*s+C*C)){if(B.angle<B.epsilon)return[new j.Vector(F,G)];x=l(c(t-m,r-d)-c(m-f,d-b));x>=a&&(x=e-x);if(x<B.angle)return[new j.Vector(d,m),new j.Vector(r,t)];if(0!==z&&x>z)return[new j.Vector(d,m)]}else if(K>x){if(K*K<=B.distance*(s*s+C*C)){if(B.angle<B.epsilon)return[new j.Vector(F,G)];x=l(c(n-t,A-r)-c(t-m,r-d));x>=a&&(x=e-x);if(x<B.angle)return[new j.Vector(d,m),new j.Vector(r,t)];if(0!==z&&x>z)return[new j.Vector2(r,t)]}}else if(s=F-(b+A)/2,C=G-(f+n)/2,s*s+C*C<=B.distance)return[new j.Vector(F,
G)];return j.Utils.subdivide(b,f,q,w,T,U,F,G,p+1).concat(j.Utils.subdivide(F,G,k,L,R,S,A,n,p+1))},getCurveFromPoints:function(a,b){for(var d=[],e=a.length,c=e-1,j=0;j<e;j++){var l=a[j],m={x:l.x,y:l.y};d.push(m);var l=b?w(j-1,e):Math.max(j-1,0),f=b?w(j+1,e):Math.min(j+1,c);s(a[l],m,a[f]);!m.u.x&&!m.u.y&&(m.u.x=m.x,m.u.y=m.y);!m.v.x&&!m.v.y&&(m.v.x=m.x,m.v.y=m.y)}return d},getControlPoints:function(b,e,d){var c=z(b,e),j=z(d,e);b=x(b,e);d=x(d,e);var l=(c+j)/2;if(1E-4>b||1E-4>d)return e.u={x:e.x,y:e.y},
e.v={x:e.x,y:e.y},e;b*=0.33;d*=0.33;l=j<c?l+r:l-r;c={x:e.x+m(l)*b,y:e.y+p(l)*b};l-=a;j={x:e.x+m(l)*d,y:e.y+p(l)*d};e.u=c;e.v=j;return e},angleBetween:function(a,b){return c(a.y-b.y,a.x-b.x)},distanceBetweenSquared:function(a,b){var d=a.x-b.x,e=a.y-b.y;return d*d+e*e},distanceBetween:function(a,e){return b(B(a,e))},mod:function(a,b){for(;0>a;)a+=b;return a%b},Error:function(a){this.name="two.js";this.message=a}}});j.Utils.Error.prototype=Error();j.Utils.Error.prototype.constructor=j.Utils.Error;var x=
j.Utils.distanceBetween,B=j.Utils.distanceBetweenSquared,z=j.Utils.angleBetween,s=j.Utils.getControlPoints,w=j.Utils.mod;_.extend(j.prototype,Backbone.Events,{appendTo:function(a){a.appendChild(this.renderer.domElement);return this},play:function(){j.Utils.setPlaying.call(this,!0);return this.trigger(j.Events.play)},pause:function(){this.playing=!1;return this.trigger(j.Events.pause)},update:function(){this.frameCount++;var a=!!this.timeDelta;this.timeDelta=a?(window.performance&&window.performance.now?
window.performance:Date).now()-this.timeDelta:(window.performance&&window.performance.now?window.performance:Date).now();var b=this.width,d=this.height,e=this.renderer;(b!==e.width||d!==e.height)&&e.setSize(b,d);this.trigger(j.Events.update,this.frameCount,a?this.timeDelta:void 0);return this.render()},render:function(){this.renderer.render();return this.trigger(j.Events.render,this.frameCount)},add:function(a){var b=a;_.isArray(a)||(b=_.toArray(arguments));this.scene.add(b);return this},makeLine:function(a,
b,d,e){d=(d-a)/2;e=(e-b)/2;var c=[new j.Vector(-d,-e),new j.Vector(d,e)],c=(new j.Polygon(c)).noFill();c.translation.set(a+d,b+e);this.scene.add(c);return c},makeRectangle:function(a,b,d,e){d/=2;e/=2;e=[new j.Vector(d,e),new j.Vector(-d,e),new j.Vector(-d,-e),new j.Vector(d,-e)];e=new j.Polygon(e,!0);e.translation.set(a,b);this.scene.add(e);return e},makeCircle:function(a,b,d){return this.makeEllipse(a,b,d,d)},makeEllipse:function(a,b,d,c){var l=j.Resolution,f=_.map(_.range(l),function(a){var b=a/
l*e;a=d*m(b);b=c*p(b);return new j.Vector(a,b)},this),f=new j.Polygon(f,!0,!0);f.translation.set(a,b);this.scene.add(f);return f},makeCurve:function(a){var b=arguments.length,d=a;if(!_.isArray(a))for(var d=[],e=0;e<b;e+=2){var c=arguments[e];if(!_.isNumber(c))break;d.push(new j.Vector(c,arguments[e+1]))}var b=arguments[b-1],d=new j.Polygon(d,!(_.isBoolean(b)&&b),!0),b=d.getBoundingClientRect(),l=b.left+b.width/2,m=b.top+b.height/2;_.each(d.vertices,function(a){a.x-=l;a.y-=m});d.translation.set(l,
m);this.scene.add(d);return d},makePolygon:function(a){var b=arguments.length,e=a;if(!_.isArray(a))for(var e=[],c=0;c<b;c+=2){var l=arguments[c];if(!_.isNumber(l))break;e.push(new j.Vector(l,arguments[c+1]))}b=arguments[b-1];e=new j.Polygon(e,!(_.isBoolean(b)&&b));e.center();this.scene.add(e);return e},makeGroup:function(a){var b=a;_.isArray(a)||(b=_.toArray(arguments));var e=new j.Group;this.scene.add(e);e.add(b);return e},interpret:function(a){var b=a.tagName.toLowerCase();if(!(b in j.Utils.read))return null;
a=j.Utils.read[b].call(this,a);this.add(a);return a}});(function(){_.each(j.Instances,function(a){a.playing&&a.update()});requestAnimationFrame(arguments.callee)})()})();(function(){var q=Two.Vector=function(f,n){f=f||0;n=n||0;Object.defineProperty(this,"x",{get:function(){return f},set:function(n){f=n;this.trigger("change","x")}});Object.defineProperty(this,"y",{get:function(){return n},set:function(f){n=f;this.trigger("change","y")}})};_.extend(q,{});_.extend(q.prototype,Backbone.Events,{set:function(f,n){this.x=f;this.y=n;return this},copy:function(f){this.x=f.x;this.y=f.y;return this},clear:function(){this.y=this.x=0;return this},clone:function(){return new q(this.x,
...
n+this.x,(f.y-this.y)*n+this.y)},isZero:function(){return 1E-4>this.length()}})})();(function(){_.range(6);var q=Math.cos,f=Math.sin,n=Math.tan,p=Two.Matrix=function(m,c,b,l,a,e){this.elements=new Two.Array(9);var f=m;_.isArray(f)||(f=_.toArray(arguments));this.identity().set(f)};_.extend(p,{Identity:[1,0,0,0,1,0,0,0,1],Multiply:function(m,c){if(3>=c.length){var b=c[0]||0,l=c[1]||0,a=c[2]||0;return{x:m[0]*b+m[1]*l+m[2]*a,y:m[3]*b+m[4]*l+m[5]*a,z:m[6]*b+m[7]*l+m[8]*a}}var b=m[0],l=m[1],a=m[2],e=m[3],f=m[4],A=m[5],t=m[6],j=m[7],n=m[8],p=c[0],q=c[1],s=c[2],w=c[3],u=c[4],v=c[5],d=c[6],
y=c[7],D=c[8];return[b*p+l*w+a*d,b*q+l*u+a*y,b*s+l*v+a*D,e*p+f*w+A*d,e*q+f*u+A*y,e*s+f*v+A*D,t*p+j*w+n*d,t*q+j*u+n*y,t*s+j*v+n*D]}});_.extend(p.prototype,{set:function(m,c,b,l,a,e){var f=m;_.isArray(f)||(f=_.toArray(arguments));_.each(f,function(a,b){_.isNumber(a)&&(this.elements[b]=a)},this);return this},identity:function(){this.set(p.Identity);return this},multiply:function(f,c,b,l,a,e,r,A,t){var j=arguments,n=j.length;if(1>=n)return _.each(this.elements,function(a,b){this.elements[b]=a*f},this),
this;if(3>=n)return f=f||0,c=c||0,b=b||0,a=this.elements,{x:a[0]*f+a[1]*c+a[2]*b,y:a[3]*f+a[4]*c+a[5]*b,z:a[6]*f+a[7]*c+a[8]*b};n=this.elements;A0=n[0];A1=n[1];A2=n[2];A3=n[3];A4=n[4];A5=n[5];A6=n[6];A7=n[7];A8=n[8];B0=j[0];B1=j[1];B2=j[2];B3=j[3];B4=j[4];B5=j[5];B6=j[6];B7=j[7];B8=j[8];this.elements[0]=A0*B0+A1*B3+A2*B6;this.elements[1]=A0*B1+A1*B4+A2*B7;this.elements[2]=A0*B2+A1*B5+A2*B8;this.elements[3]=A3*B0+A4*B3+A5*B6;this.elements[4]=A3*B1+A4*B4+A5*B7;this.elements[5]=A3*B2+A4*B5+A5*B8;this.elements[6]=
...
var p=function(b){_.each(b,function(b,a){this[a]=b},this)};_.extend(p.prototype,{render:function(b){var c=this.matrix,a=this.stroke,e=this.linewidth,m=this.fill,n=this.opacity,t=this.cap,j=this.join,p=this.miter,q=this.curved,z=this.closed,s=this.commands,w=s.length,u=w-1;if(!this.visible)return this;b.save();c&&b.transform(c[0],c[1],c[2],c[3],c[4],c[5]);m&&(b.fillStyle=m);a&&(b.strokeStyle=a);e&&(b.lineWidth=e);p&&(b.miterLimit=p);j&&(b.lineJoin=j);t&&(b.lineCap=t);_.isNumber(n)&&(b.globalAlpha=
n);b.beginPath();_.each(s,function(a,e){var c=a.x.toFixed(3),j=a.y.toFixed(3);if(q){var l=z?f(e-1,w):Math.max(e-1,0),m=z?f(e+1,w):Math.min(e+1,u),n=s[l],m=s[m],l=n.v.x.toFixed(3),n=n.v.y.toFixed(3),t=a.u.x.toFixed(3),r=a.u.y.toFixed(3);0>=e?b.moveTo(c,j):(b.bezierCurveTo(l,n,t,r,c,j),e>=u&&z&&(l=a.v.x.toFixed(3),n=a.v.y.toFixed(3),t=m.u.x.toFixed(3),r=m.u.y.toFixed(3),c=m.x.toFixed(3),j=m.y.toFixed(3),b.bezierCurveTo(l,n,t,r,c,j)))}else 0>=e?b.moveTo(c,j):b.lineTo(c,j)});z&&!q&&b.closePath();b.fill();
b.stroke();b.restore()}});var m={toArray:function(b,c,a){return!c?_.map(b,function(a){return{x:a.x,y:a.y}}):q(b,a)}},c=Two[Two.Types.canvas]=function(){this.count=0;this.domElement=document.createElement("canvas");this.ctx=this.domElement.getContext("2d");this.elements=[];this.stage=null};_.extend(c,{});_.extend(c,{Group:n,Element:p,getStyles:function(b){var c={},a=b.id,e=b._matrix,f=b.stroke,n=b.linewidth,t=b.fill,j=b.opacity,p=b.visible,q=b.cap,z=b.join,s=b.miter,w=b.curved,u=b.closed;b=b.vertices;
a&&(c.id=a);_.isObject(e)&&(c.matrix=e.toArray());f&&(c.stroke=f);t&&(c.fill=t);_.isNumber(j)&&(c.opacity=j);q&&(c.cap=q);z&&(c.join=z);s&&(c.miter=s);n&&(c.linewidth=n);b&&(c.commands=m.toArray(b,w,u));c.visible=!!p;c.curved=!!w;c.closed=!!u;return c},setStyles:function(b,c,a,e,f){switch(c){case "matrix":c="matrix";a=a.toArray();break;case "vertices":c="commands",b.curved=f,b.closed=e,a=m.toArray(a,b.curved,b.closed)}b[c]=a},Utils:m});_.extend(c.prototype,Backbone.Events,{setSize:function(b,c){this.width=
...
a.top,c=a.left,f=a.right;a=a.bottom;return new Two.Array([c,b,f,b,c,a,c,a,f,b,f,a])},updateCanvas:function(a){var b=a.commands,c=this.canvas,f=this.ctx,l=a._scale,j=a.stroke,m=a.linewidth*l,n=a.fill,q=a.opacity,s=a.cap,w=a.join,u=a.miter,v=a.curved,d=a.closed,y=b.length,D=y-1;c.width=Math.max(Math.ceil(a.rect.width*l),1);c.height=Math.max(Math.ceil(a.rect.height*l),1);a=a.rect.centroid;var E=a.x*l,H=a.y*l;f.clearRect(0,0,c.width,c.height);n&&(f.fillStyle=n);j&&(f.strokeStyle=j);m&&(f.lineWidth=m);
u&&(f.miterLimit=u);w&&(f.lineJoin=w);s&&(f.lineCap=s);_.isNumber(q)&&(f.globalAlpha=q);f.beginPath();_.each(b,function(a,c){var j=(a.x*l+E).toFixed(3),m=(a.y*l+H).toFixed(3);if(v){var n=d?p(c-1,y):Math.max(c-1,0),r=d?p(c+1,y):Math.min(c+1,D),q=b[n],r=b[r],n=(q.v.x*l+E).toFixed(3),q=(q.v.y*l+H).toFixed(3),s=(a.u.x*l+E).toFixed(3),k=(a.u.y*l+H).toFixed(3);0>=c?f.moveTo(j,m):(f.bezierCurveTo(n,q,s,k,j,m),c>=D&&d&&(n=(a.v.x*l+E).toFixed(3),q=(a.v.y*l+H).toFixed(3),s=(r.u.x*l+E).toFixed(3),k=(r.u.y*l+
H).toFixed(3),j=(r.x*l+E).toFixed(3),m=(r.y*l+H).toFixed(3),f.bezierCurveTo(n,q,s,k,j,m)))}else 0>=c?f.moveTo(j,m):f.lineTo(j,m)});d&&!v&&f.closePath();f.fill();f.stroke()},updateTexture:function(a,b){this.updateCanvas(b);b.texture&&a.deleteTexture(b.texture);a.bindBuffer(a.ARRAY_BUFFER,b.textureCoordsBuffer);b.texture=a.createTexture();a.bindTexture(a.TEXTURE_2D,b.texture);a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_S,a.CLAMP_TO_EDGE);a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_T,a.CLAMP_TO_EDGE);

...
m=!f}}d.pop();return m}var k=this,l=k._,p={},j=Array.prototype,c=Object.prototype,b=j.slice,f=j.unshift,a=c.toString,d=c.hasOwnProperty,y=j.forEach,u=j.map,s=j.reduce,m=j.reduceRight,B=j.filter,I=j.every,r=j.some,v=j.indexOf,t=j.lastIndexOf,c=Array.isArray,x=Object.keys,z=Function.prototype.bind,e=function(n){return new J(n)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=e),exports._=e):k._=e;e.VERSION="1.3.3";var w=e.each=e.forEach=function(n,
a,b){if(null!=n)if(y&&n.forEach===y)n.forEach(a,b);else if(n.length===+n.length)for(var d=0,c=n.length;d<c&&!(d in n&&a.call(b,n[d],d,n)===p);d++);else for(d in n)if(e.has(n,d)&&a.call(b,n[d],d,n)===p)break};e.map=e.collect=function(n,a,e){var b=[];if(null==n)return b;if(u&&n.map===u)return n.map(a,e);w(n,function(n,d,c){b[b.length]=a.call(e,n,d,c)});n.length===+n.length&&(b.length=n.length);return b};e.reduce=e.foldl=e.inject=function(n,a,b,d){var c=2<arguments.length;null==n&&(n=[]);if(s&&n.reduce===
s)return d&&(a=e.bind(a,d)),c?n.reduce(a,b):n.reduce(a);w(n,function(n,e,f){c?b=a.call(d,b,n,e,f):(b=n,c=!0)});if(!c)throw new TypeError("Reduce of empty array with no initial value");return b};e.reduceRight=e.foldr=function(n,a,b,d){var c=2<arguments.length;null==n&&(n=[]);if(m&&n.reduceRight===m)return d&&(a=e.bind(a,d)),c?n.reduceRight(a,b):n.reduceRight(a);var f=e.toArray(n).reverse();d&&!c&&(a=e.bind(a,d));return c?e.reduce(f,a,b,d):e.reduce(f,a)};e.find=e.detect=function(a,e,b){var d;D(a,function(a,
n,c){if(e.call(b,a,n,c))return d=a,!0});return d};e.filter=e.select=function(a,e,b){var d=[];if(null==a)return d;if(B&&a.filter===B)return a.filter(e,b);w(a,function(a,n,c){e.call(b,a,n,c)&&(d[d.length]=a)});return d};e.reject=function(a,e,b){var d=[];if(null==a)return d;w(a,function(a,n,c){e.call(b,a,n,c)||(d[d.length]=a)});return d};e.every=e.all=function(a,e,b){var d=!0;if(null==a)return d;if(I&&a.every===I)return a.every(e,b);w(a,function(a,n,c){if(!(d=d&&e.call(b,a,n,c)))return p});return!!d};
var D=e.some=e.any=function(a,b,d){b||(b=e.identity);var c=!1;if(null==a)return c;if(r&&a.some===r)return a.some(b,d);w(a,function(a,n,e){if(c||(c=b.call(d,a,n,e)))return p});return!!c};e.include=e.contains=function(a,e){var b=!1;return null==a?b:v&&a.indexOf===v?-1!=a.indexOf(e):b=D(a,function(a){return a===e})};e.invoke=function(a,d){var c=b.call(arguments,2);return e.map(a,function(a){return(e.isFunction(d)?d||a:a[d]).apply(a,c)})};e.pluck=function(a,b){return e.map(a,function(a){return a[b]})};
e.max=function(a,b,d){if(!b&&e.isArray(a)&&a[0]===+a[0])return Math.max.apply(Math,a);if(!b&&e.isEmpty(a))return-Infinity;var c={computed:-Infinity};w(a,function(a,n,e){n=b?b.call(d,a,n,e):a;n>=c.computed&&(c={value:a,computed:n})});return c.value};e.min=function(a,b,d){if(!b&&e.isArray(a)&&a[0]===+a[0])return Math.min.apply(Math,a);if(!b&&e.isEmpty(a))return Infinity;var c={computed:Infinity};w(a,function(a,n,e){n=b?b.call(d,a,n,e):a;n<c.computed&&(c={value:a,computed:n})});return c.value};e.shuffle=
function(a){var b=[],e;w(a,function(a,n){e=Math.floor(Math.random()*(n+1));b[n]=b[e];b[e]=a});return b};e.sortBy=function(a,b,d){var c=e.isFunction(b)?b:function(a){return a[b]};return e.pluck(e.map(a,function(a,n,b){return{value:a,criteria:c.call(d,a,n,b)}}).sort(function(a,n){var b=a.criteria,e=n.criteria;return void 0===b?1:void 0===e?-1:b<e?-1:b>e?1:0}),"value")};e.groupBy=function(a,b){var d={},c=e.isFunction(b)?b:function(a){return a[b]};w(a,function(a,n){var b=c(a,n);(d[b]||(d[b]=[])).push(a)});
...
w(d,function(b){a[b]=e.bind(a[b],a)});return a};e.memoize=function(a,b){var d={};b||(b=e.identity);return function(){var c=b.apply(this,arguments);return e.has(d,c)?d[c]:d[c]=a.apply(this,arguments)}};e.delay=function(a,e){var d=b.call(arguments,2);return setTimeout(function(){return a.apply(null,d)},e)};e.defer=function(a){return e.delay.apply(e,[a,1].concat(b.call(arguments,1)))};e.throttle=function(a,b){var d,c,f,m,j,x,k=e.debounce(function(){j=m=!1},b);return function(){d=this;c=arguments;f||
(f=setTimeout(function(){f=null;j&&a.apply(d,c);k()},b));m?j=!0:x=a.apply(d,c);k();m=!0;return x}};e.debounce=function(a,b,e){var d;return function(){var c=this,f=arguments;e&&!d&&a.apply(c,f);clearTimeout(d);d=setTimeout(function(){d=null;e||a.apply(c,f)},b)}};e.once=function(a){var b=!1,e;return function(){if(b)return e;b=!0;return e=a.apply(this,arguments)}};e.wrap=function(a,e){return function(){var d=[a].concat(b.call(arguments,0));return e.apply(this,d)}};e.compose=function(){var a=arguments;
return function(){for(var b=arguments,e=a.length-1;0<=e;e--)b=[a[e].apply(this,b)];return b[0]}};e.after=function(a,b){return 0>=a?b():function(){if(1>--a)return b.apply(this,arguments)}};e.keys=x||function(a){if(a!==Object(a))throw new TypeError("Invalid object");var b=[],d;for(d in a)e.has(a,d)&&(b[b.length]=d);return b};e.values=function(a){return e.map(a,e.identity)};e.functions=e.methods=function(a){var b=[],d;for(d in a)e.isFunction(a[d])&&b.push(d);return b.sort()};e.extend=function(a){w(b.call(arguments,
1),function(b){for(var e in b)a[e]=b[e]});return a};e.pick=function(a){var d={};w(e.flatten(b.call(arguments,1)),function(b){b in a&&(d[b]=a[b])});return d};e.defaults=function(a){w(b.call(arguments,1),function(b){for(var e in b)null==a[e]&&(a[e]=b[e])});return a};e.clone=function(a){return!e.isObject(a)?a:e.isArray(a)?a.slice():e.extend({},a)};e.tap=function(a,b){b(a);return a};e.isEqual=function(a,b){return q(a,b,[])};e.isEmpty=function(a){if(null==a)return!0;if(e.isArray(a)||e.isString(a))return 0===
...
e.chain=function(a){return e(a).chain()};var J=function(a){this._wrapped=a};e.prototype=J.prototype;var N=function(a,b){return b?e(a).chain():a};e.mixin(e);w("pop push reverse shift sort splice unshift".split(" "),function(a){var b=j[a];J.prototype[a]=function(){var e=this._wrapped;b.apply(e,arguments);var d=e.length;("shift"==a||"splice"==a)&&0===d&&delete e[0];return N(e,this._chain)}});w(["concat","join","slice"],function(a){var b=j[a];J.prototype[a]=function(){return N(b.apply(this._wrapped,arguments),
...
position:"fixed"}),s.bind(window,"resize",a),a()):(this.renderer.setSize(a.width,a.height),this.width=a.width,this.height=a.height);this.scene=new m.Group;this.renderer.add(this.scene);m.Instances.push(this)};_.extend(m,{Array:k.Float32Array||Array,Types:{webgl:"WebGLRenderer",svg:"SVGRenderer",canvas:"CanvasRenderer"},Properties:{hierarchy:"hierarchy",demotion:"demotion"},Events:{play:"play",pause:"pause",update:"update",render:"render",resize:"resize",change:"change"},Resolution:8,Instances:[],
noConflict:function(){k.Two=l;return this},Utils:{Curve:{CollinearityEpsilon:u(10,-30),RecursionLimit:32,CuspLimit:0,Tolerance:{distance:0.25,angle:0,epsilon:0.01}},subdivide:function(b,j,e,k,y,s,u,l,B){var p=m.Utils.Curve.CollinearityEpsilon,q=m.Utils.Curve.CuspLimit,r=m.Utils.Curve.Tolerance;B=B||0;var I=(b+e)/2,v=(j+k)/2,t=(e+y)/2,n=(k+s)/2,R=(y+u)/2,S=(s+l)/2,T=(I+t)/2,U=(v+n)/2,t=(t+R)/2,n=(n+S)/2,F=(T+t)/2,G=(U+n)/2;if(0<B){var A=u-b,C=l-j,K=f((e-u)*C-(k-l)*A),L=f((y-u)*C-(s-l)*A);if(K>p&&L>
p&&(K+L)*(K+L)<=r.distance*(A*A+C*C)){if(r.angle<r.epsilon)return[new m.Vector(F,G)];A=c(s-k,y-e);p=f(A-c(k-j,e-b));A=f(c(l-s,u-y)-A);p>=a&&(p=d-p);A>=a&&(A=d-A);if(p+A<r.angle)return[new m.Vector(F,G)];if(0!==q){if(p>q)return[new m.Vector(e,k)];if(A>q)return[new m.Vector(y,s)]}}}else if(K>p)if(K*K<=r.distance*(A*A+C*C)){if(r.angle<r.epsilon)return[new m.Vector(F,G)];p=f(c(s-k,y-e)-c(k-j,e-b));p>=a&&(p=d-p);if(p<r.angle)return[new m.Vector(e,k),new m.Vector(y,s)];if(0!==q&&p>q)return[new m.Vector(e,
k)]}else if(L>p){if(L*L<=r.distance*(A*A+C*C)){if(r.angle<r.epsilon)return[new m.Vector(F,G)];p=f(c(l-s,u-y)-c(s-k,y-e));p>=a&&(p=d-p);if(p<r.angle)return[new m.Vector(e,k),new m.Vector(y,s)];if(0!==q&&p>q)return[new m.Vector2(y,s)]}}else if(A=F-(b+u)/2,C=G-(j+l)/2,A*A+C*C<=r.distance)return[new m.Vector(F,G)];return m.Utils.subdivide(b,j,I,v,T,U,F,G,B+1).concat(m.Utils.subdivide(F,G,t,n,R,S,u,l,B+1))},getCurveFromPoints:function(a,b){for(var e=[],d=a.length,c=d-1,f=0;f<d;f++){var m=a[f],j={x:m.x,
y:m.y};e.push(j);var m=b?t(f-1,d):Math.max(f-1,0),k=b?t(f+1,d):Math.min(f+1,c);v(a[m],j,a[k]);!j.u.x&&!j.u.y&&(j.u.x=j.x,j.u.y=j.y);!j.v.x&&!j.v.y&&(j.v.x=j.x,j.v.y=j.y)}return e},getControlPoints:function(b,d,e){var c=r(b,d),f=r(e,d);b=B(b,d);e=B(e,d);var m=(c+f)/2;if(1E-4>b||1E-4>e)return d.u={x:d.x,y:d.y},d.v={x:d.x,y:d.y},d;b*=0.33;e*=0.33;m=f<c?m+y:m-y;c={x:d.x+j(m)*b,y:d.y+p(m)*b};m-=a;f={x:d.x+j(m)*e,y:d.y+p(m)*e};d.u=c;d.v=f;return d},angleBetween:function(a,b){return c(a.y-b.y,a.x-b.x)},
distanceBetweenSquared:function(a,b){var d=a.x-b.x,c=a.y-b.y;return d*d+c*c},distanceBetween:function(a,d){return b(I(a,d))},mod:function(a,b){for(;0>a;)a+=b;return a%b},Error:function(a){this.name="two.js";this.message=a}}});m.Utils.Error.prototype=Error();m.Utils.Error.prototype.constructor=m.Utils.Error;var B=m.Utils.distanceBetween,I=m.Utils.distanceBetweenSquared,r=m.Utils.angleBetween,v=m.Utils.getControlPoints,t=m.Utils.mod;_.extend(m.prototype,Backbone.Events,{appendTo:function(a){a.appendChild(this.renderer.domElement);
return this},play:function(){this.playing=!0;return this.trigger(m.Events.play)},pause:function(){this.playing=!1;return this.trigger(m.Events.pause)},update:function(){this.frameCount++;var a=this.width,b=this.height,d=this.renderer;(a!==d.width||b!==d.height)&&d.setSize(a,b);return this.trigger(m.Events.update,this.frameCount)},render:function(){this.renderer.render();return this.trigger(m.Events.render,this.frameCount)},add:function(a){var b=a;_.isArray(a)||(b=_.toArray(arguments));this.scene.add(b);
return this},makeLine:function(a,b,d,c){d=(d-a)/2;c=(c-b)/2;var f=[new m.Vector(-d,-c),new m.Vector(d,c)],f=(new m.Polygon(f)).noFill();f.translation.set(a+d,b+c);this.scene.add(f);return f},makeRectangle:function(a,b,d,c){d/=2;c/=2;c=[new m.Vector(d,c),new m.Vector(-d,c),new m.Vector(-d,-c),new m.Vector(d,-c)];c=new m.Polygon(c,!0);c.translation.set(a,b);this.scene.add(c);return c},makeCircle:function(a,b,d){return this.makeEllipse(a,b,d,d)},makeEllipse:function(a,b,e,c){var f=m.Resolution,k=_.map(_.range(f),
function(a){var b=a/f*d;a=e*j(b);b=c*p(b);return new m.Vector(a,b)},this),k=new m.Polygon(k,!0,!0);k.translation.set(a,b);this.scene.add(k);return k},makeCurve:function(a){var b=arguments.length,d=a;if(!_.isArray(a))for(var d=[],c=0;c<b;c+=2){var f=arguments[c];if(!_.isNumber(f))break;d.push(new m.Vector(f,arguments[c+1]))}var b=arguments[b-1],d=new m.Polygon(d,!(_.isBoolean(b)&&b),!0),b=d.getBoundingClientRect(),j=b.left+b.width/2,k=b.top+b.height/2;_.each(d.vertices,function(a){a.x-=j;a.y-=k});
d.translation.set(j,k);this.scene.add(d);return d},makePolygon:function(a){var b=arguments.length,d=a;if(!_.isArray(a))for(var d=[],c=0;c<b;c+=2){var f=arguments[c];if(!_.isNumber(f))break;d.push(new m.Vector(f,arguments[c+1]))}b=arguments[b-1];d=new m.Polygon(d,!(_.isBoolean(b)&&b));d.center();this.scene.add(d);return d},makeGroup:function(a){var b=a;_.isArray(a)||(b=_.toArray(arguments));var d=new m.Group;this.scene.add(d);d.add(b);return d}});(function(){_.each(m.Instances,function(a){a.playing&&
a.update().render()});requestAnimationFrame(arguments.callee)})()})();(function(){var q=Two.Vector=function(k,l){k=k||0;l=l||0;Object.defineProperty(this,"x",{get:function(){return k},set:function(l){k=l;this.trigger("change","x")}});Object.defineProperty(this,"y",{get:function(){return l},set:function(k){l=k;this.trigger("change","y")}})};_.extend(q,{});_.extend(q.prototype,Backbone.Events,{set:function(k,l){this.x=k;this.y=l;return this},copy:function(k){this.x=k.x;this.y=k.y;return this},clear:function(){this.y=this.x=0;return this},clone:function(){return new q(this.x,
...
l+this.x,(k.y-this.y)*l+this.y)},isZero:function(){return 1E-4>this.length()}})})();(function(){_.range(6);var q=Math.cos,k=Math.sin,l=Math.tan,p=Two.Matrix=function(j,c,b,f,a,d){this.elements=new Two.Array(9);var k=j;_.isArray(k)||(k=_.toArray(arguments));this.identity().set(k)};_.extend(p,{Identity:[1,0,0,0,1,0,0,0,1],Multiply:function(j,c){if(3>=c.length){var b=c[0]||0,f=c[1]||0,a=c[2]||0;return{x:j[0]*b+j[1]*f+j[2]*a,y:j[3]*b+j[4]*f+j[5]*a,z:j[6]*b+j[7]*f+j[8]*a}}var b=j[0],f=j[1],a=j[2],d=j[3],k=j[4],u=j[5],s=j[6],m=j[7],l=j[8],p=c[0],r=c[1],q=c[2],t=c[3],x=c[4],z=c[5],e=c[6],
w=c[7],D=c[8];return[b*p+f*t+a*e,b*r+f*x+a*w,b*q+f*z+a*D,d*p+k*t+u*e,d*r+k*x+u*w,d*q+k*z+u*D,s*p+m*t+l*e,s*r+m*x+l*w,s*q+m*z+l*D]}});_.extend(p.prototype,{set:function(j,c,b,f,a,d){var k=j;_.isArray(k)||(k=_.toArray(arguments));_.each(k,function(a,b){_.isNumber(a)&&(this.elements[b]=a)},this);return this},identity:function(){this.set(p.Identity);return this},multiply:function(j,c,b,f,a,d,k,u,s){var m=arguments,l=m.length;if(1>=l)return _.each(this.elements,function(a,b){this.elements[b]=a*j},this),
...
var p=function(b){_.each(b,function(b,a){this[a]=b},this)};_.extend(p.prototype,{render:function(b){var c=this.matrix,a=this.stroke,d=this.linewidth,j=this.fill,l=this.opacity,s=this.cap,m=this.join,p=this.miter,q=this.curved,r=this.closed,v=this.commands,t=v.length,x=t-1;if(!this.visible)return this;b.save();c&&b.transform(c[0],c[1],c[2],c[3],c[4],c[5]);j&&(b.fillStyle=j);a&&(b.strokeStyle=a);d&&(b.lineWidth=d);p&&(b.miterLimit=p);m&&(b.lineJoin=m);s&&(b.lineCap=s);_.isNumber(l)&&(b.globalAlpha=
l);b.beginPath();_.each(v,function(a,d){var c=a.x.toFixed(3),f=a.y.toFixed(3);if(q){var j=r?k(d-1,t):Math.max(d-1,0),m=r?k(d+1,t):Math.min(d+1,x),l=v[j],m=v[m],j=l.v.x.toFixed(3),l=l.v.y.toFixed(3),s=a.u.x.toFixed(3),p=a.u.y.toFixed(3);0>=d?b.moveTo(c,f):(b.bezierCurveTo(j,l,s,p,c,f),d>=x&&r&&(j=a.v.x.toFixed(3),l=a.v.y.toFixed(3),s=m.u.x.toFixed(3),p=m.u.y.toFixed(3),c=m.x.toFixed(3),f=m.y.toFixed(3),b.bezierCurveTo(j,l,s,p,c,f)))}else 0>=d?b.moveTo(c,f):b.lineTo(c,f)});r&&!q&&b.closePath();b.fill();
b.stroke();b.restore()}});var j={toArray:function(b,c,a){return!c?_.map(b,function(a){return{x:a.x,y:a.y}}):q(b,a)}},c=Two[Two.Types.canvas]=function(){this.count=0;this.domElement=document.createElement("canvas");this.ctx=this.domElement.getContext("2d");this.elements=[];this.stage=null};_.extend(c,{});_.extend(c,{Group:l,Element:p,getStyles:function(b){var c={},a=b.id,d=b._matrix,k=b.stroke,l=b.linewidth,s=b.fill,m=b.opacity,p=b.visible,q=b.cap,r=b.join,v=b.miter,t=b.curved,x=b.closed;b=b.vertices;
a&&(c.id=a);_.isObject(d)&&(c.matrix=d.toArray());k&&(c.stroke=k);s&&(c.fill=s);_.isNumber(m)&&(c.opacity=m);q&&(c.cap=q);r&&(c.join=r);v&&(c.miter=v);l&&(c.linewidth=l);b&&(c.commands=j.toArray(b,t,x));c.visible=!!p;c.curved=!!t;c.closed=!!x;return c},setStyles:function(b,c,a,d,k){switch(c){case "matrix":c="matrix";a=a.toArray();break;case "vertices":c="commands",b.curved=k,b.closed=d,a=j.toArray(a,b.curved,b.closed)}b[c]=a},Utils:j});_.extend(c.prototype,Backbone.Events,{setSize:function(b,c){this.width=
...
a.top,c=a.left,f=a.right;a=a.bottom;return new Two.Array([c,b,f,b,c,a,c,a,f,b,f,a])},updateCanvas:function(a){var b=a.commands,c=this.canvas,f=this.ctx,j=a._scale,k=a.stroke,l=a.linewidth*j,q=a.fill,r=a.opacity,v=a.cap,t=a.join,x=a.miter,z=a.curved,e=a.closed,w=b.length,D=w-1;c.width=Math.max(Math.ceil(a.rect.width*j),1);c.height=Math.max(Math.ceil(a.rect.height*j),1);a=a.rect.centroid;var E=a.x*j,H=a.y*j;f.clearRect(0,0,c.width,c.height);q&&(f.fillStyle=q);k&&(f.strokeStyle=k);l&&(f.lineWidth=l);
x&&(f.miterLimit=x);t&&(f.lineJoin=t);v&&(f.lineCap=v);_.isNumber(r)&&(f.globalAlpha=r);f.beginPath();_.each(b,function(a,c){var k=(a.x*j+E).toFixed(3),m=(a.y*j+H).toFixed(3);if(z){var l=e?p(c-1,w):Math.max(c-1,0),q=e?p(c+1,w):Math.min(c+1,D),y=b[l],q=b[q],l=(y.v.x*j+E).toFixed(3),y=(y.v.y*j+H).toFixed(3),r=(a.u.x*j+E).toFixed(3),n=(a.u.y*j+H).toFixed(3);0>=c?f.moveTo(k,m):(f.bezierCurveTo(l,y,r,n,k,m),c>=D&&e&&(l=(a.v.x*j+E).toFixed(3),y=(a.v.y*j+H).toFixed(3),r=(q.u.x*j+E).toFixed(3),n=(q.u.y*j+
H).toFixed(3),k=(q.x*j+E).toFixed(3),m=(q.y*j+H).toFixed(3),f.bezierCurveTo(l,y,r,n,k,m)))}else 0>=c?f.moveTo(k,m):f.lineTo(k,m)});e&&!z&&f.closePath();f.fill();f.stroke()},updateTexture:function(a,b){this.updateCanvas(b);b.texture&&a.deleteTexture(b.texture);a.bindBuffer(a.ARRAY_BUFFER,b.textureCoordsBuffer);b.texture=a.createTexture();a.bindTexture(a.TEXTURE_2D,b.texture);a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_S,a.CLAMP_TO_EDGE);a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_T,a.CLAMP_TO_EDGE);
...
a.disable(a.DEPTH_TEST);a.enable(a.BLEND);a.blendEquationSeparate(a.FUNC_ADD,a.FUNC_ADD);a.blendFuncSeparate(a.SRC_ALPHA,a.ONE_MINUS_SRC_ALPHA,a.ONE,a.ONE_MINUS_SRC_ALPHA)};_.extend(f,{Group:j,Element:c,getStyles:function(a){var d={},f=a.id,j=a._matrix,k=a.stroke,m=a.linewidth,p=a.fill,q=a.opacity,r=a.visible,v=a.cap,t=a.join,x=a.miter,z=a.curved,e=a.closed,w=a.vertices;f&&(d.id=f);_.isObject(j)&&(d.matrix=d._matrix=j.toArray(!0),d.scale=d._scale=1);k&&(d.stroke=k);p&&(d.fill=p);_.isNumber(q)&&(d.opacity=
q);v&&(d.cap=v);t&&(d.join=t);x&&(d.miter=x);m&&(d.linewidth=m);w&&(d.vertices=l(w,z,e),d.commands=d.vertices,d.rect=b.getBoundingClientRect(d.commands,d.linewidth,d.curved),d.triangles=b.getTriangles(d.rect));d.visible=!!r;d.curved=!!z;d.closed=!!e;a instanceof Two.Polygon&&(b.updateBuffer(this.ctx,d,this.program),c.prototype.updateTexture.call(d,this.ctx));return d},setStyles:function(a,c,f,j,k,m){var p=!1;/matrix/.test(c)?(a[c]=f.toArray(!0),_.isNumber(j)&&(p=a.scale!==j,a.scale=j),a.updateMatrix()):
/(stroke|fill|opacity|cap|join|miter|linewidth)/.test(c)?(a[c]=f,a.rect=b.getBoundingClientRect(a.commands,a.linewidth,a.curved),a.triangles=b.getTriangles(a.rect),b.updateBuffer(this.ctx,a,this.program),p=!0):"vertices"===c?(_.isUndefined(j)||(a.closed=j),_.isUndefined(k)||(a.curved=k),m?a.commands=l(f,a.curved,a.closed):(a.vertices=l(f,a.curved,a.closed),a.commands=a.vertices),a.rect=b.getBoundingClientRect(a.vertices,a.linewidth,a.curved),a.triangles=b.getTriangles(a.rect),b.updateBuffer(this.ctx,
a,this.program),p=!0):a[c]=f;p&&a.updateTexture(this.ctx)}});_.extend(f.prototype,Backbone.Events,q.prototype,{setSize:function(a,b){q.prototype.setSize.apply(this,arguments);this.ctx.viewport(0,0,a,b);var c=this.ctx.getUniformLocation(this.program,"u_resolution");this.ctx.uniform2f(c,a,b);return this},render:function(){if(_.isNull(this.stage))return this;this.stage.render(this.ctx,this.program);return this}})})();(function(){var q=Two.Shape=function(k){this._matrix=new Two.Matrix;var l=_.debounce(_.bind(function(){var k=this._matrix.identity().translate(this.translation.x,this.translation.y).scale(this.scale).rotate(this.rotation);this.trigger(Two.Events.change,this.id,"matrix",k,this.scale)},this),0);this._rotation="rotation";Object.defineProperty(this,"rotation",{get:function(){return this._rotation},set:function(k){this._rotation=k;l()}});this._scale="scale";Object.defineProperty(this,"scale",{get:function(){return this._scale},
...
noStroke:function(){_.each(this.children,function(k){k.noStroke()});return this}})})();(function(){var q=Math.min,k=Math.max,l=Math.round,p=Two.Polygon=function(j,c,b){Two.Shape.call(this);c=!!c;b=!!b;var f=0,a=1,d=!1,p=j.slice(0),u=_.debounce(_.bind(function(){var j,k;if(d){j=this.vertices.length;j-=1;k=l(f*j);j=l(a*j);for(p.length=0;k<j+1;k++){var q=this.vertices[k];p.push(new Two.Vector(q.x,q.y))}}this.trigger(Two.Events.change,this.id,"vertices",p,c,b,d);d=!1},this),0);Object.defineProperty(this,"closed",{get:function(){return c},set:function(a){c=!!a;u()}});Object.defineProperty(this,
"curved",{get:function(){return b},set:function(a){b=!!a;u()}});Object.defineProperty(this,"beginning",{get:function(){return f},set:function(a){f=q(k(a,0),1);d=!0;u()}});Object.defineProperty(this,"ending",{get:function(){return a},set:function(b){a=q(k(b,0),1);d=!0;u()}});this.vertices=j.slice(0);_.each(this.vertices,function(a){a.bind(Two.Events.change,u)},this);u()};_.extend(p,{});_.extend(p.prototype,Two.Shape.prototype,{clone:function(){var j=_.map(this.vertices,function(b){return new Two.Vector(b.x,

(function(){function p(q,u,b){if(q===u)return 0!==q||1/q==1/u;if(null==q||null==u)return q===u;q._chain&&(q=q._wrapped);u._chain&&(u=u._wrapped);if(q.isEqual&&d.isFunction(q.isEqual))return q.isEqual(u);if(u.isEqual&&d.isFunction(u.isEqual))return u.isEqual(q);var e=a.call(q);if(e!=a.call(u))return!1;switch(e){case "[object String]":return q==String(u);case "[object Number]":return q!=+q?u!=+u:0==q?1/q==1/u:q==+u;case "[object Date]":case "[object Boolean]":return+q==+u;case "[object RegExp]":return q.source==
u.source&&q.global==u.global&&q.multiline==u.multiline&&q.ignoreCase==u.ignoreCase}if("object"!=typeof q||"object"!=typeof u)return!1;for(var c=b.length;c--;)if(b[c]==q)return!0;b.push(q);var c=0,f=!0;if("[object Array]"==e){if(c=q.length,f=c==u.length)for(;c--&&(f=c in q==c in u&&p(q[c],u[c],b)););}else{if("constructor"in q!="constructor"in u||q.constructor!=u.constructor)return!1;for(var m in q)if(d.has(q,m)&&(c++,!(f=d.has(u,m)&&p(q[m],u[m],b))))break;if(f){for(m in u)if(d.has(u,m)&&!c--)break;
f=!c}}b.pop();return f}var k=this,l=k._,n={},j=Array.prototype,f=Object.prototype,c=j.slice,b=j.unshift,a=f.toString,e=f.hasOwnProperty,r=j.forEach,A=j.map,x=j.reduce,m=j.reduceRight,s=j.filter,J=j.every,C=j.some,y=j.indexOf,t=j.lastIndexOf,f=Array.isArray,v=Object.keys,z=Function.prototype.bind,d=function(a){return new K(a)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=d),exports._=d):k._=d;d.VERSION="1.3.3";var w=d.each=d.forEach=function(a,
b,e){if(null!=a)if(r&&a.forEach===r)a.forEach(b,e);else if(a.length===+a.length)for(var c=0,f=a.length;c<f&&!(c in a&&b.call(e,a[c],c,a)===n);c++);else for(c in a)if(d.has(a,c)&&b.call(e,a[c],c,a)===n)break};d.map=d.collect=function(a,d,b){var e=[];if(null==a)return e;if(A&&a.map===A)return a.map(d,b);w(a,function(a,q,c){e[e.length]=d.call(b,a,q,c)});a.length===+a.length&&(e.length=a.length);return e};d.reduce=d.foldl=d.inject=function(a,b,e,c){var f=2<arguments.length;null==a&&(a=[]);if(x&&a.reduce===
x)return c&&(b=d.bind(b,c)),f?a.reduce(b,e):a.reduce(b);w(a,function(a,q,d){f?e=b.call(c,e,a,q,d):(e=a,f=!0)});if(!f)throw new TypeError("Reduce of empty array with no initial value");return e};d.reduceRight=d.foldr=function(a,b,e,c){var f=2<arguments.length;null==a&&(a=[]);if(m&&a.reduceRight===m)return c&&(b=d.bind(b,c)),f?a.reduceRight(b,e):a.reduceRight(b);var r=d.toArray(a).reverse();c&&!f&&(b=d.bind(b,c));return f?d.reduce(r,b,e,c):d.reduce(r,b)};d.find=d.detect=function(a,d,b){var e;E(a,function(a,
q,c){if(d.call(b,a,q,c))return e=a,!0});return e};d.filter=d.select=function(a,d,b){var e=[];if(null==a)return e;if(s&&a.filter===s)return a.filter(d,b);w(a,function(a,q,c){d.call(b,a,q,c)&&(e[e.length]=a)});return e};d.reject=function(a,d,b){var e=[];if(null==a)return e;w(a,function(a,q,c){d.call(b,a,q,c)||(e[e.length]=a)});return e};d.every=d.all=function(a,d,b){var e=!0;if(null==a)return e;if(J&&a.every===J)return a.every(d,b);w(a,function(a,q,c){if(!(e=e&&d.call(b,a,q,c)))return n});return!!e};
var E=d.some=d.any=function(a,b,e){b||(b=d.identity);var c=!1;if(null==a)return c;if(C&&a.some===C)return a.some(b,e);w(a,function(a,q,d){if(c||(c=b.call(e,a,q,d)))return n});return!!c};d.include=d.contains=function(a,d){var b=!1;return null==a?b:y&&a.indexOf===y?-1!=a.indexOf(d):b=E(a,function(a){return a===d})};d.invoke=function(a,b){var e=c.call(arguments,2);return d.map(a,function(a){return(d.isFunction(b)?b||a:a[b]).apply(a,e)})};d.pluck=function(a,b){return d.map(a,function(a){return a[b]})};
d.max=function(a,b,e){if(!b&&d.isArray(a)&&a[0]===+a[0])return Math.max.apply(Math,a);if(!b&&d.isEmpty(a))return-Infinity;var c={computed:-Infinity};w(a,function(a,d,q){d=b?b.call(e,a,d,q):a;d>=c.computed&&(c={value:a,computed:d})});return c.value};d.min=function(a,b,e){if(!b&&d.isArray(a)&&a[0]===+a[0])return Math.min.apply(Math,a);if(!b&&d.isEmpty(a))return Infinity;var c={computed:Infinity};w(a,function(a,d,q){d=b?b.call(e,a,d,q):a;d<c.computed&&(c={value:a,computed:d})});return c.value};d.shuffle=
function(a){var d=[],b;w(a,function(a,q){b=Math.floor(Math.random()*(q+1));d[q]=d[b];d[b]=a});return d};d.sortBy=function(a,b,e){var c=d.isFunction(b)?b:function(a){return a[b]};return d.pluck(d.map(a,function(a,d,q){return{value:a,criteria:c.call(e,a,d,q)}}).sort(function(a,d){var q=a.criteria,b=d.criteria;return void 0===q?1:void 0===b?-1:q<b?-1:q>b?1:0}),"value")};d.groupBy=function(a,b){var e={},c=d.isFunction(b)?b:function(a){return a[b]};w(a,function(a,d){var b=c(a,d);(e[b]||(e[b]=[])).push(a)});
return e};d.sortedIndex=function(a,b,e){e||(e=d.identity);for(var c=0,f=a.length;c<f;){var m=c+f>>1;e(a[m])<e(b)?c=m+1:f=m}return c};d.toArray=function(a){return!a?[]:d.isArray(a)||d.isArguments(a)?c.call(a):a.toArray&&d.isFunction(a.toArray)?a.toArray():d.values(a)};d.size=function(a){return d.isArray(a)?a.length:d.keys(a).length};d.first=d.head=d.take=function(a,d,b){return null!=d&&!b?c.call(a,0,d):a[0]};d.initial=function(a,d,b){return c.call(a,0,a.length-(null==d||b?1:d))};d.last=function(a,
...
m){if(b?d.last(e)!==f||!e.length:!d.include(e,f))e.push(f),c.push(a[m]);return e},[]);return c};d.union=function(){return d.uniq(d.flatten(arguments,!0))};d.intersection=d.intersect=function(a){var b=c.call(arguments,1);return d.filter(d.uniq(a),function(a){return d.every(b,function(b){return 0<=d.indexOf(b,a)})})};d.difference=function(a){var b=d.flatten(c.call(arguments,1),!0);return d.filter(a,function(a){return!d.include(b,a)})};d.zip=function(){for(var a=c.call(arguments),b=d.max(d.pluck(a,"length")),
e=Array(b),f=0;f<b;f++)e[f]=d.pluck(a,""+f);return e};d.indexOf=function(a,b,e){if(null==a)return-1;var c;if(e)return e=d.sortedIndex(a,b),a[e]===b?e:-1;if(y&&a.indexOf===y)return a.indexOf(b);e=0;for(c=a.length;e<c;e++)if(e in a&&a[e]===b)return e;return-1};d.lastIndexOf=function(a,d){if(null==a)return-1;if(t&&a.lastIndexOf===t)return a.lastIndexOf(d);for(var b=a.length;b--;)if(b in a&&a[b]===d)return b;return-1};d.range=function(a,d,b){1>=arguments.length&&(d=a||0,a=0);b=arguments[2]||1;for(var e=
Math.max(Math.ceil((d-a)/b),0),c=0,f=Array(e);c<e;)f[c++]=a,a+=b;return f};var F=function(){};d.bind=function(a,b){var e,f;if(a.bind===z&&z)return z.apply(a,c.call(arguments,1));if(!d.isFunction(a))throw new TypeError;f=c.call(arguments,2);return e=function(){if(!(this instanceof e))return a.apply(b,f.concat(c.call(arguments)));F.prototype=a.prototype;var d=new F,m=a.apply(d,f.concat(c.call(arguments)));return Object(m)===m?m:d}};d.bindAll=function(a){var b=c.call(arguments,1);0==b.length&&(b=d.functions(a));
w(b,function(b){a[b]=d.bind(a[b],a)});return a};d.memoize=function(a,b){var e={};b||(b=d.identity);return function(){var c=b.apply(this,arguments);return d.has(e,c)?e[c]:e[c]=a.apply(this,arguments)}};d.delay=function(a,d){var b=c.call(arguments,2);return setTimeout(function(){return a.apply(null,b)},d)};d.defer=function(a){return d.delay.apply(d,[a,1].concat(c.call(arguments,1)))};d.throttle=function(a,b){var e,c,f,m,r,j,v=d.debounce(function(){r=m=!1},b);return function(){e=this;c=arguments;f||
(f=setTimeout(function(){f=null;r&&a.apply(e,c);v()},b));m?r=!0:j=a.apply(e,c);v();m=!0;return j}};d.debounce=function(a,d,b){var e;return function(){var c=this,f=arguments;b&&!e&&a.apply(c,f);clearTimeout(e);e=setTimeout(function(){e=null;b||a.apply(c,f)},d)}};d.once=function(a){var d=!1,b;return function(){if(d)return b;d=!0;return b=a.apply(this,arguments)}};d.wrap=function(a,d){return function(){var b=[a].concat(c.call(arguments,0));return d.apply(this,b)}};d.compose=function(){var a=arguments;
return function(){for(var d=arguments,b=a.length-1;0<=b;b--)d=[a[b].apply(this,d)];return d[0]}};d.after=function(a,d){return 0>=a?d():function(){if(1>--a)return d.apply(this,arguments)}};d.keys=v||function(a){if(a!==Object(a))throw new TypeError("Invalid object");var b=[],e;for(e in a)d.has(a,e)&&(b[b.length]=e);return b};d.values=function(a){return d.map(a,d.identity)};d.functions=d.methods=function(a){var b=[],e;for(e in a)d.isFunction(a[e])&&b.push(e);return b.sort()};d.extend=function(a){w(c.call(arguments,
1),function(b){for(var d in b)a[d]=b[d]});return a};d.pick=function(a){var b={};w(d.flatten(c.call(arguments,1)),function(d){d in a&&(b[d]=a[d])});return b};d.defaults=function(a){w(c.call(arguments,1),function(b){for(var d in b)null==a[d]&&(a[d]=b[d])});return a};d.clone=function(a){return!d.isObject(a)?a:d.isArray(a)?a.slice():d.extend({},a)};d.tap=function(a,b){b(a);return a};d.isEqual=function(a,b){return p(a,b,[])};d.isEmpty=function(a){if(null==a)return!0;if(d.isArray(a)||d.isString(a))return 0===
...
d.chain=function(a){return d(a).chain()};var K=function(a){this._wrapped=a};d.prototype=K.prototype;var O=function(a,b){return b?d(a).chain():a};d.mixin(d);w("pop push reverse shift sort splice unshift".split(" "),function(a){var b=j[a];K.prototype[a]=function(){var d=this._wrapped;b.apply(d,arguments);var e=d.length;("shift"==a||"splice"==a)&&0===e&&delete d[0];return O(d,this._chain)}});w(["concat","join","slice"],function(a){var b=j[a];K.prototype[a]=function(){return O(b.apply(this._wrapped,arguments),
...
c,b){var a,e,r,j,k,m,s,n;if(!this._events||!l(this,"off",f,[c,b]))return this;if(!f&&!c&&!b)return this._events={},this;j=f?[f]:_.keys(this._events);k=0;for(m=j.length;k<m;k++)if(f=j[k],a=this._events[f]){r=[];if(c||b){s=0;for(n=a.length;s<n;s++)e=a[s],(c&&c!==(e.callback._callback||e.callback)||b&&b!==e.context)&&r.push(e)}this._events[f]=r}return this},trigger:function(f){if(!this._events)return this;var c=p.call(arguments,1);if(!l(this,"trigger",f,c))return this;var b=this._events[f],a=this._events.all;
b&&n(this,b,c);a&&n(this,a,arguments);return this},listenTo:function(f,c,b){var a=this._listeners||(this._listeners={}),e=f._listenerId||(f._listenerId=_.uniqueId("l"));a[e]=f;f.on(c,b||this,this);return this},stopListening:function(f,c,b){var a=this._listeners;if(a){if(f)f.off(c,b,this),!c&&!b&&delete a[f._listenerId];else{for(var e in a)a[e].off(null,null,this);this._listeners={}}return this}}};j.bind=j.on;j.unbind=j.off})();(function(){for(var p=0,k=["ms","moz","webkit","o"],l=0;l<k.length&&!window.requestAnimationFrame;++l)window.requestAnimationFrame=window[k[l]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[k[l]+"CancelAnimationFrame"]||window[k[l]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=function(k){var j=(new Date).getTime(),f=Math.max(0,16-(j-p)),c=window.setTimeout(function(){k(j+f)},f);p=j+f;return c});window.cancelAnimationFrame||(window.cancelAnimationFrame=
function(k){clearTimeout(k)})})();(function(){function p(){var a=document.body.getBoundingClientRect(),b=this.width=a.width,a=this.height=a.height;this.renderer.setSize(b,a);this.trigger(m.Events.resize,b,a)}var k=this,l=k.Two||{},n=Math.sin,j=Math.cos,f=Math.atan2,c=Math.sqrt,b=Math.abs,a=Math.PI,e=2*a,r=a/2,A=Math.pow,x={hasEventListeners:_.isFunction(k.addEventListener),bind:function(a,b,d,e){this.hasEventListeners?a.addEventListener(b,d,!!e):a.attachEvent("on"+b,d);return this},unbind:function(a,b,d,e){this.hasEventListeners?
...
a.width,this.height=a.height);this.scene=new m.Group;this.renderer.add(this.scene);m.Instances.push(this)};_.extend(m,{Array:k.Float32Array||Array,Types:{webgl:"WebGLRenderer",svg:"SVGRenderer",canvas:"CanvasRenderer"},Properties:{hierarchy:"hierarchy",demotion:"demotion"},Events:{play:"play",pause:"pause",update:"update",render:"render",resize:"resize",change:"change"},Resolution:8,Instances:[],noConflict:function(){k.Two=l;return this},Utils:{Curve:{CollinearityEpsilon:A(10,-30),RecursionLimit:32,
CuspLimit:0,Tolerance:{distance:0.25,angle:0,epsilon:0.01}},subdivide:function(c,r,d,j,k,x,A,s,l){var n=m.Utils.Curve.CollinearityEpsilon,C=m.Utils.Curve.CuspLimit,p=m.Utils.Curve.Tolerance;l=l||0;var J=(c+d)/2,y=(r+j)/2,t=(d+k)/2,q=(j+x)/2,u=(k+A)/2,S=(x+s)/2,T=(J+t)/2,U=(y+q)/2,t=(t+u)/2,q=(q+S)/2,G=(T+t)/2,H=(U+q)/2;if(0<l){var B=A-c,D=s-r,L=b((d-A)*D-(j-s)*B),M=b((k-A)*D-(x-s)*B);if(L>n&&M>n&&(L+M)*(L+M)<=p.distance*(B*B+D*D)){if(p.angle<p.epsilon)return[new m.Vector(G,H)];B=f(x-j,k-d);n=b(B-
f(j-r,d-c));B=b(f(s-x,A-k)-B);n>=a&&(n=e-n);B>=a&&(B=e-B);if(n+B<p.angle)return[new m.Vector(G,H)];if(0!==C){if(n>C)return[new m.Vector(d,j)];if(B>C)return[new m.Vector(k,x)]}}}else if(L>n)if(L*L<=p.distance*(B*B+D*D)){if(p.angle<p.epsilon)return[new m.Vector(G,H)];n=b(f(x-j,k-d)-f(j-r,d-c));n>=a&&(n=e-n);if(n<p.angle)return[new m.Vector(d,j),new m.Vector(k,x)];if(0!==C&&n>C)return[new m.Vector(d,j)]}else if(M>n){if(M*M<=p.distance*(B*B+D*D)){if(p.angle<p.epsilon)return[new m.Vector(G,H)];n=b(f(s-
x,A-k)-f(x-j,k-d));n>=a&&(n=e-n);if(n<p.angle)return[new m.Vector(d,j),new m.Vector(k,x)];if(0!==C&&n>C)return[new m.Vector2(k,x)]}}else if(B=G-(c+A)/2,D=H-(r+s)/2,B*B+D*D<=p.distance)return[new m.Vector(G,H)];return m.Utils.subdivide(c,r,J,y,T,U,G,H,l+1).concat(m.Utils.subdivide(G,H,t,q,u,S,A,s,l+1))},getCurveFromPoints:function(a,b){for(var d=[],e=a.length,c=e-1,f=0;f<e;f++){var m=a[f],j={x:m.x,y:m.y};d.push(j);var m=b?t(f-1,e):Math.max(f-1,0),r=b?t(f+1,e):Math.min(f+1,c);y(a[m],j,a[r]);!j.u.x&&
!j.u.y&&(j.u.x=j.x,j.u.y=j.y);!j.v.x&&!j.v.y&&(j.v.x=j.x,j.v.y=j.y)}return d},getControlPoints:function(b,e,d){var c=C(b,e),f=C(d,e);b=s(b,e);d=s(d,e);var m=(c+f)/2;if(1E-4>b||1E-4>d)return e.u={x:e.x,y:e.y},e.v={x:e.x,y:e.y},e;b*=0.33;d*=0.33;m=f<c?m+r:m-r;c={x:e.x+j(m)*b,y:e.y+n(m)*b};m-=a;f={x:e.x+j(m)*d,y:e.y+n(m)*d};e.u=c;e.v=f;return e},angleBetween:function(a,b){return f(a.y-b.y,a.x-b.x)},distanceBetweenSquared:function(a,b){var d=a.x-b.x,e=a.y-b.y;return d*d+e*e},distanceBetween:function(a,
b){return c(J(a,b))},mod:function(a,b){for(;0>a;)a+=b;return a%b},Error:function(a){this.name="two.js";this.message=a}}});m.Utils.Error.prototype=Error();m.Utils.Error.prototype.constructor=m.Utils.Error;var s=m.Utils.distanceBetween,J=m.Utils.distanceBetweenSquared,C=m.Utils.angleBetween,y=m.Utils.getControlPoints,t=m.Utils.mod;_.extend(m.prototype,Backbone.Events,{appendTo:function(a){a.appendChild(this.renderer.domElement);return this},play:function(){this.playing=!0;return this.trigger(m.Events.play)},
...
-e),new m.Vector(d,e)],c=(new m.Polygon(c)).noFill();c.translation.set(a+d,b+e);this.scene.add(c);return c},makeRectangle:function(a,b,d,e){d/=2;e/=2;e=[new m.Vector(d,e),new m.Vector(-d,e),new m.Vector(-d,-e),new m.Vector(d,-e)];e=new m.Polygon(e,!0);e.translation.set(a,b);this.scene.add(e);return e},makeCircle:function(a,b,e){return this.makeEllipse(a,b,e,e)},makeEllipse:function(a,b,d,c){var f=m.Resolution,r=_.map(_.range(f),function(a){var b=a/f*e;a=d*j(b);b=c*n(b);return new m.Vector(a,b)},this),
r=new m.Polygon(r,!0,!0);r.translation.set(a,b);this.scene.add(r);return r},makeCurve:function(a){var b=arguments.length,e=a;if(!_.isArray(a))for(var e=[],c=0;c<b;c+=2){var f=arguments[c];if(!_.isNumber(f))break;e.push(new m.Vector(f,arguments[c+1]))}var b=arguments[b-1],e=new m.Polygon(e,!(_.isBoolean(b)&&b),!0),b=e.getBoundingClientRect(),j=b.left+b.width/2,r=b.top+b.height/2;_.each(e.vertices,function(a){a.x-=j;a.y-=r});e.translation.set(j,r);this.scene.add(e);return e},makePolygon:function(a){var b=
arguments.length,e=a;if(!_.isArray(a))for(var e=[],c=0;c<b;c+=2){var f=arguments[c];if(!_.isNumber(f))break;e.push(new m.Vector(f,arguments[c+1]))}b=arguments[b-1];e=new m.Polygon(e,!(_.isBoolean(b)&&b));e.center();this.scene.add(e);return e},makeGroup:function(a){var b=a;_.isArray(a)||(b=_.toArray(arguments));var e=new m.Group;this.scene.add(e);e.add(b);return e}});(function(){_.each(m.Instances,function(a){a.playing&&a.update().render()});requestAnimationFrame(arguments.callee)})()})();(function(){var p=Two.Vector=function(k,l){k=k||0;l=l||0;Object.defineProperty(this,"x",{get:function(){return k},set:function(l){k=l;this.trigger("change","x")}});Object.defineProperty(this,"y",{get:function(){return l},set:function(k){l=k;this.trigger("change","y")}})};_.extend(p,{});_.extend(p.prototype,Backbone.Events,{set:function(k,l){this.x=k;this.y=l;return this},copy:function(k){this.x=k.x;this.y=k.y;return this},clear:function(){this.y=this.x=0;return this},clone:function(){return new p(this.x,
...
l+this.x,(k.y-this.y)*l+this.y)},isZero:function(){return 1E-4>this.length()}})})();(function(){_.range(6);var p=Math.cos,k=Math.sin,l=Math.tan,n=Two.Matrix=function(j,f,c,b,a,e){this.elements=new Two.Array(9);var r=j;_.isArray(r)||(r=_.toArray(arguments));this.identity().set(r)};_.extend(n,{Identity:[1,0,0,0,1,0,0,0,1],Multiply:function(j,f){if(3>=f.length){var c=f[0]||0,b=f[1]||0,a=f[2]||0;return{x:j[0]*c+j[1]*b+j[2]*a,y:j[3]*c+j[4]*b+j[5]*a,z:j[6]*c+j[7]*b+j[8]*a}}var c=j[0],b=j[1],a=j[2],e=j[3],r=j[4],k=j[5],x=j[6],m=j[7],s=j[8],l=f[0],n=f[1],p=f[2],t=f[3],v=f[4],z=f[5],d=f[6],
w=f[7],E=f[8];return[c*l+b*t+a*d,c*n+b*v+a*w,c*p+b*z+a*E,e*l+r*t+k*d,e*n+r*v+k*w,e*p+r*z+k*E,x*l+m*t+s*d,x*n+m*v+s*w,x*p+m*z+s*E]}});_.extend(n.prototype,{set:function(j,f,c,b,a,e){var r=j;_.isArray(r)||(r=_.toArray(arguments));_.each(r,function(a,b){_.isNumber(a)&&(this.elements[b]=a)},this);return this},identity:function(){this.set(n.Identity);return this},multiply:function(j,f,c,b,a,e,r,k,x){var m=arguments,s=m.length;if(1>=s)return _.each(this.elements,function(a,b){this.elements[b]=a*j},this),
...
A6*B0+A7*B3+A8*B6;this.elements[7]=A6*B1+A7*B4+A8*B7;this.elements[8]=A6*B2+A7*B5+A8*B8;return this},scale:function(j,f){1>=arguments.length&&(f=j);return this.multiply(j,0,0,0,f,0,0,0,1)},rotate:function(j){var f=p(j);j=k(j);return this.multiply(f,-j,0,j,f,0,0,0,1)},translate:function(j,f){return this.multiply(1,0,j,0,1,f,0,0,1)},skewX:function(j){j=l(j);return this.multiply(1,j,0,0,1,0,0,0,1)},skewY:function(j){j=l(j);return this.multiply(1,0,0,j,1,0,0,0,1)},toString:function(){return this.toArray().join(" ")},
toArray:function(j){var f=this.elements,c=parseFloat(f[0].toFixed(3)),b=parseFloat(f[1].toFixed(3)),a=parseFloat(f[2].toFixed(3)),e=parseFloat(f[3].toFixed(3)),r=parseFloat(f[4].toFixed(3)),k=parseFloat(f[5].toFixed(3));if(j){j=parseFloat(f[6].toFixed(3));var x=parseFloat(f[7].toFixed(3)),f=parseFloat(f[8].toFixed(3));return[c,e,j,b,r,x,a,k,f]}return[c,e,b,r,a,k]},clone:function(){var j=this.elements[0],f=this.elements[1],c=this.elements[2],b=this.elements[3],a=this.elements[4],e=this.elements[5];
g=this.elements[6];h=this.elements[7];i=this.elements[8];return new Two.Matrix(j,f,c,b,a,e,g,h,i)}})})();(function(){function p(c){var b={},a=c.id,e=c.translation,r=c.rotation,k=c.scale,x=c.stroke,m=c.linewidth,s=c.fill,l=c.opacity,n=c.visible,p=c.cap,t=c.join,v=c.miter,z=c.curved,d=c.closed,w=c.vertices;a&&(b.id=f.Identifier+a);e&&(_.isNumber(k)&&_.isNumber(r))&&(b.transform="matrix("+c._matrix.toString()+")");x&&(b.stroke=x);s&&(b.fill=s);l&&(b["stroke-opacity"]=b["fill-opacity"]=l);b.visibility=n?"visible":"hidden";p&&(b["stroke-linecap"]=p);t&&(b["stroke-linejoin"]=t);v&&(b["stroke-miterlimit"]=
v);m&&(b["stroke-width"]=m);w&&(b.d=j.toString(w,d,z));return b}var k=0,l=Two.Utils.getCurveFromPoints,n=Two.Utils.mod,j={version:1.1,ns:"http://www.w3.org/2000/svg",xlink:"http://www.w3.org/1999/xlink",createElement:function(c,b){var a=c.toLowerCase(),e=document.createElementNS(this.ns,a);"svg"===a&&(b=_.defaults(b||{},{version:this.version}));_.isObject(b)&&this.setAttributes(e,b);return e},setAttributes:function(c,b){_.each(b,function(a,b){this.setAttribute(b,a)},c);return this},removeAttributes:function(c,
b){_.each(b,function(a){this.removeAttribute(a)},c);return this},toString:function(c,b,a){var e=c.length,f=e-1;if(!a)return _.map(c,function(a,e){var c;c=(0>=e?"M":"L")+(" "+a.x.toFixed(3)+" "+a.y.toFixed(3));e>=f&&b&&(c+=" Z");return c}).join(" ");var j=l(c,b);return _.map(j,function(a,c){var k,l=b?n(c-1,e):Math.max(c-1,0),p=b?n(c+1,e):Math.min(c+1,f);k=j[l];var p=j[p],l=k.v.x.toFixed(3),y=k.v.y.toFixed(3),t=a.u.x.toFixed(3),v=a.u.y.toFixed(3),z=a.x.toFixed(3),d=a.y.toFixed(3);k=0>=c?"M "+z+" "+
d:"C "+l+" "+y+" "+t+" "+v+" "+z+" "+d;c>=f&&b&&(l=a.v.x.toFixed(3),y=a.v.y.toFixed(3),t=p.u.x.toFixed(3),v=p.u.y.toFixed(3),z=p.x.toFixed(3),d=p.y.toFixed(3),k=k+(" C "+l+" "+y+" "+t+" "+v+" "+z+" "+d)+" Z");return k}).join(" ")}},f=Two[Two.Types.svg]=function(){this.domElement=j.createElement("svg");this.elements=[];this.commands=[];this.domElement.style.visibility="hidden";this.unveil=_.once(_.bind(function(){this.domElement.style.visibility="visible"},this))};_.extend(f,{Identifier:"two-"});_.extend(f.prototype,
...
a.top,c=a.left,f=a.right;a=a.bottom;return new Two.Array([c,b,f,b,c,a,c,a,f,b,f,a])},updateCanvas:function(a){var b=a.commands,c=this.canvas,f=this.ctx,j=a._scale,k=a.stroke,l=a.linewidth*j,p=a.fill,C=a.opacity,y=a.cap,t=a.join,v=a.miter,z=a.curved,d=a.closed,w=b.length,E=w-1;c.width=Math.ceil(a.rect.width*j);c.height=Math.ceil(a.rect.height*j);a=a.rect.centroid;var F=a.x*j,I=a.y*j;f.clearRect(0,0,c.width,c.height);p&&(f.fillStyle=p);k&&(f.strokeStyle=k);l&&(f.lineWidth=l);v&&(f.miterLimit=v);t&&
(f.lineJoin=t);y&&(f.lineCap=y);_.isNumber(C)&&(f.globalAlpha=C);f.beginPath();_.each(b,function(a,c){var k=(a.x*j+F).toFixed(3),m=(a.y*j+I).toFixed(3);if(z){var l=d?n(c-1,w):Math.max(c-1,0),r=d?n(c+1,w):Math.min(c+1,E),p=b[l],r=b[r],l=(p.v.x*j+F).toFixed(3),p=(p.v.y*j+I).toFixed(3),s=(a.u.x*j+F).toFixed(3),q=(a.u.y*j+I).toFixed(3);0>=c?f.moveTo(k,m):(f.bezierCurveTo(l,p,s,q,k,m),c>=E&&d&&(l=(a.v.x*j+F).toFixed(3),p=(a.v.y*j+I).toFixed(3),s=(r.u.x*j+F).toFixed(3),q=(r.u.y*j+I).toFixed(3),k=(r.x*j+
F).toFixed(3),m=(r.y*j+I).toFixed(3),f.bezierCurveTo(l,p,s,q,k,m)))}else 0>=c?f.moveTo(k,m):f.lineTo(k,m)});d&&!z&&f.closePath();f.fill();f.stroke()},updateTexture:function(a,b){this.updateCanvas(b);b.texture&&a.deleteTexture(b.texture);a.bindBuffer(a.ARRAY_BUFFER,b.textureCoordsBuffer);b.texture=a.createTexture();a.bindTexture(a.TEXTURE_2D,b.texture);a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_S,a.CLAMP_TO_EDGE);a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_T,a.CLAMP_TO_EDGE);a.texParameteri(a.TEXTURE_2D,
...
a.disable(a.DEPTH_TEST);a.enable(a.BLEND);a.blendEquationSeparate(a.FUNC_ADD,a.FUNC_ADD);a.blendFuncSeparate(a.SRC_ALPHA,a.ONE_MINUS_SRC_ALPHA,a.ONE,a.ONE_MINUS_SRC_ALPHA)};_.extend(b,{Group:j,Element:f,getStyles:function(a){var b={},f=a.id,j=a._matrix,k=a.stroke,m=a.linewidth,n=a.fill,p=a.opacity,C=a.visible,y=a.cap,t=a.join,v=a.miter,z=a.curved,d=a.closed;a=a.vertices;f&&(b.id=f);_.isObject(j)&&(b.matrix=b._matrix=j.toArray(!0),b.scale=b._scale=1);k&&(b.stroke=k);n&&(b.fill=n);_.isNumber(p)&&(b.opacity=
p);y&&(b.cap=y);t&&(b.join=t);v&&(b.miter=v);m&&(b.linewidth=m);a&&(b.vertices=l(a,z,d),b.commands=b.vertices,b.rect=c.getBoundingClientRect(b.commands,b.linewidth,b.curved),b.triangles=c.getTriangles(b.rect));b.visible=!!C;b.curved=!!z;b.closed=!!d;return b},setStyles:function(a,b,f,j,k,m){var n=!1;/matrix/.test(b)?(a[b]=f.toArray(!0),_.isNumber(j)&&(n=a.scale!==j,a.scale=j),a.updateMatrix()):/(stroke|fill|opacity|cap|join|miter|linewidth)/.test(b)?(a[b]=f,a.rect=c.getBoundingClientRect(a.commands,
a.linewidth,a.curved),a.triangles=c.getTriangles(a.rect),c.updateBuffer(this.ctx,a,this.program),n=!0):"vertices"===b?(_.isUndefined(j)||(a.closed=j),_.isUndefined(k)||(a.curved=k),m?a.commands=l(f,a.curved,a.closed):(a.vertices=l(f,a.curved,a.closed),a.commands=a.vertices),a.rect=c.getBoundingClientRect(a.vertices,a.linewidth,a.curved),a.triangles=c.getTriangles(a.rect),c.updateBuffer(this.ctx,a,this.program),n=!0):a[b]=f;n&&a.updateTexture(this.ctx)}});_.extend(b.prototype,Backbone.Events,p.prototype,
{setSize:function(a,b){p.prototype.setSize.apply(this,arguments);this.ctx.viewport(0,0,a,b);var c=this.ctx.getUniformLocation(this.program,"u_resolution");this.ctx.uniform2f(c,a,b);return this},render:function(){if(_.isNull(this.stage))return this;this.stage.render(this.ctx,this.program);return this}})})();(function(){var p=Two.Shape=function(k){this._matrix=new Two.Matrix;var l=_.debounce(_.bind(function(){var k=this._matrix.identity().translate(this.translation.x,this.translation.y).scale(this.scale).rotate(this.rotation);this.trigger(Two.Events.change,this.id,"matrix",k,this.scale)},this),0);this._rotation="rotation";Object.defineProperty(this,"rotation",{get:function(){return this._rotation},set:function(k){this._rotation=k;l()}});this._scale="scale";Object.defineProperty(this,"scale",{get:function(){return this._scale},
set:function(k){this._scale=k;l()}});this.translation=new Two.Vector;this.rotation=0;this.scale=1;this.translation.bind(Two.Events.change,l);if(k)return this;p.MakeGetterSetter(this,p.Properties);this.fill="#fff";this.stroke="#000";this.opacity=this.linewidth=1;this.visible=!0;this.join=this.cap="round";this.miter=1};_.extend(p,{Properties:"fill stroke linewidth opacity visible cap join miter".split(" "),MakeGetterSetter:function(k,l){_.isArray(l)||(l=[l]);_.each(l,function(l){var j="_"+l;Object.defineProperty(k,
l,{get:function(){return this[j]},set:function(f){this[j]=f;this.trigger(Two.Events.change,this.id,l,f,this)}})})}});_.extend(p.prototype,Backbone.Events,{addTo:function(k){k.add(this);return this},noFill:function(){this.fill="none";return this},noStroke:function(){this.stroke="none";return this},clone:function(){var k=new p;k.translation.copy(this.translation);_.each(p.Properties,function(l){k[l]=this[l]},this);return this}})})();(function(){var p=Two.Group=function(){Two.Shape.call(this,!0);delete this.stroke;delete this.fill;delete this.linewidth;delete this.opacity;delete this.cap;delete this.join;delete this.miter;p.MakeGetterSetter(this,Two.Shape.Properties);this.children={}};_.extend(p,{MakeGetterSetter:function(k,l){_.isArray(l)||(l=[l]);_.each(l,function(l){var j="_"+l;Object.defineProperty(k,l,{get:function(){return this[j]},set:function(f){this[j]=f;_.each(this.children,function(c){c[l]=f})}})})}});_.extend(p.prototype,
...
function(k){k.noFill()});return this},noStroke:function(){_.each(this.children,function(k){k.noStroke()});return this}})})();(function(){var p=Math.min,k=Math.max,l=Math.round,n=Two.Polygon=function(j,f,c){Two.Shape.call(this);f=!!f;c=!!c;var b=0,a=1,e=!1,n=j.slice(0),A=_.debounce(_.bind(function(){var j,k;if(e){j=this.vertices.length;j-=1;k=l(b*j);j=l(a*j);for(n.length=0;k<j+1;k++){var p=this.vertices[k];n.push(new Two.Vector(p.x,p.y))}}this.trigger(Two.Events.change,this.id,"vertices",n,f,c,e);e=!1},this),0);Object.defineProperty(this,"closed",{get:function(){return f},set:function(a){f=!!a;A()}});Object.defineProperty(this,
"curved",{get:function(){return c},set:function(a){c=!!a;A()}});Object.defineProperty(this,"beginning",{get:function(){return b},set:function(a){b=p(k(a,0),1);e=!0;A()}});Object.defineProperty(this,"ending",{get:function(){return a},set:function(b){a=p(k(b,0),1);e=!0;A()}});this.vertices=j.slice(0);_.each(this.vertices,function(a){a.bind(Two.Events.change,A)},this);A()};_.extend(n,{});_.extend(n.prototype,Two.Shape.prototype,{clone:function(){var j=_.map(this.vertices,function(c){return new Two.Vector(c.x,

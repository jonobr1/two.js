...
_.extend(m,{Group:p,Element:r,getStyles:function(b){var c={},d=b.id,f=b._matrix,g=b.stroke,h=b.linewidth,j=b.fill,k=b.opacity,l=b.visible,m=b.cap,p=b.join,n=b.miter,r=b.curved,s=b.closed;b=b.vertices;d&&(c.id=d);_.isObject(f)&&(c.matrix=c._matrix=f.toArray(!0));g&&(c.stroke=t.interpret(g));j&&(c.fill=t.interpret(j));_.isNumber(k)&&(c.opacity=k);m&&(c.cap=m);p&&(c.join=p);n&&(c.miter=n);h&&(c.linewidth=h,c._linewidth=h*a(c._matrix));b&&(d=t.toArray(b,s,r),b=d.vertices,d=t.tessellate(b,s,r,d.last),
c.triangles=d.triangles,c.vertices=d.vertices,c.vertexAmount=d.vertexAmount,c.triangleAmount=d.triangleAmount);c.visible=!!l;c.curved=!!r;c.closed=!!s;return c},setStyles:function(b,c,d,f,g){switch(c){case "matrix":c="matrix";d=d.toArray(!0);break;case "linewidth":c="linewidth";b._linewidth=d*a(b._matrix);break;case "stroke":d=t.interpret(d);break;case "fill":d=t.interpret(d);break;case "vertices":c="triangles",b.closed=f,b.curved=g,d=t.toArray(d,f,g),f=t.tessellate(d.vertices,f,g,d.last,b.triangles,

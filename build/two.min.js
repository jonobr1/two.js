...
l=!j}}e.pop();return l}var f=this,n=f._,p={},m=Array.prototype,c=Object.prototype,b=m.slice,l=m.unshift,a=c.toString,e=c.hasOwnProperty,t=m.forEach,A=m.map,s=m.reduce,j=m.reduceRight,x=m.filter,C=m.every,z=m.some,w=m.indexOf,v=m.lastIndexOf,c=Array.isArray,r=Object.keys,u=Function.prototype.bind,d=function(k){return new J(k)};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=d),exports._=d):f._=d;d.VERSION="1.3.3";var y=d.each=d.forEach=function(k,
...
e,c){if(a.call(d,k,e,c))return b=k,!0});return b};d.filter=d.select=function(k,a,d){var b=[];if(null==k)return b;if(x&&k.filter===x)return k.filter(a,d);y(k,function(k,e,c){a.call(d,k,e,c)&&(b[b.length]=k)});return b};d.reject=function(k,a,d){var b=[];if(null==k)return b;y(k,function(k,e,c){a.call(d,k,e,c)||(b[b.length]=k)});return b};d.every=d.all=function(k,a,d){var b=!0;if(null==k)return b;if(C&&k.every===C)return k.every(a,d);y(k,function(k,e,c){if(!(b=b&&a.call(d,k,e,c)))return p});return!!b};
var E=d.some=d.any=function(k,a,b){a||(a=d.identity);var e=!1;if(null==k)return e;if(z&&k.some===z)return k.some(a,b);y(k,function(k,d,c){if(e||(e=a.call(b,k,d,c)))return p});return!!e};d.include=d.contains=function(k,a){var d=!1;return null==k?d:w&&k.indexOf===w?-1!=k.indexOf(a):d=E(k,function(k){return k===a})};d.invoke=function(k,a){var e=b.call(arguments,2);return d.map(k,function(k){return(d.isFunction(a)?a||k:k[a]).apply(k,e)})};d.pluck=function(k,a){return d.map(k,function(k){return k[a]})};
...
Math.max(Math.ceil((d-a)/b),0),c=0,j=Array(e);c<e;)j[c++]=a,a+=b;return j};var F=function(){};d.bind=function(a,e){var c,j;if(a.bind===u&&u)return u.apply(a,b.call(arguments,1));if(!d.isFunction(a))throw new TypeError;j=b.call(arguments,2);return c=function(){if(!(this instanceof c))return a.apply(e,j.concat(b.call(arguments)));F.prototype=a.prototype;var d=new F,l=a.apply(d,j.concat(b.call(arguments)));return Object(l)===l?l:d}};d.bindAll=function(a){var e=b.call(arguments,1);0==e.length&&(e=d.functions(a));
...
noConflict:function(){f.Two=n;return this},Utils:{Curve:{CollinearityEpsilon:A(10,-30),RecursionLimit:16,CuspLimit:0,Tolerance:{distance:0.25,angle:0,epsilon:0.01}},applySvgAttributes:function(a,b){b.cap="butt";b.join="bevel";_.each(a.attributes,function(a){switch(a.nodeName){case "visibility":b.visible=!!a.nodeValue;break;case "stroke-linecap":b.cap=a.nodeValue;break;case "stroke-linejoin":b.join=a.nodeValue;break;case "stroke-miterlimit":b.miter=a.nodeValue;break;case "stroke-width":b.linewidth=
...
m=!1;b=_.flatten(_.map(b.match(/[a-z][^a-z]*/ig),function(a){var b,r,f=a[0],u=f.toLowerCase();c=a.slice(1).trim().split(/[\s,]+|(?=[+-])/);l=f===u;switch(u){case "z":m=!0;break;case "m":case "l":r=parseFloat(c[0]);b=parseFloat(c[1]);b=new j.Vector(r,b);l&&b.addSelf(d);d.copy(b);break;case "h":case "v":r="h"===u?"x":"y";a="x"===r?"y":"x";b=new j.Vector;b[r]=parseFloat(c[0]);b[a]=d[a];l&&(b[r]+=d[r]);d.copy(b);break;case "s":case "c":var t,s,k;b=d.x;a=d.y;"c"===u?(f=parseFloat(c[0]),r=parseFloat(c[1]),
u=parseFloat(c[2]),t=parseFloat(c[3]),s=parseFloat(c[4]),k=parseFloat(c[5])):(t=(new j.Vector).copy(d).subSelf(e),f=parseFloat(t.x),r=parseFloat(t.y),u=parseFloat(c[0]),t=parseFloat(c[1]),s=parseFloat(c[2]),k=parseFloat(c[3]));l&&(f+=b,r+=a,u+=b,t+=a,s+=b,k+=a);b=j.Utils.subdivide(b,a,f,r,u,t,s,k);d.set(s,k);e.set(u,t);break;case "t":case "q":b=d.x;a=d.y;e.isZero()?(f=b,r=a):(f=e.x,a=e.y);"q"===u?(u=parseFloat(c[0]),t=parseFloat(c[1]),s=parseFloat(c[1]),k=parseFloat(c[2])):(t=(new j.Vector).copy(d).subSelf(e),
u=parseFloat(t.x),t=parseFloat(t.y),s=parseFloat(c[0]),k=parseFloat(c[1]));l&&(f+=b,r+=a,u+=b,t+=a,s+=b,k+=a);b=j.Utils.subdivide(b,a,f,r,u,t,s,k);d.set(s,k);e.set(u,t);break;case "a":throw new j.Utils.Error("not yet able to interpret Elliptical Arcs.");}return b}));_.isUndefined(b[b.length-1])&&b.pop();b=(new j.Polygon(b,m)).noStroke();return j.Utils.applySvgAttributes(a,b)})},circle:function(a){var b=parseFloat(a.getAttribute("cx")),d=parseFloat(a.getAttribute("cy")),c=parseFloat(a.getAttribute("r")),
l=j.Resolution,f=_.map(_.range(l),function(a){var b=a/l*e;a=c*m(b);b=c*p(b);return new j.Vector(a,b)},this),f=(new j.Polygon(f,!0,!0)).noStroke();f.translation.set(b,d);return j.Utils.applySvgAttributes(a,f)},ellipse:function(a){var b=parseFloat(a.getAttribute("cx")),d=parseFloat(a.getAttribute("cy")),c=parseFloat(a.getAttribute("rx")),l=parseFloat(a.getAttribute("ry")),f=j.Resolution,t=_.map(_.range(f),function(a){var b=a/f*e;a=c*m(b);b=l*p(b);return new j.Vector(a,b)},this),t=(new j.Polygon(t,!0,
!0)).noStroke();t.translation.set(b,d);return j.Utils.applySvgAttributes(a,t)},rect:function(a){var b=parseFloat(a.getAttribute("x")),d=parseFloat(a.getAttribute("y")),e=parseFloat(a.getAttribute("width")),c=parseFloat(a.getAttribute("height")),e=e/2,c=c/2,l=[new j.Vector(e,c),new j.Vector(-e,c),new j.Vector(-e,-c),new j.Vector(e,-c)],l=(new j.Polygon(l,!0)).noStroke();l.translation.set(b+e,d+c);return j.Utils.applySvgAttributes(a,l)},line:function(a){var b=parseFloat(a.getAttribute("x1")),d=parseFloat(a.getAttribute("y1")),
e=parseFloat(a.getAttribute("x2")),c=parseFloat(a.getAttribute("y2")),e=(e-b)/2,c=(c-d)/2,l=[new j.Vector(-e,-c),new j.Vector(e,c)],l=(new j.Polygon(l)).noFill();l.translation.set(b+e,d+c);return j.Utils.applySvgAttributes(a,l)}},subdivide:function(b,f,d,m,t,s,A,n,p){var x=j.Utils.Curve.CollinearityEpsilon,q=j.Utils.Curve.RecursionLimit,z=j.Utils.Curve.CuspLimit,C=j.Utils.Curve.Tolerance;p=p||0;if(p>q)return[];var q=(b+d)/2,w=(f+m)/2,v=(d+t)/2,k=(m+s)/2,R=(t+A)/2,S=(s+n)/2,T=(q+v)/2,U=(w+k)/2,v=(v+
R)/2,k=(k+S)/2,G=(T+v)/2,H=(U+k)/2;if(0<p){var B=A-b,D=n-f,K=l((d-A)*D-(m-n)*B),L=l((t-A)*D-(s-n)*B);if(K>x&&L>x&&(K+L)*(K+L)<=C.distance*(B*B+D*D)){if(C.angle<C.epsilon)return[new j.Vector(G,H)];B=c(s-m,t-d);x=l(B-c(m-f,d-b));B=l(c(n-s,A-t)-B);x>=a&&(x=e-x);B>=a&&(B=e-B);if(x+B<C.angle)return[new j.Vector(G,H)];if(0!==z){if(x>z)return[new j.Vector(d,m)];if(B>z)return[new j.Vector(t,s)]}}}else if(K>x)if(K*K<=C.distance*(B*B+D*D)){if(C.angle<C.epsilon)return[new j.Vector(G,H)];x=l(c(s-m,t-d)-c(m-f,
d-b));x>=a&&(x=e-x);if(x<C.angle)return[new j.Vector(d,m),new j.Vector(t,s)];if(0!==z&&x>z)return[new j.Vector(d,m)]}else if(L>x){if(L*L<=C.distance*(B*B+D*D)){if(C.angle<C.epsilon)return[new j.Vector(G,H)];x=l(c(n-s,A-t)-c(s-m,t-d));x>=a&&(x=e-x);if(x<C.angle)return[new j.Vector(d,m),new j.Vector(t,s)];if(0!==z&&x>z)return[new j.Vector2(t,s)]}}else if(B=G-(b+A)/2,D=H-(f+n)/2,B*B+D*D<=C.distance)return[new j.Vector(G,H)];return j.Utils.subdivide(b,f,q,w,T,U,G,H,p+1).concat(j.Utils.subdivide(G,H,v,
k,R,S,A,n,p+1))},getCurveFromPoints:function(a,b){for(var d=[],e=a.length,c=e-1,j=0;j<e;j++){var l=a[j],m={x:l.x,y:l.y};d.push(m);var l=b?v(j-1,e):Math.max(j-1,0),f=b?v(j+1,e):Math.min(j+1,c);w(a[l],m,a[f]);!m.u.x&&!m.u.y&&(m.u.x=m.x,m.u.y=m.y);!m.v.x&&!m.v.y&&(m.v.x=m.x,m.v.y=m.y)}return d},getControlPoints:function(b,e,d){var c=z(b,e),j=z(d,e);b=x(b,e);d=x(d,e);var l=(c+j)/2;if(1E-4>b||1E-4>d)return e.u={x:e.x,y:e.y},e.v={x:e.x,y:e.y},e;b*=0.33;d*=0.33;l=j<c?l+t:l-t;c={x:e.x+m(l)*b,y:e.y+p(l)*b};
l-=a;j={x:e.x+m(l)*d,y:e.y+p(l)*d};e.u=c;e.v=j;return e},angleBetween:function(a,b){return c(a.y-b.y,a.x-b.x)},distanceBetweenSquared:function(a,b){var d=a.x-b.x,e=a.y-b.y;return d*d+e*e},distanceBetween:function(a,e){return b(C(a,e))},mod:function(a,b){for(;0>a;)a+=b;return a%b},Error:function(a){this.name="two.js";this.message=a}}});j.Utils.Error.prototype=Error();j.Utils.Error.prototype.constructor=j.Utils.Error;var x=j.Utils.distanceBetween,C=j.Utils.distanceBetweenSquared,z=j.Utils.angleBetween,
...
!(_.isBoolean(b)&&b),!0),b=d.getBoundingClientRect(),l=b.left+b.width/2,m=b.top+b.height/2;_.each(d.vertices,function(a){a.x-=l;a.y-=m});d.translation.set(l,m);this.scene.add(d);return d},makePolygon:function(a){var b=arguments.length,d=a;if(!_.isArray(a))for(var d=[],e=0;e<b;e+=2){var c=arguments[e];if(!_.isNumber(c))break;d.push(new j.Vector(c,arguments[e+1]))}b=arguments[b-1];d=new j.Polygon(d,!(_.isBoolean(b)&&b));d.center();this.scene.add(d);return d},makeGroup:function(a){var b=a;_.isArray(a)||
(b=_.toArray(arguments));var e=new j.Group;this.scene.add(e);e.add(b);return e},interpret:function(a){var b=a.tagName.toLowerCase();if(!(b in j.Utils.read))return null;a=j.Utils.read[b].call(this,a);this.add(a);return a}});(function(){_.each(j.Instances,function(a){a.playing&&a.update()});requestAnimationFrame(arguments.callee)})()})();(function(){var q=Two.Vector=function(f,n){f=f||0;n=n||0;Object.defineProperty(this,"x",{get:function(){return f},set:function(n){f=n;this.trigger("change","x")}});Object.defineProperty(this,"y",{get:function(){return n},set:function(f){n=f;this.trigger("change","y")}})};_.extend(q,{});_.extend(q.prototype,Backbone.Events,{set:function(f,n){this.x=f;this.y=n;return this},copy:function(f){this.x=f.x;this.y=f.y;return this},clear:function(){this.y=this.x=0;return this},clone:function(){return new q(this.x,
...
y=c[7],E=c[8];return[b*p+l*v+a*d,b*q+l*r+a*y,b*w+l*u+a*E,e*p+f*v+A*d,e*q+f*r+A*y,e*w+f*u+A*E,s*p+j*v+n*d,s*q+j*r+n*y,s*w+j*u+n*E]}});_.extend(p.prototype,{set:function(m,c,b,l,a,e){var f=m;_.isArray(f)||(f=_.toArray(arguments));_.each(f,function(a,b){_.isNumber(a)&&(this.elements[b]=a)},this);return this},identity:function(){this.set(p.Identity);return this},multiply:function(m,c,b,l,a,e,f,A,s){var j=arguments,n=j.length;if(1>=n)return _.each(this.elements,function(a,b){this.elements[b]=a*m},this),
...
a.top,c=a.left,f=a.right;a=a.bottom;return new Two.Array([c,b,f,b,c,a,c,a,f,b,f,a])},updateCanvas:function(a){var b=a.commands,c=this.canvas,f=this.ctx,l=a._scale,j=a.stroke,m=a.linewidth*l,n=a.fill,q=a.opacity,w=a.cap,v=a.join,r=a.miter,u=a.curved,d=a.closed,y=b.length,E=y-1;c.width=Math.max(Math.ceil(a.rect.width*l),1);c.height=Math.max(Math.ceil(a.rect.height*l),1);a=a.rect.centroid;var F=a.x*l,I=a.y*l;f.clearRect(0,0,c.width,c.height);n&&(f.fillStyle=n);j&&(f.strokeStyle=j);m&&(f.lineWidth=m);
r&&(f.miterLimit=r);v&&(f.lineJoin=v);w&&(f.lineCap=w);_.isNumber(q)&&(f.globalAlpha=q);f.beginPath();_.each(b,function(a,c){var j=(a.x*l+F).toFixed(3),m=(a.y*l+I).toFixed(3);if(u){var n=d?p(c-1,y):Math.max(c-1,0),t=d?p(c+1,y):Math.min(c+1,E),q=b[n],t=b[t],n=(q.v.x*l+F).toFixed(3),q=(q.v.y*l+I).toFixed(3),r=(a.u.x*l+F).toFixed(3),k=(a.u.y*l+I).toFixed(3);0>=c?f.moveTo(j,m):(f.bezierCurveTo(n,q,r,k,j,m),c>=E&&d&&(n=(a.v.x*l+F).toFixed(3),q=(a.v.y*l+I).toFixed(3),r=(t.u.x*l+F).toFixed(3),k=(t.u.y*l+
I).toFixed(3),j=(t.x*l+F).toFixed(3),m=(t.y*l+I).toFixed(3),f.bezierCurveTo(n,q,r,k,j,m)))}else 0>=c?f.moveTo(j,m):f.lineTo(j,m)});d&&!u&&f.closePath();f.fill();f.stroke()},updateTexture:function(a,b){this.updateCanvas(b);b.texture&&a.deleteTexture(b.texture);a.bindBuffer(a.ARRAY_BUFFER,b.textureCoordsBuffer);b.texture=a.createTexture();a.bindTexture(a.TEXTURE_2D,b.texture);a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_S,a.CLAMP_TO_EDGE);a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_T,a.CLAMP_TO_EDGE);

(function(){var B=this,m=B._,h={},f=Array.prototype,q=Object.prototype,p=f.push,d=f.slice,n=f.concat,l=q.toString,v=q.hasOwnProperty,G=f.forEach,z=f.map,s=f.reduce,c=f.reduceRight,C=f.filter,w=f.every,A=f.some,x=f.indexOf,y=f.lastIndexOf,q=Array.isArray,E=Object.keys,F=Function.prototype.bind,a=function(e){if(e instanceof a)return e;if(!(this instanceof a))return new a(e);this._wrapped=e};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=a),exports._=
a):B._=a;a.VERSION="1.5.1";var b=a.each=a.forEach=function(e,k,t){if(null!=e)if(G&&e.forEach===G)e.forEach(k,t);else if(e.length===+e.length)for(var b=0,c=e.length;b<c&&k.call(t,e[b],b,e)!==h;b++);else for(b in e)if(a.has(e,b)&&k.call(t,e[b],b,e)===h)break};a.map=a.collect=function(e,a,t){var c=[];if(null==e)return c;if(z&&e.map===z)return e.map(a,t);b(e,function(e,b,g){c.push(a.call(t,e,b,g))});return c};a.reduce=a.foldl=a.inject=function(e,k,t,c){var g=2<arguments.length;null==e&&(e=[]);if(s&&e.reduce===
...
e)})};a.zip=function(){for(var e=a.max(a.pluck(arguments,"length").concat(0)),k=Array(e),b=0;b<e;b++)k[b]=a.pluck(arguments,""+b);return k};a.object=function(e,a){if(null==e)return{};for(var b={},c=0,g=e.length;c<g;c++)a?b[e[c]]=a[c]:b[e[c][0]]=e[c][1];return b};a.indexOf=function(e,b,c){if(null==e)return-1;var g=0,r=e.length;if(c)if("number"==typeof c)g=0>c?Math.max(0,r+c):c;else return g=a.sortedIndex(e,b),e[g]===b?g:-1;if(x&&e.indexOf===x)return e.indexOf(b,c);for(;g<r;g++)if(e[g]===b)return g;
return-1};a.lastIndexOf=function(e,a,b){if(null==e)return-1;var c=null!=b;if(y&&e.lastIndexOf===y)return c?e.lastIndexOf(a,b):e.lastIndexOf(a);for(b=c?b:e.length;b--;)if(e[b]===a)return b;return-1};a.range=function(a,b,c){1>=arguments.length&&(b=a||0,a=0);c=arguments[2]||1;for(var g=Math.max(Math.ceil((b-a)/c),0),r=0,d=Array(g);r<g;)d[r++]=a,a+=c;return d};var D=function(){};a.bind=function(e,b){var c,g;if(F&&e.bind===F)return F.apply(e,d.call(arguments,1));if(!a.isFunction(e))throw new TypeError;
...
"|$","g"),f=0,l="__p+='";b.replace(d,function(a,c,g,r,d){l+=b.slice(f,d).replace(L,function(a){return"\\"+O[a]});c&&(l+="'+\n((__t=("+c+"))==null?'':_.escape(__t))+\n'");g&&(l+="'+\n((__t=("+g+"))==null?'':__t)+\n'");r&&(l+="';\n"+r+"\n__p+='");f=d+a.length;return a});l+="';\n";g.variable||(l="with(obj||{}){\n"+l+"}\n");l="var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};\n"+l+"return __p;\n";try{r=new Function(g.variable||"obj","_",l)}catch(u){throw u.source=
...
context:p,ctx:p||this});return this},once:function(f,q,p){var d=this,n=_.once(function(){d.off(f,n);q.apply(this,arguments)});n._callback=q;this.on(f,n,p);return this},off:function(f,q,p){var d,n,l,h,m,z,s,c;if(!this._events)return this;if(!f&&!q&&!p)return this._events={},this;h=f?[f]:_.keys(this._events);m=0;for(z=h.length;m<z;m++)if(f=h[m],d=this._events[f]){l=[];if(q||p)for(s=0,c=d.length;s<c;s++)n=d[s],(q&&q!==(n.callback._callback||n.callback)||p&&p!==n.context)&&l.push(n);this._events[f]=l}return this},
...
Version:"v0.4.0",Identifier:"two-",Properties:{hierarchy:"hierarchy",demotion:"demotion"},Events:{play:"play",pause:"pause",update:"update",render:"render",resize:"resize",change:"change",remove:"remove",insert:"insert"},Commands:{move:"M",line:"L",curve:"C",close:"Z"},Resolution:8,Instances:[],noConflict:function(){m.Two=h;return this},uniqueId:function(){var a=z;z++;return a},Utils:{Curve:{CollinearityEpsilon:G(10,-30),RecursionLimit:16,CuspLimit:0,Tolerance:{distance:0.25,angle:0,epsilon:0.01}},
...
g[8],g[9]);r=r.parent}return b},applySvgAttributes:function(a,b){b.cap="butt";b.join="bevel";_.each(a.attributes,function(a,c){switch(a.nodeName){case "visibility":b.visible=!!a.nodeValue;break;case "stroke-linecap":b.cap=a.nodeValue;break;case "stroke-linejoin":b.join=a.nodeValue;break;case "stroke-miterlimit":b.miter=a.nodeValue;break;case "stroke-width":b.linewidth=parseFloat(a.nodeValue);break;case "stroke-opacity":case "fill-opacity":b.opacity=a.nodeValue;break;case "fill":b.fill=a.nodeValue;
break;case "stroke":b.stroke=a.nodeValue}});return b},read:{svg:function(){return c.Utils.read.g.apply(this,arguments)},g:function(a){var b=new c.Group;this.add(b);_.each(a.childNodes,function(a){var g=a.nodeName;g&&(g=g.replace(/svg\:/ig,"").toLowerCase(),g in c.Utils.read&&(a=c.Utils.read[g].call(this,a),b.add(a)))},this);return c.Utils.applySvgAttributes(a,b)},polygon:function(a,b){var d=[];a.getAttribute("points").replace(/([\d\.?]+),([\d\.?]+)/g,function(a,b,g){d.push(new c.Anchor(parseFloat(b),
parseFloat(g)))});var g=(new c.Polygon(d,!b)).noStroke();return c.Utils.applySvgAttributes(a,g)},polyline:function(a){return c.Utils.read.polygon(a,!0)},path:function(a){var b,d,g,l=!1,f=!1,n=a.getAttribute("d").match(/[a-df-z][^a-df-z]*/ig),q=n.length-1,n=_.flatten(_.map(n,function(a,n){var h,p,m=a[0],v=m.toLowerCase();g=a.slice(1).trim();g=g.replace(/(-?\d+(?:\.\d*)?)[eE]([+\-]?\d+)/g,function(a,b,e){return parseFloat(b)*Math.pow(10,e)});g=g.split(/[\s,]+|(?=\s?[+\-])/);l=m===v;var e,k,t,s;switch(v){case "z":n>=
q?f=!0:(p=b.x,h=b.y,h=new c.Anchor(p,h,void 0,void 0,void 0,void 0,c.Commands.close));break;case "m":case "l":p=parseFloat(g[0]);h=parseFloat(g[1]);h=new c.Anchor(p,h,void 0,void 0,void 0,void 0,"m"===v?c.Commands.move:c.Commands.line);l&&h.addSelf(b);b=h;break;case "h":case "v":p="h"===v?"x":"y";m="x"===p?"y":"x";h=new c.Anchor(void 0,void 0,void 0,void 0,void 0,void 0,c.Commands.line);h[p]=parseFloat(g[0]);h[m]=b[m];l&&(h[p]+=b[p]);b=h;break;case "s":case "c":h=b.x;m=b.y;d||(d=(new c.Vector).copy(b));
"c"===v?(e=parseFloat(g[0]),p=parseFloat(g[1]),v=parseFloat(g[2]),k=parseFloat(g[3]),t=parseFloat(g[4]),s=parseFloat(g[5])):(k=c.Utils.getReflection(b,d,l),e=k.x,p=k.y,v=parseFloat(g[0]),k=parseFloat(g[1]),t=parseFloat(g[2]),s=parseFloat(g[3]));l&&(e+=h,p+=m,v+=h,k+=m,t+=h,s+=m);_.isObject(b.controls)||c.Anchor.AppendCurveProperties(b);b.controls.right.set(e,p);b=h=new c.Anchor(t,s,v,k,void 0,void 0,c.Commands.curve);d=h.controls.left;break;case "t":case "q":h=b.x;m=b.y;d||(d=(new c.Vector).copy(b));
d.isZero()?(e=h,p=m):(e=d.x,m=d.y);"q"===v?(v=parseFloat(g[0]),k=parseFloat(g[1]),t=parseFloat(g[1]),s=parseFloat(g[2])):(k=c.Utils.getReflection(b,d,l),v=k.x,k=k.y,t=parseFloat(g[0]),s=parseFloat(g[1]));l&&(e+=h,p+=m,v+=h,k+=m,t+=h,s+=m);_.isObject(b.controls)||c.Anchor.AppendCurveProperties(b);b.controls.right.set(e,p);b=h=new c.Anchor(t,s,v,k,void 0,void 0,c.Commands.curve);d=h.controls.left;break;case "a":throw new c.Utils.Error("not yet able to interpret Elliptical Arcs.");}return h}));if(!(1>=
n.length))return n=_.compact(n),n=(new c.Polygon(n,f,void 0,!0)).noStroke(),c.Utils.applySvgAttributes(a,n)},circle:function(a){var b=parseFloat(a.getAttribute("cx")),d=parseFloat(a.getAttribute("cy")),g=parseFloat(a.getAttribute("r")),h=c.Resolution,u=_.map(_.range(h),function(a){var b=a/h*l;a=g*q(b);b=g*f(b);return new c.Anchor(a,b)},this),u=(new c.Polygon(u,!0,!0)).noStroke();u.translation.set(b,d);return c.Utils.applySvgAttributes(a,u)},ellipse:function(a){var b=parseFloat(a.getAttribute("cx")),
...
b,d,g,l,f,h,n,q){var p=q=q||c.Utils.Curve.RecursionLimit;return _.map(_.range(0,p),function(q){var m=q/p;q=F(m,a,d,l,h);m=F(m,b,g,f,n);return new c.Anchor(q,m)})},getPointOnCubicBezier:function(a,b,c,g,d){var l=1-a;return l*l*l*b+3*l*l*a*c+3*l*a*a*g+a*a*a*d},getCurveFromPoints:function(a,b){for(var d=a.length,g=d-1,l=0;l<d;l++){var f=a[l];_.isObject(f.controls)||c.Anchor.AppendCurveProperties(f);var h=b?y(l-1,d):Math.max(l-1,0),n=b?y(l+1,d):Math.min(l+1,g);x(a[h],f,a[n]);f._command=0===l?c.Commands.move:
...
arguments[0]-arguments[2],g=arguments[1]-arguments[3],p(g,c);c=a.x-b.x;g=a.y-b.y;return p(g,c)},distanceBetweenSquared:function(a,b){var c=a.x-b.x,g=a.y-b.y;return c*c+g*g},distanceBetween:function(a,b){return d(w(a,b))},mod:function(a,b){for(;0>a;)a+=b;return a%b},Collection:function(){Array.call(this);1<arguments.length?Array.prototype.push.apply(this,arguments):arguments[0]&&Array.isArray(arguments[0])&&Array.prototype.push.apply(this,arguments[0])},Error:function(a){this.name="two.js";this.message=
...
!0);Backbone.Events.bind.apply(this,arguments);return this}})();(function(){var B=Two.Commands,m,h,f,q=Two.Anchor=function(d,f,h,p,m,z,s){Two.Vector.call(this,d,f);this._broadcast=_.bind(function(){this.trigger(Two.Events.change)},this);Object.defineProperty(this,"command",{get:function(){return this._command},set:function(c){this._command=c;this._command!==B.curve||_.isObject(this.controls)||q.AppendCurveProperties(this);return this.trigger(Two.Events.change)}});this._command=s||B.move;if(!s)return this;q.AppendCurveProperties(this);_.isNumber(h)&&(this.controls.left.x=
h);_.isNumber(p)&&(this.controls.left.y=p);_.isNumber(m)&&(this.controls.right.x=m);_.isNumber(z)&&(this.controls.right.y=z)};_.extend(q,{AppendCurveProperties:function(d){m=d._x||d.x;h=d._y||d.y;d.controls={left:new Two.Vector(m,h),right:new Two.Vector(m,h)}}});var p={listen:function(){_.isObject(this.controls)||q.AppendCurveProperties(this);_.each(this.controls,function(d){d.bind(Two.Events.change,this._broadcast)},this);return this},ignore:function(){_.each(this.controls,function(d){d.unbind(Two.Events.change,
this._broadcast)},this);return this},clone:function(){f=this.controls;return new Two.Anchor(this.x,this.y,f&&f.left.x,f&&f.left.y,f&&f.right.x,f&&f.right.y,this.command)}};_.extend(q.prototype,Two.Vector.prototype,p);Two.Anchor.prototype.bind=Two.Anchor.prototype.on=function(){Two.Vector.prototype.bind.apply(this,arguments);_.extend(this,p)}})();(function(){_.range(6);var B=Math.cos,m=Math.sin,h=Math.tan,f,q,p,d,n,l,v,G,z,s,c,C,w,A,x,y,E,F,a,b,r,g,H,u,D,I,J,M,P,N,O,L,e,k,t,ea,S,T,$,ba,U,V,W,X,aa,ca,da,Y,Q,Z=[],fa=Two.Matrix=function(a,b,c,e,d,g){this.elements=new Two.Array(9);var f=a;_.isArray(f)||(f=_.toArray(arguments));this.identity().set(f)};_.extend(fa,{Identity:[1,0,0,0,1,0,0,0,1],Multiply:function(c,e,d){if(3>=e.length)return C,w,A,f=e[0]||0,q=e[1]||0,p=e[2]||0,n=c,C=n[0]*f+n[1]*q+n[2]*p,w=n[3]*f+n[4]*q+n[5]*p,A=n[6]*f+n[7]*q+n[8]*
p,{x:C,y:w,z:A};x=c[0];y=c[1];E=c[2];F=c[3];a=c[4];b=c[5];r=c[6];g=c[7];H=c[8];u=e[0];D=e[1];I=e[2];J=e[3];M=e[4];P=e[5];N=e[6];O=e[7];L=e[8];d=d||new Two.Array(9);d[0]=x*u+y*J+E*N;d[1]=x*D+y*M+E*O;d[2]=x*I+y*P+E*L;d[3]=F*u+a*J+b*N;d[4]=F*D+a*M+b*O;d[5]=F*I+a*P+b*L;d[6]=r*u+g*J+H*N;d[7]=r*D+g*M+H*O;d[8]=r*I+g*P+H*L;return d}});_.extend(fa.prototype,Backbone.Events,{set:function(a,b,e,d,g,f){c=a;t=arguments.length;_.isArray(c)||(c=_.toArray(arguments));_.each(c,function(a,b){_.isNumber(a)&&(this.elements[b]=
a)},this);return this.trigger(Two.Events.change)},identity:function(){this.set(fa.Identity);return this},multiply:function(d,f,h,l,n,q,p,m,ma){c=arguments;t=c.length;if(1>=t)return _.each(this.elements,function(a,b){this.elements[b]=a*d},this),this.trigger(Two.Events.change);if(3>=t)return C,w,A,d=d||0,f=f||0,h=h||0,n=this.elements,C=n[0]*d+n[1]*f+n[2]*h,w=n[3]*d+n[4]*f+n[5]*h,A=n[6]*d+n[7]*f+n[8]*h,{x:C,y:w,z:A};e=this.elements;k=c;x=e[0];y=e[1];E=e[2];F=e[3];a=e[4];b=e[5];r=e[6];g=e[7];H=e[8];u=
k[0];D=k[1];I=k[2];J=k[3];M=k[4];P=k[5];N=k[6];O=k[7];L=k[8];this.elements[0]=x*u+y*J+E*N;this.elements[1]=x*D+y*M+E*O;this.elements[2]=x*I+y*P+E*L;this.elements[3]=F*u+a*J+b*N;this.elements[4]=F*D+a*M+b*O;this.elements[5]=F*I+a*P+b*L;this.elements[6]=r*u+g*J+H*N;this.elements[7]=r*D+g*M+H*O;this.elements[8]=r*I+g*P+H*L;return this.trigger(Two.Events.change)},inverse:function(a){f=this.elements;a=a||new Two.Matrix;S=f[0];T=f[1];$=f[2];ba=f[3];U=f[4];V=f[5];W=f[6];X=f[7];aa=f[8];ca=aa*U-V*X;da=-aa*
...
parseFloat(c[8].toFixed(3));if(s){b[0]=f;b[1]=d;b[2]=v;b[3]=q;b[4]=n;b[5]=G;b[6]=p;b[7]=l;b[8]=z;return}return[f,d,v,q,n,G,p,l,z]}if(s)b[0]=f,b[1]=d,b[2]=q,b[3]=n,b[4]=p,b[5]=l;else return[f,d,q,n,p,l]},clone:function(){f=this.elements[0];q=this.elements[1];p=this.elements[2];d=this.elements[3];n=this.elements[4];l=this.elements[5];v=this.elements[6];G=this.elements[7];z=this.elements[8];return new Two.Matrix(f,q,p,d,n,l,v,G,z)}})})();(function(){var B=Two.Utils.mod,m,h,f,q={version:1.1,ns:"http://www.w3.org/2000/svg",xlink:"http://www.w3.org/1999/xlink",createElement:function(d,n){f=d;h=document.createElementNS(this.ns,f);"svg"===f&&(n=_.defaults(n||{},{version:this.version}));_.isObject(n)&&q.setAttributes(h,n);return h},setAttribute:function(d,f){this.setAttribute(f,d)},setAttributes:function(d,f){_.each(f,q.setAttribute,d);return this},removeAttribute:function(d,f){this.removeAttribute(f)},removeAttributes:function(d,f){_.each(f,
q.removeAttribute,d);return this},toString:function(d,f){var h=d.length,q=h-1;return _.map(d,function(p,m){var s,c=f?B(m-1,h):Math.max(m-1,0),C=f?B(m+1,h):Math.min(m+1,q),c=d[c],C=d[C],w,A,x,y,E;E=p.x.toFixed(3);y=p.y.toFixed(3);switch(p._command){case Two.Commands.close:s=Two.Commands.close;break;case Two.Commands.curve:w=c.controls&&c.controls.right||c;s=p.controls&&p.controls.left||p;c=w.x.toFixed(3);w=w.y.toFixed(3);A=s.x.toFixed(3);x=s.y.toFixed(3);s=(0===m?Two.Commands.move:Two.Commands.curve)+
" "+c+" "+w+" "+A+" "+x+" "+E+" "+y;break;default:s=(0===m?Two.Commands.move:p._command)+" "+E+" "+y}m>=q&&f&&(p._command===Two.Commands.curve&&(y=p.controls&&p.controls.right||p,E=C.controls&&C.controls.left||C,c=y.x.toFixed(3),w=y.y.toFixed(3),A=E.x.toFixed(3),x=E.y.toFixed(3),E=C.x.toFixed(3),y=C.y.toFixed(3),s+=" C "+c+" "+w+" "+A+" "+x+" "+E+" "+y),s+=" Z");return s}).join(" ")},group:{appendChild:function(d){(h=this.domElement.querySelector("#"+Two.Identifier+d))&&this.elem.appendChild(h)},
removeChild:function(d){(h=this.domElement.querySelector("#"+Two.Identifier+d))&&this.elem.removeChild(h)},renderChild:function(d){q[d._renderer.type].render.call(d,this)},render:function(d){this.update();this._renderer.elem||(this._renderer.elem=q.createElement("g",{id:Two.Identifier+this.id}),d.appendChild(this._renderer.elem));m=this._matrix.manual||this._flagMatrix;var f={domElement:d,elem:this._renderer.elem};m&&this._renderer.elem.setAttribute("transform","matrix("+this._matrix.toString()+")");
_.each(this.children,q.group.renderChild,d);this._flagAdditions&&_.each(this.additions,q.group.appendChild,f);this._flagSubtractions&&_.each(this.subtractions,q.group.removeChild,f);return this.flagReset()}},polygon:{render:function(d){this.update();this._renderer.elem||(this._renderer.elem=q.createElement("path",{id:Two.Identifier+this.id}),d.appendChild(this._renderer.elem));h=this._renderer.elem;(m=this._matrix.manual||this._flagMatrix)&&h.setAttribute("transform","matrix("+this._matrix.toString()+
...
this.domElement);return this}})})();(function(){var B=Two.Utils.mod,m=Two.Utils.getRatio,h,f,q,p,d,n,l,v,G,z,s,c,C,w,A,x,y,E,F,a,b,r,g,H,u,D,I,J={group:{renderChild:function(a){J[a._renderer.type].render.call(a,this)},render:function(a){this.update();h=this._matrix.elements;a.save();a.transform(h[0],h[3],h[1],h[4],h[2],h[5]);_.each(this.children,J.group.renderChild,a);a.restore();return this.flagReset()}},polygon:{render:function(m){this.update();h=this._matrix.elements;f=this.stroke;q=this.linewidth;p=this.fill;d=this.opacity;n=this.visible;
l=this.cap;v=this.join;G=this.miter;z=this.closed;s=this._vertices;c=s.length;C=c-1;if(!n)return this;m.save();h&&m.transform(h[0],h[3],h[1],h[4],h[2],h[5]);p&&(m.fillStyle=p);f&&(m.strokeStyle=f);q&&(m.lineWidth=q);G&&(m.miterLimit=G);v&&(m.lineJoin=v);l&&(m.lineCap=l);_.isNumber(d)&&(m.globalAlpha=d);m.beginPath();_.each(s,function(d,f){D=d.x.toFixed(3);I=d.y.toFixed(3);switch(d._command){case Two.Commands.close:m.closePath();break;case Two.Commands.curve:A=z?B(f-1,c):Math.max(f-1,0);w=z?B(f+1,
c):Math.min(f+1,C);x=s[A];y=s[w];r=x.controls&&x.controls.right||x;g=d.controls&&d.controls.left||d;a=r.x.toFixed(3);b=r.y.toFixed(3);E=g.x.toFixed(3);F=g.y.toFixed(3);m.bezierCurveTo(a,b,E,F,D,I);f>=C&&z&&(H=d.controls&&d.controls.right||d,u=y.controls&&y.controls.left||y,a=H.x.toFixed(3),b=H.y.toFixed(3),E=u.x.toFixed(3),F=u.y.toFixed(3),D=y.x.toFixed(3),I=y.y.toFixed(3),m.bezierCurveTo(a,b,E,F,D,I));break;case Two.Commands.line:m.lineTo(D,I);break;case Two.Commands.move:m.moveTo(D,I)}});z&&m.closePath();
m.fill();m.stroke();m.restore();return this.flagReset()}}},M=Two[Two.Types.canvas]=function(a){this.domElement=a.domElement||document.createElement("canvas");this.ctx=this.domElement.getContext("2d");this.overdraw=!1;this.scene=new Two.Group;this.scene.parent=this};_.extend(M,{Utils:J});_.extend(M.prototype,Backbone.Events,{setSize:function(a,b,c){this.width=a;this.height=b;this.ratio=_.isUndefined(c)?m(this.ctx):c;this.domElement.width=a*this.ratio;this.domElement.height=b*this.ratio;_.extend(this.domElement.style,
{width:a+"px",height:b+"px"});return this},render:function(){var a=1===this.ratio;a||(this.ctx.save(),this.ctx.scale(this.ratio,this.ratio));this.overdraw||this.ctx.clearRect(0,0,this.width,this.height);J.group.render.call(this.scene,this.ctx);a||this.ctx.restore();return this}})})();(function(){var B=Two.Matrix.Multiply,m=Two.Utils.mod,h=[1,0,0,0,1,0,0,0,1],f=new Two.Array(9),q=Two.Utils.getRatio,p,d,n,l,v,G,z,s,c,C,w,A,x,y,E,F,a,b,r,g,H,u,D,I,J,M,P,N,O,L,e,k,t,ea,S,T,$,ba,U,V,W,X,aa,ca,da,Y,Q,Z,fa,ga,K,ia,ja,ka,ha,R={canvas:document.createElement("canvas"),uv:new Two.Array([0,0,1,0,0,1,0,1,1,0,1,1]),group:{renderChild:function(a){R[a._renderer.type].render.call(a,this.gl,this.program)},render:function(a,b){this.update();p=this.parent;d=p._matrix&&p._matrix.manual||p._flagMatrix;
...
l=this._flagVertices||this._flagFill||this._flagStroke||this._flagLinewidth||this._flagOpacity||this._flagVisible||this._flagCap||this._flagJoin||this._flagMiter||this._flagScale;this.update();if(d||n)this._renderer.matrix||(this._renderer.matrix=new Two.Array(9)),this._matrix.toArray(!0,f),B(f,p._renderer.matrix,this._renderer.matrix),this._renderer.scale=this._scale*p._renderer.scale;l&&(this._renderer.rect||(this._renderer.rect={}),this._renderer.triangles||(this._renderer.triangles=new Two.Array(12)),
...
!1,0,0);a.drawArrays(a.TRIANGLES,0,6);return this.flagReset()}},getBoundingClientRect:function(e,d,g){v=Infinity;G=-Infinity;z=Infinity;s=-Infinity;_.each(e,function(b,d){c=b.x;C=b.y;w;A;x;y;E=b.controls;z=Math.min(C,z);v=Math.min(c,v);G=Math.max(c,G);s=Math.max(C,s);b.controls&&(F=E.left,a=E.right,F&&a&&(w=F.x,A=F.y,x=a.x,y=a.y,w&&(A&&x&&y)&&(z=Math.min(A,y,z),v=Math.min(w,x,v),G=Math.max(w,x,G),s=Math.max(A,y,s))))});_.isNumber(d)&&(z-=d,v-=d,G+=d,s+=d);b=G-v;r=s-z;g.top=z;g.left=v;g.right=G;g.bottom=
s;g.width=b;g.height=r;g.centroid||(g.centroid={});g.centroid.x=-v;g.centroid.y=-z},getTriangles:function(a,b){z=a.top;v=a.left;G=a.right;s=a.bottom;b[0]=v;b[1]=z;b[2]=G;b[3]=z;b[4]=v;b[5]=s;b[6]=v;b[7]=s;b[8]=G;b[9]=z;b[10]=G;b[11]=s},updateCanvas:function(a){g=a._vertices;H=this.canvas;u=this.ctx;D=a._renderer.scale;I=a._stroke;J=a._linewidth*D;M=a._fill;P=a._opacity;N=a._cap;O=a._join;L=a._miter;e=a._closed;k=g.length;t=k-1;H.width=Math.max(Math.ceil(a._renderer.rect.width*D),1);H.height=Math.max(Math.ceil(a._renderer.rect.height*
D),1);ea=a._renderer.rect.centroid;S=ea.x*D;T=ea.y*D;u.clearRect(0,0,H.width,H.height);M&&(u.fillStyle=M);I&&(u.strokeStyle=I);J&&(u.lineWidth=J);L&&(u.miterLimit=L);O&&(u.lineJoin=O);N&&(u.lineCap=N);_.isNumber(P)&&(u.globalAlpha=P);u.beginPath();_.each(g,function(a,b){$;ba;w;x;U;V;W;X;aa;ca;da;F;c=(a.x*D+S).toFixed(3);C=(a.y*D+T).toFixed(3);switch(a._command){case Two.Commands.close:u.closePath();break;case Two.Commands.curve:ba=e?m(b-1,k):Math.max(b-1,0);$=e?m(b+1,k):Math.min(b+1,t);w=g[ba];x=
g[$];aa=w.controls&&w.controls.right||w;ca=a.controls&&a.controls.left||a;W=(aa.x*D+S).toFixed(3);X=(aa.y*D+T).toFixed(3);U=(ca.x*D+S).toFixed(3);V=(ca.y*D+T).toFixed(3);u.bezierCurveTo(W,X,U,V,c,C);b>=t&&e&&(da=a.controls&&a.controls.right||a,F=x.controls&&x.controls.left||x,W=(da.x*D+S).toFixed(3),X=(da.y*D+T).toFixed(3),U=(F.x*D+S).toFixed(3),V=(F.y*D+T).toFixed(3),c=(x.x*D+S).toFixed(3),C=(x.y*D+T).toFixed(3),u.bezierCurveTo(W,X,U,V,c,C));break;case Two.Commands.line:u.lineTo(c,C);break;case Two.Commands.move:u.moveTo(c,
...
d);verticesChanged=!0;c(this._collection)}})}});_.extend(L.prototype,Two.Shape.prototype,{_flagVertices:!0,_flagFill:!0,_flagStroke:!0,_flagLinewidth:!0,_flagOpacity:!0,_flagVisible:!0,_flagCap:!0,_flagJoin:!0,_flagMiter:!0,_fill:"#fff",_stroke:"#000",_linewidth:1,_opacity:1,_visible:!0,_cap:"round",_join:"round",_miter:4,_closed:!0,_curved:!1,_automatic:!0,_beginning:0,_ending:1,clone:function(a){a=a||this.parent;z=_.map(this.vertices,function(a){return a.clone()});s=new L(z,this.closed,this.curved,
!this.automatic);_.each(Two.Shape.Properties,function(a){s[a]=this[a]},this);s.translation.copy(this.translation);s.rotation=this.rotation;s.scale=this.scale;a.add(s);return s},noFill:function(){this.fill="transparent";return this},noStroke:function(){this.stroke="transparent";return this},corner:function(){c=this.getBoundingClientRect(!0);c.centroid={x:c.left+c.width/2,y:c.top+c.height/2};_.each(this.vertices,function(a){a.addSelf(c.centroid)});return this},center:function(){c=this.getBoundingClientRect(!0);
c.centroid={x:c.left+c.width/2,y:c.top+c.height/2};_.each(this.vertices,function(a){a.subSelf(c.centroid)});return this},remove:function(){if(!this.parent)return this;this.parent.remove(this);return this},getBoundingClientRect:function(c){this.update();C=this.linewidth/2;void 0;w=Infinity;A=-Infinity;x=Infinity;y=-Infinity;_.each(this._vertices,function(a){E=a.x;F=a.y;x=B(F,x);w=B(E,w);A=m(E,A);y=m(F,y)});x-=C;w-=C;A+=C;y+=C;H=c?this._matrix:f(this);a=H.multiply(w,x,1);b=H.multiply(A,x,1);r=H.multiply(A,
y,1);g=H.multiply(w,y,1);x=B(a.y,b.y,r.y,g.y);w=B(a.x,b.x,r.x,g.x);A=m(a.x,b.x,r.x,g.x);y=m(a.y,b.y,r.y,g.y);return{top:x,left:w,right:A,bottom:y,width:A-w,height:y-x}},plot:function(){if(this.curved)return Two.Utils.getCurveFromPoints(this.vertices,this.closed),this;_.each(this.vertices,function(a,b){a._command=0===b?Two.Commands.move:Two.Commands.line},this);return this},subdivide:function(a){this.update();n=this.vertices.length-1;b=this.vertices[n];l=this._closed||this.vertices[n].command===Two.Commands.close;
z=[];_.each(this.vertices,function(c,d){if(!(0>=d&&!l||c.command===Two.Commands.move)){A=b.controls&&b.controls.right;w=c.controls&&c.controls.left;u=b.x;D=b.y;I=(A||b).x;J=(A||b).y;M=(w||c).x;P=(w||c).y;N=c.x;O=c.y;var g=Two.Utils.subdivide(u,D,I,J,M,P,N,O,a);z=z.concat(g);_.each(g,function(a,c){a.command=0>=c&&b.command===Two.Commands.move?Two.Commands.move:Two.Commands.line});d>=n&&z.push(new Two.Anchor(N,O,void 0,void 0,void 0,void 0,l?Two.Commands.close:Two.Commands.line))}b=c},this);this._curved=
this._automatic=!1;this.vertices=z;return this},update:function(){if(this._flagVertices)for(this._automatic&&this.plot(),q=this.vertices.length,n=q-1,p=h(this._beginning*n),d=h(this._ending*n),this._vertices.length=0,G=p;G<d+1;G++)v=this.vertices[G],this._vertices.push(v);Two.Shape.prototype.update.call(this);return this},flagReset:function(){this._flagVertices=this._flagFill=this._flagStroke=this._flagLinewidth=this._flagOpacity=this._flagVisible=this._flagCap=this._flagJoin=this._flagMiter=!1;Two.Shape.prototype.flagReset.call(this);
return this}});L.MakeObservable(L.prototype)})();(function(){var B=Math.min,m=Math.max,h,f,q,p,d,n,l,v,G,z,s,c,C,w,A,x,y,E,F,a,b,r=Two.Group=function(a){Two.Shape.call(this,!0);this._renderer.type="group";this.additions=[];this.subtractions=[];this.children={}};_.extend(r,{MakeObservable:function(a){Two.Shape.MakeObservable(a);r.MakeGetterSetter(a,Two.Polygon.Properties)},MakeGetterSetter:function(a,b){_.isArray(b)||(b=[b]);_.each(b,function(b){h="_"+b;Object.defineProperty(a,b,{get:function(){return this[h]},set:function(a){this[h]=a;_.each(this.children,
function(c){c[b]=a})}})})}});_.extend(r.prototype,Two.Shape.prototype,{_flagAdditions:!1,_flagSubtractions:!1,_fill:"#fff",_stroke:"#000",_linewidth:1,_opacity:1,_visible:!0,_cap:"round",_join:"round",_miter:4,_closed:!0,_curved:!1,_automatic:!0,_beginning:0,_ending:1,clone:function(a){a=a||this.parent;q=_.map(this.children,function(a){return a.clone()});p=new r;a.add(p);p.add(q);p.translation.copy(this.translation);p.rotation=this.rotation;p.scale=this.scale;return p},corner:function(){d=this.getBoundingClientRect(!0);
n={x:d.left,y:d.top};_.each(this.children,function(a){a.translation.subSelf(n)});return this},center:function(){d=this.getBoundingClientRect(!0);d.centroid={x:d.left+d.width/2,y:d.top+d.height/2};_.each(this.children,function(a){a.translation.subSelf(d.centroid)});return this},add:function(a){l=arguments.length;v=a;q=this.children;G=this.parent;z=this.additions;_.isArray(a)||(v=_.toArray(arguments));_.each(v,function(a){a&&(s=a.id,f=a.parent,_.isUndefined(q[s])&&(f&&(delete f.children[s],b=_.indexOf(f.additions,
s),0<=b&&f.additions.splice(b,1)),q[s]=a,a.parent=this,z.push(s),this._flagAdditions=!0))},this);return this},remove:function(a){l=arguments.length;v=a;q=this.children;G=this.parent;z=this.subtractions;if(0>=l&&G)return G.remove(this),this;_.isArray(a)||(v=_.toArray(arguments));_.each(v,function(a){s=a.id;grandchildren=a.children;f=a.parent;s in q&&(delete q[s],delete a.parent,b=_.indexOf(f.additions,s),0<=b&&f.additions.splice(b,1),z.push(s),this._flagSubtractions=!0)},this);return this},getBoundingClientRect:function(b){this.update();
c=Infinity;C=-Infinity;w=Infinity;A=-Infinity;_.each(this.children,function(a){d=a.getBoundingClientRect(!0);_.isNumber(d.top)&&(_.isNumber(d.left)&&_.isNumber(d.right)&&_.isNumber(d.bottom))&&(w=B(d.top,w),c=B(d.left,c),C=m(d.right,C),A=m(d.bottom,A))},this);x=b?this._matrix:Two.Utils.getComputedMatrix(this);y=x.multiply(c,w,1);E=x.multiply(C,w,1);F=x.multiply(C,A,1);a=x.multiply(c,A,1);w=B(y.y,E.y,F.y,a.y);c=B(y.x,E.x,F.x,a.x);C=m(y.x,E.x,F.x,a.x);A=m(y.y,E.y,F.y,a.y);return{top:w,left:c,right:C,
bottom:A,width:C-c,height:A-w}},noFill:function(){_.each(this.children,function(a){a.noFill()});return this},noStroke:function(){_.each(this.children,function(a){a.noStroke()});return this},subdivide:function(){var a=arguments;_.each(this.children,function(b){b.subdivide.apply(b,a)});return this},flagReset:function(){this._flagAdditions&&(this.additions.length=0,this._flagAdditions=!1);this._flagSubtractions&&(this.subtractions.length=0,this._flagSubtractions=!1);Two.Shape.prototype.flagReset.call(this);
return this}});r.MakeObservable(r.prototype)})();

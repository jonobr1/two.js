...
return a})),d=new j.Vector,e=new j.Vector;return _.map(b,function(b){var c,l=!1,m=!1;b=_.flatten(_.map(b.match(/[a-z][^a-z]*/ig),function(a){var b,r,f=a[0],u=f.toLowerCase();c=a.slice(1).trim().split(/[\s,]+|(?=[+-])/);l=f===u;switch(u){case "z":m=!0;break;case "m":case "l":r=parseFloat(c[0]);b=parseFloat(c[1]);b=new j.Vector(r,b);l&&b.addSelf(d);d.copy(b);break;case "h":case "v":r="h"===u?"x":"y";a="x"===r?"y":"x";b=new j.Vector;b[r]=parseFloat(c[0]);b[a]=d[a];l&&(b[r]+=d[r]);d.copy(b);break;case "s":case "c":var t,
s,k;b=d.x;a=d.y;"c"===u?(f=parseFloat(c[0]),r=parseFloat(c[1]),u=parseFloat(c[2]),t=parseFloat(c[3]),s=parseFloat(c[4]),k=parseFloat(c[5])):(t=(new j.Vector).copy(d).subSelf(e),f=parseFloat(t.x),r=parseFloat(t.y),u=parseFloat(c[0]),t=parseFloat(c[1]),s=parseFloat(c[2]),k=parseFloat(c[3]));l&&(f+=b,r+=a,u+=b,t+=a,s+=b,k+=a);b=j.Utils.subdivide(b,a,f,r,u,t,s,k);d.set(s,k);e.set(u,t);break;case "t":case "q":b=d.x;a=d.y;e.isZero()?(f=b,r=a):(f=e.x,a=e.y);"q"===u?(u=parseFloat(c[0]),t=parseFloat(c[1]),
s=parseFloat(c[1]),k=parseFloat(c[2])):(t=(new j.Vector).copy(d).subSelf(e),u=parseFloat(t.x),t=parseFloat(t.y),s=parseFloat(c[0]),k=parseFloat(c[1]));l&&(f+=b,r+=a,u+=b,t+=a,s+=b,k+=a);b=j.Utils.subdivide(b,a,f,r,u,t,s,k);d.set(s,k);e.set(u,t);break;case "a":throw new j.Utils.Error("not yet able to interpret Elliptical Arcs.");}return b}));_.isUndefined(b[b.length-1])&&b.pop();b=(new j.Polygon(b,m)).noStroke();return j.Utils.applySvgAttributes(a,b)})},circle:function(a){var b=parseFloat(a.getAttribute("cx")),
d=parseFloat(a.getAttribute("cy")),c=parseFloat(a.getAttribute("r")),l=j.Resolution,f=_.map(_.range(l),function(a){var b=a/l*e;a=c*m(b);b=c*p(b);return new j.Vector(a,b)},this),f=(new j.Polygon(f,!0,!0)).noStroke();f.translation.set(b,d);return j.Utils.applySvgAttributes(a,f)},ellipse:function(a){var b=parseFloat(a.getAttribute("cx")),d=parseFloat(a.getAttribute("cy")),c=parseFloat(a.getAttribute("rx")),l=parseFloat(a.getAttribute("ry")),f=j.Resolution,t=_.map(_.range(f),function(a){var b=a/f*e;a=
c*m(b);b=l*p(b);return new j.Vector(a,b)},this),t=(new j.Polygon(t,!0,!0)).noStroke();t.translation.set(b,d);return j.Utils.applySvgAttributes(a,t)},rect:function(a){var b=parseFloat(a.getAttribute("x")),d=parseFloat(a.getAttribute("y")),e=parseFloat(a.getAttribute("width")),c=parseFloat(a.getAttribute("height")),e=e/2,c=c/2,l=[new j.Vector(e,c),new j.Vector(-e,c),new j.Vector(-e,-c),new j.Vector(e,-c)],l=(new j.Polygon(l,!0)).noStroke();l.translation.set(b+e,d+c);return j.Utils.applySvgAttributes(a,
...
var q=(b+d)/2,w=(f+m)/2,v=(d+t)/2,k=(m+s)/2,R=(t+A)/2,S=(s+n)/2,T=(q+v)/2,U=(w+k)/2,v=(v+R)/2,k=(k+S)/2,G=(T+v)/2,H=(U+k)/2;if(0<p){var B=A-b,D=n-f,K=l((d-A)*D-(m-n)*B),L=l((t-A)*D-(s-n)*B);if(K>x&&L>x&&(K+L)*(K+L)<=C.distance*(B*B+D*D)){if(C.angle<C.epsilon)return[new j.Vector(G,H)];B=c(s-m,t-d);x=l(B-c(m-f,d-b));B=l(c(n-s,A-t)-B);x>=a&&(x=e-x);B>=a&&(B=e-B);if(x+B<C.angle)return[new j.Vector(G,H)];if(0!==z){if(x>z)return[new j.Vector(d,m)];if(B>z)return[new j.Vector(t,s)]}}}else if(K>x)if(K*K<=
C.distance*(B*B+D*D)){if(C.angle<C.epsilon)return[new j.Vector(G,H)];x=l(c(s-m,t-d)-c(m-f,d-b));x>=a&&(x=e-x);if(x<C.angle)return[new j.Vector(d,m),new j.Vector(t,s)];if(0!==z&&x>z)return[new j.Vector(d,m)]}else if(L>x){if(L*L<=C.distance*(B*B+D*D)){if(C.angle<C.epsilon)return[new j.Vector(G,H)];x=l(c(n-s,A-t)-c(s-m,t-d));x>=a&&(x=e-x);if(x<C.angle)return[new j.Vector(d,m),new j.Vector(t,s)];if(0!==z&&x>z)return[new j.Vector2(t,s)]}}else if(B=G-(b+A)/2,D=H-(f+n)/2,B*B+D*D<=C.distance)return[new j.Vector(G,
H)];return j.Utils.subdivide(b,f,q,w,T,U,G,H,p+1).concat(j.Utils.subdivide(G,H,v,k,R,S,A,n,p+1))},getCurveFromPoints:function(a,b){for(var d=[],e=a.length,c=e-1,j=0;j<e;j++){var l=a[j],m={x:l.x,y:l.y};d.push(m);var l=b?v(j-1,e):Math.max(j-1,0),f=b?v(j+1,e):Math.min(j+1,c);w(a[l],m,a[f]);!m.u.x&&!m.u.y&&(m.u.x=m.x,m.u.y=m.y);!m.v.x&&!m.v.y&&(m.v.x=m.x,m.v.y=m.y)}return d},getControlPoints:function(b,e,d){var c=z(b,e),j=z(d,e);b=x(b,e);d=x(d,e);var l=(c+j)/2;if(1E-4>b||1E-4>d)return e.u={x:e.x,y:e.y},
e.v={x:e.x,y:e.y},e;b*=0.33;d*=0.33;l=j<c?l+t:l-t;c={x:e.x+m(l)*b,y:e.y+p(l)*b};l-=a;j={x:e.x+m(l)*d,y:e.y+p(l)*d};e.u=c;e.v=j;return e},angleBetween:function(a,b){return c(a.y-b.y,a.x-b.x)},distanceBetweenSquared:function(a,b){var d=a.x-b.x,e=a.y-b.y;return d*d+e*e},distanceBetween:function(a,e){return b(C(a,e))},mod:function(a,b){for(;0>a;)a+=b;return a%b},Error:function(a){this.name="two.js";this.message=a}}});j.Utils.Error.prototype=Error();j.Utils.Error.prototype.constructor=j.Utils.Error;var x=
j.Utils.distanceBetween,C=j.Utils.distanceBetweenSquared,z=j.Utils.angleBetween,w=j.Utils.getControlPoints,v=j.Utils.mod;_.extend(j.prototype,Backbone.Events,{appendTo:function(a){a.appendChild(this.renderer.domElement);return this},play:function(){j.Utils.setPlaying.apply(this,arguments);return this.trigger(j.Events.play)},pause:function(){this.playing=!1;return this.trigger(j.Events.pause)},update:function(){this.frameCount++;var a=this.width,b=this.height,d=this.renderer;(a!==d.width||b!==d.height)&&
d.setSize(a,b);this.trigger(j.Events.update,this.frameCount);return this.render()},render:function(){this.renderer.render();return this.trigger(j.Events.render,this.frameCount)},add:function(a){var b=a;_.isArray(a)||(b=_.toArray(arguments));this.scene.add(b);return this},makeLine:function(a,b,d,e){d=(d-a)/2;e=(e-b)/2;var c=[new j.Vector(-d,-e),new j.Vector(d,e)],c=(new j.Polygon(c)).noFill();c.translation.set(a+d,b+e);this.scene.add(c);return c},makeRectangle:function(a,b,d,e){d/=2;e/=2;e=[new j.Vector(d,
e),new j.Vector(-d,e),new j.Vector(-d,-e),new j.Vector(d,-e)];e=new j.Polygon(e,!0);e.translation.set(a,b);this.scene.add(e);return e},makeCircle:function(a,b,d){return this.makeEllipse(a,b,d,d)},makeEllipse:function(a,b,d,c){var l=j.Resolution,f=_.map(_.range(l),function(a){var b=a/l*e;a=d*m(b);b=c*p(b);return new j.Vector(a,b)},this),f=new j.Polygon(f,!0,!0);f.translation.set(a,b);this.scene.add(f);return f},makeCurve:function(a){var b=arguments.length,d=a;if(!_.isArray(a))for(var d=[],e=0;e<b;e+=
2){var c=arguments[e];if(!_.isNumber(c))break;d.push(new j.Vector(c,arguments[e+1]))}var b=arguments[b-1],d=new j.Polygon(d,!(_.isBoolean(b)&&b),!0),b=d.getBoundingClientRect(),l=b.left+b.width/2,m=b.top+b.height/2;_.each(d.vertices,function(a){a.x-=l;a.y-=m});d.translation.set(l,m);this.scene.add(d);return d},makePolygon:function(a){var b=arguments.length,d=a;if(!_.isArray(a))for(var d=[],e=0;e<b;e+=2){var c=arguments[e];if(!_.isNumber(c))break;d.push(new j.Vector(c,arguments[e+1]))}b=arguments[b-
1];d=new j.Polygon(d,!(_.isBoolean(b)&&b));d.center();this.scene.add(d);return d},makeGroup:function(a){var b=a;_.isArray(a)||(b=_.toArray(arguments));var e=new j.Group;this.scene.add(e);e.add(b);return e},interpret:function(a){var b=a.tagName.toLowerCase();if(!(b in j.Utils.read))return null;a=j.Utils.read[b].call(this,a);this.add(a);return a}});(function(){_.each(j.Instances,function(a){a.playing&&a.update()});requestAnimationFrame(arguments.callee)})()})();(function(){var q=Two.Vector=function(f,n){f=f||0;n=n||0;Object.defineProperty(this,"x",{get:function(){return f},set:function(n){f=n;this.trigger("change","x")}});Object.defineProperty(this,"y",{get:function(){return n},set:function(f){n=f;this.trigger("change","y")}})};_.extend(q,{});_.extend(q.prototype,Backbone.Events,{set:function(f,n){this.x=f;this.y=n;return this},copy:function(f){this.x=f.x;this.y=f.y;return this},clear:function(){this.y=this.x=0;return this},clone:function(){return new q(this.x,

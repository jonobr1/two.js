...
THREE.BinaryLoader.prototype.createBinModel=function(a,b,c,d){var f=function(b){var c,f,j,k,m,p,n,s,q,u,r,w,B,x,v;function t(a){return a%4?4-a%4:0}function C(a,b){return(new Uint8Array(a,b,1))[0]}function z(a,b){return(new Uint32Array(a,b,1))[0]}function D(b,c){var d,f,e,g,h,j,k,m,n=new Uint32Array(a,c,3*b);for(d=0;d<b;d++){f=n[3*d];e=n[3*d+1];g=n[3*d+2];h=L[2*f];f=L[2*f+1];j=L[2*e];k=L[2*e+1];e=L[2*g];m=L[2*g+1];g=O.faceVertexUvs[0];var r=[];r.push(new THREE.UV(h,f));r.push(new THREE.UV(j,k));r.push(new THREE.UV(e,
...
20)/4),void 0!==d&&d instanceof THREE.SkinnedMesh&&(b=Math.min(d.bones.length,b),b<d.bones.length&&console.warn("WebGLRenderer: too many bones - "+d.bones.length+", this GPU supports just "+b+" (try OpenGL instead of ANGLE)")),m=b);var s;a:{w=a.fragmentShader;v=a.vertexShader;p=a.uniforms;b=a.attributes;q=a.defines;c={map:!!a.map,envMap:!!a.envMap,lightMap:!!a.lightMap,bumpMap:!!a.bumpMap,normalMap:!!a.normalMap,specularMap:!!a.specularMap,vertexColors:a.vertexColors,fog:c,useFog:a.fog,sizeAttenuation:a.sizeAttenuation,
...
alphaTest:a.alphaTest,metal:a.metal,perPixel:a.perPixel,wrapAround:a.wrapAround,doubleSided:a.side===THREE.DoubleSide,flipSided:a.side===THREE.BackSide};var t,u,x;d=[];r?d.push(r):(d.push(w),d.push(v));for(u in q)d.push(u),d.push(q[u]);for(t in c)d.push(t),d.push(c[t]);r=d.join();t=0;for(u=ta.length;t<u;t++)if(d=ta[t],d.code===r){d.usedTimes++;s=d.program;break a}t=[];for(x in q)u=q[x],!1!==u&&(u="#define "+x+" "+u,t.push(u));u=t.join("\n");x=l.createProgram();t=["precision "+M+" float;",u,kc?"#define VERTEX_TEXTURES":
...
"#define FLIP_SIDED":"",c.shadowMapEnabled?"#define USE_SHADOWMAP":"",c.shadowMapSoft?"#define SHADOWMAP_SOFT":"",c.shadowMapDebug?"#define SHADOWMAP_DEBUG":"",c.shadowMapCascade?"#define SHADOWMAP_CASCADE":"","uniform mat4 viewMatrix;\nuniform vec3 cameraPosition;\n"].join("\n");u=E("fragment",u+w);t=E("vertex",t+v);l.attachShader(x,t);l.attachShader(x,u);l.linkProgram(x);l.getProgramParameter(x,l.LINK_STATUS)||console.error("Could not initialise shader\nVALIDATE_STATUS: "+l.getProgramParameter(x,
l.VALIDATE_STATUS)+", gl error ["+l.getError()+"]");l.deleteShader(u);l.deleteShader(t);x.uniforms={};x.attributes={};var B;t="viewMatrix modelViewMatrix projectionMatrix normalMatrix modelMatrix cameraPosition morphTargetInfluences".split(" ");c.useVertexTexture?t.push("boneTexture"):t.push("boneGlobalMatrices");for(B in p)t.push(B);B=t;t=0;for(u=B.length;t<u;t++)d=B[t],x.uniforms[d]=l.getUniformLocation(x,d);t="position normal uv uv2 tangent color skinIndex skinWeight".split(" ");for(B=0;B<c.maxMorphTargets;B++)t.push("morphTarget"+
B);for(B=0;B<c.maxMorphNormals;B++)t.push("morphNormal"+B);for(s in b)t.push(s);s=t;B=0;for(t=s.length;B<t;B++)u=s[B],x.attributes[u]=l.getAttribLocation(x,u);x.id=oa++;ta.push({program:x,code:r,usedTimes:1});S.info.memory.programs=ta.length;s=x}a.program=s;s=a.program.attributes;0<=s.position&&l.enableVertexAttribArray(s.position);0<=s.color&&l.enableVertexAttribArray(s.color);0<=s.normal&&l.enableVertexAttribArray(s.normal);0<=s.tangent&&l.enableVertexAttribArray(s.tangent);a.skinning&&(0<=s.skinIndex&&
...
THREE.CubeGeometry=function(a,b,c,d,f,e,g,h){function j(a,b,c,g,h,j,m,n){var r,p=d||1,q=f||1,s=h/2,w=j/2,u=k.vertices.length;if("x"===a&&"y"===b||"y"===a&&"x"===b)r="z";else if("x"===a&&"z"===b||"z"===a&&"x"===b)r="y",q=e||1;else if("z"===a&&"y"===b||"y"===a&&"z"===b)r="x",p=e||1;var x=p+1,B=q+1,ba=h/p,$=j/q,Q=new THREE.Vector3;Q[r]=0<m?1:-1;for(h=0;h<B;h++)for(j=0;j<x;j++){var ga=new THREE.Vector3;ga[a]=(j*ba-s)*c;ga[b]=(h*$-w)*g;ga[r]=m;k.vertices.push(ga)}for(h=0;h<q;h++)for(j=0;j<p;j++)a=new THREE.Face4(j+
...
this.mesh.add(this.outline.mesh);this.outline.mesh.position.x=0;this.outline.mesh.position.y=0;f.push(this)},Group:function(a){this.children=[];this.mesh=new THREE.Object3D;this.add.apply(this,a);this.center()},Vector:function(a,b,c){1>=arguments.length&&_.isObject(a)?(this.x=a.x||0,this.y=a.y||0,this.z=a.z||0):(this.x=a||0,this.y=b||0,this.z=c||0)}});var s={getVertices:function(a){return a?this.geometry.vertices:_.map(this.geometry.vertices,function(a){return a.clone()})},updateVertexFlags:function(){this.geometry.verticesNeedUpdate=

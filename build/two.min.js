...
a;_.isArray(a)||(b=_.toArray(arguments));var d=new e.Group;this.scene.add(d);d.add(b);return d},interpret:function(a){var b=a.tagName.toLowerCase();if(!(b in e.Utils.read))return null;a=e.Utils.read[b].call(this,a);this.add(a);return a}});(function(){_.each(e.Instances,function(a){a.playing&&a.update()});requestAnimationFrame(arguments.callee)})()})();(function(){var q=Two.Vector=function(f,p){f=f||0;p=p||0;Object.defineProperty(this,"x",{get:function(){return f},set:function(l){f=l;this.trigger(Two.Events.change,"x")}});Object.defineProperty(this,"y",{get:function(){return p},set:function(f){p=f;this.trigger(Two.Events.change,"y")}})};_.extend(q,{});_.extend(q.prototype,Backbone.Events,{set:function(f,p){this.x=f;this.y=p;return this},copy:function(f){this.x=f.x;this.y=f.y;return this},clear:function(){this.y=this.x=0;return this},clone:function(){return new q(this.x,

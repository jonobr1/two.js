(function(){var p=this,j=p._,e={},h=Array.prototype,d=Object.prototype,b=h.push,c=h.slice,q=h.concat,a=d.toString,l=d.hasOwnProperty,n=h.forEach,m=h.map,w=h.reduce,g=h.reduceRight,u=h.filter,x=h.every,v=h.some,r=h.indexOf,z=h.lastIndexOf,d=Array.isArray,s=Object.keys,t=Function.prototype.bind,f=function(k){if(k instanceof f)return k;if(!(this instanceof f))return new f(k);this._wrapped=k};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=f),exports._=
f):p._=f;f.VERSION="1.5.1";var y=f.each=f.forEach=function(k,a,b){if(null!=k)if(n&&k.forEach===n)k.forEach(a,b);else if(k.length===+k.length)for(var c=0,d=k.length;c<d&&a.call(b,k[c],c,k)!==e;c++);else for(c in k)if(f.has(k,c)&&a.call(b,k[c],c,k)===e)break};f.map=f.collect=function(k,f,a){var b=[];if(null==k)return b;if(m&&k.map===m)return k.map(f,a);y(k,function(k,c,d){b.push(f.call(a,k,c,d))});return b};f.reduce=f.foldl=f.inject=function(k,a,b,c){var d=2<arguments.length;null==k&&(k=[]);if(w&&k.reduce===
w)return c&&(a=f.bind(a,c)),d?k.reduce(a,b):k.reduce(a);y(k,function(k,f,g){d?b=a.call(c,b,k,f,g):(b=k,d=!0)});if(!d)throw new TypeError("Reduce of empty array with no initial value");return b};f.reduceRight=f.foldr=function(k,a,b,c){var d=2<arguments.length;null==k&&(k=[]);if(g&&k.reduceRight===g)return c&&(a=f.bind(a,c)),d?k.reduceRight(a,b):k.reduceRight(a);var t=k.length;if(t!==+t)var l=f.keys(k),t=l.length;y(k,function(f,g,s){g=l?l[--t]:--t;d?b=a.call(c,b,k[g],g,s):(b=k[g],d=!0)});if(!d)throw new TypeError("Reduce of empty array with no initial value");
return b};f.find=f.detect=function(k,f,a){var b;A(k,function(k,c,d){if(f.call(a,k,c,d))return b=k,!0});return b};f.filter=f.select=function(k,f,a){var b=[];if(null==k)return b;if(u&&k.filter===u)return k.filter(f,a);y(k,function(k,c,d){f.call(a,k,c,d)&&b.push(k)});return b};f.reject=function(k,a,b){return f.filter(k,function(k,f,c){return!a.call(b,k,f,c)},b)};f.every=f.all=function(k,a,b){a||(a=f.identity);var c=!0;if(null==k)return c;if(x&&k.every===x)return k.every(a,b);y(k,function(k,f,d){if(!(c=
c&&a.call(b,k,f,d)))return e});return!!c};var A=f.some=f.any=function(k,a,b){a||(a=f.identity);var c=!1;if(null==k)return c;if(v&&k.some===v)return k.some(a,b);y(k,function(k,f,d){if(c||(c=a.call(b,k,f,d)))return e});return!!c};f.contains=f.include=function(k,a){return null==k?!1:r&&k.indexOf===r?-1!=k.indexOf(a):A(k,function(k){return k===a})};f.invoke=function(k,a){var b=c.call(arguments,2),d=f.isFunction(a);return f.map(k,function(k){return(d?a:k[a]).apply(k,b)})};f.pluck=function(k,a){return f.map(k,
function(k){return k[a]})};f.where=function(k,a,b){return f.isEmpty(a)?b?void 0:[]:f[b?"find":"filter"](k,function(k){for(var f in a)if(a[f]!==k[f])return!1;return!0})};f.findWhere=function(k,a){return f.where(k,a,!0)};f.max=function(k,a,b){if(!a&&f.isArray(k)&&k[0]===+k[0]&&65535>k.length)return Math.max.apply(Math,k);if(!a&&f.isEmpty(k))return-Infinity;var c={computed:-Infinity,value:-Infinity};y(k,function(k,f,d){f=a?a.call(b,k,f,d):k;f>c.computed&&(c={value:k,computed:f})});return c.value};f.min=
function(k,a,b){if(!a&&f.isArray(k)&&k[0]===+k[0]&&65535>k.length)return Math.min.apply(Math,k);if(!a&&f.isEmpty(k))return Infinity;var c={computed:Infinity,value:Infinity};y(k,function(k,f,d){f=a?a.call(b,k,f,d):k;f<c.computed&&(c={value:k,computed:f})});return c.value};f.shuffle=function(k){var a,b=0,c=[];y(k,function(k){a=f.random(b++);c[b-1]=c[a];c[a]=k});return c};var C=function(k){return f.isFunction(k)?k:function(a){return a[k]}};f.sortBy=function(a,b,c){var d=C(b);return f.pluck(f.map(a,function(a,
k,f){return{value:a,index:k,criteria:d.call(c,a,k,f)}}).sort(function(a,k){var f=a.criteria,b=k.criteria;if(f!==b){if(f>b||void 0===f)return 1;if(f<b||void 0===b)return-1}return a.index<k.index?-1:1}),"value")};var Q=function(a,b,c,d){var g={},t=C(null==b?f.identity:b);y(a,function(f,b){var l=t.call(c,f,b,a);d(g,l,f)});return g};f.groupBy=function(a,b,c){return Q(a,b,c,function(a,k,b){(f.has(a,k)?a[k]:a[k]=[]).push(b)})};f.countBy=function(a,b,c){return Q(a,b,c,function(a,k){f.has(a,k)||(a[k]=0);
a[k]++})};f.sortedIndex=function(a,b,c,d){c=null==c?f.identity:C(c);b=c.call(d,b);for(var g=0,t=a.length;g<t;){var l=g+t>>>1;c.call(d,a[l])<b?g=l+1:t=l}return g};f.toArray=function(a){return!a?[]:f.isArray(a)?c.call(a):a.length===+a.length?f.map(a,f.identity):f.values(a)};f.size=function(a){return null==a?0:a.length===+a.length?a.length:f.keys(a).length};f.first=f.head=f.take=function(a,f,b){return null==a?void 0:null!=f&&!b?c.call(a,0,f):a[0]};f.initial=function(a,f,b){return c.call(a,0,a.length-
...
a}return this},trigger:function(e){if(!this._events)return this;var d=p.call(arguments,1),b=this._events[e],c=this._events.all;b&&j(this,b,d);c&&j(this,c,arguments);return this},listenTo:function(e,d,b){var c=this._listeners||(this._listeners={}),q=e._listenerId||(e._listenerId=_.uniqueId("l"));c[q]=e;e.on(d,b||this,this);return this},stopListening:function(e,d,b){var c=this._listeners;if(c){if(e)e.off(d,b,this),!d&&!b&&delete c[e._listenerId];else{for(var q in c)c[q].off(null,null,this);this._listeners=
{}}return this}}};e.bind=e.on;e.unbind=e.off;"undefined"!==typeof exports&&("undefined"!==typeof module&&module.exports&&(exports=module.exports=e),exports.Backbone=exports.Backbone||Backbone)})();(function(){function p(b){var c=(new Date).getTime(),d=Math.max(0,16-(c-e)),a=j.setTimeout(function(){b(c+d)},d);e=c+d;return a}var j=this,e=0,h=["ms","moz","webkit","o"];if("undefined"!==typeof exports)"undefined"!==typeof module&&module.exports&&(exports=module.exports=p),exports.requestAnimationFrame=p;else{for(var d=0;d<h.length&&!j.requestAnimationFrame;++d)j.requestAnimationFrame=j[h[d]+"RequestAnimationFrame"],j.cancelAnimationFrame=j[h[d]+"CancelAnimationFrame"]||j[h[d]+"CancelRequestAnimationFrame"];
j.requestAnimationFrame||(j.requestAnimationFrame=p);j.cancelAnimationFrame||(j.cancelAnimationFrame=function(b){clearTimeout(b)})}})();(function(){function p(){var a=document.body.getBoundingClientRect(),b=this.width=a.width,a=this.height=a.height;this.renderer.setSize(b,a,this.ratio);this.trigger(g.Events.resize,b,a)}var j=this,e=j.Two||{},h=Math.sin,d=Math.cos,b=Math.atan2,c=Math.sqrt,q=Math.abs,a=Math.PI,l=2*a,n=a/2,m=Math.pow,w={hasEventListeners:_.isFunction(j.addEventListener),bind:function(a,b,f,c){this.hasEventListeners?a.addEventListener(b,f,!!c):a.attachEvent("on"+b,f);return this},unbind:function(a,b,f,c){this.hasEventListeners?
a.removeEventListeners(b,f,!!c):a.detachEvent("on"+b,f);return this}},g=j.Two=function(a){a=_.defaults(a||{},{fullscreen:!1,width:640,height:480,type:g.Types.svg,autostart:!1});_.each(a,function(a,b){"fullscreen"===b||("width"===b||"height"===b||"autostart"===b)||(this[b]=a)},this);this.renderer=new g[this.type](this);g.Utils.setPlaying.call(this,a.autostart);this.frameCount=0;a.fullscreen?(a=_.bind(p,this),_.extend(document.body.style,{overflow:"hidden",margin:0,padding:0,top:0,left:0,right:0,bottom:0,
position:"fixed"}),_.extend(this.renderer.domElement.style,{display:"block",top:0,left:0,right:0,bottom:0,position:"fixed"}),w.bind(j,"resize",a),a()):(this.renderer.setSize(a.width,a.height,this.ratio),this.width=a.width,this.height=a.height);this.scene=new g.Group;this.renderer.add(this.scene);g.Instances.push(this)};_.extend(g,{Array:j.Float32Array||Array,Types:{webgl:"WebGLRenderer",svg:"SVGRenderer",canvas:"CanvasRenderer"},Version:"v0.3.0",Properties:{hierarchy:"hierarchy",demotion:"demotion"},
Events:{play:"play",pause:"pause",update:"update",render:"render",resize:"resize",change:"change",remove:"remove",insert:"insert"},Commands:{move:"M",line:"L",curve:"C",close:"Z"},Resolution:8,Instances:[],noConflict:function(){j.Two=e;return this},Utils:{Curve:{CollinearityEpsilon:m(10,-30),RecursionLimit:16,CuspLimit:0,Tolerance:{distance:0.25,angle:0,epsilon:0.01}},setPlaying:function(a){_.defer(_.bind(function(){this.playing=!!a},this))},getComputedMatrix:function(a){for(var b=new g.Matrix;a&&
a._matrix;){var f=a._matrix.elements;b.multiply(f[0],f[1],f[2],f[3],f[4],f[5],f[6],f[7],f[8],f[9]);a=a.parent}return b},applySvgAttributes:function(a,b){b.cap="butt";b.join="bevel";_.each(a.attributes,function(a){switch(a.nodeName){case "visibility":b.visible=!!a.nodeValue;break;case "stroke-linecap":b.cap=a.nodeValue;break;case "stroke-linejoin":b.join=a.nodeValue;break;case "stroke-miterlimit":b.miter=a.nodeValue;break;case "stroke-width":b.linewidth=parseFloat(a.nodeValue);break;case "stroke-opacity":case "fill-opacity":b.opacity=
a.nodeValue;break;case "fill":b.fill=a.nodeValue;break;case "stroke":b.stroke=a.nodeValue}});return b},read:{svg:function(){return g.Utils.read.g.apply(this,arguments)},g:function(a){var b=new g.Group;this.add(b);_.each(a.childNodes,function(a){var c=a.nodeName;c&&(c=c.replace(/svg\:/ig,"").toLowerCase(),c in g.Utils.read&&(a=g.Utils.read[c].call(this,a),b.add(a)))},this);return g.Utils.applySvgAttributes(a,b)},polygon:function(a,b){var f=[];a.getAttribute("points").replace(/([\d\.?]+),([\d\.?]+)/g,
function(a,b,c){f.push(new g.Anchor(parseFloat(b),parseFloat(c)))});var c=(new g.Polygon(f,!b)).noStroke();return g.Utils.applySvgAttributes(a,c)},polyline:function(a){return g.Utils.read.polygon(a,!0)},path:function(a){var b,f,c,d=!1,l=!1,e=a.getAttribute("d").match(/[a-df-z][^a-df-z]*/ig),n=e.length-1,e=_.flatten(_.map(e,function(a,e){var s,m,q=a[0],h=q.toLowerCase();c=a.slice(1).trim();c=c.replace(/(-?\d+(?:\.\d*)?)[eE]([+\-]?\d+)/g,function(a,b,f){return parseFloat(b)*Math.pow(10,f)});c=c.split(/[\s,]+|(?=\s?[+\-])/);
d=q===h;var w,u,k,j;switch(h){case "z":e>=n?l=!0:(m=b.x,s=b.y,s=new g.Anchor(m,s,void 0,void 0,void 0,void 0,g.Commands.close));break;case "m":case "l":m=parseFloat(c[0]);s=parseFloat(c[1]);s=new g.Anchor(m,s,void 0,void 0,void 0,void 0,"m"===h?g.Commands.move:g.Commands.line);d&&s.addSelf(b);b=s;break;case "h":case "v":m="h"===h?"x":"y";q="x"===m?"y":"x";s=new g.Anchor(void 0,void 0,void 0,void 0,void 0,void 0,g.Commands.line);s[m]=parseFloat(c[0]);s[q]=b[q];d&&(s[m]+=b[m]);b=s;break;case "s":case "c":s=
b.x;q=b.y;f||(f=(new g.Vector).copy(b));"c"===h?(w=parseFloat(c[0]),m=parseFloat(c[1]),h=parseFloat(c[2]),u=parseFloat(c[3]),k=parseFloat(c[4]),j=parseFloat(c[5])):(u=g.Utils.getReflection(b,f,d),w=u.x,m=u.y,h=parseFloat(c[0]),u=parseFloat(c[1]),k=parseFloat(c[2]),j=parseFloat(c[3]));d&&(w+=s,m+=q,h+=s,u+=q,k+=s,j+=q);_.isObject(b.controls)||g.Anchor.AppendCurveProperties(b);b.controls.right.set(w,m);b=s=new g.Anchor(k,j,h,u,void 0,void 0,g.Commands.curve);f=s.controls.left;break;case "t":case "q":s=
b.x;q=b.y;f||(f=(new g.Vector).copy(b));f.isZero()?(w=s,m=q):(w=f.x,q=f.y);"q"===h?(h=parseFloat(c[0]),u=parseFloat(c[1]),k=parseFloat(c[1]),j=parseFloat(c[2])):(u=g.Utils.getReflection(b,f,d),h=u.x,u=u.y,k=parseFloat(c[0]),j=parseFloat(c[1]));d&&(w+=s,m+=q,h+=s,u+=q,k+=s,j+=q);_.isObject(b.controls)||g.Anchor.AppendCurveProperties(b);b.controls.right.set(w,m);b=s=new g.Anchor(k,j,h,u,void 0,void 0,g.Commands.curve);f=s.controls.left;break;case "a":throw new g.Utils.Error("not yet able to interpret Elliptical Arcs.");
...
c=parseFloat(a.getAttribute("cy")),e=parseFloat(a.getAttribute("rx")),n=parseFloat(a.getAttribute("ry")),m=g.Resolution,q=_.map(_.range(m),function(a){var b=a/m*l;a=e*d(b);b=n*h(b);return new g.Anchor(a,b)},this),q=(new g.Polygon(q,!0,!0)).noStroke();q.translation.set(b,c);return g.Utils.applySvgAttributes(a,q)},rect:function(a){var b=parseFloat(a.getAttribute("x")),c=parseFloat(a.getAttribute("y")),d=parseFloat(a.getAttribute("width")),l=parseFloat(a.getAttribute("height")),d=d/2,l=l/2,e=[new g.Anchor(d,
l),new g.Anchor(-d,l),new g.Anchor(-d,-l),new g.Anchor(d,-l)],e=(new g.Polygon(e,!0)).noStroke();e.translation.set(b+d,c+l);return g.Utils.applySvgAttributes(a,e)},line:function(a){var b=parseFloat(a.getAttribute("x1")),c=parseFloat(a.getAttribute("y1")),d=parseFloat(a.getAttribute("x2")),l=parseFloat(a.getAttribute("y2")),d=(d-b)/2,l=(l-c)/2,e=[new g.Anchor(-d,-l),new g.Anchor(d,l)],e=(new g.Polygon(e)).noFill();e.translation.set(b+d,c+l);return g.Utils.applySvgAttributes(a,e)}},subdivide:function(c,
d,f,e,n,m,h,w,u){var j=g.Utils.Curve.CollinearityEpsilon,x=g.Utils.Curve.RecursionLimit,v=g.Utils.Curve.CuspLimit,r=g.Utils.Curve.Tolerance,p;u=u||0;if(u>x)return[];var x=(c+f)/2,z=(d+e)/2,F=(f+n)/2,k=(e+m)/2,M=(n+h)/2,N=(m+w)/2,O=(x+F)/2,P=(z+k)/2,F=(F+M)/2,k=(k+N)/2,D=(O+F)/2,E=(P+k)/2;p=h-c;var B=w-d,G=q((f-h)*B-(e-w)*p),H=q((n-h)*B-(m-w)*p);if(0<u){if(G>j&&H>j&&(G+H)*(G+H)<=r.distance*(p*p+B*B)){if(r.angle<r.epsilon)return[new g.Anchor(D,E)];p=b(m-e,n-f);j=q(p-b(e-d,f-c));p=q(b(w-m,h-n)-p);j>=
a&&(j=l-j);p>=a&&(p=l-p);if(j+p<r.angle)return[new g.Anchor(D,E)];if(0!==v){if(j>v)return[new g.Anchor(f,e)];if(p>v)return[new g.Anchor(n,m)]}}}else if(G>j)if(G*G<=r.distance*(p*p+B*B)){if(r.angle<r.epsilon)return[new g.Anchor(D,E)];j=q(b(m-e,n-f)-b(e-d,f-c));j>=a&&(j=l-j);if(j<r.angle)return[new g.Anchor(f,e),new g.Anchor(n,m)];if(0!==v&&j>v)return[new g.Anchor(f,e)]}else if(H>j){if(H*H<=r.distance*(p*p+B*B)){if(r.angle<r.epsilon)return[new g.Anchor(D,E)];j=q(b(w-m,h-n)-b(m-e,n-f));j>=a&&(j=l-j);
if(j<r.angle)return[new g.Anchor(f,e),new g.Anchor(n,m)];if(0!==v&&j>v)return[new g.Anchor(n,m)]}}else if(p=D-(c+h)/2,B=E-(d+w)/2,p*p+B*B<=r.distance)return[new g.Anchor(D,E)];return g.Utils.subdivide(c,d,x,z,O,P,D,E,u+1).concat(g.Utils.subdivide(D,E,F,k,M,N,h,w,u+1))},getCurveFromPoints:function(a,b){for(var c=a.length,d=c-1,l=0;l<c;l++){var e=a[l];_.isObject(e.controls)||g.Anchor.AppendCurveProperties(e);var n=b?z(l-1,c):Math.max(l-1,0),m=b?z(l+1,c):Math.min(l+1,d);r(a[n],e,a[m]);e._command=0===
...
h+this.x,(e.y-this.y)*h+this.y)},isZero:function(){return 1E-4>this.length()},toString:function(){return this.x+","+this.y},toObject:function(){return{x:this.x,y:this.y}}});var j={set:function(e,h){this._x=e;this._y=h;return this.trigger(Two.Events.change)},copy:function(e){this._x=e.x;this._y=e.y;return this.trigger(Two.Events.change)},clear:function(){this._y=this._x=0;return this.trigger(Two.Events.change)},clone:function(){return new p(this._x,this._y)},add:function(e,h){this._x=e.x+h.x;this._y=
e.y+h.y;return this.trigger(Two.Events.change)},addSelf:function(e){this._x+=e.x;this._y+=e.y;return this.trigger(Two.Events.change)},sub:function(e,h){this._x=e.x-h.x;this._y=e.y-h.y;return this.trigger(Two.Events.change)},subSelf:function(e){this._x-=e.x;this._y-=e.y;return this.trigger(Two.Events.change)},multiplySelf:function(e){this._x*=e.x;this._y*=e.y;return this.trigger(Two.Events.change)},multiplyScalar:function(e){this._x*=e;this._y*=e;return this.trigger(Two.Events.change)},divideScalar:function(e){return e?
(this._x/=e,this._y/=e,this.trigger(Two.Events.change)):this.clear()},negate:function(){return this.multiplyScalar(-1)},dot:function(e){return this._x*e.x+this._y*e.y},lengthSquared:function(){return this._x*this._x+this._y*this._y},length:function(){return Math.sqrt(this.lengthSquared())},normalize:function(){return this.divideScalar(this.length())},distanceTo:function(e){return Math.sqrt(this.distanceToSquared(e))},distanceToSquared:function(e){var h=this._x-e.x;e=this._y-e.y;return h*h+e*e},setLength:function(e){return this.normalize().multiplyScalar(e)},
equals:function(e){return 1E-4>this.distanceTo(e)},lerp:function(e,h){return this.set((e.x-this._x)*h+this._x,(e.y-this._y)*h+this._y)},isZero:function(){return 1E-4>this.length()},toString:function(){return this._x+","+this._y},toObject:function(){return{x:this._x,y:this._y}}};Two.Vector.prototype.bind=Two.Vector.prototype.on=function(){this._bound||(Two.Vector.MakeGetterSetter(this,"x",this.x),Two.Vector.MakeGetterSetter(this,"y",this.y),_.extend(this,j),this._bound=!0);Backbone.Events.bind.apply(this,
arguments);return this}})();(function(){var p=Two.Commands,j=Two.Anchor=function(e,h,d,b,c,q,a){Two.Vector.call(this,e,h);this._broadcast=_.bind(function(){this.trigger(Two.Events.change)},this);Object.defineProperty(this,"command",{get:function(){return this._command},set:function(a){this._command=a;this._command===p.curve&&!_.isObject(this.controls)&&j.AppendCurveProperties(this);return this.trigger(Two.Events.change)}});this._command=a||p.move;if(!a)return this;j.AppendCurveProperties(this);_.isNumber(d)&&(this.controls.left.x=
d);_.isNumber(b)&&(this.controls.left.y=b);_.isNumber(c)&&(this.controls.right.x=c);_.isNumber(q)&&(this.controls.right.y=q)};_.extend(j,{AppendCurveProperties:function(e){var h=e._x||e.x,d=e._y||e.y;e.controls={left:new Two.Vector(h,d),right:new Two.Vector(h,d)}}});_.extend(j.prototype,Two.Vector.prototype,{listen:function(){_.isObject(this.controls)||j.AppendCurveProperties(this);_.each(this.controls,function(e){e.bind(Two.Events.change,this._broadcast)},this);return this},ignore:function(){_.each(this.controls,
function(e){e.unbind(Two.Events.change,this._broadcast)},this);return this},clone:function(){var e=this.controls;return new Two.Anchor(this.x,this.y,e&&e.left.x,e&&e.left.y,e&&e.right.x,e&&e.right.y,this.command)}})})();(function(){_.range(6);var p=Math.cos,j=Math.sin,e=Math.tan,h=Two.Matrix=function(d,b,c,e,a,l){this.elements=new Two.Array(9);var n=d;_.isArray(n)||(n=_.toArray(arguments));this.identity().set(n)};_.extend(h,{Identity:[1,0,0,0,1,0,0,0,1],Multiply:function(d,b){if(3>=b.length){var c=b[0]||0,e=b[1]||0,a=b[2]||0;return{x:d[0]*c+d[1]*e+d[2]*a,y:d[3]*c+d[4]*e+d[5]*a,z:d[6]*c+d[7]*e+d[8]*a}}var c=d[0],e=d[1],a=d[2],l=d[3],n=d[4],m=d[5],h=d[6],g=d[7],j=d[8],x=b[0],v=b[1],r=b[2],p=b[3],s=b[4],t=b[5],f=b[6],
y=b[7],A=b[8];return[c*x+e*p+a*f,c*v+e*s+a*y,c*r+e*t+a*A,l*x+n*p+m*f,l*v+n*s+m*y,l*r+n*t+m*A,h*x+g*p+j*f,h*v+g*s+j*y,h*r+g*t+j*A]}});_.extend(h.prototype,Backbone.Events,{set:function(d,b,c,e,a,l){var n=d;_.isArray(n)||(n=_.toArray(arguments));_.each(n,function(a,b){_.isNumber(a)&&(this.elements[b]=a)},this);return this.trigger(Two.Events.change)},identity:function(){this.set(h.Identity);return this},multiply:function(d,b,c,e,a,l,n,m,h){var g=arguments,j=g.length;if(1>=j)return _.each(this.elements,
function(a,b){this.elements[b]=a*d},this),this.trigger(Two.Events.change);if(3>=j)return d=d||0,b=b||0,c=c||0,a=this.elements,{x:a[0]*d+a[1]*b+a[2]*c,y:a[3]*d+a[4]*b+a[5]*c,z:a[6]*d+a[7]*b+a[8]*c};j=this.elements;A0=j[0];A1=j[1];A2=j[2];A3=j[3];A4=j[4];A5=j[5];A6=j[6];A7=j[7];A8=j[8];B0=g[0];B1=g[1];B2=g[2];B3=g[3];B4=g[4];B5=g[5];B6=g[6];B7=g[7];B8=g[8];this.elements[0]=A0*B0+A1*B3+A2*B6;this.elements[1]=A0*B1+A1*B4+A2*B7;this.elements[2]=A0*B2+A1*B5+A2*B8;this.elements[3]=A3*B0+A4*B3+A5*B6;this.elements[4]=
A3*B1+A4*B4+A5*B7;this.elements[5]=A3*B2+A4*B5+A5*B8;this.elements[6]=A6*B0+A7*B3+A8*B6;this.elements[7]=A6*B1+A7*B4+A8*B7;this.elements[8]=A6*B2+A7*B5+A8*B8;return this.trigger(Two.Events.change)},inverse:function(d){var b=this.elements;d=d||new Two.Matrix;var c=b[0],e=b[1],a=b[2],l=b[3],n=b[4],m=b[5],h=b[6],g=b[7],b=b[8],j=b*n-m*g,p=-b*l+m*h,v=g*l-n*h,r=c*j+e*p+a*v;if(!r)return null;r=1/r;d.elements[0]=j*r;d.elements[1]=(-b*e+a*g)*r;d.elements[2]=(m*e-a*n)*r;d.elements[3]=p*r;d.elements[4]=(b*c-
a*h)*r;d.elements[5]=(-m*c+a*l)*r;d.elements[6]=v*r;d.elements[7]=(-g*c+e*h)*r;d.elements[8]=(n*c-e*l)*r;return d},scale:function(d,b){1>=arguments.length&&(b=d);return this.multiply(d,0,0,0,b,0,0,0,1)},rotate:function(d){var b=p(d);d=j(d);return this.multiply(b,-d,0,d,b,0,0,0,1)},translate:function(d,b){return this.multiply(1,0,d,0,1,b,0,0,1)},skewX:function(d){d=e(d);return this.multiply(1,d,0,0,1,0,0,0,1)},skewY:function(d){d=e(d);return this.multiply(1,0,0,d,1,0,0,0,1)},toString:function(){return this.toArray().join(" ")},
...
l=l.y,h&&(a&&b&&l)&&(e=Math.min(a,l,e),c=Math.min(h,b,c),d=Math.max(h,b,d),g=Math.max(a,l,g))))});_.isNumber(b)&&(e-=b,c-=b,d+=b,g+=b);return{top:e,left:c,right:d,bottom:g,width:d-c,height:g-e,centroid:{x:-c,y:-e}}},getTriangles:function(a){var b=a.top,c=a.left,d=a.right;a=a.bottom;return new Two.Array([c,b,d,b,c,a,c,a,d,b,d,a])},updateCanvas:function(a){var b=a.commands,c=this.canvas,d=this.ctx,e=a._scale,g=a.stroke,j=a.linewidth*e,q=a.fill,p=a.opacity,r=a.cap,z=a.join,s=a.miter,t=a.closed,f=b.length,
y=f-1;c.width=Math.max(Math.ceil(a.rect.width*e),1);c.height=Math.max(Math.ceil(a.rect.height*e),1);a=a.rect.centroid;var A=a.x*e,C=a.y*e;d.clearRect(0,0,c.width,c.height);q&&(d.fillStyle=q);g&&(d.strokeStyle=g);j&&(d.lineWidth=j);s&&(d.miterLimit=s);z&&(d.lineJoin=z);r&&(d.lineCap=r);_.isNumber(p)&&(d.globalAlpha=p);d.beginPath();_.each(b,function(a,c){var g,j,n,q,p,r,s;s=(a.x*e+A).toFixed(3);r=(a.y*e+C).toFixed(3);switch(a._command){case Two.Commands.close:d.closePath();break;case Two.Commands.curve:j=
t?h(c-1,f):Math.max(c-1,0);g=t?h(c+1,f):Math.min(c+1,y);j=b[j];g=b[g];n=j.controls&&j.controls.right||j;q=a.controls&&a.controls.left||a;j=(n.x*e+A).toFixed(3);p=(n.y*e+C).toFixed(3);n=(q.x*e+A).toFixed(3);q=(q.y*e+C).toFixed(3);d.bezierCurveTo(j,p,n,q,s,r);c>=y&&t&&(r=a.controls&&a.controls.right||a,s=g.controls&&g.controls.left||g,j=(r.x*e+A).toFixed(3),p=(r.y*e+C).toFixed(3),n=(s.x*e+A).toFixed(3),q=(s.y*e+C).toFixed(3),s=(g.x*e+A).toFixed(3),r=(g.y*e+C).toFixed(3),d.bezierCurveTo(j,p,n,q,s,r));
...
fragment:"precision mediump float;\n\nuniform sampler2D u_image;\nvarying vec2 v_textureCoords;\n\nvoid main() {\n  gl_FragColor = texture2D(u_image, v_textureCoords);\n}"}};c.ctx=c.canvas.getContext("2d");var q=Two[Two.Types.webgl]=function(a){this.count=0;this.domElement=document.createElement("canvas");this.elements=[];this.stage=null;this._matrix=[1,0,0,0,1,0,0,0,1];this._scale=1;a=_.defaults(a||{},{antialias:!1,alpha:!0,premultipliedAlpha:!0,stencil:!0,preserveDrawingBuffer:!0,overdraw:!1});
...
a.getUniformLocation(this.program,"u_matrix");this.program.textureCoords=a.getAttribLocation(this.program,"a_textureCoords");a.disable(a.DEPTH_TEST);a.enable(a.BLEND);a.blendEquationSeparate(a.FUNC_ADD,a.FUNC_ADD);a.blendFuncSeparate(a.SRC_ALPHA,a.ONE_MINUS_SRC_ALPHA,a.ONE,a.ONE_MINUS_SRC_ALPHA)};_.extend(q,{Group:d,Element:b,getStyles:function(a){var d={},e=a.id,h=a._matrix,j=a.stroke,g=a.linewidth,q=a.fill,p=a.opacity,v=a.visible,r=a.cap,z=a.join,s=a.miter,t=a.closed,f=a.vertices;e&&(d.id=e);_.isObject(h)&&
(d.matrix=d._matrix=h.toArray(!0),d.scale=d._scale=1);j&&(d.stroke=j);q&&(d.fill=q);_.isNumber(p)&&(d.opacity=p);r&&(d.cap=r);z&&(d.join=z);s&&(d.miter=s);g&&(d.linewidth=g);f&&(d.vertices=f,d.commands=d.vertices,d.rect=c.getBoundingClientRect(d.commands,d.linewidth),d.triangles=c.getTriangles(d.rect));d.visible=!!v;d.closed=!!t;a instanceof Two.Polygon&&(c.updateBuffer(this.ctx,d,this.program),b.prototype.updateTexture.call(d,this.ctx));return d},setStyles:function(a,b,d,e,h){var g=!1;/matrix/.test(b)?
(a[b]=d.toArray(!0),_.isNumber(e)&&(g=a.scale!==e,a.scale=e),a.updateMatrix()):/(stroke|fill|opacity|cap|join|miter|linewidth)/.test(b)?(a[b]=d,a.rect=p(c.getBoundingClientRect(a.commands,a.linewidth),a.rect),a.triangles=c.getTriangles(a.rect),c.updateBuffer(this.ctx,a,this.program),g=!0):"vertices"===b?(_.isUndefined(e)||(a.closed=e),h?a.commands=d:(a.vertices=d,a.commands=a.vertices),a.rect=p(c.getBoundingClientRect(a.vertices,a.linewidth),a.rect),a.triangles=c.getTriangles(a.rect),c.updateBuffer(this.ctx,
a,this.program),g=!0):a[b]=d;g&&a.updateTexture(this.ctx)}});_.extend(q.prototype,Backbone.Events,j.prototype,{setSize:function(a,b,c){j.prototype.setSize.apply(this,arguments);a*=this.ratio;b*=this.ratio;this._matrix[0]=this._matrix[4]=this._scale=this.ratio;_.isNull(this.stage)||this.stage.updateMatrix();this.ctx.viewport(0,0,a,b);var d=this.ctx.getUniformLocation(this.program,"u_resolution");this.ctx.uniform2f(d,a,b);return this},render:function(){if(_.isNull(this.stage))return this;var a=this.ctx;
this.overdraw||a.clear(a.COLOR_BUFFER_BIT|a.DEPTH_BUFFER_BIT);this.stage.render(a,this.program);return this}})})();(function(){var p=Two.Shape=function(j){this._matrix=new Two.Matrix;var e=_.debounce(_.bind(function(){var e=this._matrix.identity().translate(this.translation.x,this.translation.y).scale(this.scale).rotate(this.rotation);this.trigger(Two.Events.change,this.id,"matrix",e,this.scale)},this),0);this._rotation=0;Object.defineProperty(this,"rotation",{get:function(){return this._rotation},set:function(h){this._rotation=h;e()}});this._scale="scale";Object.defineProperty(this,"scale",{get:function(){return this._scale},
set:function(h){this._scale=h;e()}});this.translation=new Two.Vector;this.rotation=0;this.scale=1;this.translation.bind(Two.Events.change,e);if(j)return this;p.MakeGetterSetter(this,p.Properties);this.fill="#fff";this.stroke="#000";this.opacity=this.linewidth=1;this.visible=!0;this.join=this.cap="round";this.miter=4};_.extend(p,{Properties:"fill stroke linewidth opacity visible cap join miter".split(" "),MakeGetterSetter:function(j,e){_.isArray(e)||(e=[e]);_.each(e,function(e){var d="_"+e;Object.defineProperty(j,
e,{get:function(){return this[d]},set:function(b){this[d]=b;this.trigger(Two.Events.change,this.id,e,b,this)}})})}});_.extend(p.prototype,Backbone.Events,{addTo:function(j){j.add(this);return this},noFill:function(){this.fill="transparent";return this},noStroke:function(){this.stroke="transparent";return this},clone:function(){var j=new p;j.translation.copy(this.translation);_.each(p.Properties,function(e){j[e]=this[e]},this);return this}})})();(function(){var p=Math.min,j=Math.max,e=Two.Group=function(){Two.Shape.call(this,!0);delete this.stroke;delete this.fill;delete this.linewidth;delete this.opacity;delete this.cap;delete this.join;delete this.miter;e.MakeGetterSetter(this,Two.Shape.Properties);this.children={}};_.extend(e,{MakeGetterSetter:function(e,d){_.isArray(d)||(d=[d]);_.each(d,function(b){var c="_"+b;Object.defineProperty(e,b,{get:function(){return this[c]},set:function(d){this[c]=d;_.each(this.children,function(a){a[b]=d})}})})}});

...
[],c;for(c in a)f.has(a,c)&&b.push([c,a[c]]);return b};f.invert=function(a){var b={},c;for(c in a)f.has(a,c)&&(b[a[c]]=c);return b};f.functions=f.methods=function(a){var b=[],c;for(c in a)f.isFunction(a[c])&&b.push(c);return b.sort()};f.extend=function(a){y(c.call(arguments,1),function(f){if(f)for(var b in f)a[b]=f[b]});return a};f.pick=function(a){var f={},b=p.apply(h,c.call(arguments,1));y(b,function(b){b in a&&(f[b]=a[b])});return f};f.omit=function(a){var b={},d=p.apply(h,c.call(arguments,1)),
...
(function(){var n=[].slice,k=function(e,d,b){var c;e=-1;var p=d.length;switch(b.length){case 0:for(;++e<p;)(c=d[e]).callback.call(c.ctx);break;case 1:for(;++e<p;)(c=d[e]).callback.call(c.ctx,b[0]);break;case 2:for(;++e<p;)(c=d[e]).callback.call(c.ctx,b[0],b[1]);break;case 3:for(;++e<p;)(c=d[e]).callback.call(c.ctx,b[0],b[1],b[2]);break;default:for(;++e<p;)(c=d[e]).callback.apply(c.ctx,b)}},e=Backbone.Events={on:function(e,d,b){this._events||(this._events={});(this._events[e]||(this._events[e]=[])).push({callback:d,
context:b,ctx:b||this});return this},once:function(e,d,b){var c=this,p=_.once(function(){c.off(e,p);d.apply(this,arguments)});p._callback=d;this.on(e,p,b);return this},off:function(e,d,b){var c,p,a,l,m,u,r,g;if(!this._events)return this;if(!e&&!d&&!b)return this._events={},this;l=e?[e]:_.keys(this._events);m=0;for(u=l.length;m<u;m++)if(e=l[m],c=this._events[e]){a=[];if(d||b){r=0;for(g=c.length;r<g;r++)p=c[r],(d&&d!==(p.callback._callback||p.callback)||b&&b!==p.context)&&a.push(p)}this._events[e]=
a}return this},trigger:function(e){if(!this._events)return this;var d=n.call(arguments,1),b=this._events[e],c=this._events.all;b&&k(this,b,d);c&&k(this,c,arguments);return this},listenTo:function(e,d,b){var c=this._listeners||(this._listeners={}),p=e._listenerId||(e._listenerId=_.uniqueId("l"));c[p]=e;e.on(d,b||this,this);return this},stopListening:function(e,d,b){var c=this._listeners;if(c){if(e)e.off(d,b,this),!d&&!b&&delete c[e._listenerId];else{for(var p in c)c[p].off(null,null,this);this._listeners=
{}}return this}}};e.bind=e.on;e.unbind=e.off;"undefined"!==typeof exports&&("undefined"!==typeof module&&module.exports&&(exports=module.exports=e),exports.Backbone=exports.Backbone||Backbone)})();(function(){function n(b){var c=(new Date).getTime(),d=Math.max(0,16-(c-e)),a=k.setTimeout(function(){b(c+d)},d);e=c+d;return a}var k=this,e=0,h=["ms","moz","webkit","o"];if("undefined"!==typeof exports)"undefined"!==typeof module&&module.exports&&(exports=module.exports=n),exports.requestAnimationFrame=n;else{for(var d=0;d<h.length&&!k.requestAnimationFrame;++d)k.requestAnimationFrame=k[h[d]+"RequestAnimationFrame"],k.cancelAnimationFrame=k[h[d]+"CancelAnimationFrame"]||k[h[d]+"CancelRequestAnimationFrame"];
k.requestAnimationFrame||(k.requestAnimationFrame=n);k.cancelAnimationFrame||(k.cancelAnimationFrame=function(b){clearTimeout(b)})}})();(function(){function n(){var a=document.body.getBoundingClientRect(),b=this.width=a.width,a=this.height=a.height;this.renderer.setSize(b,a);this.trigger(g.Events.resize,b,a)}var k=this,e=k.Two||{},h=Math.sin,d=Math.cos,b=Math.atan2,c=Math.sqrt,p=Math.abs,a=Math.PI,l=2*a,m=a/2,u=Math.pow,r={hasEventListeners:_.isFunction(k.addEventListener),bind:function(a,b,f,c){this.hasEventListeners?a.addEventListener(b,f,!!c):a.attachEvent("on"+b,f);return this},unbind:function(a,b,f,c){this.hasEventListeners?
a.removeEventListeners(b,f,!!c):a.detachEvent("on"+b,f);return this}},g=k.Two=function(a){a=_.defaults(a||{},{fullscreen:!1,width:640,height:480,type:g.Types.svg,autostart:!1});this.type=a.type;this.renderer=new g[this.type](this);g.Utils.setPlaying.call(this,a.autostart);this.frameCount=0;a.fullscreen?(a=_.bind(n,this),_.extend(document.body.style,{overflow:"hidden",margin:0,padding:0,top:0,left:0,right:0,bottom:0,position:"fixed"}),_.extend(this.renderer.domElement.style,{display:"block",top:0,
left:0,right:0,bottom:0,position:"fixed"}),r.bind(k,"resize",a),a()):(this.renderer.setSize(a.width,a.height),this.width=a.width,this.height=a.height);this.scene=new g.Group;this.renderer.add(this.scene);g.Instances.push(this)};_.extend(g,{Array:k.Float32Array||Array,Types:{webgl:"WebGLRenderer",svg:"SVGRenderer",canvas:"CanvasRenderer"},Version:"v0.3.0",Properties:{hierarchy:"hierarchy",demotion:"demotion"},Events:{play:"play",pause:"pause",update:"update",render:"render",resize:"resize",change:"change",
remove:"remove",insert:"insert"},Commands:{move:"M",line:"L",curve:"C",close:"Z"},Resolution:8,Instances:[],noConflict:function(){k.Two=e;return this},Utils:{Curve:{CollinearityEpsilon:u(10,-30),RecursionLimit:16,CuspLimit:0,Tolerance:{distance:0.25,angle:0,epsilon:0.01}},setPlaying:function(a){_.defer(_.bind(function(){this.playing=!!a},this))},getComputedMatrix:function(a){for(var b=new g.Matrix;a&&a._matrix;){var f=a._matrix.elements;b.multiply(f[0],f[1],f[2],f[3],f[4],f[5],f[6],f[7],f[8],f[9]);
...
a.nodeValue}});return b},read:{svg:function(){return g.Utils.read.g.apply(this,arguments)},g:function(a){var b=new g.Group;this.add(b);_.each(a.childNodes,function(a){if(a.localName){var c=a.localName.toLowerCase();c in g.Utils.read&&(a=g.Utils.read[c].call(this,a),b.add(a))}},this);return g.Utils.applySvgAttributes(a,b)},polygon:function(a,b){var f=a.points;if(f){var c=_.map(_.range(f.numberOfItems),function(a){a=f.getItem(a);return new g.Anchor(a.x,a.y)}),c=(new g.Polygon(c,!b)).noStroke();return g.Utils.applySvgAttributes(a,
c)}},polyline:function(a){return g.Utils.read.polygon(a,!0)},path:function(a){var b,f,c,d=!1,l=!1,e=a.getAttribute("d").match(/[a-df-z][^a-df-z]*/ig),m=e.length-1,e=_.flatten(_.map(e,function(a,e){var s,p,h=a[0],u=h.toLowerCase();c=a.slice(1).trim();c=c.replace(/(-?\d+(?:\.\d*)?)[eE]([+\-]?\d+)/g,function(a,b,f){return parseFloat(b)*Math.pow(10,f)});c=c.split(/[\s,]+|(?=\s?[+\-])/);d=h===u;var r,w,j,k;switch(u){case "z":e>=m?l=!0:(p=b.x,s=b.y,s=new g.Anchor(p,s,void 0,void 0,void 0,void 0,g.Commands.close));
break;case "m":case "l":p=parseFloat(c[0]);s=parseFloat(c[1]);s=new g.Anchor(p,s,void 0,void 0,void 0,void 0,"m"===u?g.Commands.move:g.Commands.line);d&&s.addSelf(b);b=s;break;case "h":case "v":p="h"===u?"x":"y";h="x"===p?"y":"x";s=new g.Anchor(void 0,void 0,void 0,void 0,void 0,void 0,g.Commands.line);s[p]=parseFloat(c[0]);s[h]=b[h];d&&(s[p]+=b[p]);b=s;break;case "s":case "c":s=b.x;h=b.y;f||(f=(new g.Vector).copy(b));"c"===u?(r=parseFloat(c[0]),p=parseFloat(c[1]),u=parseFloat(c[2]),w=parseFloat(c[3]),
j=parseFloat(c[4]),k=parseFloat(c[5])):(w=g.Utils.getReflection(b,f,d),r=w.x,p=w.y,u=parseFloat(c[0]),w=parseFloat(c[1]),j=parseFloat(c[2]),k=parseFloat(c[3]));d&&(r+=s,p+=h,u+=s,w+=h,j+=s,k+=h);_.isObject(b.controls)||g.Anchor.AppendCurveProperties(b);b.controls.right.set(r,p);b=s=new g.Anchor(j,k,u,w,void 0,void 0,g.Commands.curve);f=s.controls.left;break;case "t":case "q":s=b.x;h=b.y;f||(f=(new g.Vector).copy(b));f.isZero()?(r=s,p=h):(r=f.x,h=f.y);"q"===u?(u=parseFloat(c[0]),w=parseFloat(c[1]),
j=parseFloat(c[1]),k=parseFloat(c[2])):(w=g.Utils.getReflection(b,f,d),u=w.x,w=w.y,j=parseFloat(c[0]),k=parseFloat(c[1]));d&&(r+=s,p+=h,u+=s,w+=h,j+=s,k+=h);_.isObject(b.controls)||g.Anchor.AppendCurveProperties(b);b.controls.right.set(r,p);b=s=new g.Anchor(j,k,u,w,void 0,void 0,g.Commands.curve);f=s.controls.left;break;case "a":throw new g.Utils.Error("not yet able to interpret Elliptical Arcs.");}return s}));if(!(1>=e.length))return e=_.compact(e),e=(new g.Polygon(e,l,void 0,!0)).noStroke(),g.Utils.applySvgAttributes(a,
e)},circle:function(a){var b=parseFloat(a.getAttribute("cx")),f=parseFloat(a.getAttribute("cy")),c=parseFloat(a.getAttribute("r")),e=g.Resolution,m=_.map(_.range(e),function(a){var b=a/e*l;a=c*d(b);b=c*h(b);return new g.Anchor(a,b)},this),m=(new g.Polygon(m,!0,!0)).noStroke();m.translation.set(b,f);return g.Utils.applySvgAttributes(a,m)},ellipse:function(a){var b=parseFloat(a.getAttribute("cx")),f=parseFloat(a.getAttribute("cy")),c=parseFloat(a.getAttribute("rx")),e=parseFloat(a.getAttribute("ry")),
m=g.Resolution,p=_.map(_.range(m),function(a){var b=a/m*l;a=c*d(b);b=e*h(b);return new g.Anchor(a,b)},this),p=(new g.Polygon(p,!0,!0)).noStroke();p.translation.set(b,f);return g.Utils.applySvgAttributes(a,p)},rect:function(a){var b=parseFloat(a.getAttribute("x")),f=parseFloat(a.getAttribute("y")),c=parseFloat(a.getAttribute("width")),d=parseFloat(a.getAttribute("height")),c=c/2,d=d/2,l=[new g.Anchor(c,d),new g.Anchor(-c,d),new g.Anchor(-c,-d),new g.Anchor(c,-d)],l=(new g.Polygon(l,!0)).noStroke();
l.translation.set(b+c,f+d);return g.Utils.applySvgAttributes(a,l)},line:function(a){var b=parseFloat(a.getAttribute("x1")),c=parseFloat(a.getAttribute("y1")),d=parseFloat(a.getAttribute("x2")),l=parseFloat(a.getAttribute("y2")),d=(d-b)/2,l=(l-c)/2,e=[new g.Anchor(-d,-l),new g.Anchor(d,l)],e=(new g.Polygon(e)).noFill();e.translation.set(b+d,c+l);return g.Utils.applySvgAttributes(a,e)}},subdivide:function(c,d,f,e,m,h,u,r,w){var k=g.Utils.Curve.CollinearityEpsilon,x=g.Utils.Curve.RecursionLimit,v=g.Utils.Curve.CuspLimit,
q=g.Utils.Curve.Tolerance,n;w=w||0;if(w>x)return[];var x=(c+f)/2,z=(d+e)/2,F=(f+m)/2,j=(e+h)/2,M=(m+u)/2,N=(h+r)/2,O=(x+F)/2,P=(z+j)/2,F=(F+M)/2,j=(j+N)/2,D=(O+F)/2,E=(P+j)/2;n=u-c;var B=r-d,G=p((f-u)*B-(e-r)*n),H=p((m-u)*B-(h-r)*n);if(0<w){if(G>k&&H>k&&(G+H)*(G+H)<=q.distance*(n*n+B*B)){if(q.angle<q.epsilon)return[new g.Anchor(D,E)];n=b(h-e,m-f);k=p(n-b(e-d,f-c));n=p(b(r-h,u-m)-n);k>=a&&(k=l-k);n>=a&&(n=l-n);if(k+n<q.angle)return[new g.Anchor(D,E)];if(0!==v){if(k>v)return[new g.Anchor(f,e)];if(n>
v)return[new g.Anchor(m,h)]}}}else if(G>k)if(G*G<=q.distance*(n*n+B*B)){if(q.angle<q.epsilon)return[new g.Anchor(D,E)];k=p(b(h-e,m-f)-b(e-d,f-c));k>=a&&(k=l-k);if(k<q.angle)return[new g.Anchor(f,e),new g.Anchor(m,h)];if(0!==v&&k>v)return[new g.Anchor(f,e)]}else if(H>k){if(H*H<=q.distance*(n*n+B*B)){if(q.angle<q.epsilon)return[new g.Anchor(D,E)];k=p(b(r-h,u-m)-b(h-e,m-f));k>=a&&(k=l-k);if(k<q.angle)return[new g.Anchor(f,e),new g.Anchor(m,h)];if(0!==v&&k>v)return[new g.Anchor(m,h)]}}else if(n=D-(c+
u)/2,B=E-(d+r)/2,n*n+B*B<=q.distance)return[new g.Anchor(D,E)];return g.Utils.subdivide(c,d,x,z,O,P,D,E,w+1).concat(g.Utils.subdivide(D,E,F,j,M,N,u,r,w+1))},getCurveFromPoints:function(a,b){for(var c=a.length,d=c-1,l=0;l<c;l++){var e=a[l];_.isObject(e.controls)||g.Anchor.AppendCurveProperties(e);var m=b?z(l-1,c):Math.max(l-1,0),h=b?z(l+1,c):Math.min(l+1,d);q(a[m],e,a[h]);e._command=0===l?g.Commands.move:g.Commands.curve;e.controls.left.x=_.isNumber(e.controls.left.x)?e.controls.left.x:e.x;e.controls.left.y=
_.isNumber(e.controls.left.y)?e.controls.left.y:e.y;e.controls.right.x=_.isNumber(e.controls.right.x)?e.controls.right.x:e.x;e.controls.right.y=_.isNumber(e.controls.right.y)?e.controls.right.y:e.y}},getControlPoints:function(b,c,f){var e=v(b,c),l=v(f,c);b=w(b,c);f=w(f,c);var p=(e+l)/2;c.u=_.isObject(c.controls.left)?c.controls.left:new g.Vector(c.x,c.y);c.v=_.isObject(c.controls.right)?c.controls.right:new g.Vector(c.x,c.y);if(1E-4>b||1E-4>f)return c.controls.left.copy(c),c.controls.right.copy(c),
c;b*=0.33;f*=0.33;p=l<e?p+m:p-m;c.controls.left.x=c.x+d(p)*b;c.controls.left.y=c.y+h(p)*b;p-=a;c.controls.right.x=c.x+d(p)*f;c.controls.right.y=c.y+h(p)*f;return c},getReflection:function(a,b,c){var d=a.distanceTo(b);if(1E-4>=d)return c?new g.Vector:a.clone();b=v(a,b);return new g.Vector(d*Math.cos(b)+(c?0:a.x),d*Math.sin(b)+(c?0:a.y))},angleBetween:function(a,c){return b(a.y-c.y,a.x-c.x)},distanceBetweenSquared:function(a,b){var c=a.x-b.x,d=a.y-b.y;return c*c+d*d},distanceBetween:function(a,b){return c(x(a,
...
requestAnimationFrame(arguments.callee)})();"function"===typeof define&&define.amd?define(function(){return g}):"undefined"!=typeof module&&module.exports&&(module.exports=g)})();(function(){var n=Two.Vector=function(e,h){this.x=e||0;this.y=h||0};_.extend(n,{MakeGetterSetter:function(e,h,d){var b="_"+h;Object.defineProperty(e,h,{get:function(){return this[b]},set:function(c){this[b]=c;this.trigger(Two.Events.change,h)}});e[b]=d}});_.extend(n.prototype,Backbone.Events,{set:function(e,h){this.x=e;this.y=h;return this},copy:function(e){this.x=e.x;this.y=e.y;return this},clear:function(){this.y=this.x=0;return this},clone:function(){return new n(this.x,this.y)},add:function(e,
...
this.distanceTo(e)},lerp:function(e,h){return this.set((e.x-this._x)*h+this._x,(e.y-this._y)*h+this._y)},isZero:function(){return 1E-4>this.length()}};Two.Vector.prototype.bind=Two.Vector.prototype.on=function(){this._bound||(Two.Vector.MakeGetterSetter(this,"x",this.x),Two.Vector.MakeGetterSetter(this,"y",this.y),_.extend(this,k),this._bound=!0);Backbone.Events.bind.apply(this,arguments);return this}})();(function(){var n=Two.Commands,k=Two.Anchor=function(e,h,d,b,c,p,a){Two.Vector.call(this,e,h);this._broadcast=_.bind(function(){this.trigger(Two.Events.change)},this);Object.defineProperty(this,"command",{get:function(){return this._command},set:function(a){this._command=a;this._command===n.curve&&!_.isObject(this.controls)&&k.AppendCurveProperties(this);return this.trigger(Two.Events.change)}});this._command=a||n.move;if(!a)return this;k.AppendCurveProperties(this);_.isNumber(d)&&(this.controls.left.x=
d);_.isNumber(b)&&(this.controls.left.y=b);_.isNumber(c)&&(this.controls.right.x=c);_.isNumber(p)&&(this.controls.right.y=p)};_.extend(k,{AppendCurveProperties:function(e){var h=e._x||e.x,d=e._y||e.y;e.controls={left:new Two.Vector(h,d),right:new Two.Vector(h,d)}}});_.extend(k.prototype,Two.Vector.prototype,{listen:function(){_.isObject(this.controls)||k.AppendCurveProperties(this);_.each(this.controls,function(e){e.bind(Two.Events.change,this._broadcast)},this);return this},ignore:function(){_.each(this.controls,
function(e){e.unbind(Two.Events.change,this._broadcast)},this);return this},clone:function(){var e=this.controls;return new Two.Anchor(this.x,this.y,e&&e.left.x,e&&e.left.y,e&&e.right.x,e&&e.right.y,this.command)}})})();(function(){_.range(6);var n=Math.cos,k=Math.sin,e=Math.tan,h=Two.Matrix=function(d,b,c,e,a,l){this.elements=new Two.Array(9);var m=d;_.isArray(m)||(m=_.toArray(arguments));this.identity().set(m)};_.extend(h,{Identity:[1,0,0,0,1,0,0,0,1],Multiply:function(d,b){if(3>=b.length){var c=b[0]||0,e=b[1]||0,a=b[2]||0;return{x:d[0]*c+d[1]*e+d[2]*a,y:d[3]*c+d[4]*e+d[5]*a,z:d[6]*c+d[7]*e+d[8]*a}}var c=d[0],e=d[1],a=d[2],l=d[3],m=d[4],h=d[5],r=d[6],g=d[7],k=d[8],x=b[0],v=b[1],q=b[2],n=b[3],s=b[4],t=b[5],f=b[6],
y=b[7],A=b[8];return[c*x+e*n+a*f,c*v+e*s+a*y,c*q+e*t+a*A,l*x+m*n+h*f,l*v+m*s+h*y,l*q+m*t+h*A,r*x+g*n+k*f,r*v+g*s+k*y,r*q+g*t+k*A]}});_.extend(h.prototype,Backbone.Events,{set:function(d,b,c,e,a,l){var m=d;_.isArray(m)||(m=_.toArray(arguments));_.each(m,function(a,b){_.isNumber(a)&&(this.elements[b]=a)},this);return this.trigger(Two.Events.change)},identity:function(){this.set(h.Identity);return this},multiply:function(d,b,c,e,a,l,m,h,r){var g=arguments,k=g.length;if(1>=k)return _.each(this.elements,
...
A3*B1+A4*B4+A5*B7;this.elements[5]=A3*B2+A4*B5+A5*B8;this.elements[6]=A6*B0+A7*B3+A8*B6;this.elements[7]=A6*B1+A7*B4+A8*B7;this.elements[8]=A6*B2+A7*B5+A8*B8;return this.trigger(Two.Events.change)},inverse:function(d){var b=this.elements;d=d||new Two.Matrix;var c=b[0],e=b[1],a=b[2],l=b[3],m=b[4],h=b[5],r=b[6],g=b[7],b=b[8],k=b*m-h*g,n=-b*l+h*r,v=g*l-m*r,q=c*k+e*n+a*v;if(!q)return null;q=1/q;d.elements[0]=k*q;d.elements[1]=(-b*e+a*g)*q;d.elements[2]=(h*e-a*m)*q;d.elements[3]=n*q;d.elements[4]=(b*c-
a*r)*q;d.elements[5]=(-h*c+a*l)*q;d.elements[6]=v*q;d.elements[7]=(-g*c+e*r)*q;d.elements[8]=(m*c-e*l)*q;return d},scale:function(d,b){1>=arguments.length&&(b=d);return this.multiply(d,0,0,0,b,0,0,0,1)},rotate:function(d){var b=n(d);d=k(d);return this.multiply(b,-d,0,d,b,0,0,0,1)},translate:function(d,b){return this.multiply(1,0,d,0,1,b,0,0,1)},skewX:function(d){d=e(d);return this.multiply(1,d,0,0,1,0,0,0,1)},skewY:function(d){d=e(d);return this.multiply(1,0,0,d,1,0,0,0,1)},toString:function(){return this.toArray().join(" ")},
toArray:function(d){var b=this.elements,c=parseFloat(b[0].toFixed(3)),e=parseFloat(b[1].toFixed(3)),a=parseFloat(b[2].toFixed(3)),l=parseFloat(b[3].toFixed(3)),m=parseFloat(b[4].toFixed(3)),h=parseFloat(b[5].toFixed(3));if(d){d=parseFloat(b[6].toFixed(3));var r=parseFloat(b[7].toFixed(3)),b=parseFloat(b[8].toFixed(3));return[c,l,d,e,m,r,a,h,b]}return[c,l,e,m,a,h]},clone:function(){return new Two.Matrix(this.elements[0],this.elements[1],this.elements[2],this.elements[3],this.elements[4],this.elements[5],
this.elements[6],this.elements[7],this.elements[8])}})})();(function(){function n(d){var b={},c=d.id,p=d.translation,a=d.rotation,l=d.scale,m=d.stroke,u=d.linewidth,r=d.fill,g=d.opacity,k=d.visible,n=d.cap,v=d.join,q=d.miter,z=d.closed,s=d.vertices;c&&(b.id=h.Identifier+c);p&&(_.isNumber(l)&&_.isNumber(a))&&(b.transform="matrix("+d._matrix.toString()+")");m&&(b.stroke=m);r&&(b.fill=r);g&&(b["stroke-opacity"]=b["fill-opacity"]=g);b.visibility=k?"visible":"hidden";n&&(b["stroke-linecap"]=n);v&&(b["stroke-linejoin"]=v);q&&(b["stroke-miterlimit"]=q);u&&(b["stroke-width"]=
u);s&&(b.d=e.toString(s,z));return b}var k=Two.Utils.mod,e={version:1.1,ns:"http://www.w3.org/2000/svg",xlink:"http://www.w3.org/1999/xlink",createElement:function(d,b){var c=document.createElementNS(this.ns,d);"svg"===d&&(b=_.defaults(b||{},{version:this.version}));_.isObject(b)&&this.setAttributes(c,b);return c},setAttributes:function(d,b){_.each(b,function(b,d){this.setAttribute(d,b)},d);return this},removeAttributes:function(d,b){_.each(b,function(b){this.removeAttribute(b)},d);return this},toString:function(d,
b){var c=d.length,e=c-1;return _.map(d,function(a,l){var m,h=b?k(l-1,c):Math.max(l-1,0),r=b?k(l+1,c):Math.min(l+1,e),h=d[h],r=d[r],g,n,x,v,q;q=a.x.toFixed(3);v=a.y.toFixed(3);switch(a._command){case Two.Commands.close:m=a._command;break;case Two.Commands.curve:g=h.controls&&h.controls.right||h;m=a.controls&&a.controls.left||a;h=g.x.toFixed(3);g=g.y.toFixed(3);n=m.x.toFixed(3);x=m.y.toFixed(3);m=a._command+" "+h+" "+g+" "+n+" "+x+" "+q+" "+v;break;default:m=(a._command||(0===l?Two.Commands.move:Two.Commands.line))+
" "+q+" "+v}l>=e&&b&&(a._command===Two.Commands.curve&&(v=a.controls&&a.controls.right||a,q=r.controls&&r.controls.left||r,h=v.x.toFixed(3),g=v.y.toFixed(3),n=q.x.toFixed(3),x=q.y.toFixed(3),q=r.x.toFixed(3),v=r.y.toFixed(3),m+=" C "+h+" "+g+" "+n+" "+x+" "+q+" "+v),m+=" Z");return m}).join(" ")}},h=Two[Two.Types.svg]=function(){this.count=0;this.domElement=e.createElement("svg");this.elements=[];this.domElement.style.visibility="hidden";this.unveil=_.once(_.bind(function(){this.domElement.style.visibility=
...
var e=function(b){_.each(b,function(b,d){this[d]=b},this)};_.extend(e.prototype,{render:function(b){var c=this.matrix,d=this.stroke,a=this.linewidth,e=this.fill,h=this.opacity,u=this.cap,r=this.join,g=this.miter,k=this.closed,x=this.commands,v=x.length,q=v-1;if(!this.visible)return this;b.save();c&&b.transform(c[0],c[1],c[2],c[3],c[4],c[5]);e&&(b.fillStyle=e);d&&(b.strokeStyle=d);a&&(b.lineWidth=a);g&&(b.miterLimit=g);r&&(b.lineJoin=r);u&&(b.lineCap=u);_.isNumber(h)&&(b.globalAlpha=h);b.beginPath();
_.each(x,function(a,c){var d,f,e,l,g,h,m;m=a.x.toFixed(3);h=a.y.toFixed(3);switch(a._command){case Two.Commands.close:b.closePath();break;case Two.Commands.curve:f=k?n(c-1,v):Math.max(c-1,0);d=k?n(c+1,v):Math.min(c+1,q);f=x[f];d=x[d];e=f.controls&&f.controls.right||f;l=a.controls&&a.controls.left||a;f=e.x.toFixed(3);g=e.y.toFixed(3);e=l.x.toFixed(3);l=l.y.toFixed(3);b.bezierCurveTo(f,g,e,l,m,h);c>=q&&k&&(h=a.controls&&a.controls.right||a,m=d.controls&&d.controls.left||d,f=h.x.toFixed(3),g=h.y.toFixed(3),
e=m.x.toFixed(3),l=m.y.toFixed(3),m=d.x.toFixed(3),h=d.y.toFixed(3),b.bezierCurveTo(f,g,e,l,m,h));break;case Two.Commands.line:b.lineTo(m,h);break;case Two.Commands.move:b.moveTo(m,h)}});k&&b.closePath();b.fill();b.stroke();b.restore()}});var h={devicePixelRatio:this.devicePixelRatio||1,getBackingStoreRatio:function(b){return b.webkitBackingStorePixelRatio||b.mozBackingStorePixelRatio||b.msBackingStorePixelRatio||b.oBackingStorePixelRatio||b.backingStorePixelRatio||1},getRatio:function(b){return this.devicePixelRatio/
this.getBackingStoreRatio(b)}},d=Two[Two.Types.canvas]=function(){this.count=0;this.domElement=document.createElement("canvas");this.ctx=this.domElement.getContext("2d");this.overdraw=!1;this.elements=[];this.stage=null};_.extend(d,{Group:k,Element:e,getStyles:function(b){var c={},d=b.id,a=b._matrix,e=b.stroke,h=b.linewidth,k=b.fill,r=b.opacity,g=b.visible,n=b.cap,x=b.join,v=b.miter,q=b.closed;b=b.vertices;d&&(c.id=d);_.isObject(a)&&(c.matrix=a.toArray());e&&(c.stroke=e);k&&(c.fill=k);_.isNumber(r)&&
(c.opacity=r);n&&(c.cap=n);x&&(c.join=x);v&&(c.miter=v);h&&(c.linewidth=h);b&&(c.commands=b);c.visible=!!g;c.closed=!!q;return c},setStyles:function(b,c,d,a){switch(c){case "matrix":c="matrix";d=d.toArray();break;case "vertices":c="commands",b.closed=a}b[c]=d},Utils:h});_.extend(d.prototype,Backbone.Events,{setSize:function(b,c,d){this.width=b;this.height=c;this.ratio=_.isUndefined(d)?h.getRatio(this.ctx):d;this.domElement.width=b*this.ratio;this.domElement.height=c*this.ratio;_.extend(this.domElement.style,
...
l=l.y,h&&(a&&b&&l)&&(e=Math.min(a,l,e),c=Math.min(h,b,c),d=Math.max(h,b,d),g=Math.max(a,l,g))))});_.isNumber(b)&&(e-=b,c-=b,d+=b,g+=b);return{top:e,left:c,right:d,bottom:g,width:d-c,height:g-e,centroid:{x:-c,y:-e}}},getTriangles:function(a){var b=a.top,c=a.left,d=a.right;a=a.bottom;return new Two.Array([c,b,d,b,c,a,c,a,d,b,d,a])},updateCanvas:function(a){var b=a.commands,c=this.canvas,d=this.ctx,e=a._scale,g=a.stroke,k=a.linewidth*e,p=a.fill,n=a.opacity,q=a.cap,z=a.join,s=a.miter,t=a.closed,f=b.length,
y=f-1;c.width=Math.max(Math.ceil(a.rect.width*e),1);c.height=Math.max(Math.ceil(a.rect.height*e),1);a=a.rect.centroid;var A=a.x*e,C=a.y*e;d.clearRect(0,0,c.width,c.height);p&&(d.fillStyle=p);g&&(d.strokeStyle=g);k&&(d.lineWidth=k);s&&(d.miterLimit=s);z&&(d.lineJoin=z);q&&(d.lineCap=q);_.isNumber(n)&&(d.globalAlpha=n);d.beginPath();_.each(b,function(a,c){var g,m,k,p,n,q,s;s=(a.x*e+A).toFixed(3);q=(a.y*e+C).toFixed(3);switch(a._command){case Two.Commands.close:d.closePath();break;case Two.Commands.curve:m=
t?h(c-1,f):Math.max(c-1,0);g=t?h(c+1,f):Math.min(c+1,y);m=b[m];g=b[g];k=m.controls&&m.controls.right||m;p=a.controls&&a.controls.left||a;m=(k.x*e+A).toFixed(3);n=(k.y*e+C).toFixed(3);k=(p.x*e+A).toFixed(3);p=(p.y*e+C).toFixed(3);d.bezierCurveTo(m,n,k,p,s,q);c>=y&&t&&(q=a.controls&&a.controls.right||a,s=g.controls&&g.controls.left||g,m=(q.x*e+A).toFixed(3),n=(q.y*e+C).toFixed(3),k=(s.x*e+A).toFixed(3),p=(s.y*e+C).toFixed(3),s=(g.x*e+A).toFixed(3),q=(g.y*e+C).toFixed(3),d.bezierCurveTo(m,n,k,p,s,q));
break;case Two.Commands.line:d.lineTo(s,q);break;case Two.Commands.move:d.moveTo(s,q)}});t&&d.closePath();d.fill();d.stroke()},updateTexture:function(a,b){this.updateCanvas(b);b.texture&&a.deleteTexture(b.texture);a.bindBuffer(a.ARRAY_BUFFER,b.textureCoordsBuffer);b.texture=a.createTexture();a.bindTexture(a.TEXTURE_2D,b.texture);a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_S,a.CLAMP_TO_EDGE);a.texParameteri(a.TEXTURE_2D,a.TEXTURE_WRAP_T,a.CLAMP_TO_EDGE);a.texParameteri(a.TEXTURE_2D,a.TEXTURE_MIN_FILTER,
...
fragment:"precision mediump float;\n\nuniform sampler2D u_image;\nvarying vec2 v_textureCoords;\n\nvoid main() {\n  gl_FragColor = texture2D(u_image, v_textureCoords);\n}"}};c.ctx=c.canvas.getContext("2d");var p=Two[Two.Types.webgl]=function(a){this.count=0;this.domElement=document.createElement("canvas");this.elements=[];this.stage=null;this._matrix=[1,0,0,0,1,0,0,0,1];this._scale=1;a=_.defaults(a||{},{antialias:!1,alpha:!0,premultipliedAlpha:!0,stencil:!0,preserveDrawingBuffer:!1});a=this.ctx=this.domElement.getContext("webgl",
...
a.getAttribLocation(this.program,"a_textureCoords");a.disable(a.DEPTH_TEST);a.enable(a.BLEND);a.blendEquationSeparate(a.FUNC_ADD,a.FUNC_ADD);a.blendFuncSeparate(a.SRC_ALPHA,a.ONE_MINUS_SRC_ALPHA,a.ONE,a.ONE_MINUS_SRC_ALPHA)};_.extend(p,{Group:d,Element:b,getStyles:function(a){var d={},e=a.id,h=a._matrix,k=a.stroke,g=a.linewidth,p=a.fill,n=a.opacity,v=a.visible,q=a.cap,z=a.join,s=a.miter,t=a.closed,f=a.vertices;e&&(d.id=e);_.isObject(h)&&(d.matrix=d._matrix=h.toArray(!0),d.scale=d._scale=1);k&&(d.stroke=
k);p&&(d.fill=p);_.isNumber(n)&&(d.opacity=n);q&&(d.cap=q);z&&(d.join=z);s&&(d.miter=s);g&&(d.linewidth=g);f&&(d.vertices=f,d.commands=d.vertices,d.rect=c.getBoundingClientRect(d.commands,d.linewidth),d.triangles=c.getTriangles(d.rect));d.visible=!!v;d.closed=!!t;a instanceof Two.Polygon&&(c.updateBuffer(this.ctx,d,this.program),b.prototype.updateTexture.call(d,this.ctx));return d},setStyles:function(a,b,d,e,h){var g=!1;/matrix/.test(b)?(a[b]=d.toArray(!0),_.isNumber(e)&&(g=a.scale!==e,a.scale=e),
a.updateMatrix()):/(stroke|fill|opacity|cap|join|miter|linewidth)/.test(b)?(a[b]=d,a.rect=n(c.getBoundingClientRect(a.commands,a.linewidth),a.rect),a.triangles=c.getTriangles(a.rect),c.updateBuffer(this.ctx,a,this.program),g=!0):"vertices"===b?(_.isUndefined(e)||(a.closed=e),h?a.commands=d:(a.vertices=d,a.commands=a.vertices),a.rect=n(c.getBoundingClientRect(a.vertices,a.linewidth),a.rect),a.triangles=c.getTriangles(a.rect),c.updateBuffer(this.ctx,a,this.program),g=!0):a[b]=d;g&&a.updateTexture(this.ctx)}});
_.extend(p.prototype,Backbone.Events,k.prototype,{setSize:function(a,b,c){k.prototype.setSize.apply(this,arguments);a*=this.ratio;b*=this.ratio;this._matrix[0]=this._matrix[4]=this._scale=this.ratio;_.isNull(this.stage)||this.stage.updateMatrix();this.ctx.viewport(0,0,a,b);var d=this.ctx.getUniformLocation(this.program,"u_resolution");this.ctx.uniform2f(d,a,b);return this},render:function(){if(_.isNull(this.stage))return this;this.stage.render(this.ctx,this.program);return this}})})();(function(){var n=Two.Shape=function(k){this._matrix=new Two.Matrix;var e=_.debounce(_.bind(function(){var e=this._matrix.identity().translate(this.translation.x,this.translation.y).scale(this.scale).rotate(this.rotation);this.trigger(Two.Events.change,this.id,"matrix",e,this.scale)},this),0);this._rotation=0;Object.defineProperty(this,"rotation",{get:function(){return this._rotation},set:function(h){this._rotation=h;e()}});this._scale="scale";Object.defineProperty(this,"scale",{get:function(){return this._scale},
set:function(h){this._scale=h;e()}});this.translation=new Two.Vector;this.rotation=0;this.scale=1;this.translation.bind(Two.Events.change,e);if(k)return this;n.MakeGetterSetter(this,n.Properties);this.fill="#fff";this.stroke="#000";this.opacity=this.linewidth=1;this.visible=!0;this.join=this.cap="round";this.miter=4};_.extend(n,{Properties:"fill stroke linewidth opacity visible cap join miter".split(" "),MakeGetterSetter:function(k,e){_.isArray(e)||(e=[e]);_.each(e,function(e){var d="_"+e;Object.defineProperty(k,
e,{get:function(){return this[d]},set:function(b){this[d]=b;this.trigger(Two.Events.change,this.id,e,b,this)}})})}});_.extend(n.prototype,Backbone.Events,{addTo:function(k){k.add(this);return this},noFill:function(){this.fill="transparent";return this},noStroke:function(){this.stroke="transparent";return this},clone:function(){var k=new n;k.translation.copy(this.translation);_.each(n.Properties,function(e){k[e]=this[e]},this);return this}})})();(function(){var n=Math.min,k=Math.max,e=Two.Group=function(){Two.Shape.call(this,!0);delete this.stroke;delete this.fill;delete this.linewidth;delete this.opacity;delete this.cap;delete this.join;delete this.miter;e.MakeGetterSetter(this,Two.Shape.Properties);this.children={}};_.extend(e,{MakeGetterSetter:function(e,d){_.isArray(d)||(d=[d]);_.each(d,function(b){var c="_"+b;Object.defineProperty(e,b,{get:function(){return this[c]},set:function(d){this[c]=d;_.each(this.children,function(a){a[b]=d})}})})}});
...
p=-Infinity;_.each(this.children,function(a){a=a.getBoundingClientRect(!0);c&&(d&&b&&p)&&(c=n(a.top,c),d=n(a.left,d),b=k(a.right,b),p=k(a.bottom,p))},this);var a=e?this._matrix:Two.Utils.getComputedMatrix(this);e=a.multiply(d,c,1);var l=a.multiply(b,c,1),m=a.multiply(b,p,1),a=a.multiply(d,p,1),c=n(e.y,l.y,m.y,a.y),d=n(e.x,l.x,m.x,a.x),b=k(e.x,l.x,m.x,a.x),p=k(e.y,l.y,m.y,a.y);return{top:c,left:d,right:b,bottom:p,width:b-d,height:p-c}},noFill:function(){_.each(this.children,function(e){e.noFill()});
return this},noStroke:function(){_.each(this.children,function(e){e.noStroke()});return this},subdivide:function(){_.each(this.children,function(e){e.subdivide()});return this}})})();(function(){var n=Math.min,k=Math.max,e=Math.round,h=Two.Polygon=function(d,b,c,h){Two.Shape.call(this);this._closed=!!b;this._curved=!!c;this._automatic=!h;var a=0,l=1,m=!1,u=!1,r,g=[],w=_.debounce(_.bind(function(){var b,c;this._automatic&&this.plot();if(m||u){b=r.length;c=b-1;b=e(a*c);c=e(l*c);for(g.length=0;b<c+1;b++)g.push(r[b])}this.trigger(Two.Events.change,this.id,"vertices",g,this._closed,m);u=m=!1},this),0);Object.defineProperty(this,"closed",{get:function(){return this._closed},set:function(a){this._closed=
!!a;w()}});Object.defineProperty(this,"curved",{get:function(){return this._curved},set:function(a){this._curved=!!a;w()}});Object.defineProperty(this,"automatic",{get:function(){return this._automatic},set:function(a){if(a!==this._automatic){var b=(this._automatic=!!a)?"ignore":"listen";_.each(this.vertices,function(a){a[b]()},this);w()}}});Object.defineProperty(this,"beginning",{get:function(){return a},set:function(b){a=n(k(b,0),1);m=!0;w()}});Object.defineProperty(this,"ending",{get:function(){return l},
set:function(a){l=n(k(a,0),1);m=!0;w()}});Object.defineProperty(this,"vertices",{get:function(){return r},set:function(a){var b=_.bind(function(a){_.each(a,function(a){a.bind(Two.Events.change,w)},this);u=!0;w()},this),c=_.bind(function(a){_.each(a,function(a){a.unbind(Two.Events.change,w)},this);u=!0;w()},this);r&&r.unbind();r=new Two.Utils.Collection(a.slice(0));r.bind(Two.Events.insert,b);r.bind(Two.Events.remove,c);u=!0;b(r)}});this.vertices=d;if(this._automatic)return this.plot(),this;_.each(this.vertices,
...
this.getBoundingClientRect(!0);d.centroid={x:d.left+d.width/2,y:d.top+d.height/2};_.each(this.vertices,function(b){b.subSelf(d.centroid)});return this},remove:function(){if(!this.parent)return this;this.parent.remove(this);return this},getBoundingClientRect:function(d){var b=this.linewidth/2,c=Infinity,e=-Infinity,a=Infinity,h=-Infinity;_.each(this.vertices,function(b){var d=b.x;b=b.y;a=n(b,a);c=n(d,c);e=k(d,e);h=k(b,h)});var a=a-b,c=c-b,e=e+b,h=h+b,m=d?this._matrix:Two.Utils.getComputedMatrix(this);
d=m.multiply(c,a,1);var b=m.multiply(e,a,1),u=m.multiply(e,h,1),m=m.multiply(c,h,1),a=n(d.y,b.y,u.y,m.y),c=n(d.x,b.x,u.x,m.x),e=k(d.x,b.x,u.x,m.x),h=k(d.y,b.y,u.y,m.y);return{top:a,left:c,right:e,bottom:h,width:e-c,height:h-a}},plot:function(){if(this._curved)return Two.Utils.getCurveFromPoints(this.vertices,this._closed),this;_.each(this.vertices,function(d,b){d._command=0===b?Two.Commands.move:Two.Commands.line},this);return this},subdivide:function(){var d=this.vertices.length-1,b=this._closed||
this.vertices[d].command===Two.Commands.close,c=[],e;_.each(this.vertices,function(a,d){var h,k,n,g,w,x,v,q;if(!(0>=d)||b)h=e.x,k=e.y,n=(e.controls&&e.controls.right||e).x,g=(e.controls&&e.controls.right||e).y,w=(a.controls&&a.controls.left||a).x,x=(a.controls&&a.controls.left||a).y,v=a.x,q=a.y,c.push(Two.Utils.subdivide(h,k,n,g,w,x,v,q));e=a},this);this._curved=this._manual=!1;this.vertices=_.flatten(c);this.plot();return this}})})();

...
c=Array(b),d=0;d<b;d++)c[d]=e.pluck(a,""+d);return c};e.indexOf=function(a,b,c){if(null==a)return-1;var d;if(c)return c=e.sortedIndex(a,b),a[c]===b?c:-1;if(v&&a.indexOf===v)return a.indexOf(b);c=0;for(d=a.length;c<d;c++)if(c in a&&a[c]===b)return c;return-1};e.lastIndexOf=function(a,b){if(null==a)return-1;if(t&&a.lastIndexOf===t)return a.lastIndexOf(b);for(var e=a.length;e--;)if(e in a&&a[e]===b)return e;return-1};e.range=function(a,b,e){1>=arguments.length&&(b=a||0,a=0);e=arguments[2]||1;for(var c=
...
return function(){for(var b=arguments,e=a.length-1;0<=e;e--)b=[a[e].apply(this,b)];return b[0]}};e.after=function(a,b){return 0>=a?b():function(){if(1>--a)return b.apply(this,arguments)}};e.keys=q||function(a){if(a!==Object(a))throw new TypeError("Invalid object");var b=[],c;for(c in a)e.has(a,c)&&(b[b.length]=c);return b};e.values=function(a){return e.map(a,e.identity)};e.functions=e.methods=function(a){var b=[],c;for(c in a)e.isFunction(a[c])&&b.push(c);return b.sort()};e.extend=function(a){x(h.call(arguments,
1),function(b){for(var e in b)a[e]=b[e]});return a};e.pick=function(a){var b={};x(e.flatten(h.call(arguments,1)),function(e){e in a&&(b[e]=a[e])});return b};e.defaults=function(a){x(h.call(arguments,1),function(b){for(var e in b)null==a[e]&&(a[e]=b[e])});return a};e.clone=function(a){return!e.isObject(a)?a:e.isArray(a)?a.slice():e.extend({},a)};e.tap=function(a,b){b(a);return a};e.isEqual=function(a,b){return n(a,b,[])};e.isEmpty=function(a){if(null==a)return!0;if(e.isArray(a)||e.isString(a))return 0===
...
c,d){var j,l,p,m,r,k,s,n;if(!this._events||!b(this,"off",a,[c,d]))return this;if(!a&&!c&&!d)return this._events={},this;m=a?[a]:_.keys(this._events);r=0;for(k=m.length;r<k;r++)if(a=m[r],j=this._events[a]){p=[];if(c||d){s=0;for(n=j.length;s<n;s++)l=j[s],(c&&c!==(l.callback._callback||l.callback)||d&&d!==l.context)&&p.push(l)}this._events[a]=p}return this},trigger:function(a){if(!this._events)return this;var d=n.call(arguments,1);if(!b(this,"trigger",a,d))return this;var g=this._events[a],j=this._events.all;
g&&c(this,g,d);j&&c(this,j,arguments);return this},listenTo:function(a,b,c){var d=this._listeners||(this._listeners={}),l=a._listenerId||(a._listenerId=_.uniqueId("l"));d[l]=a;a.on(b,c||this,this);return this},stopListening:function(a,b,c){var d=this._listeners;if(d){if(a)a.off(b,c,this),!b&&!c&&delete d[a._listenerId];else{for(var l in d)d[l].off(null,null,this);this._listeners={}}return this}}};d.bind=d.on;d.unbind=d.off})();(function(){for(var n=0,a=["ms","moz","webkit","o"],b=0;b<a.length&&!window.requestAnimationFrame;++b)window.requestAnimationFrame=window[a[b]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[a[b]+"CancelAnimationFrame"]||window[a[b]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=function(a){var b=(new Date).getTime(),f=Math.max(0,16-(b-n)),h=window.setTimeout(function(){a(b+f)},f);n=b+f;return h});window.cancelAnimationFrame||(window.cancelAnimationFrame=
function(a){clearTimeout(a)})})();(function(){var n=this;previousTessellation=n.tessellation;tessellation=n.tessellation={noConflict:function(){n.tessellation=previousTessellation;return this}};tessellation.cmp=function(a,b){return a.y==b.y?a.x-b.x:a.y-b.y};tessellation.equals=function(a,b){return a.x==b.x&&a.y==b.y};tessellation.Edge=function(){this.q=this.p=null;2==arguments.length?arguments[0].y>arguments[1].y?(this.q=arguments[0],this.p=arguments[1]):arguments[0].y==arguments[1].y?arguments[0].x>arguments[1].x?(this.q=arguments[0],
...
b,c)){var h=d.PointCCW(f),h=tessellation.Orient2d(c,h,b)||tessellation.Orientation.CW;if(h==tessellation.Orientation.COLLINEAR)alert("tessellation.sweep.EdgeEvent: Collinear not supported!");else{var g=d.PointCW(f),g=tessellation.Orient2d(c,g,b)||tessellation.Orientation.CW;g==tessellation.Orientation.COLLINEAR?alert("tessellation.sweep.EdgeEvent: Collinear not supported!"):h==g?(d=h==tessellation.Orientation.CW?d.NeighborCCW(f):d.NeighborCW(f),tessellation.sweep.EdgeEvent(a,b,c,d,f)):tessellation.sweep.FlipEdgeEvent(a,
b,c,d,f)}}}};tessellation.sweep.IsEdgeSideOfTriangle=function(a,b,c){var d=a.EdgeIndex(b,c);return-1!=d?(a.MarkConstrainedEdge(d),a=a.GetNeighbor(d),null!=a&&a.MarkConstrainedEdge(b,c),!0):!1};tessellation.sweep.NewFrontTriangle=function(a,b,c){var d=new tessellation.Triangle(b,c.point,c.next.point);d.MarkNeighbor(c.triangle);a.AddToMap(d);b=new tessellation.Node(b);b.next=c.next;b.prev=c;c.next.prev=b;c.next=b;tessellation.sweep.Legalize(a,d)||a.MapTriangleToNodes(d);return b};tessellation.sweep.Fill=
function(a,b){var c=new tessellation.Triangle(b.prev.point,b.point,b.next.point);c.MarkNeighbor(b.prev.triangle);c.MarkNeighbor(b.triangle);a.AddToMap(c);b.prev.next=b.next;b.next.prev=b.prev;tessellation.sweep.Legalize(a,c)||a.MapTriangleToNodes(c)};tessellation.sweep.FillAdvancingFront=function(a,b){for(var c=b.next,d;null!=c.next;){d=tessellation.sweep.HoleAngle(c);if(d>tessellation.PI_2||d<-tessellation.PI_2)break;tessellation.sweep.Fill(a,c);c=c.next}for(c=b.prev;null!=c.prev;){d=tessellation.sweep.HoleAngle(c);
...
a.width,this.height=a.height);this.scene=new k.Group;this.renderer.add(this.scene);k.Instances.push(this)};_.extend(k,{Array:a.Float32Array||Array,Types:{webgl:"WebGLRenderer",svg:"SVGRenderer",canvas:"CanvasRenderer"},Properties:{hierarchy:"hierarchy",demotion:"demotion"},Events:{play:"play",pause:"pause",update:"update",render:"render",resize:"resize",change:"change"},Resolution:8,Instances:[],noConflict:function(){a.Two=b;return this},Utils:{Curve:{CollinearityEpsilon:m(10,-30),RecursionLimit:32,
CuspLimit:0,Tolerance:{distance:0.25,angle:0,epsilon:0.01}},decoupleShapes:function(a,b){b=b||0;var c=a.length;if(3>=c||b>k.Utils.Curve.RecursionLimit)return[a];for(var d=0,c=a.length;d<c;d++)for(var g=u(d+1,c),f=a[d],h=a[g],j=0,l=u(d+1,c);j<c;j++){var p=u(l+1,c),r=a[l],m=a[p];if(!(l==d||l==g||p==d||p==g))if(r=t(f,h,r,m))return d=[r],f=[r.clone()],d=a.slice(0,g).concat(d),l=a.slice(g,l+1).concat(f),p>g?d=d.concat(a.slice(p,c)):0<p&&(l=l.concat(a.slice(p,c))),[q(d,b+1),q(l,b+1)];l=u(l+1,c)}return[a]},
solveSegmentIntersection:function(a,b,c,d){var g=(d.x-c.x)*(a.y-c.y)-(d.y-c.y)*(a.x-c.x),f=(b.x-a.x)*(a.y-c.y)-(b.y-a.y)*(a.x-c.x);c=(d.y-c.y)*(b.x-a.x)-(d.x-c.x)*(b.y-a.y);return 0!=c&&(g/=c,f/=c,0<=g&&1>=g&&0<=f&&1>=f)?new k.Vector(a.x+g*(b.x-a.x),a.y+g*(b.y-a.y)):null},subdivide:function(a,b,c,d,h,q,u,p,r){var m=k.Utils.Curve.CollinearityEpsilon,s=k.Utils.Curve.CuspLimit,n=k.Utils.Curve.Tolerance;r=r||0;var t=(a+c)/2,z=(b+d)/2,w=(c+h)/2,v=(d+q)/2,N=(h+u)/2,O=(q+p)/2,P=(t+w)/2,Q=(z+v)/2,w=(w+N)/
2,v=(v+O)/2,B=(P+w)/2,C=(Q+v)/2;if(0<r){var y=u-a,A=p-b,G=g((c-u)*A-(d-p)*y),H=g((h-u)*A-(q-p)*y);if(G>m&&H>m&&(G+H)*(G+H)<=n.distance*(y*y+A*A)){if(n.angle<n.epsilon)return[new k.Vector(B,C)];y=f(q-d,h-c);m=g(y-f(d-b,c-a));y=g(f(p-q,u-h)-y);m>=j&&(m=l-m);y>=j&&(y=l-y);if(m+y<n.angle)return[new k.Vector(B,C)];if(0!==s){if(m>s)return[new k.Vector(c,d)];if(y>s)return[new k.Vector(h,q)]}}}else if(G>m)if(G*G<=n.distance*(y*y+A*A)){if(n.angle<n.epsilon)return[new k.Vector(B,C)];m=g(f(q-d,h-c)-f(d-b,c-
a));m>=j&&(m=l-m);if(m<n.angle)return[new k.Vector(c,d),new k.Vector(h,q)];if(0!==s&&m>s)return[new k.Vector(c,d)]}else if(H>m){if(H*H<=n.distance*(y*y+A*A)){if(n.angle<n.epsilon)return[new k.Vector(B,C)];m=g(f(p-q,u-h)-f(q-d,h-c));m>=j&&(m=l-m);if(m<n.angle)return[new k.Vector(c,d),new k.Vector(h,q)];if(0!==s&&m>s)return[new k.Vector2(h,q)]}}else if(y=B-(a+u)/2,A=C-(b+p)/2,y*y+A*A<=n.distance)return[new k.Vector(B,C)];return k.Utils.subdivide(a,b,t,z,P,Q,B,C,r+1).concat(k.Utils.subdivide(B,C,w,v,
N,O,u,p,r+1))},getCurveFromPoints:function(a,b){for(var c=[],d=a.length,g=d-1,f=0;f<d;f++){var h=a[f],q={x:h.x,y:h.y};c.push(q);var h=b?u(f-1,d):Math.max(f-1,0),j=b?u(f+1,d):Math.min(f+1,g);v(a[h],q,a[j]);!q.u.x&&!q.u.y&&(q.u.x=q.x,q.u.y=q.y);!q.v.x&&!q.v.y&&(q.v.x=q.x,q.v.y=q.y)}return c},getControlPoints:function(a,b,g){var f=w(a,b),q=w(g,b);a=s(a,b);g=s(g,b);var h=(f+q)/2;if(1E-4>a||1E-4>g)return b.u={x:b.x,y:b.y},b.v={x:b.x,y:b.y},b;a*=0.33;g*=0.33;h=q<f?h+p:h-p;f={x:b.x+d(h)*a,y:b.y+c(h)*a};
h-=j;q={x:b.x+d(h)*g,y:b.y+c(h)*g};b.u=f;b.v=q;return b},angleBetween:function(a,b){return f(a.y-b.y,a.x-b.x)},distanceBetweenSquared:function(a,b){var c=a.x-b.x,d=a.y-b.y;return c*c+d*d},distanceBetween:function(a,b){return h(z(a,b))},mod:function(a,b){for(;0>a;)a+=b;return a%b},Error:function(a){this.name="two.js";this.message=a}}});k.Utils.Error.prototype=Error();k.Utils.Error.prototype.constructor=k.Utils.Error;var s=k.Utils.distanceBetween,z=k.Utils.distanceBetweenSquared,w=k.Utils.angleBetween,
v=k.Utils.getControlPoints,t=k.Utils.solveSegmentIntersection,q=k.Utils.decoupleShapes,u=k.Utils.mod;_.extend(k.prototype,Backbone.Events,{appendTo:function(a){a.appendChild(this.renderer.domElement);return this},play:function(){this.playing=!0;return this.trigger(k.Events.play)},pause:function(){this.playing=!1;return this.trigger(k.Events.pause)},update:function(){this.frameCount++;var a=this.width,b=this.height,c=this.renderer;(a!==c.width||b!==c.height)&&c.setSize(a,b);return this.trigger(k.Events.update,
...
q=b.left+b.width/2,f=b.top+b.height/2;_.each(c.vertices,function(a){a.x-=q;a.y-=f});c.translation.set(q,f);this.scene.add(c);return c},makeGroup:function(a){var b=a;_.isArray(a)||(b=_.toArray(arguments));var c=new k.Group;this.scene.add(c);c.add(b);return c}});(function(){_.each(k.Instances,function(a){a.playing&&a.update().render()});requestAnimationFrame(arguments.callee)})()})();(function(){var n=Two.Vector=function(a,b){a=a||0;b=b||0;Object.defineProperty(this,"x",{get:function(){return a},set:function(b){a=b;this.trigger("change","x")}});Object.defineProperty(this,"y",{get:function(){return b},set:function(a){b=a;this.trigger("change","y")}})};_.extend(n,{});_.extend(n.prototype,Backbone.Events,{set:function(a,b){this.x=a;this.y=b;return this},copy:function(a){this.x=a.x;this.y=a.y;return this},clear:function(){this.y=this.x=0;return this},clone:function(){return new n(this.x,
...
b+this.x,(a.y-this.y)*b+this.y)},isZero:function(){return 1E-4>this.length()}})})();(function(){_.range(6);var n=Math.cos,a=Math.sin,b=Math.tan,c=Two.Matrix=function(a,b,c,g,j,l){this.elements=new Two.Array(9);var p=a;_.isArray(p)||(p=_.toArray(arguments));this.identity().set(p)};_.extend(c,{Identity:[1,0,0,0,1,0,0,0,1],Determinant:function(a,b,c,g,j,l,p,m,r){return a*j*r-a*l*m-b*g*r+b*l*p+c*g*m-c*j*p},Multiply:function(a,b){if(3>=b.length){var c=b[0]||0,g=b[1]||0,j=b[2]||0;return{x:a[0]*c+a[1]*g+a[2]*j,y:a[3]*c+a[4]*g+a[5]*j,z:a[6]*c+a[7]*g+a[8]*j}}var c=a[0],g=a[1],j=a[2],l=a[3],
p=a[4],m=a[5],r=a[6],k=a[7],s=a[8],n=b[0],w=b[1],v=b[2],t=b[3],q=b[4],u=b[5],e=b[6],x=b[7],F=b[8];return[c*n+g*t+j*e,c*w+g*q+j*x,c*v+g*u+j*F,l*n+p*t+m*e,l*w+p*q+m*x,l*v+p*u+m*F,r*n+k*t+s*e,r*w+k*q+s*x,r*v+k*u+s*F]}});_.extend(c.prototype,{set:function(a,b,c,g,j,l){var p=a;_.isArray(p)||(p=_.toArray(arguments));_.each(p,function(a,b){_.isNumber(a)&&(this.elements[b]=a)},this);return this},identity:function(){this.set(c.Identity);return this},multiply:function(a,b,c,g,j,l,p,m,r){var k=arguments,s=k.length;
...
B6;this.elements[4]=A3*B1+A4*B4+A5*B7;this.elements[5]=A3*B2+A4*B5+A5*B8;this.elements[6]=A6*B0+A7*B3+A8*B6;this.elements[7]=A6*B1+A7*B4+A8*B7;this.elements[8]=A6*B2+A7*B5+A8*B8;return this},determinant:function(){var a=this.elements,b=a[0],c=a[1],g=a[2],j=a[3],l=a[4],p=a[5],m=a[6],r=a[7],a=a[8];return b*l*a-b*p*r-c*j*a+c*p*m+g*j*r-g*l*m},scale:function(a,b){1>=arguments.length&&(b=a);return this.multiply(a,0,0,0,b,0,0,0,1)},rotate:function(b){var c=n(b);b=a(b);return this.multiply(c,-b,0,b,c,0,0,
0,1)},translate:function(a,b){return this.multiply(1,0,a,0,1,b,0,0,1)},skewX:function(a){a=b(a);return this.multiply(1,a,0,0,1,0,0,0,1)},skewY:function(a){a=b(a);return this.multiply(1,0,0,a,1,0,0,0,1)},toString:function(){return this.toArray().join(" ")},toArray:function(a){var b=this.elements,c=parseFloat(b[0].toFixed(3)),g=parseFloat(b[1].toFixed(3)),j=parseFloat(b[2].toFixed(3)),l=parseFloat(b[3].toFixed(3)),p=parseFloat(b[4].toFixed(3)),m=parseFloat(b[5].toFixed(3));if(a){a=parseFloat(b[6].toFixed(3));
var r=parseFloat(b[7].toFixed(3)),b=parseFloat(b[8].toFixed(3));return[c,l,a,g,p,r,j,m,b]}return[c,l,g,p,j,m]},clone:function(){return new Two.Matrix(this.elements[0],this.elements[1],this.elements[2],this.elements[3],this.elements[4],this.elements[5])}})})();(function(){function n(a){var b={},c=a.id,l=a.translation,p=a.rotation,m=a.scale,r=a.stroke,k=a.linewidth,s=a.fill,n=a.opacity,w=a.visible,v=a.cap,t=a.join,q=a.miter,u=a.curved,e=a.closed;a=a.vertices;c&&(b.id=f.Identifier+c);l&&(_.isNumber(m)&&_.isNumber(p))&&(b.transform="translate("+l.x+","+l.y+") scale("+m+") rotate("+p+")");r&&(b.stroke=r);s&&(b.fill=s);n&&(b["stroke-opacity"]=b["fill-opacity"]=n);b.visibility=w?"visible":"hidden";v&&(b["stroke-linecap"]=v);t&&(b["stroke-linejoin"]=t);q&&(b["stroke-miterlimit"]=
q);k&&(b["stroke-width"]=k);a&&(b.d=d.toString(a,e,u));return b}var a=0,b=Two.Utils.getCurveFromPoints,c=Two.Utils.mod,d={version:1.1,ns:"http://www.w3.org/2000/svg",xlink:"http://www.w3.org/1999/xlink",createElement:function(a,b){var c=a.toLowerCase(),d=document.createElementNS(this.ns,c);"svg"===c&&(b=_.defaults(b||{},{version:this.version}));_.isObject(b)&&this.setAttributes(d,b);return d},setAttributes:function(a,b){_.each(b,function(a,b){this.setAttribute(b,a)},a);return this},removeAttributes:function(a,
b){_.each(b,function(a){this.removeAttribute(a)},a);return this},toString:function(a,d,f){var l=a.length,p=l-1;if(!f)return _.map(a,function(a,b){var c;c=(0>=b?"M":"L")+(" "+a.x.toFixed(3)+" "+a.y.toFixed(3));b>=p&&d&&(c+=" Z");return c}).join(" ");var m=b(a,d);return _.map(m,function(a,b){var f,h=d?c(b-1,l):Math.max(b-1,0),j=d?c(b+1,l):Math.min(b+1,p);f=m[h];var j=m[j],h=f.v.x.toFixed(3),n=f.v.y.toFixed(3),t=a.u.x.toFixed(3),q=a.u.y.toFixed(3),u=a.x.toFixed(3),e=a.y.toFixed(3);f=0>=b?"M "+u+" "+
e:"C "+h+" "+n+" "+t+" "+q+" "+u+" "+e;b>=p&&d&&(h=a.v.x.toFixed(3),n=a.v.y.toFixed(3),t=j.u.x.toFixed(3),q=j.u.y.toFixed(3),u=j.x.toFixed(3),e=j.y.toFixed(3),f=f+(" C "+h+" "+n+" "+t+" "+q+" "+u+" "+e)+" Z");return f}).join(" ")}},f=Two[Two.Types.svg]=function(){this.domElement=d.createElement("svg");this.elements=[];this.commands=[];this.domElement.style.visibility="hidden";this.unveil=_.once(_.bind(function(){this.domElement.style.visibility="visible"},this))};_.extend(f,{Identifier:"two-"});_.extend(f.prototype,
...
break;case Two.Properties.demotion:_.each(c,function(a){n.removeChild(k[a]);this.elements[a]=null},this);default:h.setStyles.call(this,n,b,c,d,f)}return this},render:function(){if(_.isNull(this.stage))return this;this.ctx.clearRect(0,0,this.width,this.height);this.stage.render(this.ctx);return this}})})();(function(){function n(a){var b=[];_.each(a,function(a){_.isArray(a)&&_.isArray(a[0])?b=b.concat(n(a)):b.push(a)});return b}function a(a){a=f([a[0],a[1],a[2],a[3],a[4],a[5],0,0,1],[1,0,1]);return j(a.x*a.x+a.y*a.y)}var b=Two[Two.Types.canvas],c=Two.Utils.getCurveFromPoints,d=Two.Utils.mod,f=Two.Matrix.Multiply,h=Two.Utils.decoupleShapes,g=Two.Utils.subdivide,j=Math.sqrt,l={aliceblue:"#F0F8FF",antiquewhite:"#FAEBD7",aqua:"#00FFFF",aquamarine:"#7FFFD4",azure:"#F0FFFF",beige:"#F5F5DC",bisque:"#FFE4C4",
...
snow:"#FFFAFA",springgreen:"#00FF7F",transparent:"#000",steelblue:"#4682B4",tan:"#D2B48C",teal:"#008080",thistle:"#D8BFD8",tomato:"#FF6347",turquoise:"#40E0D0",violet:"#EE82EE",wheat:"#F5DEB3",white:"#FFFFFF",whitesmoke:"#F5F5F5",yellow:"#FFFF00",yellowgreen:'#9ACD32"'},p="(?:\\+|-)?\\d+",m="(?:\\+|-)?\\d*\\.\\d+",r="(?:"+p+")|(?:"+m+")",p="("+p+")",m="("+m+")",r="("+r+")",m=r+"%",k=RegExp(["^hsl(a?)\\(",r,",",m,",",m,"(,",r,")?\\)$"].join("\\s*?")),s=RegExp(["^rgb(a?)\\(",p,",",p,",",p,"(,",r,")?\\)$"].join("\\s*?")),
z=RegExp(["^rgb(a?)\\(",m,",",m,",",m,"(,",r,")?\\)$"].join("\\s*?")),w=/^,\s*/,v=[function(a){function b(c,d){var e=a.match(c);if(e&&1!==!!e[1]+!!e[5]){var f=_.isUndefined(e[5])?1:e[5].replace(w,"");return{r:Math.min(1,Math.max(0,e[2]/d)),g:Math.min(1,Math.max(0,e[3]/d)),b:Math.min(1,Math.max(0,e[4]/d)),a:Math.min(1,Math.max(f,0))}}}a=a.replace(/^\s+|\s+$/g,"");var c=b(s,255);return c?c:b(z,100)},function(a){var b=a.toLowerCase();b in l&&(a=l[b]);if(a.match(/^#([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/)){a=
a.replace(/^#/,"");var b=a.length/3,c=Math.pow(16,b)-1;return{r:parseInt(a.slice(0,b),16)/c,g:parseInt(a.slice(1*b,2*b),16)/c,b:parseInt(a.slice(2*b),16)/c,a:1}}},function(a){var b=a.replace(/^\s+|\s+$/g,"").match(k);if(!b||1===!!b[1]+!!b[5])return null;a=(b[2]%360+360)%360/360;var c=Math.max(0,Math.min(parseInt(b[3],10)/100,1)),d=Math.max(0,Math.min(parseInt(b[4],10)/100,1)),b=b[5];if(0!=c)var f=function(a,b,c){0>c&&(c+=1);1<c&&(c-=1);return c<1/6?a+6*(b-a)*c:0.5>c?b:c<2/3?a+6*(b-a)*(2/3-c):a},g=
0.5>d?d*(1+c):d+c-d*c,h=2*d-g;c=_.isUndefined(b)||_.isNull(b)?1:b.replace(w,"");return{r:f(h,g,a+1/3),g:f(h,g,a),b:f(h,g,a-1/3),a:c}}],p=function(a){b.Group.call(this,a)};_.extend(p.prototype,b.Group.prototype,{appendChild:function(){b.Group.prototype.appendChild.apply(this,arguments);this.updateMatrix();return this},updateMatrix:function(a){a=a||this.parent&&this.parent.matrix;if(!a)return this;this._matrix=f(this.matrix,a);_.each(this.children,function(a){a.updateMatrix(this._matrix)},this);return this},
render:function(a,b,c,d){_.each(this.children,function(f){f.render(a,b,c,d)})}});r=function(a){b.Element.call(this,a)};_.extend(r.prototype,b.Element.prototype,{updateMatrix:function(b){b=b||this.parent&&this.parent.matrix;if(!b)return this;this._matrix=f(this.matrix,b);this._linewidth=this.linewidth*a(this._matrix);return this},render:function(a,b,c,d){if(!this.visible||!this.fillBuffer||!this.strokeBuffer)return this;a.bindBuffer(a.ARRAY_BUFFER,this.fillBuffer);0<this.fill.a&&0<this.triangleAmount&&
(a.vertexAttribPointer(b,2,a.FLOAT,!1,0,0),a.uniformMatrix3fv(c,!1,this._matrix),a.uniform4f(d,this.fill.r,this.fill.g,this.fill.b,this.fill.a*this.opacity),a.drawArrays(a.TRIANGLES,0,this.triangleAmount));a.bindBuffer(a.ARRAY_BUFFER,this.strokeBuffer);if(0>=this._linewidth||0>=this.stroke.a||4>this.vertexAmount)return this;a.vertexAttribPointer(b,2,a.FLOAT,!1,0,0);a.uniformMatrix3fv(c,!1,this._matrix);a.uniform4f(d,this.stroke.r,this.stroke.g,this.stroke.b,this.stroke.a*this.opacity);a.lineWidth(this._linewidth);
a.drawArrays(a.LINES,0,this.vertexAmount);return this}});var t={updateBuffer:function(a,b,c){_.isObject(b.fillBuffer)&&a.deleteBuffer(b.fillBuffer);b.fillBuffer=a.createBuffer();a.bindBuffer(a.ARRAY_BUFFER,b.fillBuffer);a.enableVertexAttribArray(c);a.bufferData(a.ARRAY_BUFFER,b.triangles,a.STATIC_DRAW);_.isObject(b.strokeBuffer)&&a.deleteBuffer(b.strokeBuffer);b.strokeBuffer=a.createBuffer();a.bindBuffer(a.ARRAY_BUFFER,b.strokeBuffer);a.enableVertexAttribArray(c);a.bufferData(a.ARRAY_BUFFER,b.vertices,
a.STATIC_DRAW)},interpret:function(a){for(var b=0,c=v.length;b<c;b++){var d=v[b](a);if(d)return d}return{r:0,g:0,b:0,a:0}},extrapolate:function(a,b,e){a=a.slice(0);if(!e)return{vertices:a,last:a.length-1};var f=c(a,!0),h=f.length,j=h-1,k=[],l=f.length;_.each(f,function(a,b){var c=f[d(b+1,h)],c=g(a.x,a.y,a.v.x,a.v.y,c.u.x,c.u.y,c.x,c.y);b>=j&&(l=k.length-2);k=k.concat(c)});return{vertices:k,last:l}},tessellate:function(a,b,c,f,g,j){var k=n(h(a)),l=[],p=[],m=0;c=0;_.each(k,function(a){3>a.length||(a=
new tessellation.SweepContext(_.map(a,function(a){return new Two.Vector(a.x,a.y)})),tessellation.sweep.Triangulate(a,!0),m+=6*a.triangles.length,_.each(a.triangles,function(a){var b=a.points;a=b[0];var c=b[1],b=b[2];l.push(a.x,a.y,c.x,c.y,b.x,b.y)}))});var r=a.length;c=4*r;_.each(a,function(b,c){var e=a[d(c+1,r)];p.push(b.x,b.y,e.x,e.y)});g=g&&m<=g.length?g:new Two.Array(m);j=j&&c<=j.length?j:new Two.Array(c);g.set(l);j.set(p);return{triangles:g,vertices:j,triangleAmount:m/2,vertexAmount:b?c/2:2*
f}},program:{create:function(a,b){var c=a.createProgram();_.each(b,function(b){a.attachShader(c,b)});a.linkProgram(c);if(!a.getProgramParameter(c,a.LINK_STATUS))throw error=a.getProgramInfoLog(c),new Two.Utils.Error("unable to link program: "+error);return c}},shaders:{create:function(a,b,c){c=a.createShader(a[c]);a.shaderSource(c,b);a.compileShader(c);if(!a.getShaderParameter(c,a.COMPILE_STATUS))throw a=a.getShaderInfoLog(c),new Two.Utils.Error("unable to compile shader "+c+": "+a);return c},types:{vertex:"VERTEX_SHADER",
fragment:"FRAGMENT_SHADER"},vertex:"attribute vec2 position;\nuniform mat3 matrix;\nuniform vec2 resolution;\n\nvoid main() {\n   vec2 projected = (matrix * vec3(position, 1)).xy;\n   vec2 normal = projected / resolution;\n   vec2 clipspace = (normal * 2.0) - 1.0;\n\n   gl_Position = vec4(clipspace * vec2(1.0, -1.0), 0.0, 1.0);\n}",fragment:"precision mediump float;\n\nuniform vec4 color;\n\nvoid main() {\n  gl_FragColor = color;\n}"}},m=Two[Two.Types.webgl]=function(a){this.domElement=document.createElement("canvas");
this.elements=[];this.stage=null;a=_.defaults(a||{},{antialias:!1,alpha:!0,premultipliedAlpha:!0,stencil:!0,preserveDrawingBuffer:!1});this.ctx=this.domElement.getContext("webgl",a)||this.domElement.getContext("experimental-webgl",a);if(!this.ctx)throw new Two.Utils.Error("unable to create a webgl context. Try using another renderer.");a=t.shaders.create(this.ctx,t.shaders.vertex,t.shaders.types.vertex);var b=t.shaders.create(this.ctx,t.shaders.fragment,t.shaders.types.fragment);this.program=t.program.create(this.ctx,
[a,b]);this.ctx.useProgram(this.program);this.positionLocation=this.ctx.getAttribLocation(this.program,"position");this.colorLocation=this.ctx.getUniformLocation(this.program,"color");this.matrixLocation=this.ctx.getUniformLocation(this.program,"matrix");this.ctx.disable(this.ctx.DEPTH_TEST);this.ctx.enable(this.ctx.BLEND);this.ctx.blendEquationSeparate(this.ctx.FUNC_ADD,this.ctx.FUNC_ADD);this.ctx.blendFuncSeparate(this.ctx.SRC_ALPHA,this.ctx.ONE_MINUS_SRC_ALPHA,this.ctx.ONE,this.ctx.ONE_MINUS_SRC_ALPHA)};
_.extend(m,{Group:p,Element:r,getStyles:function(b){var c={},d=b.id,f=b._matrix,g=b.stroke,h=b.linewidth,j=b.fill,k=b.opacity,l=b.visible,m=b.cap,p=b.join,n=b.miter,r=b.curved,s=b.closed;b=b.vertices;d&&(c.id=d);_.isObject(f)&&(c.matrix=c._matrix=f.toArray(!0));g&&(c.stroke=t.interpret(g));j&&(c.fill=t.interpret(j));_.isNumber(k)&&(c.opacity=k);m&&(c.cap=m);p&&(c.join=p);n&&(c.miter=n);h&&(c.linewidth=h,c._linewidth=h*a(c._matrix));b&&(d=t.extrapolate(b,s,r),b=d.vertices,d=t.tessellate(b,s,r,d.last),
c.triangles=d.triangles,c.vertices=d.vertices,c.vertexAmount=d.vertexAmount,c.triangleAmount=d.triangleAmount);c.visible=!!l;c.curved=!!r;c.closed=!!s;return c},setStyles:function(b,c,d,f,g){switch(c){case "matrix":c="matrix";d=d.toArray(!0);break;case "linewidth":c="linewidth";b._linewidth=d*a(b._matrix);break;case "stroke":d=t.interpret(d);break;case "fill":d=t.interpret(d);break;case "vertices":c="triangles",b.closed=f,b.curved=g,d=t.extrapolate(d,f,g),f=t.tessellate(d.vertices,f,g,d.last,b.triangles,
b.vertices),d=f.triangles,b.vertices=f.vertices,b.vertexAmount=f.vertexAmount,b.triangleAmount=f.triangleAmount}b[c]=d;"triangles"===c&&t.updateBuffer(this.ctx,b,this.positionLocation);"matrix"===c&&b.updateMatrix()}});_.extend(m.prototype,Backbone.Events,b.prototype,{setSize:function(a,c){b.prototype.setSize.apply(this,arguments);this.ctx.viewport(0,0,a,c);var d=this.ctx.getUniformLocation(this.program,"resolution");this.ctx.uniform2f(d,a,c);return this},render:function(){if(_.isNull(this.stage))return this;
this.stage.render(this.ctx,this.positionLocation,this.matrixLocation,this.colorLocation);return this}})})();(function(){var n=Two.Shape=function(a){this._matrix=new Two.Matrix;var b=_.debounce(_.bind(function(){var a=this._matrix.identity().translate(this.translation.x,this.translation.y).scale(this.scale).rotate(this.rotation);this.trigger(Two.Events.change,this.id,"matrix",a)},this),0);this._rotation="rotation";Object.defineProperty(this,"rotation",{get:function(){return this._rotation},set:function(a){this._rotation=a;b()}});this._scale="scale";Object.defineProperty(this,"scale",{get:function(){return this._scale},
set:function(a){this._scale=a;b()}});this.translation=new Two.Vector;this.rotation=0;this.scale=1;this.translation.bind(Two.Events.change,b);if(a)return this;n.MakeGetterSetter(this,n.Properties);this.fill="#fff";this.stroke="#000";this.opacity=this.linewidth=1;this.visible=!0;this.miter=this.join=this.cap="round"};_.extend(n,{Properties:"fill stroke linewidth opacity visible cap join miter".split(" "),MakeGetterSetter:function(a,b){_.isArray(b)||(b=[b]);_.each(b,function(b){var d="_"+b;Object.defineProperty(a,
b,{get:function(){return this[d]},set:function(a){this[d]=a;this.trigger(Two.Events.change,this.id,b,a,this)}})})}});_.extend(n.prototype,Backbone.Events,{addTo:function(a){a.add(this);return this},noFill:function(){this.fill="none";return this},noStroke:function(){this.stroke="none";return this},clone:function(){var a=new n;a.translation.copy(this.translation);_.each(n.Properties,function(b){a[b]=this[b]},this);return this}})})();(function(){var n=Two.Group=function(){Two.Shape.call(this,!0);delete this.stroke;delete this.fill;delete this.linewidth;delete this.opacity;delete this.cap;delete this.join;delete this.miter;n.MakeGetterSetter(this,Two.Shape.Properties);this.children={}};_.extend(n,{MakeGetterSetter:function(a,b){_.isArray(b)||(b=[b]);_.each(b,function(b){var d="_"+b;Object.defineProperty(a,b,{get:function(){return this[d]},set:function(a){this[d]=a;_.each(this.children,function(d){d[b]=a})}})})}});_.extend(n.prototype,
...
noStroke:function(){_.each(this.children,function(a){a.noStroke()});return this}})})();(function(){var n=Math.min,a=Math.max,b=Math.round,c=Two.Polygon=function(c,f,h){Two.Shape.call(this);f=!!f;h=!!h;var g=0,j=1,l=!1,p=c.slice(0),m=_.debounce(_.bind(function(){var a,c;if(l){a=this.vertices.length;a-=1;c=b(g*a);a=b(j*a);for(p.length=0;c<a+1;c++){var d=this.vertices[c];p.push(new Two.Vector(d.x,d.y))}l=!1}this.trigger(Two.Events.change,this.id,"vertices",p,f,h)},this),0);Object.defineProperty(this,"closed",{get:function(){return f},set:function(a){f=!!a;m()}});Object.defineProperty(this,
"curved",{get:function(){return h},set:function(a){h=!!a;m()}});Object.defineProperty(this,"beginning",{get:function(){return g},set:function(b){g=n(a(b,0),1);l=!0;m()}});Object.defineProperty(this,"ending",{get:function(){return j},set:function(b){j=n(a(b,0),1);l=!0;m()}});this.vertices=c.slice(0);_.each(this.vertices,function(a){a.bind(Two.Events.change,m)},this);m()};_.extend(c,{});_.extend(c.prototype,Two.Shape.prototype,{clone:function(){var a=_.map(this.vertices,function(a){return new Two.Vector(a.x,

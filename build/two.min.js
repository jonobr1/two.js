(function(){var B=this,m=B._,k={},f=Array.prototype,q=Object.prototype,p=f.push,d=f.slice,n=f.concat,l=q.toString,v=q.hasOwnProperty,G=f.forEach,w=f.map,s=f.reduce,c=f.reduceRight,C=f.filter,x=f.every,A=f.some,y=f.indexOf,z=f.lastIndexOf,q=Array.isArray,E=Object.keys,F=Function.prototype.bind,a=function(e){if(e instanceof a)return e;if(!(this instanceof a))return new a(e);this._wrapped=e};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=a),exports._=
a):B._=a;a.VERSION="1.5.1";var b=a.each=a.forEach=function(e,h,t){if(null!=e)if(G&&e.forEach===G)e.forEach(h,t);else if(e.length===+e.length)for(var b=0,c=e.length;b<c&&h.call(t,e[b],b,e)!==k;b++);else for(b in e)if(a.has(e,b)&&h.call(t,e[b],b,e)===k)break};a.map=a.collect=function(a,h,t){var c=[];if(null==a)return c;if(w&&a.map===w)return a.map(h,t);b(a,function(a,e,b){c.push(h.call(t,a,e,b))});return c};a.reduce=a.foldl=a.inject=function(e,h,t,c){var g=2<arguments.length;null==e&&(e=[]);if(s&&e.reduce===
s)return c&&(h=a.bind(h,c)),g?e.reduce(h,t):e.reduce(h);b(e,function(a,e,b){g?t=h.call(c,t,a,e,b):(t=a,g=!0)});if(!g)throw new TypeError("Reduce of empty array with no initial value");return t};a.reduceRight=a.foldr=function(e,h,t,g){var r=2<arguments.length;null==e&&(e=[]);if(c&&e.reduceRight===c)return g&&(h=a.bind(h,g)),r?e.reduceRight(h,t):e.reduceRight(h);var d=e.length;if(d!==+d)var l=a.keys(e),d=l.length;b(e,function(a,b,c){b=l?l[--d]:--d;r?t=h.call(g,t,e[b],b,c):(t=e[b],r=!0)});if(!r)throw new TypeError("Reduce of empty array with no initial value");
return t};a.find=a.detect=function(a,h,b){var c;r(a,function(a,e,g){if(h.call(b,a,e,g))return c=a,!0});return c};a.filter=a.select=function(a,h,t){var c=[];if(null==a)return c;if(C&&a.filter===C)return a.filter(h,t);b(a,function(a,e,b){h.call(t,a,e,b)&&c.push(a)});return c};a.reject=function(e,h,b){return a.filter(e,function(a,e,c){return!h.call(b,a,e,c)},b)};a.every=a.all=function(e,h,t){h||(h=a.identity);var c=!0;if(null==e)return c;if(x&&e.every===x)return e.every(h,t);b(e,function(a,e,b){if(!(c=
c&&h.call(t,a,e,b)))return k});return!!c};var r=a.some=a.any=function(e,h,t){h||(h=a.identity);var c=!1;if(null==e)return c;if(A&&e.some===A)return e.some(h,t);b(e,function(a,e,b){if(c||(c=h.call(t,a,e,b)))return k});return!!c};a.contains=a.include=function(a,h){return null==a?!1:y&&a.indexOf===y?-1!=a.indexOf(h):r(a,function(a){return a===h})};a.invoke=function(e,h){var b=d.call(arguments,2),c=a.isFunction(h);return a.map(e,function(a){return(c?h:a[h]).apply(a,b)})};a.pluck=function(e,h){return a.map(e,
function(a){return a[h]})};a.where=function(e,h,b){return a.isEmpty(h)?b?void 0:[]:a[b?"find":"filter"](e,function(a){for(var e in h)if(h[e]!==a[e])return!1;return!0})};a.findWhere=function(e,h){return a.where(e,h,!0)};a.max=function(e,h,t){if(!h&&a.isArray(e)&&e[0]===+e[0]&&65535>e.length)return Math.max.apply(Math,e);if(!h&&a.isEmpty(e))return-Infinity;var c={computed:-Infinity,value:-Infinity};b(e,function(a,e,b){e=h?h.call(t,a,e,b):a;e>c.computed&&(c={value:a,computed:e})});return c.value};a.min=
function(e,h,t){if(!h&&a.isArray(e)&&e[0]===+e[0]&&65535>e.length)return Math.min.apply(Math,e);if(!h&&a.isEmpty(e))return Infinity;var c={computed:Infinity,value:Infinity};b(e,function(a,e,b){e=h?h.call(t,a,e,b):a;e<c.computed&&(c={value:a,computed:e})});return c.value};a.shuffle=function(e){var h,t=0,c=[];b(e,function(e){h=a.random(t++);c[t-1]=c[h];c[h]=e});return c};var g=function(e){return a.isFunction(e)?e:function(a){return a[e]}};a.sortBy=function(e,h,b){var c=g(h);return a.pluck(a.map(e,function(a,
e,h){return{value:a,index:e,criteria:c.call(b,a,e,h)}}).sort(function(a,e){var h=a.criteria,b=e.criteria;if(h!==b){if(h>b||void 0===h)return 1;if(h<b||void 0===b)return-1}return a.index<e.index?-1:1}),"value")};var H=function(e,h,t,c){var r={},d=g(null==h?a.identity:h);b(e,function(a,h){var b=d.call(t,a,h,e);c(r,b,a)});return r};a.groupBy=function(e,h,b){return H(e,h,b,function(e,h,b){(a.has(e,h)?e[h]:e[h]=[]).push(b)})};a.countBy=function(e,h,b){return H(e,h,b,function(e,h){a.has(e,h)||(e[h]=0);
e[h]++})};a.sortedIndex=function(e,h,b,c){b=null==b?a.identity:g(b);h=b.call(c,h);for(var r=0,d=e.length;r<d;){var l=r+d>>>1;b.call(c,e[l])<h?r=l+1:d=l}return r};a.toArray=function(e){return e?a.isArray(e)?d.call(e):e.length===+e.length?a.map(e,a.identity):a.values(e):[]};a.size=function(e){return null==e?0:e.length===+e.length?e.length:a.keys(e).length};a.first=a.head=a.take=function(a,h,b){return null==a?void 0:null==h||b?a[0]:d.call(a,0,h)};a.initial=function(a,h,b){return d.call(a,0,a.length-
(null==h||b?1:h))};a.last=function(a,h,b){return null==a?void 0:null==h||b?a[a.length-1]:d.call(a,Math.max(a.length-h,0))};a.rest=a.tail=a.drop=function(a,h,b){return d.call(a,null==h||b?1:h)};a.compact=function(e){return a.filter(e,a.identity)};var u=function(e,h,c){if(h&&a.every(e,a.isArray))return n.apply(c,e);b(e,function(e){a.isArray(e)||a.isArguments(e)?h?p.apply(c,e):u(e,h,c):c.push(e)});return c};a.flatten=function(a,h){return u(a,h,[])};a.without=function(e){return a.difference(e,d.call(arguments,
1))};a.uniq=a.unique=function(e,h,c,g){a.isFunction(h)&&(g=c,c=h,h=!1);c=c?a.map(e,c,g):e;var r=[],d=[];b(c,function(b,c){(h?c&&d[d.length-1]===b:a.contains(d,b))||(d.push(b),r.push(e[c]))});return r};a.union=function(){return a.uniq(a.flatten(arguments,!0))};a.intersection=function(e){var h=d.call(arguments,1);return a.filter(a.uniq(e),function(e){return a.every(h,function(h){return 0<=a.indexOf(h,e)})})};a.difference=function(e){var h=n.apply(f,d.call(arguments,1));return a.filter(e,function(e){return!a.contains(h,
e)})};a.zip=function(){for(var e=a.max(a.pluck(arguments,"length").concat(0)),h=Array(e),b=0;b<e;b++)h[b]=a.pluck(arguments,""+b);return h};a.object=function(a,h){if(null==a)return{};for(var b={},c=0,g=a.length;c<g;c++)h?b[a[c]]=h[c]:b[a[c][0]]=a[c][1];return b};a.indexOf=function(e,h,b){if(null==e)return-1;var c=0,g=e.length;if(b)if("number"==typeof b)c=0>b?Math.max(0,g+b):b;else return c=a.sortedIndex(e,h),e[c]===h?c:-1;if(y&&e.indexOf===y)return e.indexOf(h,b);for(;c<g;c++)if(e[c]===h)return c;
return-1};a.lastIndexOf=function(a,h,b){if(null==a)return-1;var c=null!=b;if(z&&a.lastIndexOf===z)return c?a.lastIndexOf(h,b):a.lastIndexOf(h);for(b=c?b:a.length;b--;)if(a[b]===h)return b;return-1};a.range=function(a,h,b){1>=arguments.length&&(h=a||0,a=0);b=arguments[2]||1;for(var c=Math.max(Math.ceil((h-a)/b),0),g=0,r=Array(c);g<c;)r[g++]=a,a+=b;return r};var D=function(){};a.bind=function(e,h){var b,c;if(F&&e.bind===F)return F.apply(e,d.call(arguments,1));if(!a.isFunction(e))throw new TypeError;
b=d.call(arguments,2);return c=function(){if(!(this instanceof c))return e.apply(h,b.concat(d.call(arguments)));D.prototype=e.prototype;var a=new D;D.prototype=null;var g=e.apply(a,b.concat(d.call(arguments)));return Object(g)===g?g:a}};a.partial=function(a){var h=d.call(arguments,1);return function(){return a.apply(this,h.concat(d.call(arguments)))}};a.bindAll=function(e){var h=d.call(arguments,1);if(0===h.length)throw Error("bindAll must be passed function names");b(h,function(h){e[h]=a.bind(e[h],
e)});return e};a.memoize=function(e,h){var b={};h||(h=a.identity);return function(){var c=h.apply(this,arguments);return a.has(b,c)?b[c]:b[c]=e.apply(this,arguments)}};a.delay=function(a,h){var b=d.call(arguments,2);return setTimeout(function(){return a.apply(null,b)},h)};a.defer=function(e){return a.delay.apply(a,[e,1].concat(d.call(arguments,1)))};a.throttle=function(a,b,c){var g,r,d,l=null,f=0;c||(c={});var u=function(){f=!1===c.leading?0:new Date;l=null;d=a.apply(g,r)};return function(){var H=
...
f=!0;if("[object Array]"==r){if(d=e.length,f=d==b.length)for(;d--&&(f=I(e[d],b[d],c,g)););}else{for(var u in e)if(a.has(e,u)&&(d++,!(f=a.has(b,u)&&I(e[u],b[u],c,g))))break;if(f){for(u in b)if(a.has(b,u)&&!d--)break;f=!d}}c.pop();g.pop();return f};a.isEqual=function(a,b){return I(a,b,[],[])};a.isEmpty=function(b){if(null==b)return!0;if(a.isArray(b)||a.isString(b))return 0===b.length;for(var c in b)if(a.has(b,c))return!1;return!0};a.isElement=function(a){return!(!a||1!==a.nodeType)};a.isArray=q||function(a){return"[object Array]"==
...
J.unescape=a.invert(J.escape);var M={escape:RegExp("["+a.keys(J.escape).join("")+"]","g"),unescape:RegExp("("+a.keys(J.unescape).join("|")+")","g")};a.each(["escape","unescape"],function(b){a[b]=function(a){return null==a?"":(""+a).replace(M[b],function(a){return J[b][a]})}});a.result=function(b,c){if(null!=b){var g=b[c];return a.isFunction(g)?g.call(b):g}};a.mixin=function(c){b(a.functions(c),function(b){var g=a[b]=c[b];a.prototype[b]=function(){var b=[this._wrapped];p.apply(b,arguments);b=g.apply(a,
...
"|$","g"),f=0,l="__p+='";b.replace(d,function(a,c,g,h,r){l+=b.slice(f,r).replace(L,function(a){return"\\"+O[a]});c&&(l+="'+\n((__t=("+c+"))==null?'':_.escape(__t))+\n'");g&&(l+="'+\n((__t=("+g+"))==null?'':__t)+\n'");h&&(l+="';\n"+h+"\n__p+='");f=r+a.length;return a});l+="';\n";g.variable||(l="with(obj||{}){\n"+l+"}\n");l="var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};\n"+l+"return __p;\n";try{r=new Function(g.variable||"obj","_",l)}catch(u){throw u.source=
...
(function(){var B=[].slice,m=function(f,q,p){var d;f=-1;var n=q.length;switch(p.length){case 0:for(;++f<n;)(d=q[f]).callback.call(d.ctx);break;case 1:for(;++f<n;)(d=q[f]).callback.call(d.ctx,p[0]);break;case 2:for(;++f<n;)(d=q[f]).callback.call(d.ctx,p[0],p[1]);break;case 3:for(;++f<n;)(d=q[f]).callback.call(d.ctx,p[0],p[1],p[2]);break;default:for(;++f<n;)(d=q[f]).callback.apply(d.ctx,p)}},k=Backbone.Events={on:function(f,q,p){this._events||(this._events={});(this._events[f]||(this._events[f]=[])).push({callback:q,
context:p,ctx:p||this});return this},once:function(f,q,p){var d=this,n=_.once(function(){d.off(f,n);q.apply(this,arguments)});n._callback=q;this.on(f,n,p);return this},off:function(f,q,p){var d,n,l,k,m,w,s,c;if(!this._events)return this;if(!f&&!q&&!p)return this._events={},this;k=f?[f]:_.keys(this._events);m=0;for(w=k.length;m<w;m++)if(f=k[m],d=this._events[f]){l=[];if(q||p)for(s=0,c=d.length;s<c;s++)n=d[s],(q&&q!==(n.callback._callback||n.callback)||p&&p!==n.context)&&l.push(n);this._events[f]=l}return this},
trigger:function(f){if(!this._events)return this;var q=B.call(arguments,1),k=this._events[f],d=this._events.all;k&&m(this,k,q);d&&m(this,d,arguments);return this},listenTo:function(f,q,k){var d=this._listeners||(this._listeners={}),n=f._listenerId||(f._listenerId=_.uniqueId("l"));d[n]=f;f.on(q,k||this,this);return this},stopListening:function(f,q,k){var d=this._listeners;if(d){if(f)f.off(q,k,this),q||k||delete d[f._listenerId];else{for(var n in d)d[n].off(null,null,this);this._listeners={}}return this}}};
k.bind=k.on;k.unbind=k.off;"undefined"!==typeof exports&&("undefined"!==typeof module&&module.exports&&(exports=module.exports=k),exports.Backbone=exports.Backbone||Backbone)})();(function(){function B(f,d){var n=(new Date).getTime(),l=Math.max(0,16-(n-k)),q=m.setTimeout(function(){f(n+l)},l);k=n+l;return q}var m=this,k=0,f=["ms","moz","webkit","o"];if("undefined"!==typeof exports)"undefined"!==typeof module&&module.exports&&(exports=module.exports=B),exports.requestAnimationFrame=B;else{for(var q=0;q<f.length&&!m.requestAnimationFrame;++q)m.requestAnimationFrame=m[f[q]+"RequestAnimationFrame"],m.cancelAnimationFrame=m[f[q]+"CancelAnimationFrame"]||m[f[q]+"CancelRequestAnimationFrame"];
m.requestAnimationFrame||(m.requestAnimationFrame=B);m.cancelAnimationFrame||(m.cancelAnimationFrame=function(f){clearTimeout(f)})}})();(function(){function B(){var a=document.body.getBoundingClientRect(),b=this.width=a.width,a=this.height=a.height;this.renderer.setSize(b,a,this.ratio);this.trigger(c.Events.resize,b,a)}var m=this,k=m.Two||{},f=Math.sin,q=Math.cos,p=Math.atan2,d=Math.sqrt,n=Math.PI,l=2*n,v=n/2,G=Math.pow,w=0,s={hasEventListeners:_.isFunction(m.addEventListener),bind:function(a,b,c,g){this.hasEventListeners?a.addEventListener(b,c,!!g):a.attachEvent("on"+b,c);return this},unbind:function(a,b,c,g){this.hasEventListeners?
...
Version:"v0.4.0",Identifier:"two-",Properties:{hierarchy:"hierarchy",demotion:"demotion"},Events:{play:"play",pause:"pause",update:"update",render:"render",resize:"resize",change:"change",remove:"remove",insert:"insert"},Commands:{move:"M",line:"L",curve:"C",close:"Z"},Resolution:8,Instances:[],noConflict:function(){m.Two=k;return this},uniqueId:function(){var a=w;w++;return a},Utils:{release:function(a){_.isObject(a)&&(_.isFunction(a.unbind)&&a.unbind(),a.vertices&&(_.isFunction(a.vertices.unbind)&&
a.vertices.unbind(),_.each(a.vertices,function(a){_.isFunction(a.unbind)&&a.unbind()})),a.children&&_.each(a.children,function(a){c.Utils.release(a)}))},Curve:{CollinearityEpsilon:G(10,-30),RecursionLimit:16,CuspLimit:0,Tolerance:{distance:0.25,angle:0,epsilon:0.01}},devicePixelRatio:m.devicePixelRatio||1,getBackingStoreRatio:function(a){return a.webkitBackingStorePixelRatio||a.mozBackingStorePixelRatio||a.msBackingStorePixelRatio||a.oBackingStorePixelRatio||a.backingStorePixelRatio||1},getRatio:function(a){return c.Utils.devicePixelRatio/
E(a)},setPlaying:function(a){this.playing=!!a;return this},getComputedMatrix:function(a,b){b=b&&b.identity()||new c.Matrix;for(var r=a;r&&r._matrix;){var g=r._matrix.elements;b.multiply(g[0],g[1],g[2],g[3],g[4],g[5],g[6],g[7],g[8],g[9]);r=r.parent}return b},applySvgAttributes:function(a,b){_.each(a.attributes,function(a,c){switch(a.nodeName){case "visibility":b.visible=!!a.nodeValue;break;case "stroke-linecap":b.cap=a.nodeValue;break;case "stroke-linejoin":b.join=a.nodeValue;break;case "stroke-miterlimit":b.miter=
...
a),b.add(a)))},this);return c.Utils.applySvgAttributes(a,b)},polygon:function(a,b){var d=[];a.getAttribute("points").replace(/([\d\.?]+),([\d\.?]+)/g,function(a,b,g){d.push(new c.Anchor(parseFloat(b),parseFloat(g)))});var g=(new c.Polygon(d,!b)).noStroke();return c.Utils.applySvgAttributes(a,g)},polyline:function(a){return c.Utils.read.polygon(a,!0)},path:function(a){var b,d,g,l=!1,f=!1,n=a.getAttribute("d").match(/[a-df-z][^a-df-z]*/ig),q=n.length-1,n=_.flatten(_.map(n,function(a,n){var k,p,m=a[0],
v=m.toLowerCase();g=a.slice(1).trim();g=g.replace(/(-?\d+(?:\.\d*)?)[eE]([+\-]?\d+)/g,function(a,b,c){return parseFloat(b)*Math.pow(10,c)});g=g.split(/[\s,]+|(?=\s?[+\-])/);l=m===v;var e,h,t,s;switch(v){case "z":n>=q?f=!0:(p=b.x,k=b.y,k=new c.Anchor(p,k,void 0,void 0,void 0,void 0,c.Commands.close));break;case "m":case "l":p=parseFloat(g[0]);k=parseFloat(g[1]);k=new c.Anchor(p,k,void 0,void 0,void 0,void 0,"m"===v?c.Commands.move:c.Commands.line);l&&k.addSelf(b);k.controls.left.copy(k);k.controls.right.copy(k);
b=k;break;case "h":case "v":p="h"===v?"x":"y";m="x"===p?"y":"x";k=new c.Anchor(void 0,void 0,void 0,void 0,void 0,void 0,c.Commands.line);k[p]=parseFloat(g[0]);k[m]=b[m];l&&(k[p]+=b[p]);k.controls.left.copy(k);k.controls.right.copy(k);b=k;break;case "s":case "c":k=b.x;m=b.y;d||(d=(new c.Vector).copy(b));"c"===v?(e=parseFloat(g[0]),p=parseFloat(g[1]),v=parseFloat(g[2]),h=parseFloat(g[3]),t=parseFloat(g[4]),s=parseFloat(g[5])):(h=c.Utils.getReflection(b,d,l),e=h.x,p=h.y,v=parseFloat(g[0]),h=parseFloat(g[1]),
t=parseFloat(g[2]),s=parseFloat(g[3]));l&&(e+=k,p+=m,v+=k,h+=m,t+=k,s+=m);_.isObject(b.controls)||c.Anchor.AppendCurveProperties(b);b.controls.right.set(e,p);b=k=new c.Anchor(t,s,v,h,void 0,void 0,c.Commands.curve);d=k.controls.left;break;case "t":case "q":k=b.x;m=b.y;d||(d=(new c.Vector).copy(b));d.isZero()?(e=k,p=m):(e=d.x,m=d.y);"q"===v?(v=parseFloat(g[0]),h=parseFloat(g[1]),t=parseFloat(g[1]),s=parseFloat(g[2])):(h=c.Utils.getReflection(b,d,l),v=h.x,h=h.y,t=parseFloat(g[0]),s=parseFloat(g[1]));
l&&(e+=k,p+=m,v+=k,h+=m,t+=k,s+=m);_.isObject(b.controls)||c.Anchor.AppendCurveProperties(b);b.controls.right.set(e,p);b=k=new c.Anchor(t,s,v,h,void 0,void 0,c.Commands.curve);d=k.controls.left;break;case "a":throw new c.Utils.Error("not yet able to interpret Elliptical Arcs.");}return k}));if(!(1>=n.length))return n=_.compact(n),n=(new c.Polygon(n,f,void 0,!0)).noStroke(),c.Utils.applySvgAttributes(a,n)},circle:function(a){var b=parseFloat(a.getAttribute("cx")),d=parseFloat(a.getAttribute("cy")),
g=parseFloat(a.getAttribute("r")),k=c.Resolution,u=_.map(_.range(k),function(a){var b=a/k*l;a=g*q(b);b=g*f(b);return new c.Anchor(a,b)},this),u=(new c.Polygon(u,!0,!0)).noStroke();u.translation.set(b,d);return c.Utils.applySvgAttributes(a,u)},ellipse:function(a){var b=parseFloat(a.getAttribute("cx")),d=parseFloat(a.getAttribute("cy")),g=parseFloat(a.getAttribute("rx")),k=parseFloat(a.getAttribute("ry")),u=c.Resolution,n=_.map(_.range(u),function(a){var b=a/u*l;a=g*q(b);b=k*f(b);return new c.Anchor(a,
b)},this),n=(new c.Polygon(n,!0,!0)).noStroke();n.translation.set(b,d);return c.Utils.applySvgAttributes(a,n)},rect:function(a){var b=parseFloat(a.getAttribute("x")),d=parseFloat(a.getAttribute("y")),g=parseFloat(a.getAttribute("width")),l=parseFloat(a.getAttribute("height")),g=g/2,l=l/2,f=[new c.Anchor(g,l),new c.Anchor(-g,l),new c.Anchor(-g,-l),new c.Anchor(g,-l)],f=(new c.Polygon(f,!0)).noStroke();f.translation.set(b+g,d+l);return c.Utils.applySvgAttributes(a,f)},line:function(a){var b=parseFloat(a.getAttribute("x1")),
d=parseFloat(a.getAttribute("y1")),g=parseFloat(a.getAttribute("x2")),l=parseFloat(a.getAttribute("y2")),g=(g-b)/2,l=(l-d)/2,f=[new c.Anchor(-g,-l),new c.Anchor(g,l)],f=(new c.Polygon(f)).noFill();f.translation.set(b+g,d+l);return c.Utils.applySvgAttributes(a,f)}},subdivide:function(a,b,d,g,l,f,k,n,q){q=q||c.Utils.Curve.RecursionLimit;var p=q+1;return _.map(_.range(0,p),function(q){var m=q/p;q=F(m,a,d,l,k);m=F(m,b,g,f,n);return new c.Anchor(q,m)})},getPointOnCubicBezier:function(a,b,c,g,d){var l=
1-a;return l*l*l*b+3*l*l*a*c+3*l*a*a*g+a*a*a*d},getCurveFromPoints:function(a,b){for(var d=a.length,g=d-1,l=0;l<d;l++){var f=a[l];_.isObject(f.controls)||c.Anchor.AppendCurveProperties(f);var k=b?z(l-1,d):Math.max(l-1,0),n=b?z(l+1,d):Math.min(l+1,g);y(a[k],f,a[n]);f._command=0===l?c.Commands.move:c.Commands.curve;f.controls.left.x=_.isNumber(f.controls.left.x)?f.controls.left.x:f.x;f.controls.left.y=_.isNumber(f.controls.left.y)?f.controls.left.y:f.y;f.controls.right.x=_.isNumber(f.controls.right.x)?
f.controls.right.x:f.x;f.controls.right.y=_.isNumber(f.controls.right.y)?f.controls.right.y:f.y}},getControlPoints:function(a,b,d){var g=A(a,b),l=A(d,b);a=C(a,b);d=C(d,b);var k=(g+l)/2;b.u=_.isObject(b.controls.left)?b.controls.left:new c.Vector(b.x,b.y);b.v=_.isObject(b.controls.right)?b.controls.right:new c.Vector(b.x,b.y);if(1E-4>a||1E-4>d)return b.controls.left.copy(b),b.controls.right.copy(b),b;a*=0.33;d*=0.33;k=l<g?k+v:k-v;b.controls.left.x=b.x+q(k)*a;b.controls.left.y=b.y+f(k)*a;k-=n;b.controls.right.x=
b.x+q(k)*d;b.controls.right.y=b.y+f(k)*d;return b},getReflection:function(a,b,d){var g=a.distanceTo(b);if(1E-4>=g)return d?new c.Vector:a.clone();b=A(a,b);return new c.Vector(g*Math.cos(b)+(d?0:a.x),g*Math.sin(b)+(d?0:a.y))},angleBetween:function(a,b){var c,g;if(4<=arguments.length)return c=arguments[0]-arguments[2],g=arguments[1]-arguments[3],p(g,c);c=a.x-b.x;g=a.y-b.y;return p(g,c)},distanceBetweenSquared:function(a,b){var c=a.x-b.x,g=a.y-b.y;return c*c+g*g},distanceBetween:function(a,b){return d(x(a,
b))},mod:function(a,b){for(;0>a;)a+=b;return a%b},Collection:function(){Array.call(this);1<arguments.length?Array.prototype.push.apply(this,arguments):arguments[0]&&Array.isArray(arguments[0])&&Array.prototype.push.apply(this,arguments[0])},Error:function(a){this.name="two.js";this.message=a}}});c.Utils.Error.prototype=Error();c.Utils.Error.prototype.constructor=c.Utils.Error;c.Utils.Collection.prototype=[];c.Utils.Collection.constructor=c.Utils.Collection;_.extend(c.Utils.Collection.prototype,Backbone.Events,
{pop:function(){var a=Array.prototype.pop.apply(this,arguments);this.trigger(c.Events.remove,[a]);return a},shift:function(){var a=Array.prototype.shift.apply(this,arguments);this.trigger(c.Events.remove,[a]);return a},push:function(){var a=Array.prototype.push.apply(this,arguments);this.trigger(c.Events.insert,arguments);return a},unshift:function(){var a=Array.prototype.unshift.apply(this,arguments);this.trigger(c.Events.insert,arguments);return a},splice:function(){var a=Array.prototype.splice.apply(this,
arguments),b;this.trigger(c.Events.remove,a);2<arguments.length&&(b=this.slice(arguments[0],arguments.length-2),this.trigger(c.Events.insert,b));return a}});var C=c.Utils.distanceBetween,x=c.Utils.distanceBetweenSquared,A=c.Utils.angleBetween,y=c.Utils.getControlPoints,z=c.Utils.mod,E=c.Utils.getBackingStoreRatio,F=c.Utils.getPointOnCubicBezier;_.extend(c.prototype,Backbone.Events,{appendTo:function(a){a.appendChild(this.renderer.domElement);return this},play:function(){c.Utils.setPlaying.call(this,
!0);return this.trigger(c.Events.play)},pause:function(){this.playing=!1;return this.trigger(c.Events.pause)},update:function(){var a=!!this._lastFrame,b=(m.performance&&m.performance.now?m.performance:Date).now();this.frameCount++;a&&(this.timeDelta=parseFloat((b-this._lastFrame).toFixed(3)));this._lastFrame=b;var a=this.width,b=this.height,d=this.renderer;a===d.width&&b===d.height||d.setSize(a,b,this.ratio);this.trigger(c.Events.update,this.frameCount,this.timeDelta);return this.render()},render:function(){this.renderer.render();
return this.trigger(c.Events.render,this.frameCount)},add:function(a){var b=a;_.isArray(a)||(b=_.toArray(arguments));this.scene.add(b);return this},remove:function(a){var b=a;_.isArray(a)||(b=_.toArray(arguments));this.scene.remove(b);return this},clear:function(){this.scene.remove(_.toArray(this.scene.children));return this},makeLine:function(a,b,d,g){d=(d-a)/2;g=(g-b)/2;var l=[new c.Anchor(-d,-g),new c.Anchor(d,g)],l=(new c.Polygon(l)).noFill();l.translation.set(a+d,b+g);this.scene.add(l);return l},
makeRectangle:function(a,b,d,g){d/=2;g/=2;g=[new c.Anchor(d,g),new c.Anchor(-d,g),new c.Anchor(-d,-g),new c.Anchor(d,-g)];g=new c.Polygon(g,!0);g.translation.set(a,b);this.scene.add(g);return g},makeCircle:function(a,b,c){return this.makeEllipse(a,b,c,c)},makeEllipse:function(a,b,d,g){var k=c.Resolution,n=_.map(_.range(k),function(a){var b=a/k*l;a=d*q(b);b=g*f(b);return new c.Anchor(a,b)},this),n=new c.Polygon(n,!0,!0);n.translation.set(a,b);this.scene.add(n);return n},makeCurve:function(a){var b=
arguments.length,d=a;if(!_.isArray(a))for(var d=[],g=0;g<b;g+=2){var l=arguments[g];if(!_.isNumber(l))break;d.push(new c.Anchor(l,arguments[g+1]))}var b=arguments[b-1],d=new c.Polygon(d,!(_.isBoolean(b)&&b),!0),b=d.getBoundingClientRect(),f=b.left+b.width/2,k=b.top+b.height/2;_.each(d.vertices,function(a){a.x-=f;a.y-=k});d.translation.set(f,k);this.scene.add(d);return d},makePolygon:function(a){var b=arguments.length,d=a;if(!_.isArray(a))for(var d=[],g=0;g<b;g+=2){var l=arguments[g];if(!_.isNumber(l))break;
d.push(new c.Anchor(l,arguments[g+1]))}b=arguments[b-1];d=new c.Polygon(d,!(_.isBoolean(b)&&b));b=d.getBoundingClientRect();d.center().translation.set(b.left+b.width/2,b.top+b.height/2);this.scene.add(d);return d},makeGroup:function(a){var b=a;_.isArray(a)||(b=_.toArray(arguments));var d=new c.Group;this.scene.add(d);d.add(b);return d},interpret:function(a){var b=a.tagName.toLowerCase();if(!(b in c.Utils.read))return null;a=c.Utils.read[b].call(this,a);this.add(a);return a}});(function(){requestAnimationFrame(arguments.callee);
_.each(c.Instances,function(a){a.playing&&a.update()})})();"function"===typeof define&&define.amd?define(function(){return c}):"undefined"!=typeof module&&module.exports&&(module.exports=c)})();(function(){var B,m,k,f,q=Two.Vector=function(d,f){this.x=d||0;this.y=f||0};_.extend(q.prototype,Backbone.Events,{set:function(d,f){this.x=d;this.y=f;return this},copy:function(d){this.x=d.x;this.y=d.y;return this},clear:function(){this.y=this.x=0;return this},clone:function(){return new q(this.x,this.y)},add:function(d,f){this.x=d.x+f.x;this.y=d.y+f.y;return this},addSelf:function(d){this.x+=d.x;this.y+=d.y;return this},sub:function(d,f){this.x=d.x-f.x;this.y=d.y-f.y;return this},subSelf:function(d){this.x-=
...
distanceTo:function(d){return Math.sqrt(this.distanceToSquared(d))},distanceToSquared:function(d){k=this.x-d.x;f=this.y-d.y;return k*k+f*f},setLength:function(d){return this.normalize().multiplyScalar(d)},equals:function(d){return 1E-4>this.distanceTo(d)},lerp:function(d,f){B=(d.x-this.x)*f+this.x;m=(d.y-this.y)*f+this.y;return this.set(B,m)},isZero:function(){return 1E-4>this.length()},toString:function(){return this.x+","+this.y},toObject:function(){return{x:this.x,y:this.y}}});var p={set:function(d,
...
this._x+this._y*this._y},length:function(){return Math.sqrt(this.lengthSquared())},normalize:function(){return this.divideScalar(this.length())},distanceTo:function(d){return Math.sqrt(this.distanceToSquared(d))},distanceToSquared:function(d){k=this._x-d.x;f=this._y-d.y;return k*k+f*f},setLength:function(d){return this.normalize().multiplyScalar(d)},equals:function(d){return 1E-4>this.distanceTo(d)},lerp:function(d,f){B=(d.x-this._x)*f+this._x;m=(d.y-this._y)*f+this._y;return this.set(B,m)},isZero:function(){return 1E-4>
...
!0);Backbone.Events.bind.apply(this,arguments);return this}})();(function(){var B=Two.Commands,m,k,f,q=Two.Anchor=function(d,f,k,p,m,w,s){Two.Vector.call(this,d,f);this._broadcast=_.bind(function(){this.trigger(Two.Events.change)},this);Object.defineProperty(this,"command",{get:function(){return this._command},set:function(c){this._command=c;this._command!==B.curve||_.isObject(this.controls)||q.AppendCurveProperties(this);return this.trigger(Two.Events.change)}});this._command=s||B.move;if(!s)return this;q.AppendCurveProperties(this);_.isNumber(k)&&(this.controls.left.x=
k);_.isNumber(p)&&(this.controls.left.y=p);_.isNumber(m)&&(this.controls.right.x=m);_.isNumber(w)&&(this.controls.right.y=w)};_.extend(q,{AppendCurveProperties:function(d){m=d._x||d.x;k=d._y||d.y;d.controls={left:new Two.Vector(m,k),right:new Two.Vector(m,k)}}});var p={listen:function(){_.isObject(this.controls)||q.AppendCurveProperties(this);_.each(this.controls,function(d){d.bind(Two.Events.change,this._broadcast)},this);return this},ignore:function(){_.each(this.controls,function(d){d.unbind(Two.Events.change,
...
arguments);_.extend(this,p)}})();(function(){_.range(6);var B=Math.cos,m=Math.sin,k=Math.tan,f,q,p,d,n,l,v,G,w,s,c,C,x,A,y,z,E,F,a,b,r,g,H,u,D,I,J,M,P,N,O,L,e,h,t,ea,S,T,$,ba,U,V,W,X,aa,ca,da,Y,Q,Z=[],fa=Two.Matrix=function(a,b,c,d,e,g){this.elements=new Two.Array(9);var h=a;_.isArray(h)||(h=_.toArray(arguments));this.identity().set(h)};_.extend(fa,{Identity:[1,0,0,0,1,0,0,0,1],Multiply:function(c,d,e){if(3>=d.length)return C,x,A,f=d[0]||0,q=d[1]||0,p=d[2]||0,n=c,C=n[0]*f+n[1]*q+n[2]*p,x=n[3]*f+n[4]*q+n[5]*p,A=n[6]*f+n[7]*q+n[8]*
p,{x:C,y:x,z:A};y=c[0];z=c[1];E=c[2];F=c[3];a=c[4];b=c[5];r=c[6];g=c[7];H=c[8];u=d[0];D=d[1];I=d[2];J=d[3];M=d[4];P=d[5];N=d[6];O=d[7];L=d[8];e=e||new Two.Array(9);e[0]=y*u+z*J+E*N;e[1]=y*D+z*M+E*O;e[2]=y*I+z*P+E*L;e[3]=F*u+a*J+b*N;e[4]=F*D+a*M+b*O;e[5]=F*I+a*P+b*L;e[6]=r*u+g*J+H*N;e[7]=r*D+g*M+H*O;e[8]=r*I+g*P+H*L;return e}});_.extend(fa.prototype,Backbone.Events,{set:function(a,b,d,e,g,h){c=a;t=arguments.length;_.isArray(c)||(c=_.toArray(arguments));_.each(c,function(a,b){_.isNumber(a)&&(this.elements[b]=
a)},this);return this.trigger(Two.Events.change)},identity:function(){this.set(fa.Identity);return this},multiply:function(d,f,k,l,n,q,p,m,ma){c=arguments;t=c.length;if(1>=t)return _.each(this.elements,function(a,b){this.elements[b]=a*d},this),this.trigger(Two.Events.change);if(3>=t)return C,x,A,d=d||0,f=f||0,k=k||0,n=this.elements,C=n[0]*d+n[1]*f+n[2]*k,x=n[3]*d+n[4]*f+n[5]*k,A=n[6]*d+n[7]*f+n[8]*k,{x:C,y:x,z:A};e=this.elements;h=c;y=e[0];z=e[1];E=e[2];F=e[3];a=e[4];b=e[5];r=e[6];g=e[7];H=e[8];u=
h[0];D=h[1];I=h[2];J=h[3];M=h[4];P=h[5];N=h[6];O=h[7];L=h[8];this.elements[0]=y*u+z*J+E*N;this.elements[1]=y*D+z*M+E*O;this.elements[2]=y*I+z*P+E*L;this.elements[3]=F*u+a*J+b*N;this.elements[4]=F*D+a*M+b*O;this.elements[5]=F*I+a*P+b*L;this.elements[6]=r*u+g*J+H*N;this.elements[7]=r*D+g*M+H*O;this.elements[8]=r*I+g*P+H*L;return this.trigger(Two.Events.change)},inverse:function(a){f=this.elements;a=a||new Two.Matrix;S=f[0];T=f[1];$=f[2];ba=f[3];U=f[4];V=f[5];W=f[6];X=f[7];aa=f[8];ca=aa*U-V*X;da=-aa*
...
0,a,0,1,b,0,0,1)},skewX:function(a){f=k(a);return this.multiply(1,f,0,0,1,0,0,0,1)},skewY:function(a){f=k(a);return this.multiply(1,0,0,f,1,0,0,0,1)},toString:function(a){this.toArray(a,Z);return Z.join(" ")},toArray:function(a,b){c=this.elements;s=!!b;f=parseFloat(c[0].toFixed(3));q=parseFloat(c[1].toFixed(3));p=parseFloat(c[2].toFixed(3));d=parseFloat(c[3].toFixed(3));n=parseFloat(c[4].toFixed(3));l=parseFloat(c[5].toFixed(3));if(a){v=parseFloat(c[6].toFixed(3));G=parseFloat(c[7].toFixed(3));w=
parseFloat(c[8].toFixed(3));if(s){b[0]=f;b[1]=d;b[2]=v;b[3]=q;b[4]=n;b[5]=G;b[6]=p;b[7]=l;b[8]=w;return}return[f,d,v,q,n,G,p,l,w]}if(s)b[0]=f,b[1]=d,b[2]=q,b[3]=n,b[4]=p,b[5]=l;else return[f,d,q,n,p,l]},clone:function(){f=this.elements[0];q=this.elements[1];p=this.elements[2];d=this.elements[3];n=this.elements[4];l=this.elements[5];v=this.elements[6];G=this.elements[7];w=this.elements[8];return new Two.Matrix(f,q,p,d,n,l,v,G,w)}})})();(function(){var B=Two.Utils.mod,m,k,f,q={version:1.1,ns:"http://www.w3.org/2000/svg",xlink:"http://www.w3.org/1999/xlink",createElement:function(d,n){f=d;k=document.createElementNS(this.ns,f);"svg"===f&&(n=_.defaults(n||{},{version:this.version}));_.isObject(n)&&q.setAttributes(k,n);return k},setAttribute:function(d,f){this.setAttribute(f,d)},setAttributes:function(d,f){_.each(f,q.setAttribute,d);return this},removeAttribute:function(d,f){this.removeAttribute(f)},removeAttributes:function(d,f){_.each(f,
q.removeAttribute,d);return this},toString:function(d,f){var k=d.length,q=k-1;return _.map(d,function(p,m){var s,c=f?B(m-1,k):Math.max(m-1,0),C=f?B(m+1,k):Math.min(m+1,q),c=d[c],C=d[C],x,A,y,z,E;E=p.x.toFixed(3);z=p.y.toFixed(3);switch(p._command){case Two.Commands.close:s=Two.Commands.close;break;case Two.Commands.curve:x=c.controls&&c.controls.right||c;s=p.controls&&p.controls.left||p;c=x.x.toFixed(3);x=x.y.toFixed(3);A=s.x.toFixed(3);y=s.y.toFixed(3);s=(0===m?Two.Commands.move:Two.Commands.curve)+
" "+c+" "+x+" "+A+" "+y+" "+E+" "+z;break;default:s=(0===m?Two.Commands.move:p._command)+" "+E+" "+z}m>=q&&f&&(p._command===Two.Commands.curve&&(z=p.controls&&p.controls.right||p,E=C.controls&&C.controls.left||C,c=z.x.toFixed(3),x=z.y.toFixed(3),A=E.x.toFixed(3),y=E.y.toFixed(3),E=C.x.toFixed(3),z=C.y.toFixed(3),s+=" C "+c+" "+x+" "+A+" "+y+" "+E+" "+z),s+=" Z");return s}).join(" ")},group:{appendChild:function(d){(k=this.domElement.querySelector("#"+Two.Identifier+d))&&this.elem.appendChild(k)},
removeChild:function(d){(k=this.domElement.querySelector("#"+Two.Identifier+d))&&this.elem.removeChild(k)},renderChild:function(d){q[d._renderer.type].render.call(d,this)},render:function(d){this._update();this._renderer.elem||(this._renderer.elem=q.createElement("g",{id:Two.Identifier+this.id}),d.appendChild(this._renderer.elem));m=this._matrix.manual||this._flagMatrix;var f={domElement:d,elem:this._renderer.elem};m&&this._renderer.elem.setAttribute("transform","matrix("+this._matrix.toString()+
")");_.each(this.children,q.group.renderChild,d);this._flagAdditions&&_.each(this.additions,q.group.appendChild,f);this._flagSubtractions&&_.each(this.subtractions,q.group.removeChild,f);return this.flagReset()}},polygon:{render:function(d){this._update();this._renderer.elem||(this._renderer.elem=q.createElement("path",{id:Two.Identifier+this.id}),d.appendChild(this._renderer.elem));k=this._renderer.elem;(m=this._matrix.manual||this._flagMatrix)&&k.setAttribute("transform","matrix("+this._matrix.toString()+
")");this._flagVertices&&(vertices=q.toString(this._vertices,this._closed),k.setAttribute("d",vertices));this._flagFill&&k.setAttribute("fill",this._fill);this._flagStroke&&k.setAttribute("stroke",this._stroke);this._flagLinewidth&&k.setAttribute("stroke-width",this._linewidth);this._flagOpacity&&(k.setAttribute("stroke-opacity",this._opacity),k.setAttribute("fill-opacity",this._opacity));this._flagVisible&&k.setAttribute("visibility",this._visible?"visible":"hidden");this._flagCap&&k.setAttribute("stroke-linecap",
this._cap);this._flagJoin&&k.setAttribute("stroke-linejoin",this._join);this._flagMiter&&k.setAttribute("stroke-miterlimit",this.miter);return this.flagReset()}}},p=Two[Two.Types.svg]=function(d){this.domElement=d.domElement||q.createElement("svg");this.scene=new Two.Group;this.scene.parent=this};_.extend(p,{Utils:q});_.extend(p.prototype,Backbone.Events,{setSize:function(d,f){this.width=d;this.height=f;q.setAttributes(this.domElement,{width:d,height:f});return this},render:function(){q.group.render.call(this.scene,
this.domElement);return this}})})();(function(){var B=Two.Utils.mod,m=Two.Utils.getRatio,k,f,q,p,d,n,l,v,G,w,s,c,C,x,A,y,z,E,F,a,b,r,g,H,u,D,I,J={group:{renderChild:function(a){J[a._renderer.type].render.call(a,this)},render:function(a){this._update();k=this._matrix.elements;a.save();a.transform(k[0],k[3],k[1],k[4],k[2],k[5]);_.each(this.children,J.group.renderChild,a);a.restore();return this.flagReset()}},polygon:{render:function(m){this._update();k=this._matrix.elements;f=this.stroke;q=this.linewidth;p=this.fill;d=this.opacity;n=
this.visible;l=this.cap;v=this.join;G=this.miter;w=this.closed;s=this._vertices;c=s.length;C=c-1;if(!n)return this;m.save();k&&m.transform(k[0],k[3],k[1],k[4],k[2],k[5]);p&&(m.fillStyle=p);f&&(m.strokeStyle=f);q&&(m.lineWidth=q);G&&(m.miterLimit=G);v&&(m.lineJoin=v);l&&(m.lineCap=l);_.isNumber(d)&&(m.globalAlpha=d);m.beginPath();_.each(s,function(d,f){D=d.x.toFixed(3);I=d.y.toFixed(3);switch(d._command){case Two.Commands.close:m.closePath();break;case Two.Commands.curve:A=w?B(f-1,c):Math.max(f-1,
...
this.ratio;_.extend(this.domElement.style,{width:a+"px",height:b+"px"});return this},render:function(){var a=1===this.ratio;a||(this.ctx.save(),this.ctx.scale(this.ratio,this.ratio));this.overdraw||this.ctx.clearRect(0,0,this.width,this.height);J.group.render.call(this.scene,this.ctx);a||this.ctx.restore();return this}})})();(function(){var B=Two.Matrix.Multiply,m=Two.Utils.mod,k=[1,0,0,0,1,0,0,0,1],f=new Two.Array(9),q=Two.Utils.getRatio,p,d,n,l,v,G,w,s,c,C,x,A,y,z,E,F,a,b,r,g,H,u,D,I,J,M,P,N,O,L,e,h,t,ea,S,T,$,ba,U,V,W,X,aa,ca,da,Y,Q,Z,fa,ga,K,ia,ja,ka,ha,R={canvas:document.createElement("canvas"),uv:new Two.Array([0,0,1,0,0,1,0,1,1,0,1,1]),group:{renderChild:function(a){R[a._renderer.type].render.call(a,this.gl,this.program)},render:function(a,b){this._update();p=this.parent;d=p._matrix&&p._matrix.manual||p._flagMatrix;
...
!1,0,0);a.drawArrays(a.TRIANGLES,0,6);return this.flagReset()}},getBoundingClientRect:function(d,e,g){v=Infinity;G=-Infinity;w=Infinity;s=-Infinity;_.each(d,function(b,d){c=b.x;C=b.y;x;A;y;z;E=b.controls;w=Math.min(C,w);v=Math.min(c,v);G=Math.max(c,G);s=Math.max(C,s);b.controls&&(F=E.left,a=E.right,F&&a&&(x=F.x,A=F.y,y=a.x,z=a.y,x&&(A&&y&&z)&&(w=Math.min(A,z,w),v=Math.min(x,y,v),G=Math.max(x,y,G),s=Math.max(A,z,s))))});_.isNumber(e)&&(w-=e,v-=e,G+=e,s+=e);b=G-v;r=s-w;g.top=w;g.left=v;g.right=G;g.bottom=
s;g.width=b;g.height=r;g.centroid||(g.centroid={});g.centroid.x=-v;g.centroid.y=-w},getTriangles:function(a,b){w=a.top;v=a.left;G=a.right;s=a.bottom;b[0]=v;b[1]=w;b[2]=G;b[3]=w;b[4]=v;b[5]=s;b[6]=v;b[7]=s;b[8]=G;b[9]=w;b[10]=G;b[11]=s},updateCanvas:function(a){g=a._vertices;H=this.canvas;u=this.ctx;D=a._renderer.scale;I=a._stroke;J=a._linewidth*D;M=a._fill;P=a._opacity;N=a._cap;O=a._join;L=a._miter;e=a._closed;h=g.length;t=h-1;H.width=Math.max(Math.ceil(a._renderer.rect.width*D),1);H.height=Math.max(Math.ceil(a._renderer.rect.height*
D),1);ea=a._renderer.rect.centroid;S=ea.x*D;T=ea.y*D;u.clearRect(0,0,H.width,H.height);M&&(u.fillStyle=M);I&&(u.strokeStyle=I);J&&(u.lineWidth=J);L&&(u.miterLimit=L);O&&(u.lineJoin=O);N&&(u.lineCap=N);_.isNumber(P)&&(u.globalAlpha=P);u.beginPath();_.each(g,function(a,b){$;ba;x;y;U;V;W;X;aa;ca;da;F;c=(a.x*D+S).toFixed(3);C=(a.y*D+T).toFixed(3);switch(a._command){case Two.Commands.close:u.closePath();break;case Two.Commands.curve:ba=e?m(b-1,h):Math.max(b-1,0);$=e?m(b+1,h):Math.min(b+1,t);x=g[ba];y=
...
a.createBuffer();a.bindBuffer(a.ARRAY_BUFFER,b._renderer.textureCoordsBuffer);a.enableVertexAttribArray(c.textureCoords);a.bufferData(a.ARRAY_BUFFER,this.uv,a.STATIC_DRAW)},program:{create:function(a,b){Y=a.createProgram();_.each(b,function(b){a.attachShader(Y,b)});a.linkProgram(Y);Q=a.getProgramParameter(Y,a.LINK_STATUS);if(!Q)throw ga=a.getProgramInfoLog(Y),a.deleteProgram(Y),new Two.Utils.Error("unable to link program: "+ga);return Y}},shaders:{create:function(a,b,c){Z=a.createShader(a[c]);a.shaderSource(Z,
...
fragment:"precision mediump float;\n\nuniform sampler2D u_image;\nvarying vec2 v_textureCoords;\n\nvoid main() {\n  gl_FragColor = texture2D(u_image, v_textureCoords);\n}"}};R.ctx=R.canvas.getContext("2d");var la=Two[Two.Types.webgl]=function(a){this.domElement=a.domElement||document.createElement("canvas");this.scene=new Two.Group;this.scene.parent=this;this._renderer={matrix:new Two.Array(k),scale:1};this._flagMatrix=!0;ha=_.defaults(a||{},{antialias:!1,alpha:!0,premultipliedAlpha:!0,stencil:!0,
...
I=(A||b).x;J=(A||b).y;M=(x||c).x;P=(x||c).y;N=c.x;O=c.y;var g=Two.Utils.subdivide(u,D,I,J,M,P,N,O,a);w=w.concat(g);_.each(g,function(a,c){a.command=0>=c&&b.command===Two.Commands.move?Two.Commands.move:Two.Commands.line});d>=n&&(w.push(new Two.Anchor(N,O)),w[w.length-1].command=l?Two.Commands.close:Two.Commands.line)}b=c},this);this._curved=this._automatic=!1;this.vertices=w;return this},_update:function(){if(this._flagVertices)for(this._automatic&&this.plot(),q=this.vertices.length,n=q-1,p=k(this._beginning*
n),d=k(this._ending*n),this._vertices.length=0,G=p;G<d+1;G++)v=this.vertices[G],this._vertices.push(v);Two.Shape.prototype._update.call(this);return this},flagReset:function(){this._flagVertices=this._flagFill=this._flagStroke=this._flagLinewidth=this._flagOpacity=this._flagVisible=this._flagCap=this._flagJoin=this._flagMiter=!1;Two.Shape.prototype.flagReset.call(this);return this}});L.MakeObservable(L.prototype)})();(function(){var B=Math.min,m=Math.max,k,f,q,p,d,n,l,v,G,w,s,c,C,x,A,y,z,E,F,a,b,r=Two.Group=function(a){Two.Shape.call(this,!0);this._renderer.type="group";this.additions=[];this.subtractions=[];this.children={}};_.extend(r,{MakeObservable:function(a){Two.Shape.MakeObservable(a);r.MakeGetterSetter(a,Two.Polygon.Properties)},MakeGetterSetter:function(a,b){_.isArray(b)||(b=[b]);_.each(b,function(b){k="_"+b;Object.defineProperty(a,b,{get:function(){return this[k]},set:function(a){this[k]=a;_.each(this.children,
function(c){c[b]=a})}})})}});_.extend(r.prototype,Two.Shape.prototype,{_flagAdditions:!1,_flagSubtractions:!1,_fill:"#fff",_stroke:"#000",_linewidth:1,_opacity:1,_visible:!0,_cap:"round",_join:"round",_miter:4,_closed:!0,_curved:!1,_automatic:!0,_beginning:0,_ending:1,clone:function(a){a=a||this.parent;p=new r;a.add(p);q=_.map(this.children,function(a){return a.clone(p)});p.translation.copy(this.translation);p.rotation=this.rotation;p.scale=this.scale;return p},toObject:function(){var a={children:{},
